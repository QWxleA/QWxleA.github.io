...
var block = (function (){var G__51155 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id__$1], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__51155) : frontend.db.entity.call(null,G__51155));
})();
...
var map__51160 = frontend.util.calc_delta_rect_offset(el,document.documentElement);
var map__51160__$1 = cljs.core.__destructure_map(map__51160);
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51160__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51160__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
...
return daiquiri.interpreter.interpret((function (){var temp__5720__auto__ = (function (){var G__51190 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__51190) : frontend.db.entity.call(null,G__51190));
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#custom-context-menu","div#custom-context-menu",16263198),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ref","ref",1289896967),_STAR_el_ref], null),new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.py-1.rounded-md.bg-base-3.shadow-xs","div.py-1.rounded-md.bg-base-3.shadow-xs",-1742962126),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex-row.flex.justify-between.py-4.pl-2","div.flex-row.flex.justify-between.py-4.pl-2",696313401),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex-row.flex.justify-between","div.flex-row.flex.justify-between",-1427495066),(function (){var iter__5520__auto__ = (function frontend$components$content$iter__51191(s__51192){
return (new cljs.core.LazySeq(null,(function (){
var s__51192__$1 = s__51192;
while(true){
var temp__5720__auto____$1 = cljs.core.seq(s__51192__$1);
if(temp__5720__auto____$1){
var s__51192__$2 = temp__5720__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__51192__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__51192__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__51194 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__51193 = (0);
while(true){
if((i__51193 < size__5519__auto__)){
var color = cljs.core._nth(c__5518__auto__,i__51193);
cljs.core.chunk_append(b__51194,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.m-2.shadow-sm","a.m-2.shadow-sm",982721374),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__51193,color,c__5518__auto__,size__5519__auto__,b__51194,s__51192__$2,temp__5720__auto____$1,properties,heading_QMARK_,block,temp__5720__auto__,_STAR_el_ref){
return (function (_e){
return frontend.handler.editor.set_block_property_BANG_(block_id,"background-color",color);
});})(i__51193,color,c__5518__auto__,size__5519__auto__,b__51194,s__51192__$2,temp__5720__auto____$1,properties,heading_QMARK_,block,temp__5720__auto__,_STAR_el_ref))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51194),frontend$components$content$iter__51191(cljs.core.chunk_rest(s__51192__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51194),null);
}
} else {
var color = cljs.core.first(s__51192__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.m-2.shadow-sm","a.m-2.shadow-sm",982721374),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (color,s__51192__$2,temp__5720__auto____$1,properties,heading_QMARK_,block,temp__5720__auto__,_STAR_el_ref){
return (function (_e){
return frontend.handler.editor.set_block_property_BANG_(block_id,"background-color",color);
});})(color,s__51192__$2,temp__5720__auto____$1,properties,heading_QMARK_,block,temp__5720__auto__,_STAR_el_ref))
], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.heading-bg","div.heading-bg",-1373479286),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),color], null)], null)], null)], null),frontend$components$content$iter__51191(cljs.core.rest(s__51192__$2)));
}
} else {
return null;
}
...
return frontend.handler.editor.copy_block_ref_BANG_.cljs$core$IFn$_invoke$arity$2(block_id,(function (p1__51158_SHARP_){
return ["((",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51158_SHARP_),"))"].join('');
}));
...
return frontend.handler.editor.copy_block_ref_BANG_.cljs$core$IFn$_invoke$arity$2(block_id,(function (p1__51159_SHARP_){
return frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("{{embed ((%s))}}",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__51159_SHARP_], 0));
}));
...
var iter__5520__auto__ = (function frontend$components$content$iter__51200(s__51201){
return (new cljs.core.LazySeq(null,(function (){
var s__51201__$1 = s__51201;
while(true){
var temp__5720__auto____$2 = cljs.core.seq(s__51201__$1);
if(temp__5720__auto____$2){
var s__51201__$2 = temp__5720__auto____$2;
if(cljs.core.chunked_seq_QMARK_(s__51201__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__51201__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__51203 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__51202 = (0);
while(true){
if((i__51202 < size__5519__auto__)){
var vec__51204 = cljs.core._nth(c__5518__auto__,i__51202);
...
var cmd = map__51207__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51207__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51207__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51204,(2),null);
var pid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51204,(3),null);
cljs.core.chunk_append(b__51203,frontend.ui.menu_link(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),key,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__51202,vec__51204,_,map__51207,map__51207__$1,cmd,key,label,action,pid,c__5518__auto__,size__5519__auto__,b__51203,s__51201__$2,temp__5720__auto____$2,cmds,temp__5720__auto____$1,properties,heading_QMARK_,block,temp__5720__auto__,_STAR_el_ref){
return (function (){
...
});})(i__51202,vec__51204,_,map__51207,map__51207__$1,cmd,key,label,action,pid,c__5518__auto__,size__5519__auto__,b__51203,s__51201__$2,temp__5720__auto____$2,cmds,temp__5720__auto____$1,properties,heading_QMARK_,block,temp__5720__auto__,_STAR_el_ref))
], null),label));

var G__51240 = (i__51202 + (1));
i__51202 = G__51240;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51203),frontend$components$content$iter__51200(cljs.core.chunk_rest(s__51201__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51203),null);
}
} else {
var vec__51208 = cljs.core.first(s__51201__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51208,(0),null);
var map__51211 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51208,(1),null);
var map__51211__$1 = cljs.core.__destructure_map(map__51211);
var cmd = map__51211__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51211__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51211__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51208,(2),null);
var pid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51208,(3),null);
return cljs.core.cons(frontend.ui.menu_link(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),key,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__51208,_,map__51211,map__51211__$1,cmd,key,label,action,pid,s__51201__$2,temp__5720__auto____$2,cmds,temp__5720__auto____$1,properties,heading_QMARK_,block,temp__5720__auto__,_STAR_el_ref){
return (function (){
return frontend.commands.exec_plugin_simple_command_BANG_(pid,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cmd,new cljs.core.Keyword(null,"uuid","uuid",-2145095719),block_id),action);
});})(vec__51208,_,map__51211,map__51211__$1,cmd,key,label,action,pid,s__51201__$2,temp__5720__auto____$2,cmds,temp__5720__auto____$1,properties,heading_QMARK_,block,temp__5720__auto__,_STAR_el_ref))
], null),label),frontend$components$content$iter__51200(cljs.core.rest(s__51201__$2)));
}
} else {
return null;
}
...
var _STAR_print_newline_STAR__orig_val__51212_51241 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51213_51242 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51214_51243 = true;
var _STAR_print_fn_STAR__temp_val__51215_51244 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51214_51243);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51215_51244);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1((function (){var G__51216 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__51216) : frontend.db.pull.call(null,G__51216));
})());
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51213_51242);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51212_51241);
}
...
return daiquiri.core.create_element("div",{'id':"custom-context-menu"},[daiquiri.core.create_element("div",{'className':"py-1 rounded-md bg-base-3 shadow-xs"},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5520__auto__ = (function frontend$components$content$iter__51217(s__51218){
return (new cljs.core.LazySeq(null,(function (){
var s__51218__$1 = s__51218;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__51218__$1);
if(temp__5720__auto__){
var s__51218__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__51218__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__51218__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__51220 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__51219 = (0);
while(true){
if((i__51219 < size__5519__auto__)){
var map__51221 = cljs.core._nth(c__5518__auto__,i__51219);
var map__51221__$1 = cljs.core.__destructure_map(map__51221);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51221__$1,new cljs.core.Keyword(null,"title","title",636505583));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51221__$1,new cljs.core.Keyword(null,"options","options",99638489));
cljs.core.chunk_append(b__51220,frontend.ui.menu_link(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),title], null),options], 0)),title));

var G__51245 = (i__51219 + (1));
i__51219 = G__51245;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51220),frontend$components$content$iter__51217(cljs.core.chunk_rest(s__51218__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51220),null);
}
} else {
var map__51222 = cljs.core.first(s__51218__$2);
var map__51222__$1 = cljs.core.__destructure_map(map__51222);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51222__$1,new cljs.core.Keyword(null,"title","title",636505583));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51222__$1,new cljs.core.Keyword(null,"options","options",99638489));
return cljs.core.cons(frontend.ui.menu_link(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),title], null),options], 0)),title),frontend$components$content$iter__51217(cljs.core.rest(s__51218__$2)));
}
} else {
return null;
}
...
frontend.components.content.hiccup_content = rum.core.lazy_build(rum.core.build_defc,(function (id,p__51223){
var map__51224 = p__51223;
var map__51224__$1 = cljs.core.__destructure_map(map__51224);
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51224__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var map__51227 = frontend.state.sub(new cljs.core.Keyword("block-ref","context","block-ref/context",-2102048446));
var map__51227__$1 = cljs.core.__destructure_map(map__51227);
var block = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51227__$1,new cljs.core.Keyword(null,"block","block",664686210));
var block_ref = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51227__$1,new cljs.core.Keyword(null,"block-ref","block-ref",362929756));
var map__51228 = frontend.state.sub(new cljs.core.Keyword("page-title","context","page-title/context",1788836745));
var map__51228__$1 = cljs.core.__destructure_map(map__51228);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51228__$1,new cljs.core.Keyword(null,"page","page",849072397));
...
var seq__51233 = cljs.core.seq(draws);
var chunk__51234 = null;
var count__51235 = (0);
var i__51236 = (0);
while(true){
if((i__51236 < count__51235)){
var draw = chunk__51234.cljs$core$IIndexed$_nth$arity$2(null,i__51236);
...
var height_51246 = (function (){var x__5128__auto__ = (700);
var y__5129__auto__ = (width__$1 / (2));
return ((x__5128__auto__ > y__5129__auto__) ? x__5128__auto__ : y__5129__auto__);
})();
dommy.core.set_style_BANG_.cljs$core$IFn$_invoke$arity$variadic(draw,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"height","height",1025178622),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(height_51246),"px"].join('')], 0));
...
var G__51247 = seq__51233;
var G__51248 = chunk__51234;
var G__51249 = count__51235;
var G__51250 = (i__51236 + (1));
seq__51233 = G__51247;
chunk__51234 = G__51248;
count__51235 = G__51249;
i__51236 = G__51250;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__51233);
if(temp__5720__auto__){
var seq__51233__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__51233__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__51233__$1);
var G__51251 = cljs.core.chunk_rest(seq__51233__$1);
var G__51252 = c__5565__auto__;
var G__51253 = cljs.core.count(c__5565__auto__);
var G__51254 = (0);
seq__51233 = G__51251;
chunk__51234 = G__51252;
count__51235 = G__51253;
i__51236 = G__51254;
continue;
} else {
var draw = cljs.core.first(seq__51233__$1);
dommy.core.set_style_BANG_.cljs$core$IFn$_invoke$arity$variadic(draw,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"width","width",-384071477),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(width__$1),"px"].join('')], 0));

var height_51255 = (function (){var x__5128__auto__ = (700);
var y__5129__auto__ = (width__$1 / (2));
return ((x__5128__auto__ > y__5129__auto__) ? x__5128__auto__ : y__5129__auto__);
})();
dommy.core.set_style_BANG_.cljs$core$IFn$_invoke$arity$variadic(draw,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"height","height",1025178622),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(height_51255),"px"].join('')], 0));

dommy.core.set_style_BANG_.cljs$core$IFn$_invoke$arity$variadic(draw,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),[cljs.core.str.cljs$core$IFn$_invoke$arity$1((- ((width__$1 - (570)) / (2)))),"px"].join('')], 0));


var G__51256 = cljs.core.next(seq__51233__$1);
var G__51257 = null;
var G__51258 = (0);
var G__51259 = (0);
seq__51233 = G__51256;
chunk__51234 = G__51257;
count__51235 = G__51258;
i__51236 = G__51259;
continue;
}
} else {
...
frontend.components.content.content = rum.core.lazy_build(rum.core.build_defcs,(function (state,id,p__51237){
var map__51238 = p__51237;
var map__51238__$1 = cljs.core.__destructure_map(map__51238);
var option = map__51238__$1;
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51238__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51238__$1,new cljs.core.Keyword(null,"config","config",994861415));
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51238__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51238__$1,new cljs.core.Keyword(null,"content","content",15833224));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51238__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var on_hide = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51238__$1,new cljs.core.Keyword(null,"on-hide","on-hide",1263105709));
