...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__74666){
var vec__74667 = p__74666;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74667,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74667,(1),null);
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__74672,args){
var vec__74673 = p__74672;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74673,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74673,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__74681,sym){
var map__74683 = p__74681;
var map__74683__$1 = cljs.core.__destructure_map(map__74683);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74683__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74683__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
var or__4253__auto__ = (function (){var temp__5718__auto__ = cljs.core.namespace(sym);
if(cljs.core.truth_(temp__5718__auto__)){
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__74688,sym){
var map__74690 = p__74688;
var map__74690__$1 = cljs.core.__destructure_map(map__74690);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74690__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74690__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
var class_opts = (function (){var or__4253__auto__ = (function (){var temp__5718__auto__ = cljs.core.namespace(sym);
if(cljs.core.truth_(temp__5718__auto__)){
var ns_STAR_ = temp__5718__auto__;
if(("js" === ns_STAR_)){
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__74691 = temp__5718__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74691,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74691,(1),null);
