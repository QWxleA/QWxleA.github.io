...
var hierarchy__5643__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__57470 = cljs.core.get_global_hierarchy;
return (fexpr__57470.cljs$core$IFn$_invoke$arity$0 ? fexpr__57470.cljs$core$IFn$_invoke$arity$0() : fexpr__57470.call(null));
})());
...
var page_title = (function (){var G__57471 = frontend.extensions.zotero.extractor.item_type(item);
switch (G__57471) {
case "case":
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__57474){
var map__57475 = p__57474;
var map__57475__$1 = cljs.core.__destructure_map(map__57475);
var first_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57475__$1,new cljs.core.Keyword(null,"first-name","first-name",-1559982131));
var last_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57475__$1,new cljs.core.Keyword(null,"last-name","last-name",-1695738974));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57475__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var tags = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__57488_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__57488_SHARP_,/,\s?/);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__57498){
var map__57499 = p__57498;
var map__57499__$1 = cljs.core.__destructure_map(map__57499);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57499__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__57539){
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__57545){
var vec__57546 = p__57545;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57546,(0),null);
...
var map__57589 = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(item);
var map__57589__$1 = cljs.core.__destructure_map(map__57589);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57589__$1,new cljs.core.Keyword(null,"title","title",636505583));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57589__$1,new cljs.core.Keyword(null,"url","url",276297046));
var link_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57589__$1,new cljs.core.Keyword(null,"link-mode","link-mode",-960686913));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57589__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var content_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57589__$1,new cljs.core.Keyword(null,"content-type","content-type",-508222634));
var filename = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57589__$1,new cljs.core.Keyword(null,"filename","filename",-1428840783));
var G__57590 = link_mode;
switch (G__57590) {
case "imported_file":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57590)].join('')));
