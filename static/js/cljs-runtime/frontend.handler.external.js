...
var files_61697__$3 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__61686){
var map__61687 = p__61686;
var map__61687__$1 = cljs.core.__destructure_map(map__61687);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61687__$1,new cljs.core.Keyword("file","path","file/path",-191335748));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61687__$1,new cljs.core.Keyword("file","content","file/content",12680964));
...
var page_name = (function (){var G__61688 = logseq.graph_parser.date_time_util.int__GT_journal_title(day,frontend.state.get_date_formatter());
return (frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(G__61688) : frontend.util.page_name_sanity_lc.call(null,G__61688));
})();
...
if(cljs.core.truth_(temp__5720__auto__)){
var repo = temp__5720__auto__;
var vec__61689 = frontend.format.mldoc.opml__GT_edn(data);
var headers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61689,(0),null);
var parsed_blocks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61689,(1),null);
...
var page_block = (function (){var G__61695 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(page_name) : frontend.util.page_name_sanity_lc.call(null,page_name))], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__61695) : frontend.db.entity.call(null,G__61695));
})();
...
var vec__61692 = (cljs.core.truth_((function (){var and__5041__auto__ = last_block;
...
var target_block = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61692,(0),null);
var sibling_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61692,(1),null);
...
var G__61696 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [page_name], null);
return (finished_ok_handler.cljs$core$IFn$_invoke$arity$1 ? finished_ok_handler.cljs$core$IFn$_invoke$arity$1(G__61696) : finished_ok_handler.call(null,G__61696));
} else {
return null;
}
});
