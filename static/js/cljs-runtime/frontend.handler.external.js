...
var files_51861__$3 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__51850){
var map__51851 = p__51850;
var map__51851__$1 = cljs.core.__destructure_map(map__51851);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51851__$1,new cljs.core.Keyword("file","path","file/path",-191335748));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51851__$1,new cljs.core.Keyword("file","content","file/content",12680964));
...
var page_name = (function (){var G__51852 = logseq.graph_parser.date_time_util.int__GT_journal_title(day,frontend.state.get_date_formatter());
return (frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(G__51852) : frontend.util.page_name_sanity_lc.call(null,G__51852));
})();
...
if(cljs.core.truth_(temp__5720__auto__)){
var repo = temp__5720__auto__;
var vec__51853 = frontend.format.mldoc.opml__GT_edn(data);
var headers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51853,(0),null);
var parsed_blocks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51853,(1),null);
...
var page_block = (function (){var G__51859 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(page_name) : frontend.util.page_name_sanity_lc.call(null,page_name))], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__51859) : frontend.db.entity.call(null,G__51859));
})();
...
var vec__51856 = (cljs.core.truth_((function (){var and__5041__auto__ = last_block;
...
var target_block = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51856,(0),null);
var sibling_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51856,(1),null);
...
var G__51860 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [page_name], null);
return (finished_ok_handler.cljs$core$IFn$_invoke$arity$1 ? finished_ok_handler.cljs$core$IFn$_invoke$arity$1(G__51860) : finished_ok_handler.call(null,G__51860));
} else {
return null;
}
});
