...
var title__$2 = clojure.string.replace(frontend.util.page_name_sanity.cljs$core$IFn$_invoke$arity$1(title__$1),"\n"," ");
...
var files_71209__$3 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__71199){
var map__71200 = p__71199;
var map__71200__$1 = cljs.core.__destructure_map(map__71200);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71200__$1,new cljs.core.Keyword("file","path","file/path",-191335748));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71200__$1,new cljs.core.Keyword("file","content","file/content",12680964));
...
var page_name = frontend.util.page_name_sanity_lc(frontend.date.int__GT_journal_title(day));
...
if(cljs.core.truth_(temp__5720__auto__)){
var repo = temp__5720__auto__;
var vec__71201 = frontend.format.mldoc.opml__GT_edn(data);
var headers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71201,(0),null);
var parsed_blocks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71201,(1),null);
...
var page_block = (function (){var G__71207 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.page_name_sanity_lc(page_name)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__71207) : frontend.db.entity.call(null,G__71207));
})();
...
var vec__71204 = (cljs.core.truth_((function (){var and__4251__auto__ = last_block;
...
var target_block = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71204,(0),null);
var sibling_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71204,(1),null);
...
var G__71208 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [page_name], null);
return (finished_ok_handler.cljs$core$IFn$_invoke$arity$1 ? finished_ok_handler.cljs$core$IFn$_invoke$arity$1(G__71208) : finished_ok_handler.call(null,G__71208));
} else {
return null;
}
});
