...
var G__73287 = opt;
var G__73287__$1 = (((G__73287 instanceof cljs.core.Keyword))?G__73287.fqn:null);
switch (G__73287__$1) {
case "page-ref":
...
var G__73288 = ast;
var G__73289 = config;
var G__73290 = (function (){var or__4253__auto__ = references;
...
return (logseq.graph_parser.mldoc.astExportMarkdown.cljs$core$IFn$_invoke$arity$3 ? logseq.graph_parser.mldoc.astExportMarkdown.cljs$core$IFn$_invoke$arity$3(G__73288,G__73289,G__73290) : logseq.graph_parser.mldoc.astExportMarkdown.call(null,G__73288,G__73289,G__73290));
});
logseq.graph_parser.mldoc.default_config = (function logseq$graph_parser$mldoc$default_config(var_args){
var G__73293 = arguments.length;
switch (G__73293) {
case 1:
...
(logseq.graph_parser.mldoc.default_config.cljs$core$IFn$_invoke$arity$2 = (function (format,p__73294){
var map__73295 = p__73294;
var map__73295__$1 = cljs.core.__destructure_map(map__73295);
var export_heading_to_list_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73295__$1,new cljs.core.Keyword(null,"export-heading-to-list?","export-heading-to-list?",-596132321));
var export_keep_properties_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73295__$1,new cljs.core.Keyword(null,"export-keep-properties?","export-keep-properties?",1001383866));
var export_md_indent_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73295__$1,new cljs.core.Keyword(null,"export-md-indent-style","export-md-indent-style",481813710));
var export_md_remove_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73295__$1,new cljs.core.Keyword(null,"export-md-remove-options","export-md-remove-options",-1015252352));
var parse_outline_only_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73295__$1,new cljs.core.Keyword(null,"parse_outline_only?","parse_outline_only?",-731229637));
var format__$1 = clojure.string.capitalize(cljs.core.name((function (){var or__4253__auto__ = format;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__73299){
var vec__73300 = p__73299;
var block = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73300,(0),null);
var pos_meta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73300,(1),null);
if(((cljs.core.vector_QMARK_(block)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("Src",cljs.core.first(block))))){
var map__73303 = pos_meta;
var map__73303__$1 = cljs.core.__destructure_map(map__73303);
var start_pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73303__$1,new cljs.core.Keyword(null,"start_pos","start_pos",272375959));
var end_pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73303__$1,new cljs.core.Keyword(null,"end_pos","end_pos",-1418940));
...
var len__4864__auto___73344 = arguments.length;
var i__4865__auto___73345 = (0);
while(true){
if((i__4865__auto___73345 < len__4864__auto___73344)){
args__4870__auto__.push((arguments[i__4865__auto___73345]));

var G__73346 = (i__4865__auto___73345 + (1));
i__4865__auto___73345 = G__73346;
continue;
} else {
}
break;
...
return logseq.graph_parser.mldoc.__GT_vec_concat.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});
...
/** @this {Function} */
(logseq.graph_parser.mldoc.__GT_vec_concat.cljs$lang$applyTo = (function (seq73304){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq73304));
}));
...
var directive_QMARK_ = (function (p__73308){
var vec__73309 = p__73308;
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73309,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73309,(1),null);
...
var macros = ((cljs.core.seq(macro_properties))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__73316){
var vec__73317 = p__73316;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73317,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73317,(1),null);
var vec__73320 = logseq.graph_parser.util.split_first(" ",v);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73320,(0),null);
var v__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73320,(1),null);
...
var properties__$3 = (function (){var G__73323 = properties__$2;
if(cljs.core.seq(macros)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__73323,new cljs.core.Keyword(null,"macros","macros",811339431),macros);
} else {
return G__73323;
}
})();
...
var properties__$6 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(linked.core.map.cljs$core$IFn$_invoke$arity$0(),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__73324){
var vec__73325 = p__73324;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73325,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73325,(1),null);
...
}catch (e73335){var _e = e73335;
return cljs.core.PersistentVector.EMPTY;
}});
logseq.graph_parser.mldoc.link_QMARK_ = (function logseq$graph_parser$mldoc$link_QMARK_(format,link){
if(typeof link === 'string'){
var vec__73336 = cljs.core.first(logseq.graph_parser.mldoc.inline__GT_edn(link,logseq.graph_parser.mldoc.default_config.cljs$core$IFn$_invoke$arity$1(format)));
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73336,(0),null);
var link__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73336,(1),null);
var vec__73339 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(link__$1);
var ref_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73339,(0),null);
var ref_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73339,(1),null);
