...
var G__47391 = opt;
var G__47391__$1 = (((G__47391 instanceof cljs.core.Keyword))?G__47391.fqn:null);
switch (G__47391__$1) {
case "page-ref":
...
var G__47393 = ast;
var G__47394 = config;
var G__47395 = (function (){var or__4253__auto__ = references;
...
return (logseq.graph_parser.mldoc.astExportMarkdown.cljs$core$IFn$_invoke$arity$3 ? logseq.graph_parser.mldoc.astExportMarkdown.cljs$core$IFn$_invoke$arity$3(G__47393,G__47394,G__47395) : logseq.graph_parser.mldoc.astExportMarkdown.call(null,G__47393,G__47394,G__47395));
});
...
(logseq.graph_parser.mldoc.default_config.cljs$core$IFn$_invoke$arity$2 = (function (format,p__47401){
var map__47402 = p__47401;
var map__47402__$1 = cljs.core.__destructure_map(map__47402);
var export_heading_to_list_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47402__$1,new cljs.core.Keyword(null,"export-heading-to-list?","export-heading-to-list?",-596132321));
var export_keep_properties_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47402__$1,new cljs.core.Keyword(null,"export-keep-properties?","export-keep-properties?",1001383866));
var export_md_indent_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47402__$1,new cljs.core.Keyword(null,"export-md-indent-style","export-md-indent-style",481813710));
var export_md_remove_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47402__$1,new cljs.core.Keyword(null,"export-md-remove-options","export-md-remove-options",-1015252352));
var parse_outline_only_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47402__$1,new cljs.core.Keyword(null,"parse_outline_only?","parse_outline_only?",-731229637));
...
return JSON.stringify(cljs_bean.core.__GT_js(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47397_SHARP_){
return (!((cljs.core.second(p1__47397_SHARP_) == null)));
...
var vec__47403 = lines;
var seq__47404 = cljs.core.seq(vec__47403);
var first__47405 = cljs.core.first(seq__47404);
var seq__47404__$1 = cljs.core.next(seq__47404);
var f = first__47405;
var r = seq__47404__$1;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__47406){
var vec__47407 = p__47406;
var block = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47407,(0),null);
var pos_meta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47407,(1),null);
if(((cljs.core.vector_QMARK_(block)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("Src",cljs.core.first(block))))){
var map__47410 = pos_meta;
var map__47410__$1 = cljs.core.__destructure_map(map__47410);
var start_pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47410__$1,new cljs.core.Keyword(null,"start_pos","start_pos",272375959));
var end_pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47410__$1,new cljs.core.Keyword(null,"end_pos","end_pos",-1418940));
...
var len__4864__auto___47463 = arguments.length;
var i__4865__auto___47464 = (0);
while(true){
if((i__4865__auto___47464 < len__4864__auto___47463)){
args__4870__auto__.push((arguments[i__4865__auto___47464]));

var G__47465 = (i__4865__auto___47464 + (1));
i__4865__auto___47464 = G__47465;
continue;
} else {
}
break;
...
/** @this {Function} */
(logseq.graph_parser.mldoc.__GT_vec_concat.cljs$lang$applyTo = (function (seq47411){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47411));
}));
...
var directive_QMARK_ = (function (p__47415){
var vec__47416 = p__47415;
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47416,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47416,(1),null);
...
var macros = ((cljs.core.seq(macro_properties))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__47423){
var vec__47424 = p__47423;
...
var vec__47427 = logseq.graph_parser.util.split_first(" ",v);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47427,(0),null);
var v__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47427,(1),null);
...
var properties__$3 = (function (){var G__47430 = properties__$2;
if(cljs.core.seq(macros)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47430,new cljs.core.Keyword(null,"macros","macros",811339431),macros);
} else {
return G__47430;
}
})();
...
var properties__$6 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(linked.core.map.cljs$core$IFn$_invoke$arity$0(),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__47431){
var vec__47432 = p__47431;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47432,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47432,(1),null);
...
}catch (e47438){var _e = e47438;
return cljs.core.PersistentVector.EMPTY;
}});
logseq.graph_parser.mldoc.link_QMARK_ = (function logseq$graph_parser$mldoc$link_QMARK_(format,link){
if(typeof link === 'string'){
var vec__47439 = cljs.core.first(logseq.graph_parser.mldoc.inline__GT_edn(link,logseq.graph_parser.mldoc.default_config.cljs$core$IFn$_invoke$arity$1(format)));
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47439,(0),null);
var link__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47439,(1),null);
var vec__47442 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(link__$1);
var ref_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47442,(0),null);
var ref_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47442,(1),null);
