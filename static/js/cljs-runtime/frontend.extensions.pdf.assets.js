...
return ["file://",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__57444 = frontend.config.get_repo_dir(frontend.state.get_current_repo());
var G__57445 = full_path__$2;
return (frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2 ? frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2(G__57444,G__57445) : frontend.util.node_path.join.call(null,G__57444,G__57445));
})())].join('');
})()
)));
...
frontend.extensions.pdf.assets.load_hls_data$ = (function frontend$extensions$pdf$assets$load_hls_data$(p__57446){
var map__57447 = p__57446;
var map__57447__$1 = cljs.core.__destructure_map(map__57447);
var hls_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57447__$1,new cljs.core.Keyword(null,"hls-file","hls-file",192681120));
...
frontend.extensions.pdf.assets.persist_hls_data$ = (function frontend$extensions$pdf$assets$persist_hls_data$(p__57448,highlights){
var map__57449 = p__57448;
var map__57449__$1 = cljs.core.__destructure_map(map__57449);
var hls_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57449__$1,new cljs.core.Keyword(null,"hls-file","hls-file",192681120));
if(cljs.core.truth_(hls_file)){
var repo_cur = frontend.state.get_current_repo();
var repo_dir = frontend.config.get_repo_dir(repo_cur);
...
frontend.extensions.pdf.assets.persist_hl_area_image$ = (function frontend$extensions$pdf$assets$persist_hl_area_image$(viewer,current,new_hl,old_hl,p__57451){
var map__57452 = p__57451;
var map__57452__$1 = cljs.core.__destructure_map(map__57452);
var top = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57452__$1,new cljs.core.Keyword(null,"top","top",-1856271961));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57452__$1,new cljs.core.Keyword(null,"left","left",-399115937));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57452__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57452__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(current,(function (p__57455){
var map__57456 = p__57455;
var map__57456__$1 = cljs.core.__destructure_map(map__57456);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57456__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(frontend.fs.rename_BANG_,repo_cur,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57450_SHARP_){
return (frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2 ? frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2(repo_dir,p1__57450_SHARP_) : frontend.util.node_path.join.call(null,repo_dir,p1__57450_SHARP_));
...
var fpath = (function (){var G__57457 = repo_dir;
var G__57458 = [fdir,"/",fname,"_",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fstamp),".png"].join('');
return (frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2 ? frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2(G__57457,G__57458) : frontend.util.node_path.join.call(null,G__57457,G__57458));
})();
...
frontend.handler.page.create_BANG_.cljs$core$IFn$_invoke$arity$2(page_name__$1,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"redirect?","redirect?",-1229259098),false,new cljs.core.Keyword(null,"create-first-block?","create-first-block?",397553841),false,new cljs.core.Keyword(null,"split-namespace?","split-namespace?",-1035468161),false,new cljs.core.Keyword(null,"format","format",-1306924766),format,new cljs.core.Keyword(null,"properties","properties",685819552),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),(function (){var G__57459 = format;
...
frontend.extensions.pdf.assets.create_ref_block_BANG_ = (function frontend$extensions$pdf$assets$create_ref_block_BANG_(p__57461){
var map__57462 = p__57461;
var map__57462__$1 = cljs.core.__destructure_map(map__57462);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57462__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57462__$1,new cljs.core.Keyword(null,"content","content",15833224));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57462__$1,new cljs.core.Keyword(null,"page","page",849072397));
...
var wrap_props = (function (p1__57460_SHARP_){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__57460_SHARP_,new cljs.core.Keyword(null,"hl-type","hl-type",992471876),"area",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hl-stamp","hl-stamp",-695479513),stamp], 0));
} else {
return p1__57460_SHARP_;
}
});
...
frontend.extensions.pdf.assets.del_ref_block_BANG_ = (function frontend$extensions$pdf$assets$del_ref_block_BANG_(p__57463){
var map__57464 = p__57463;
var map__57464__$1 = cljs.core.__destructure_map(map__57464);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57464__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
if(cljs.core.truth_(and__5041__auto__)){
return medley.core.find_first.cljs$core$IFn$_invoke$arity$2((function (p1__57465_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__57465_SHARP_));
}),hls__$1);
} else {
return and__5041__auto__;
}
...
frontend.extensions.pdf.assets.goto_block_ref_BANG_ = (function frontend$extensions$pdf$assets$goto_block_ref_BANG_(p__57466){
var map__57467 = p__57466;
var map__57467__$1 = cljs.core.__destructure_map(map__57467);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57467__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
