...
return ["file://",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__48215 = frontend.config.get_repo_dir(frontend.state.get_current_repo());
var G__48216 = full_path__$2;
return (frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2 ? frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2(G__48215,G__48216) : frontend.util.node_path.join.call(null,G__48215,G__48216));
})())].join('');
})()
)));
...
frontend.extensions.pdf.assets.load_hls_data$ = (function frontend$extensions$pdf$assets$load_hls_data$(p__48218){
var map__48220 = p__48218;
var map__48220__$1 = cljs.core.__destructure_map(map__48220);
var hls_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48220__$1,new cljs.core.Keyword(null,"hls-file","hls-file",192681120));
...
frontend.extensions.pdf.assets.persist_hls_data$ = (function frontend$extensions$pdf$assets$persist_hls_data$(p__48223,highlights){
var map__48224 = p__48223;
var map__48224__$1 = cljs.core.__destructure_map(map__48224);
var hls_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48224__$1,new cljs.core.Keyword(null,"hls-file","hls-file",192681120));
if(cljs.core.truth_(hls_file)){
var repo_cur = frontend.state.get_current_repo();
var repo_dir = frontend.config.get_repo_dir(repo_cur);
...
frontend.extensions.pdf.assets.persist_hl_area_image$ = (function frontend$extensions$pdf$assets$persist_hl_area_image$(viewer,current,new_hl,old_hl,p__48226){
var map__48227 = p__48226;
var map__48227__$1 = cljs.core.__destructure_map(map__48227);
var top = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48227__$1,new cljs.core.Keyword(null,"top","top",-1856271961));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48227__$1,new cljs.core.Keyword(null,"left","left",-399115937));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48227__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48227__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(current,(function (p__48230){
var map__48231 = p__48230;
var map__48231__$1 = cljs.core.__destructure_map(map__48231);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48231__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(frontend.fs.rename_BANG_,repo_cur,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48225_SHARP_){
return (frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2 ? frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2(repo_dir,p1__48225_SHARP_) : frontend.util.node_path.join.call(null,repo_dir,p1__48225_SHARP_));
...
var fpath = (function (){var G__48243 = repo_dir;
var G__48244 = [fdir,"/",fname,"_",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fstamp),".png"].join('');
return (frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2 ? frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2(G__48243,G__48244) : frontend.util.node_path.join.call(null,G__48243,G__48244));
})();
...
frontend.handler.page.create_BANG_.cljs$core$IFn$_invoke$arity$2(page_name__$1,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"redirect?","redirect?",-1229259098),false,new cljs.core.Keyword(null,"create-first-block?","create-first-block?",397553841),false,new cljs.core.Keyword(null,"split-namespace?","split-namespace?",-1035468161),false,new cljs.core.Keyword(null,"format","format",-1306924766),format,new cljs.core.Keyword(null,"properties","properties",685819552),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),(function (){var G__48245 = format;
var G__48245__$1 = (((G__48245 instanceof cljs.core.Keyword))?G__48245.fqn:null);
switch (G__48245__$1) {
case "markdown":
...
frontend.extensions.pdf.assets.create_ref_block_BANG_ = (function frontend$extensions$pdf$assets$create_ref_block_BANG_(p__48255){
var map__48256 = p__48255;
var map__48256__$1 = cljs.core.__destructure_map(map__48256);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48256__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48256__$1,new cljs.core.Keyword(null,"content","content",15833224));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48256__$1,new cljs.core.Keyword(null,"page","page",849072397));
...
var wrap_props = (function (p1__48254_SHARP_){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__48254_SHARP_,new cljs.core.Keyword(null,"hl-type","hl-type",992471876),"area",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hl-stamp","hl-stamp",-695479513),stamp], 0));
} else {
return p1__48254_SHARP_;
}
});
...
frontend.extensions.pdf.assets.del_ref_block_BANG_ = (function frontend$extensions$pdf$assets$del_ref_block_BANG_(p__48258){
var map__48259 = p__48258;
var map__48259__$1 = cljs.core.__destructure_map(map__48259);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48259__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
if(cljs.core.truth_(and__5041__auto__)){
return medley.core.find_first.cljs$core$IFn$_invoke$arity$2((function (p1__48261_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__48261_SHARP_));
}),hls__$1);
} else {
return and__5041__auto__;
}
...
frontend.extensions.pdf.assets.goto_block_ref_BANG_ = (function frontend$extensions$pdf$assets$goto_block_ref_BANG_(p__48268){
var map__48269 = p__48268;
var map__48269__$1 = cljs.core.__destructure_map(map__48269);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48269__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
