...
var attrs61617 = (function (){var picker_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(flag,new cljs.core.Keyword(null,"picker","picker",-659389603));
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs61617))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["cp__onboarding-setups","flex","flex-1"], null)], null),attrs61617], 0))):{'className':"cp__onboarding-setups flex flex-1"}),((cljs.core.map_QMARK_(attrs61617))?null:[daiquiri.interpreter.interpret(attrs61617)]));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61632),frontend$components$onboarding$setups$iter__61629(cljs.core.chunk_rest(s__61630__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61632),null);
}
} else {
var vec__61636 = cljs.core.first(s__61630__$2);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61636,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61636,(1),null);
var icon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61636,(2),null);
return cljs.core.cons(((cljs.core.not(title))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li.hr","li.hr",-431034643)], null):new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),title], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.as-flex-center","i.as-flex-center",-901481825),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),((clojure.string.ends_with_QMARK_(label,".edn"))?"is-file":null)], null),(cljs.core.truth_(icon)?frontend.ui.icon.cljs$core$IFn$_invoke$arity$1(icon):null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong.uppercase","strong.uppercase",-1521442439),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"small.opacity-50","small.opacity-50",-519407779),label], null)], null)], null)),frontend$components$onboarding$setups$iter__61629(cljs.core.rest(s__61630__$2)));
}
} else {
return null;
}
...
frontend.components.onboarding.setups.importer = rum.core.lazy_build(rum.core.build_defc,(function (p__61639){
var map__61640 = p__61639;
var map__61640__$1 = cljs.core.__destructure_map(map__61640);
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61640__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
