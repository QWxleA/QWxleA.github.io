...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(frontend.state.state),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56301_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__56301_SHARP_,"@")){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$2(p1__56301_SHARP_,(1));
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__56301_SHARP_);
}
}),path__$1));
} else {
return null;
...
if(cljs.core.truth_(temp__5720__auto__)){
var vec__56324 = temp__5720__auto__;
var cmd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56324,(0),null);
var actions = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56324,(1),null);
return frontend.handler.plugin.register_plugin_slash_command(pid,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cmd,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__56323_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.first(p1__56323_SHARP_))], null),cljs.core.rest(p1__56323_SHARP_));
}),actions)], null));
} else {
return null;
}
...
if(cljs.core.truth_(temp__5720__auto__)){
var vec__56329 = temp__5720__auto__;
var cmd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56329,(0),null);
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56329,(1),null);
...
var vec__56335 = cljs.core.update.cljs$core$IFn$_invoke$arity$5(shortcut_args,(2),cljs.core.assoc,new cljs.core.Keyword(null,"fn","fn",-1175266204),dispatch_cmd);
var handler_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56335,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56335,(1),null);
var shortcut_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56335,(2),null);
...
var palette_matched = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__56338_SHARP_){
return clojure.string.includes_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__56338_SHARP_)),["plugin.",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pid)].join(''));
}),frontend.handler.command_palette.get_commands());
if(cljs.core.seq(palette_matched)){
var seq__56339 = cljs.core.seq(palette_matched);
var chunk__56340 = null;
var count__56341 = (0);
var i__56342 = (0);
while(true){
if((i__56342 < count__56341)){
var cmd = chunk__56340.cljs$core$IIndexed$_nth$arity$2(null,i__56342);
...
var G__56587 = seq__56339;
var G__56588 = chunk__56340;
var G__56589 = count__56341;
var G__56590 = (i__56342 + (1));
seq__56339 = G__56587;
chunk__56340 = G__56588;
count__56341 = G__56589;
i__56342 = G__56590;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__56339);
if(temp__5720__auto__){
var seq__56339__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__56339__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__56339__$1);
var G__56591 = cljs.core.chunk_rest(seq__56339__$1);
var G__56592 = c__5565__auto__;
var G__56593 = cljs.core.count(c__5565__auto__);
var G__56594 = (0);
seq__56339 = G__56591;
chunk__56340 = G__56592;
count__56341 = G__56593;
i__56342 = G__56594;
continue;
} else {
var cmd = cljs.core.first(seq__56339__$1);
frontend.handler.command_palette.unregister(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cmd));
...
var G__56595 = cljs.core.next(seq__56339__$1);
var G__56596 = null;
var G__56597 = (0);
var G__56598 = (0);
seq__56339 = G__56595;
chunk__56340 = G__56596;
count__56341 = G__56597;
i__56342 = G__56598;
continue;
}
} else {
...
while (G__56600__i < G__56600__a.length) {G__56600__a[G__56600__i] = arguments[G__56600__i + 1]; ++G__56600__i;}
  args = new cljs.core.IndexedSeq(G__56600__a,0,null);
} 
...
logseq$api$invoke_external_command.cljs$lang$applyTo = (function (arglist__56601){
var type = cljs.core.first(arglist__56601);
var args = cljs.core.rest(arglist__56601);
...
var G__56368 = el.getAttribute("blockid");
if((G__56368 == null)){
return null;
} else {
return frontend.db.model.query_block_by_uuid(G__56368);
}
}),blocks);
...
var G__56384 = (function (){var temp__5718__auto__ = frontend.db.model.get_page(name);
if(cljs.core.truth_(temp__5718__auto__)){
var page = temp__5718__auto__;
return page;
} else {
var properties__$1 = cljs_bean.core.__GT_clj(properties);
var map__56385 = cljs_bean.core.__GT_clj(opts);
var map__56385__$1 = cljs.core.__destructure_map(map__56385);
var redirect = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56385__$1,new cljs.core.Keyword(null,"redirect","redirect",-1975673286));
var createFirstBlock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56385__$1,new cljs.core.Keyword(null,"createFirstBlock","createFirstBlock",-362653431));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56385__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var journal = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56385__$1,new cljs.core.Keyword(null,"journal","journal",1585898830));
...
var G__56384__$1 = (((G__56384 == null))?null:new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(G__56384));
var G__56384__$2 = (((G__56384__$1 == null))?null:frontend.db.utils.pull.cljs$core$IFn$_invoke$arity$1(G__56384__$1));
var G__56384__$3 = (((G__56384__$2 == null))?null:logseq.api.normalize_keyword_for_json(G__56384__$2));
if((G__56384__$3 == null)){
return null;
} else {
return cljs_bean.core.__GT_js(G__56384__$3);
}
});
...
var map__56386 = cljs_bean.core.__GT_clj(opts);
var map__56386__$1 = cljs.core.__destructure_map(map__56386);
var pos = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56386__$1,new cljs.core.Keyword(null,"pos","pos",-864607220),new cljs.core.Keyword(null,"max","max",61366548));
...
var map__56388 = cljs_bean.core.__GT_clj(opts);
var map__56388__$1 = cljs.core.__destructure_map(map__56388);
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56388__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var sibling = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56388__$1,new cljs.core.Keyword(null,"sibling","sibling",-1183865000));
var isPageBlock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56388__$1,new cljs.core.Keyword(null,"isPageBlock","isPageBlock",1969744282));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56388__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
})())?(function (){var block = (function (){var G__56406 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_uuid], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__56406) : frontend.db.entity.call(null,G__56406));
})();
...
var vec__56389 = ((insert_at_first_child_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sibling,before], null));
var sibling_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56389,(0),null);
var before_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56389,(1),null);
...
var map__56418 = cljs_bean.core.__GT_clj(opts);
var map__56418__$1 = cljs.core.__destructure_map(map__56418);
var sibling = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56418__$1,new cljs.core.Keyword(null,"sibling","sibling",-1183865000));
...
var map__56440 = cljs_bean.core.__GT_clj(opts);
var map__56440__$1 = cljs.core.__destructure_map(map__56440);
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56440__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56440__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var map__56473 = cljs_bean.core.__GT_clj(opts);
var map__56473__$1 = cljs.core.__destructure_map(map__56473);
var includeChildren = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56473__$1,new cljs.core.Keyword(null,"includeChildren","includeChildren",-941062106));
var repo = frontend.state.get_current_repo();
var block__$1 = (cljs.core.truth_(includeChildren)?cljs.core.first(frontend.modules.outliner.tree.blocks__GT_vec_tree.cljs$core$IFn$_invoke$arity$2(frontend.db.model.get_block_and_children(repo,uuid),uuid)):cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(block,new cljs.core.Keyword("block","children","block/children",-1040716209),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56458_SHARP_){
return (new cljs.core.List(null,new cljs.core.Keyword(null,"uuid","uuid",-2145095719),(new cljs.core.List(null,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__56458_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552)], null)),null,(1),null)),(2),null));
...
var G__56492 = cljs.core.first(frontend.state.get_selection_blocks());
var G__56492__$1 = (((G__56492 == null))?null:G__56492.getAttribute("blockid"));
if((G__56492__$1 == null)){
return null;
} else {
return frontend.db.model.get_block_by_uuid(G__56492__$1);
}
}
})();
...
if(cljs.core.truth_(temp__5720__auto__)){
var block = temp__5720__auto__;
var map__56518 = block;
var map__56518__$1 = cljs.core.__destructure_map(map__56518);
var parent = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56518__$1,new cljs.core.Keyword("block","parent","block/parent",-918309064));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56518__$1,new cljs.core.Keyword("block","left","block/left",-443712566));
...
var map__56529 = opts__$2;
var map__56529__$1 = cljs.core.__destructure_map(map__56529);
var flag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56529__$1,new cljs.core.Keyword(null,"flag","flag",1088647881));
...
if(cljs.core.truth_(temp__5720__auto__)){
var map__56534 = temp__5720__auto__;
var map__56534__$1 = cljs.core.__destructure_map(map__56534);
var mft = map__56534__$1;
var repo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56534__$1,new cljs.core.Keyword(null,"repo","repo",-1999060679));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56534__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var len__5766__auto___56628 = arguments.length;
var i__5767__auto___56629 = (0);
while(true){
if((i__5767__auto___56629 < len__5766__auto___56628)){
args__5772__auto__.push((arguments[i__5767__auto___56629]));

var G__56630 = (i__5767__auto___56629 + (1));
i__5767__auto___56629 = G__56630;
continue;
} else {
}
break;
...
/** @this {Function} */
(logseq.api.datascript_query.cljs$lang$applyTo = (function (seq56535){
var G__56536 = cljs.core.first(seq56535);
var seq56535__$1 = cljs.core.next(seq56535);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56536,seq56535__$1);
}));
...
var map__56544 = cljs_bean.core.__GT_clj(opts);
var map__56544__$1 = cljs.core.__destructure_map(map__56544);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56544__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var timeout = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56544__$1,new cljs.core.Keyword(null,"timeout","timeout",-318625318));
...
var args__5772__auto__ = [];
var len__5766__auto___56632 = arguments.length;
var i__5767__auto___56633 = (0);
while(true){
if((i__5767__auto___56633 < len__5766__auto___56632)){
args__5772__auto__.push((arguments[i__5767__auto___56633]));

var G__56634 = (i__5767__auto___56633 + (1));
i__5767__auto___56633 = G__56634;
continue;
} else {
}
break;
...
/** @this {Function} */
(logseq.api.ui_show_msg.cljs$lang$applyTo = (function (seq56545){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56545));
}));
...
var args__5772__auto__ = [];
var len__5766__auto___56635 = arguments.length;
var i__5767__auto___56636 = (0);
while(true){
if((i__5767__auto___56636 < len__5766__auto___56635)){
args__5772__auto__.push((arguments[i__5767__auto___56636]));

var G__56637 = (i__5767__auto___56636 + (1));
i__5767__auto___56636 = G__56637;
continue;
} else {
}
break;
...
var seq__56550 = cljs.core.seq(scripts);
var chunk__56552 = null;
var count__56553 = (0);
var i__56554 = (0);
while(true){
if((i__56554 < count__56553)){
var s = chunk__56552.cljs$core$IIndexed$_nth$arity$2(null,i__56554);
var upt_status_56638 = ((function (seq__56550,chunk__56552,count__56553,i__56554,s,_pl,temp__5720__auto__){
return (function (p1__56547_SHARP_){
return frontend.state.upt_plugin_resource(pid,new cljs.core.Keyword(null,"scripts","scripts",626373193),s,new cljs.core.Keyword(null,"status","status",-1997798413),p1__56547_SHARP_);
});})(seq__56550,chunk__56552,count__56553,i__56554,s,_pl,temp__5720__auto__))
;
var init_QMARK__56639 = frontend.handler.plugin.register_plugin_resources(pid,new cljs.core.Keyword(null,"scripts","scripts",626373193),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"src","src",-1651076051),s], null));
if(cljs.core.truth_(init_QMARK__56639)){
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2((function (){
upt_status_56638(new cljs.core.Keyword(null,"pending","pending",-220036727));
...
,((function (seq__56550,chunk__56552,count__56553,i__56554,upt_status_56638,init_QMARK__56639,s,_pl,temp__5720__auto__){
return (function (){
return upt_status_56638(new cljs.core.Keyword(null,"done","done",-889844188));
});})(seq__56550,chunk__56552,count__56553,i__56554,upt_status_56638,init_QMARK__56639,s,_pl,temp__5720__auto__))
),((function (seq__56550,chunk__56552,count__56553,i__56554,upt_status_56638,init_QMARK__56639,s,_pl,temp__5720__auto__){
return (function (){
return upt_status_56638(new cljs.core.Keyword(null,"error","error",-978969032));
});})(seq__56550,chunk__56552,count__56553,i__56554,upt_status_56638,init_QMARK__56639,s,_pl,temp__5720__auto__))
);
} else {
}
...
var G__56640 = seq__56550;
var G__56641 = chunk__56552;
var G__56642 = count__56553;
var G__56643 = (i__56554 + (1));
seq__56550 = G__56640;
chunk__56552 = G__56641;
count__56553 = G__56642;
i__56554 = G__56643;
continue;
} else {
var temp__5720__auto____$1 = cljs.core.seq(seq__56550);
if(temp__5720__auto____$1){
var seq__56550__$1 = temp__5720__auto____$1;
if(cljs.core.chunked_seq_QMARK_(seq__56550__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__56550__$1);
var G__56644 = cljs.core.chunk_rest(seq__56550__$1);
var G__56645 = c__5565__auto__;
var G__56646 = cljs.core.count(c__5565__auto__);
var G__56647 = (0);
seq__56550 = G__56644;
chunk__56552 = G__56645;
count__56553 = G__56646;
i__56554 = G__56647;
continue;
} else {
var s = cljs.core.first(seq__56550__$1);
var upt_status_56648 = ((function (seq__56550,chunk__56552,count__56553,i__56554,s,seq__56550__$1,temp__5720__auto____$1,_pl,temp__5720__auto__){
return (function (p1__56547_SHARP_){
return frontend.state.upt_plugin_resource(pid,new cljs.core.Keyword(null,"scripts","scripts",626373193),s,new cljs.core.Keyword(null,"status","status",-1997798413),p1__56547_SHARP_);
});})(seq__56550,chunk__56552,count__56553,i__56554,s,seq__56550__$1,temp__5720__auto____$1,_pl,temp__5720__auto__))
;
var init_QMARK__56649 = frontend.handler.plugin.register_plugin_resources(pid,new cljs.core.Keyword(null,"scripts","scripts",626373193),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"src","src",-1651076051),s], null));
if(cljs.core.truth_(init_QMARK__56649)){
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2((function (){
upt_status_56648(new cljs.core.Keyword(null,"pending","pending",-220036727));

return frontend.loader.load.cljs$core$IFn$_invoke$arity$3(s,null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"data-ref","data-ref",-1090558888),cljs.core.name(pid)], null)], null));
})()
,((function (seq__56550,chunk__56552,count__56553,i__56554,upt_status_56648,init_QMARK__56649,s,seq__56550__$1,temp__5720__auto____$1,_pl,temp__5720__auto__){
return (function (){
return upt_status_56648(new cljs.core.Keyword(null,"done","done",-889844188));
});})(seq__56550,chunk__56552,count__56553,i__56554,upt_status_56648,init_QMARK__56649,s,seq__56550__$1,temp__5720__auto____$1,_pl,temp__5720__auto__))
),((function (seq__56550,chunk__56552,count__56553,i__56554,upt_status_56648,init_QMARK__56649,s,seq__56550__$1,temp__5720__auto____$1,_pl,temp__5720__auto__){
return (function (){
return upt_status_56648(new cljs.core.Keyword(null,"error","error",-978969032));
});})(seq__56550,chunk__56552,count__56553,i__56554,upt_status_56648,init_QMARK__56649,s,seq__56550__$1,temp__5720__auto____$1,_pl,temp__5720__auto__))
);
} else {
}
...
var G__56650 = cljs.core.next(seq__56550__$1);
var G__56651 = null;
var G__56652 = (0);
var G__56653 = (0);
seq__56550 = G__56650;
chunk__56552 = G__56651;
count__56553 = G__56652;
i__56554 = G__56653;
continue;
}
} else {
...
/** @this {Function} */
(logseq.api.exper_load_scripts.cljs$lang$applyTo = (function (seq56548){
var G__56549 = cljs.core.first(seq56548);
var seq56548__$1 = cljs.core.next(seq56548);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56549,seq56548__$1);
}));
...
if(cljs.core.truth_(temp__5720__auto__)){
var _pl = temp__5720__auto__;
return frontend.handler.plugin.register_fenced_code_renderer(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(pid),type,cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__56557_SHARP_,p2__56558_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__56557_SHARP_,p2__56558_SHARP_,(opts[cljs.core.name(p2__56558_SHARP_)]));
