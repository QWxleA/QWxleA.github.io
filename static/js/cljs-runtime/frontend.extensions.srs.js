...
var card_entity = (function (){var G__60198 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.extensions.srs.card_hash_tag], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__60198) : frontend.db.entity.call(null,G__60198));
})();
...
return (frontend.extensions.srs.get_of(of_matrix,n,ef) * (function (){var G__60199 = (n - (1));
var G__60200 = ef;
var G__60201 = of_matrix;
return (frontend.extensions.srs.interval.cljs$core$IFn$_invoke$arity$3 ? frontend.extensions.srs.interval.cljs$core$IFn$_invoke$arity$3(G__60199,G__60200,G__60201) : frontend.extensions.srs.interval.call(null,G__60199,G__60200,G__60201));
})());
}
});
...
var frontend$extensions$srs$ICard$get_root_block$dyn_60350 = (function (this$){
...
return frontend$extensions$srs$ICard$get_root_block$dyn_60350(this$);
}
});
...
var frontend$extensions$srs$ICardShow$show_cycle$dyn_60351 = (function (this$,phase){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
return frontend$extensions$srs$ICardShow$show_cycle$dyn_60351(this$,phase);
}
});

var frontend$extensions$srs$ICardShow$show_cycle_config$dyn_60352 = (function (this$,phase){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
return frontend$extensions$srs$ICardShow$show_cycle_config$dyn_60352(this$,phase);
}
});

frontend.extensions.srs.has_cloze_QMARK_ = (function frontend$extensions$srs$has_cloze_QMARK_(blocks){
return cljs.core.some((function (p1__60208_SHARP_){
return clojure.string.includes_QMARK_(p1__60208_SHARP_,"{{cloze ");
...
var self__ = this;
var _this__$1 = this;
var G__60209 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(self__.block)], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__60209) : frontend.db.pull.call(null,G__60209));
}));
...
var self__ = this;
var _this__$1 = this;
var blocks = frontend.extensions.srs.clear_collapsed_property((function (){var G__60210 = frontend.state.get_current_repo();
var G__60211 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(self__.block);
return (frontend.db.get_block_and_children.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_block_and_children.cljs$core$IFn$_invoke$arity$2(G__60210,G__60211) : frontend.db.get_block_and_children.call(null,G__60210,G__60211));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60214)].join('')));
...
(frontend.extensions.srs.query.cljs$core$IFn$_invoke$arity$3 = (function (repo,query_string,p__60230){
var map__60231 = p__60230;
var map__60231__$1 = cljs.core.__destructure_map(map__60231);
var disable_reactive_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60231__$1,new cljs.core.Keyword(null,"disable-reactive?","disable-reactive?",-1162731342));
var use_cache_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__60231__$1,new cljs.core.Keyword(null,"use-cache?","use-cache?",-81331778),true);
if(typeof query_string === 'string'){
var query_string__$1 = frontend.template.resolve_dynamic_template_BANG_(query_string);
var map__60232 = frontend.db.query_dsl.parse(query_string__$1);
var map__60232__$1 = cljs.core.__destructure_map(map__60232);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60232__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60232__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60232__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
})()], null),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"use-cache?","use-cache?",-81331778),use_cache_QMARK_], null),(function (){var G__60233 = (cljs.core.truth_(sort_by)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transform-fn","transform-fn",1106801327),sort_by], null):null);
if(cljs.core.truth_(disable_reactive_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60233,new cljs.core.Keyword(null,"disable-reactive?","disable-reactive?",-1162731342),true);
} else {
return G__60233;
}
})()], 0)));
...
var vec__60235 = frontend.extensions.srs.next_interval(last_interval,repeats,last_ef,score,cljs.core.deref(frontend.extensions.srs.of_matrix));
var next_interval = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60235,(0),null);
var next_repeats = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60235,(1),null);
var next_ef = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60235,(2),null);
var of_matrix_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60235,(3),null);
...
return frontend.extensions.srs.save_block_card_properties_BANG_((function (){var G__60239 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block)], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__60239) : frontend.db.pull.call(null,G__60239));
...
var block = card.block;
return frontend.extensions.srs.reset_block_card_properties_BANG_((function (){var G__60241 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block)], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__60241) : frontend.db.pull.call(null,G__60241));
})());
});
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_STAR_review_records,(function (p1__60242_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__60242_SHARP_,score,(function (ov){
...
var G__60243_60365 = cljs.core.deref(_STAR_review_records);
(cb.cljs$core$IFn$_invoke$arity$1 ? cb.cljs$core$IFn$_invoke$arity$1(G__60243_60365) : cb.call(null,G__60243_60365));
} else {
}
} else {
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_STAR_review_records,(function (p1__60244_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__60244_SHARP_,"skip",(function (ov){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ov,card);
}));
}));
...
if(frontend.extensions.srs.review_finished_QMARK_(cards)){
if(cljs.core.truth_(cb)){
var G__60245 = cljs.core.deref(_STAR_review_records);
return (cb.cljs$core$IFn$_invoke$arity$1 ? cb.cljs$core$IFn$_invoke$arity$1(G__60245) : cb.call(null,G__60245));
} else {
return null;
}
} else {
...
frontend.extensions.srs.btn_with_shortcut = (function frontend$extensions$srs$btn_with_shortcut(p__60246){
var map__60247 = p__60246;
var map__60247__$1 = cljs.core.__destructure_map(map__60247);
var shortcut = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60247__$1,new cljs.core.Keyword(null,"shortcut","shortcut",-431647697));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60247__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var btn_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60247__$1,new cljs.core.Keyword(null,"btn-text","btn-text",1312481577));
var background = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60247__$1,new cljs.core.Keyword(null,"background","background",-863952629));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60247__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
...
var temp__5720__auto___60366 = frontend.extensions.srs.goog$module$goog$object.get(e,"target");
if(cljs.core.truth_(temp__5720__auto___60366)){
var elem_60367 = temp__5720__auto___60366;
console.log(elem_60367.classList);

elem_60367.classList.add("opacity-25");
} else {
}
...
frontend.extensions.srs.view = rum.core.lazy_build(rum.core.build_defcs,(function (state,blocks,p__60249,card_index){
var map__60250 = p__60249;
var map__60250__$1 = cljs.core.__destructure_map(map__60250);
var preview_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60250__$1,new cljs.core.Keyword(null,"preview?","preview?",590561578));
var modal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60250__$1,new cljs.core.Keyword(null,"modal?","modal?",2146094679));
var cb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60250__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
var map__60251 = frontend.extensions.srs.show_cycle(card,cljs.core.deref(phase));
var map__60251__$1 = cljs.core.__destructure_map(map__60251);
var blocks__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60251__$1,new cljs.core.Keyword(null,"value","value",305978217));
var next_phase = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60251__$1,new cljs.core.Keyword(null,"next-phase","next-phase",-424821986));
...
})())?(function (){var attrs60272 = ((((cljs.core.not(preview_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(next_phase,(1)))))?null:frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),(function (){var G__60288 = next_phase;
switch (G__60288) {
case (1):
return "Hide answers";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60288)].join('')));
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs60272))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","my-4","justify-between"], null)], null),attrs60272], 0))):{'className':"flex my-4 justify-between"}),((cljs.core.map_QMARK_(attrs60272))?[(cljs.core.truth_((function (){var and__5041__auto__ = (cljs.core.count(cards) > (1));
...
})], 0))):null),((((cljs.core.not(preview_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),next_phase))))?(function (){var attrs60285 = frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Forgotten",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"f",new cljs.core.Keyword(null,"id","id",-1388402092),"card-forgotten",new cljs.core.Keyword(null,"background","background",-863952629),"red",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
return daiquiri.core.create_element(daiquiri.core.fragment,((cljs.core.map_QMARK_(attrs60285))?daiquiri.interpreter.element_attributes(attrs60285):null),((cljs.core.map_QMARK_(attrs60285))?[daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),(cljs.core.truth_(frontend.util.mobile_QMARK_())?"Hard":"Took a while to recall"),new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"t",new cljs.core.Keyword(null,"id","id",-1388402092),"card-recall",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
})], null)))]:[daiquiri.interpreter.interpret(attrs60285),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),(cljs.core.truth_(frontend.util.mobile_QMARK_())?"Hard":"Took a while to recall"),new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"t",new cljs.core.Keyword(null,"id","id",-1388402092),"card-recall",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((3),card,card_index,cards,phase,review_records,cb);
})], null))),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Remembered",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"r",new cljs.core.Keyword(null,"id","id",-1388402092),"card-remembered",new cljs.core.Keyword(null,"background","background",-863952629),"green",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((5),card,card_index,cards,phase,review_records,cb);
})], null)))]));
...
})], 0))):null)]:[daiquiri.interpreter.interpret(attrs60272),(cljs.core.truth_((function (){var and__5041__auto__ = (cljs.core.count(cards) > (1));
if(and__5041__auto__){
return preview_QMARK_;
} else {
return and__5041__auto__;
...
return frontend.extensions.srs.skip_card(card,card_index,cards,phase,review_records,cb);
})], 0))):null),((((cljs.core.not(preview_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),next_phase))))?(function (){var attrs60286 = frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Forgotten",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"f",new cljs.core.Keyword(null,"id","id",-1388402092),"card-forgotten",new cljs.core.Keyword(null,"background","background",-863952629),"red",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
frontend.extensions.srs.score_and_next_card((1),card,card_index,cards,phase,review_records,cb);

var tomorrow = cljs_time.coerce.to_string(cljs_time.core.plus.cljs$core$IFn$_invoke$arity$2(cljs_time.core.today(),cljs_time.core.days.cljs$core$IFn$_invoke$arity$1((1))));
return frontend.handler.editor.set_block_property_BANG_(root_block_id,frontend.extensions.srs.card_next_schedule_property,tomorrow);
})], null));
return daiquiri.core.create_element(daiquiri.core.fragment,((cljs.core.map_QMARK_(attrs60286))?daiquiri.interpreter.element_attributes(attrs60286):null),((cljs.core.map_QMARK_(attrs60286))?[daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),(cljs.core.truth_(frontend.util.mobile_QMARK_())?"Hard":"Took a while to recall"),new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"t",new cljs.core.Keyword(null,"id","id",-1388402092),"card-recall",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((3),card,card_index,cards,phase,review_records,cb);
})], null))),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Remembered",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"r",new cljs.core.Keyword(null,"id","id",-1388402092),"card-remembered",new cljs.core.Keyword(null,"background","background",-863952629),"green",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((5),card,card_index,cards,phase,review_records,cb);
})], null)))]:[daiquiri.interpreter.interpret(attrs60286),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),(cljs.core.truth_(frontend.util.mobile_QMARK_())?"Hard":"Took a while to recall"),new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"t",new cljs.core.Keyword(null,"id","id",-1388402092),"card-recall",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((3),card,card_index,cards,phase,review_records,cb);
})], null))),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Remembered",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"r",new cljs.core.Keyword(null,"id","id",-1388402092),"card-remembered",new cljs.core.Keyword(null,"background","background",-863952629),"green",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((5),card,card_index,cards,phase,review_records,cb);
})], null)))]));
...
})():(function (){var attrs60287 = frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic("Review cards",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"small?","small?",95242445),true], 0));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs60287))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["my-3"], null)], null),attrs60287], 0))):{'className':"my-3"}),((cljs.core.map_QMARK_(attrs60287))?null:[daiquiri.interpreter.interpret(attrs60287)]));
})())]);
}
...
var G__60289 = frontend.state.get_current_repo();
var G__60290 = block_id;
var G__60291 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scoped-block-id","scoped-block-id",-2061689117),block_id], null);
return (frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$3 ? frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$3(G__60289,G__60290,G__60291) : frontend.db.get_paginated_blocks.call(null,G__60289,G__60290,G__60291));
});
...
var map__60305 = frontend.extensions.srs.query_scheduled(repo,blocks,cljs_time.local.local_now());
var map__60305__$1 = cljs.core.__destructure_map(map__60305);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60305__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var map__60321 = frontend.extensions.srs.query_scheduled(repo,query_result,cljs_time.local.local_now());
var map__60321__$1 = cljs.core.__destructure_map(map__60321);
var total = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60321__$1,new cljs.core.Keyword(null,"total","total",1916810418));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60321__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var review_cards = result;
var card_query_block = (function (){var G__60322 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(config)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__60322) : frontend.db.entity.call(null,G__60322));
})();
...
})], null),frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("arrows-shuffle",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__60337 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(18),new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(600)], null);
if(cljs.core.truth_(cljs.core.deref(_STAR_random_mode_QMARK_))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60337,new cljs.core.Keyword(null,"color","color",1011675173),"orange");
} else {
return G__60337;
}
})()], null))], null))]:[daiquiri.interpreter.interpret(attrs60331),frontend.ui.tippy(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"html","html",-998796897),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.text-sm","div.text-sm",1753784969),"Toggle preview mode"], null),new cljs.core.Keyword(null,"delay","delay",-574225219),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1000),(100)], null),new cljs.core.Keyword(null,"class","class",-2030961996),"tippy-hover",new cljs.core.Keyword(null,"interactive","interactive",-2024078362),true,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),false], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.opacity-60.hover:opacity-100.svg-small.inline.font-bold","a.opacity-60.hover:opacity-100.svg-small.inline.font-bold",94613611),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),"preview-all-cards",new cljs.core.Keyword(null,"style","style",-496642736),(cljs.core.truth_(cljs.core.deref(_STAR_preview_mode_QMARK_))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),"orange"], null):null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (e){
frontend.util.stop(e);
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_STAR_random_mode_QMARK_,cljs.core.not);
})], null),frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("arrows-shuffle",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__60339 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(18),new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(600)], null);
if(cljs.core.truth_(cljs.core.deref(_STAR_random_mode_QMARK_))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60339,new cljs.core.Keyword(null,"color","color",1011675173),"orange");
} else {
return G__60339;
}
})()], null))], null))]));
})()]),((cljs.core.seq(review_cards))?(function (){var attrs60340 = (cljs.core.truth_(modal_QMARK_)?null:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs60340))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["px-1"], null)], null),attrs60340], 0))):{'className':"px-1"}),((cljs.core.map_QMARK_(attrs60340))?[(function (){var view_fn = (cljs.core.truth_(modal_QMARK_)?frontend.extensions.srs.view_modal:frontend.extensions.srs.view);
...
})()]:[daiquiri.interpreter.interpret(attrs60340),(function (){var view_fn = (cljs.core.truth_(modal_QMARK_)?frontend.extensions.srs.view_modal:frontend.extensions.srs.view);
var blocks_fn = (cljs.core.truth_(cljs.core.deref(_STAR_preview_mode_QMARK_))?(function (){
return frontend.extensions.srs.query.cljs$core$IFn$_invoke$arity$2(repo,query_string);
}):review_cards);
return daiquiri.interpreter.interpret(view_fn(blocks_fn,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([config,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"global?","global?",-2022837689),global_QMARK_,new cljs.core.Keyword(null,"random-mode?","random-mode?",160495452),cljs.core.deref(_STAR_random_mode_QMARK_),new cljs.core.Keyword(null,"preview?","preview?",590561578),cljs.core.deref(_STAR_preview_mode_QMARK_),new cljs.core.Keyword(null,"callback","callback",-705136228),callback_fn], null)], 0)),_STAR_card_index));
...
var temp__5720__auto__ = (function (){var G__60347 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__60347) : frontend.db.entity.call(null,G__60347));
})();
if(cljs.core.truth_(temp__5720__auto__)){
