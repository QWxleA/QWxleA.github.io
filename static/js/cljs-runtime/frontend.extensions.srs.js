...
var card_entity = (function (){var G__50995 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.extensions.srs.card_hash_tag], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__50995) : frontend.db.entity.call(null,G__50995));
})();
...
return (frontend.extensions.srs.get_of(of_matrix,n,ef) * (function (){var G__50998 = (n - (1));
var G__50999 = ef;
var G__51000 = of_matrix;
return (frontend.extensions.srs.interval.cljs$core$IFn$_invoke$arity$3 ? frontend.extensions.srs.interval.cljs$core$IFn$_invoke$arity$3(G__50998,G__50999,G__51000) : frontend.extensions.srs.interval.call(null,G__50998,G__50999,G__51000));
})());
}
});
...
var frontend$extensions$srs$ICard$get_root_block$dyn_51143 = (function (this$){
...
return frontend$extensions$srs$ICard$get_root_block$dyn_51143(this$);
}
});
...
var frontend$extensions$srs$ICardShow$show_cycle$dyn_51144 = (function (this$,phase){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
return frontend$extensions$srs$ICardShow$show_cycle$dyn_51144(this$,phase);
}
});

var frontend$extensions$srs$ICardShow$show_cycle_config$dyn_51145 = (function (this$,phase){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
return frontend$extensions$srs$ICardShow$show_cycle_config$dyn_51145(this$,phase);
}
});

frontend.extensions.srs.has_cloze_QMARK_ = (function frontend$extensions$srs$has_cloze_QMARK_(blocks){
return cljs.core.some((function (p1__51006_SHARP_){
return clojure.string.includes_QMARK_(p1__51006_SHARP_,"{{cloze ");
...
var self__ = this;
var _this__$1 = this;
var G__51007 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(self__.block)], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__51007) : frontend.db.pull.call(null,G__51007));
}));
...
var self__ = this;
var _this__$1 = this;
var blocks = frontend.extensions.srs.clear_collapsed_property((function (){var G__51008 = frontend.state.get_current_repo();
var G__51009 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(self__.block);
return (frontend.db.get_block_and_children.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_block_and_children.cljs$core$IFn$_invoke$arity$2(G__51008,G__51009) : frontend.db.get_block_and_children.call(null,G__51008,G__51009));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51010)].join('')));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51011)].join('')));
...
(frontend.extensions.srs.query.cljs$core$IFn$_invoke$arity$3 = (function (repo,query_string,p__51014){
var map__51015 = p__51014;
var map__51015__$1 = cljs.core.__destructure_map(map__51015);
var disable_reactive_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51015__$1,new cljs.core.Keyword(null,"disable-reactive?","disable-reactive?",-1162731342));
var use_cache_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51015__$1,new cljs.core.Keyword(null,"use-cache?","use-cache?",-81331778),true);
if(typeof query_string === 'string'){
var query_string__$1 = frontend.template.resolve_dynamic_template_BANG_(query_string);
var map__51016 = frontend.db.query_dsl.parse(query_string__$1);
var map__51016__$1 = cljs.core.__destructure_map(map__51016);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51016__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51016__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51016__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
})()], null),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"use-cache?","use-cache?",-81331778),use_cache_QMARK_], null),(function (){var G__51017 = (cljs.core.truth_(sort_by)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transform-fn","transform-fn",1106801327),sort_by], null):null);
if(cljs.core.truth_(disable_reactive_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51017,new cljs.core.Keyword(null,"disable-reactive?","disable-reactive?",-1162731342),true);
} else {
return G__51017;
}
})()], 0)));
...
var vec__51019 = frontend.extensions.srs.next_interval(last_interval,repeats,last_ef,score,cljs.core.deref(frontend.extensions.srs.of_matrix));
var next_interval = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51019,(0),null);
var next_repeats = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51019,(1),null);
var next_ef = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51019,(2),null);
var of_matrix_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51019,(3),null);
...
return frontend.extensions.srs.save_block_card_properties_BANG_((function (){var G__51023 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block)], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__51023) : frontend.db.pull.call(null,G__51023));
...
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__51025) : frontend.db.pull.call(null,G__51025));
})());
});
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_STAR_review_records,(function (p1__51026_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__51026_SHARP_,score,(function (ov){
...
var G__51027_51149 = cljs.core.deref(_STAR_review_records);
(cb.cljs$core$IFn$_invoke$arity$1 ? cb.cljs$core$IFn$_invoke$arity$1(G__51027_51149) : cb.call(null,G__51027_51149));
} else {
}
} else {
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_STAR_review_records,(function (p1__51028_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__51028_SHARP_,"skip",(function (ov){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ov,card);
}));
}));
...
if(frontend.extensions.srs.review_finished_QMARK_(cards)){
if(cljs.core.truth_(cb)){
var G__51029 = cljs.core.deref(_STAR_review_records);
return (cb.cljs$core$IFn$_invoke$arity$1 ? cb.cljs$core$IFn$_invoke$arity$1(G__51029) : cb.call(null,G__51029));
} else {
return null;
}
} else {
...
frontend.extensions.srs.btn_with_shortcut = (function frontend$extensions$srs$btn_with_shortcut(p__51030){
var map__51031 = p__51030;
var map__51031__$1 = cljs.core.__destructure_map(map__51031);
var shortcut = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51031__$1,new cljs.core.Keyword(null,"shortcut","shortcut",-431647697));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51031__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var btn_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51031__$1,new cljs.core.Keyword(null,"btn-text","btn-text",1312481577));
var background = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51031__$1,new cljs.core.Keyword(null,"background","background",-863952629));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51031__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
...
var temp__5720__auto___51150 = frontend.extensions.srs.goog$module$goog$object.get(e,"target");
if(cljs.core.truth_(temp__5720__auto___51150)){
var elem_51151 = temp__5720__auto___51150;
console.log(elem_51151.classList);

elem_51151.classList.add("opacity-25");
} else {
}
...
frontend.extensions.srs.view = rum.core.lazy_build(rum.core.build_defcs,(function (state,blocks,p__51033,card_index){
var map__51034 = p__51033;
var map__51034__$1 = cljs.core.__destructure_map(map__51034);
var preview_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51034__$1,new cljs.core.Keyword(null,"preview?","preview?",590561578));
var modal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51034__$1,new cljs.core.Keyword(null,"modal?","modal?",2146094679));
var cb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51034__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
var map__51035 = frontend.extensions.srs.show_cycle(card,cljs.core.deref(phase));
var map__51035__$1 = cljs.core.__destructure_map(map__51035);
var blocks__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51035__$1,new cljs.core.Keyword(null,"value","value",305978217));
var next_phase = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51035__$1,new cljs.core.Keyword(null,"next-phase","next-phase",-424821986));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51042)].join('')));
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs51038))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","my-4","justify-between"], null)], null),attrs51038], 0))):{'className':"flex my-4 justify-between"}),((cljs.core.map_QMARK_(attrs51038))?[(cljs.core.truth_((function (){var and__5041__auto__ = (cljs.core.count(cards) > (1));
...
})], 0))):null),((((cljs.core.not(preview_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),next_phase))))?(function (){var attrs51039 = frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Forgotten",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"f",new cljs.core.Keyword(null,"id","id",-1388402092),"card-forgotten",new cljs.core.Keyword(null,"background","background",-863952629),"red",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
return daiquiri.core.create_element(daiquiri.core.fragment,((cljs.core.map_QMARK_(attrs51039))?daiquiri.interpreter.element_attributes(attrs51039):null),((cljs.core.map_QMARK_(attrs51039))?[daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),(cljs.core.truth_(frontend.util.mobile_QMARK_())?"Hard":"Took a while to recall"),new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"t",new cljs.core.Keyword(null,"id","id",-1388402092),"card-recall",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
})], null)))]:[daiquiri.interpreter.interpret(attrs51039),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),(cljs.core.truth_(frontend.util.mobile_QMARK_())?"Hard":"Took a while to recall"),new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"t",new cljs.core.Keyword(null,"id","id",-1388402092),"card-recall",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((3),card,card_index,cards,phase,review_records,cb);
})], null))),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Remembered",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"r",new cljs.core.Keyword(null,"id","id",-1388402092),"card-remembered",new cljs.core.Keyword(null,"background","background",-863952629),"green",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((5),card,card_index,cards,phase,review_records,cb);
})], null)))]));
...
})], 0))):null)]:[daiquiri.interpreter.interpret(attrs51038),(cljs.core.truth_((function (){var and__5041__auto__ = (cljs.core.count(cards) > (1));
if(and__5041__auto__){
return preview_QMARK_;
} else {
return and__5041__auto__;
...
return frontend.extensions.srs.skip_card(card,card_index,cards,phase,review_records,cb);
})], 0))):null),((((cljs.core.not(preview_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),next_phase))))?(function (){var attrs51040 = frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Forgotten",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"f",new cljs.core.Keyword(null,"id","id",-1388402092),"card-forgotten",new cljs.core.Keyword(null,"background","background",-863952629),"red",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
frontend.extensions.srs.score_and_next_card((1),card,card_index,cards,phase,review_records,cb);

var tomorrow = cljs_time.coerce.to_string(cljs_time.core.plus.cljs$core$IFn$_invoke$arity$2(cljs_time.core.today(),cljs_time.core.days.cljs$core$IFn$_invoke$arity$1((1))));
return frontend.handler.editor.set_block_property_BANG_(root_block_id,frontend.extensions.srs.card_next_schedule_property,tomorrow);
})], null));
return daiquiri.core.create_element(daiquiri.core.fragment,((cljs.core.map_QMARK_(attrs51040))?daiquiri.interpreter.element_attributes(attrs51040):null),((cljs.core.map_QMARK_(attrs51040))?[daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),(cljs.core.truth_(frontend.util.mobile_QMARK_())?"Hard":"Took a while to recall"),new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"t",new cljs.core.Keyword(null,"id","id",-1388402092),"card-recall",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((3),card,card_index,cards,phase,review_records,cb);
})], null))),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Remembered",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"r",new cljs.core.Keyword(null,"id","id",-1388402092),"card-remembered",new cljs.core.Keyword(null,"background","background",-863952629),"green",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((5),card,card_index,cards,phase,review_records,cb);
})], null)))]:[daiquiri.interpreter.interpret(attrs51040),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),(cljs.core.truth_(frontend.util.mobile_QMARK_())?"Hard":"Took a while to recall"),new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"t",new cljs.core.Keyword(null,"id","id",-1388402092),"card-recall",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((3),card,card_index,cards,phase,review_records,cb);
})], null))),daiquiri.interpreter.interpret(frontend.extensions.srs.btn_with_shortcut(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"btn-text","btn-text",1312481577),"Remembered",new cljs.core.Keyword(null,"shortcut","shortcut",-431647697),"r",new cljs.core.Keyword(null,"id","id",-1388402092),"card-remembered",new cljs.core.Keyword(null,"background","background",-863952629),"green",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.extensions.srs.score_and_next_card((5),card,card_index,cards,phase,review_records,cb);
})], null)))]));
...
})():(function (){var attrs51041 = frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic("Review cards",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"small?","small?",95242445),true], 0));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs51041))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["my-3"], null)], null),attrs51041], 0))):{'className':"my-3"}),((cljs.core.map_QMARK_(attrs51041))?null:[daiquiri.interpreter.interpret(attrs51041)]));
})())]);
}
...
var G__51060 = frontend.state.get_current_repo();
var G__51061 = block_id;
var G__51062 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scoped-block-id","scoped-block-id",-2061689117),block_id], null);
return (frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$3 ? frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$3(G__51060,G__51061,G__51062) : frontend.db.get_paginated_blocks.call(null,G__51060,G__51061,G__51062));
});
...
var map__51085 = frontend.extensions.srs.query_scheduled(repo,blocks,cljs_time.local.local_now());
var map__51085__$1 = cljs.core.__destructure_map(map__51085);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51085__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
}catch (e51084){if((e51084 instanceof Error)){
var e = e51084;
console.error(e);
...
var map__51090 = frontend.extensions.srs.query_scheduled(repo,query_result,cljs_time.local.local_now());
var map__51090__$1 = cljs.core.__destructure_map(map__51090);
var total = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51090__$1,new cljs.core.Keyword(null,"total","total",1916810418));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51090__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var review_cards = result;
var card_query_block = (function (){var G__51091 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(config)], null);
...
})], null),frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("arrows-shuffle",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__51117 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(18),new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(600)], null);
if(cljs.core.truth_(cljs.core.deref(_STAR_random_mode_QMARK_))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51117,new cljs.core.Keyword(null,"color","color",1011675173),"orange");
} else {
return G__51117;
}
})()], null))], null))]:[daiquiri.interpreter.interpret(attrs51100),frontend.ui.tippy(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"html","html",-998796897),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.text-sm","div.text-sm",1753784969),"Toggle preview mode"], null),new cljs.core.Keyword(null,"delay","delay",-574225219),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1000),(100)], null),new cljs.core.Keyword(null,"class","class",-2030961996),"tippy-hover",new cljs.core.Keyword(null,"interactive","interactive",-2024078362),true,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),false], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.opacity-60.hover:opacity-100.svg-small.inline.font-bold","a.opacity-60.hover:opacity-100.svg-small.inline.font-bold",94613611),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),"preview-all-cards",new cljs.core.Keyword(null,"style","style",-496642736),(cljs.core.truth_(cljs.core.deref(_STAR_preview_mode_QMARK_))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),"orange"], null):null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (e){
frontend.util.stop(e);
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_STAR_random_mode_QMARK_,cljs.core.not);
})], null),frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("arrows-shuffle",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__51121 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(18),new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(600)], null);
if(cljs.core.truth_(cljs.core.deref(_STAR_random_mode_QMARK_))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51121,new cljs.core.Keyword(null,"color","color",1011675173),"orange");
} else {
return G__51121;
}
})()], null))], null))]));
})()]),((cljs.core.seq(review_cards))?(function (){var attrs51124 = (cljs.core.truth_(modal_QMARK_)?null:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs51124))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["px-1"], null)], null),attrs51124], 0))):{'className':"px-1"}),((cljs.core.map_QMARK_(attrs51124))?[(function (){var view_fn = (cljs.core.truth_(modal_QMARK_)?frontend.extensions.srs.view_modal:frontend.extensions.srs.view);
...
})()]:[daiquiri.interpreter.interpret(attrs51124),(function (){var view_fn = (cljs.core.truth_(modal_QMARK_)?frontend.extensions.srs.view_modal:frontend.extensions.srs.view);
var blocks_fn = (cljs.core.truth_(cljs.core.deref(_STAR_preview_mode_QMARK_))?(function (){
return frontend.extensions.srs.query.cljs$core$IFn$_invoke$arity$2(repo,query_string);
}):review_cards);
return daiquiri.interpreter.interpret(view_fn(blocks_fn,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([config,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"global?","global?",-2022837689),global_QMARK_,new cljs.core.Keyword(null,"random-mode?","random-mode?",160495452),cljs.core.deref(_STAR_random_mode_QMARK_),new cljs.core.Keyword(null,"preview?","preview?",590561578),cljs.core.deref(_STAR_preview_mode_QMARK_),new cljs.core.Keyword(null,"callback","callback",-705136228),callback_fn], null)], 0)),_STAR_card_index));
...
var temp__5720__auto__ = (function (){var G__51140 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__51140) : frontend.db.entity.call(null,G__51140));
})();
if(cljs.core.truth_(temp__5720__auto__)){
