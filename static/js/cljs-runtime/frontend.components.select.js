...
frontend.components.select.render_item = rum.core.lazy_build(rum.core.build_defc,(function (p__72167,chosen_QMARK_){
var map__72168 = p__72167;
var map__72168__$1 = cljs.core.__destructure_map(map__72168);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72168__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72168__$1,new cljs.core.Keyword(null,"value","value",305978217));
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["inline-grid","grid-cols-4","gap-x-4","w-full",(cljs.core.truth_(chosen_QMARK_)?"chosen":null)], null))},[(function (){var attrs72169 = value;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs72169))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["col-span-3"], null)], null),attrs72169], 0))):{'className':"col-span-3"}),((cljs.core.map_QMARK_(attrs72169))?null:[daiquiri.interpreter.interpret(attrs72169)]));
})(),(function (){var attrs72170 = (cljs.core.truth_(id)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.opacity-20.bg-transparent","code.opacity-20.bg-transparent",-2039164517),id], null):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs72170))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["col-span-1","justify-end","tip","flex"], null)], null),attrs72170], 0))):{'className':"col-span-1 justify-end tip flex"}),((cljs.core.map_QMARK_(attrs72170))?null:[daiquiri.interpreter.interpret(attrs72170)]));
})()]);
}),null,"frontend.components.select/render-item");
frontend.components.select.select = rum.core.lazy_build(rum.core.build_defcs,(function (state,p__72172){
var map__72173 = p__72172;
var map__72173__$1 = cljs.core.__destructure_map(map__72173);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72173__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var limit = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72173__$1,new cljs.core.Keyword(null,"limit","limit",-1355822363),(100));
var on_chosen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72173__$1,new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900));
var empty_placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72173__$1,new cljs.core.Keyword(null,"empty-placeholder","empty-placeholder",-68202085),(function (_t){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null);
}));
var prompt_key = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72173__$1,new cljs.core.Keyword(null,"prompt-key","prompt-key",1549371683),new cljs.core.Keyword("select","default-prompt","select/default-prompt",-657561626));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__72207){
var map__72209 = p__72207;
var map__72209__$1 = cljs.core.__destructure_map(map__72209);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72209__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__72211){
var map__72212 = p__72211;
var map__72212__$1 = cljs.core.__destructure_map(map__72212);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72212__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
}),new cljs.core.Keyword(null,"prompt-key","prompt-key",1549371683),new cljs.core.Keyword("select.graph","prompt","select.graph/prompt",640552877),new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900),(function (p1__72200_SHARP_){
return frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("graph","switch","graph/switch",178853840),new cljs.core.Keyword(null,"graph","graph",1558099509).cljs$core$IFn$_invoke$arity$1(p1__72200_SHARP_)], null));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__72220){
var map__72221 = p__72220;
var map__72221__$1 = cljs.core.__destructure_map(map__72221);
var original_graph = map__72221__$1;
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72221__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__72223){
var map__72224 = p__72223;
var map__72224__$1 = cljs.core.__destructure_map(map__72224);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72224__$1,new cljs.core.Keyword(null,"url","url",276297046));
return frontend.config.demo_graph_QMARK_.cljs$core$IFn$_invoke$arity$1(url);
}),frontend.state.get_repos()));
}),new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900),(function (p1__72201_SHARP_){
return frontend.handler.repo.remove_repo_BANG_(new cljs.core.Keyword(null,"original-graph","original-graph",1959751157).cljs$core$IFn$_invoke$arity$1(p1__72201_SHARP_));
})], null)], null);
});
...
var select_type_config_72231 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(frontend.components.select.select_config(),select_type);
frontend.state.set_modal_BANG_.cljs$core$IFn$_invoke$arity$2((function (){
return frontend.components.select.select(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.select_keys(select_type_config_72231,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900),new cljs.core.Keyword(null,"empty-placeholder","empty-placeholder",-68202085),new cljs.core.Keyword(null,"prompt-key","prompt-key",1549371683)], null)),new cljs.core.Keyword(null,"items","items",1031954938),(function (){var fexpr__72229 = new cljs.core.Keyword(null,"items-fn","items-fn",1580041737).cljs$core$IFn$_invoke$arity$1(select_type_config_72231);
return (fexpr__72229.cljs$core$IFn$_invoke$arity$0 ? fexpr__72229.cljs$core$IFn$_invoke$arity$0() : fexpr__72229.call(null));
})()));
