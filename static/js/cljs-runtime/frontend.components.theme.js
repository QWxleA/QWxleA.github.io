...
frontend.components.theme.container = rum.core.lazy_build(rum.core.build_defc,(function (p__48231,child){
var map__48232 = p__48231;
var map__48232__$1 = cljs.core.__destructure_map(map__48232);
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
var system_theme_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"system-theme?","system-theme?",1330394234));
var settings_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"settings-open?","settings-open?",1491874651));
var sidebar_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"sidebar-open?","sidebar-open?",-1099774467));
var current_repo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"current-repo","current-repo",134812359));
var db_restoring_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"db-restoring?","db-restoring?",-1548628664));
var sidebar_blocks_len = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"sidebar-blocks-len","sidebar-blocks-len",235708585));
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"route","route",329891309));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var nfs_granted_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48232__$1,new cljs.core.Keyword(null,"nfs-granted?","nfs-granted?",-649584328));
var mounted_fn = frontend.rum.use_mounted();
var vec__48233 = rum.core.use_state(false);
var restored_sidebar_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48233,(0),null);
var set_restored_sidebar_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48233,(1),null);
