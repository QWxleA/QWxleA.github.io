...
return daiquiri.core.create_element("div",{'className':"flex-1 overflow-hidden"},[(function (){var attrs62541 = frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"all-files","all-files",1120339891)], 0));
return daiquiri.core.create_element("h1",((cljs.core.map_QMARK_(attrs62541))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["title"], null)], null),attrs62541], 0))):{'className':"title"}),((cljs.core.map_QMARK_(attrs62541))?null:[daiquiri.interpreter.interpret(attrs62541)]));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62566),frontend$components$file$iter__62563(cljs.core.chunk_rest(s__62564__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62566),null);
}
} else {
var vec__62574 = cljs.core.first(s__62564__$2);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62574,(0),null);
var modified_at = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62574,(1),null);
return cljs.core.cons((function (){var file_id = file;
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),file_id], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(function (){var href = ((logseq.graph_parser.config.draw_QMARK_(file))?reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"draw","draw",1358331674),null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"file","file",-1269645878),clojure.string.replace(file,[logseq.graph_parser.config.default_draw_directory,"/"].join(''),"")], null)):reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"path","path",-188191168),file_id], null)));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),href], null),file], null);
})()], null),(cljs.core.truth_(mobile_QMARK_)?null:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-gray-500.text-sm","span.text-gray-500.text-sm",921719094),(((modified_at === (0)))?frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("file","no-data","file/no-data",-1707813734)], 0)):frontend.date.get_date_time_string.cljs$core$IFn$_invoke$arity$1(cljs_time.core.to_default_time_zone(cljs_time.coerce.to_date_time(modified_at))))], null)], null)),(cljs.core.truth_(mobile_QMARK_)?null:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.text-sm","a.text-sm",-884048665),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (file_id,vec__62574,file,modified_at,s__62564__$2,temp__5720__auto____$1,files,mobile_QMARK_,current_repo,temp__5720__auto__){
return (function (_e){
return frontend.handler.export$.download_file_BANG_(file);
});})(file_id,vec__62574,file,modified_at,s__62564__$2,temp__5720__auto____$1,files,mobile_QMARK_,current_repo,temp__5720__auto__))
], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"download","download",-300081668)], 0))], null)], null)], null))], null);
})(),frontend$components$file$iter__62563(cljs.core.rest(s__62564__$2)));
}
} else {
return null;
}
...
var temp__5720__auto___62643 = (function (){var G__62629 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(original_name) : frontend.util.page_name_sanity_lc.call(null,original_name))], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__62629) : frontend.db.entity.call(null,G__62629));
})();
if(cljs.core.truth_(temp__5720__auto___62643)){
var page_62646 = temp__5720__auto___62643;
frontend.state.sidebar_add_block_BANG_(frontend.state.get_current_repo(),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page_62646),new cljs.core.Keyword(null,"page","page",849072397));
} else {
}
...
})())?(function (){var attrs62592 = frontend.components.svg.warning.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),"1em",new cljs.core.Keyword(null,"display","display",242065432),"inline-block"], null)], null));
return daiquiri.core.create_element("p",((cljs.core.map_QMARK_(attrs62592))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-sm","ml-1","mb-4"], null)], null),attrs62592], 0))):{'className':"text-sm ml-1 mb-4"}),((cljs.core.map_QMARK_(attrs62592))?[daiquiri.core.create_element("span",{'className':"ml-1"},["Please don't remove the page's title property (you can still modify it)."])]:[daiquiri.interpreter.interpret(attrs62592),daiquiri.core.create_element("span",{'className':"ml-1"},["Please don't remove the page's title property (you can still modify it)."])]));
...
})()):(function (){var attrs62628 = frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("file","format-not-supported","file/format-not-supported",1268716007),cljs.core.name(format)], 0));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs62628))?daiquiri.interpreter.element_attributes(attrs62628):null),((cljs.core.map_QMARK_(attrs62628))?null:[daiquiri.interpreter.interpret(attrs62628)]));
})()
))]);
