...
var ref_pages = (function (){var G__50475 = repo;
var G__50476 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("block","name","block/name",1619760316)], null);
var G__50477 = ref_pages_ids;
return (frontend.db.pull_many.cljs$core$IFn$_invoke$arity$3 ? frontend.db.pull_many.cljs$core$IFn$_invoke$arity$3(G__50475,G__50476,G__50477) : frontend.db.pull_many.call(null,G__50475,G__50476,G__50477));
})();
...
var G__50481 = ref_blocks__$1;
var G__50481__$1 = ((cljs.core.seq(exclude_ids))?cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (block){
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__50466_SHARP_){
return cljs.core.empty_QMARK_(cljs.core.second(p1__50466_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__50486){
var vec__50487 = p__50486;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50487,(0),null);
var ref_blocks__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50487,(1),null);
...
}),(function (p1__50490_SHARP_){
return cljs.core.second(cljs.core.second(p1__50490_SHARP_));
}));
});
...
var option = (function (){var G__50492 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"limit","limit",-1355822363),frontend.db.model.step_loading_blocks], null);
if(block_QMARK_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50492,new cljs.core.Keyword(null,"scoped-block-id","scoped-block-id",-2061689117),db_id);
} else {
return G__50492;
}
})();
var more_data = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50491_SHARP_){
var G__50493 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__50491_SHARP_);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__50493) : frontend.db.pull.call(null,G__50493));
...
frontend.handler.block.indentable_QMARK_ = (function frontend$handler$block$indentable_QMARK_(p__50494){
var map__50495 = p__50494;
var map__50495__$1 = cljs.core.__destructure_map(map__50495);
var block = map__50495__$1;
var parent = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50495__$1,new cljs.core.Keyword("block","parent","block/parent",-918309064));
...
frontend.handler.block.outdentable_QMARK_ = (function frontend$handler$block$outdentable_QMARK_(p__50497){
var map__50498 = p__50497;
var map__50498__$1 = cljs.core.__destructure_map(map__50498);
var _block = map__50498__$1;
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50498__$1,new cljs.core.Keyword("block","level","block/level",1182509971));
...
var opts__49908__auto__ = (cljs.core.truth_(transact_data__49907__auto__)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"move-blocks","move-blocks",-955702999)], null),new cljs.core.Keyword(null,"nested-transaction?","nested-transaction?",-1949299281),true):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"move-blocks","move-blocks",-955702999)], null));
...
var _STAR_transaction_data_STAR__orig_val__50499 = frontend.modules.outliner.core._STAR_transaction_data_STAR_;
var _STAR_transaction_data_STAR__temp_val__50500 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.core._STAR_transaction_data_STAR_ = _STAR_transaction_data_STAR__temp_val__50500);
...
}finally {(frontend.modules.outliner.core._STAR_transaction_data_STAR_ = _STAR_transaction_data_STAR__orig_val__50499);
}}
});
...
var map__50509 = cljs.core.deref(frontend.handler.block._STAR_swipe);
var map__50509__$1 = cljs.core.__destructure_map(map__50509);
var x0 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50509__$1,new cljs.core.Keyword(null,"x0","x0",410843387));
var xi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50509__$1,new cljs.core.Keyword(null,"xi","xi",-163483319));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50509__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var touch = (touches[(0)]);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(frontend.handler.block._STAR_swipe,(function (p1__50501_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50501_SHARP_,new cljs.core.Keyword(null,"tx","tx",466630418),tx),new cljs.core.Keyword(null,"ty","ty",158290825),ty),new cljs.core.Keyword(null,"xi","xi",-163483319),tx),new cljs.core.Keyword(null,"yi","yi",-1352135633),ty),new cljs.core.Keyword(null,"direction","direction",-633359395),direction__$1);
}));

if((((xi - x0) * (tx - xi)) < (0))){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(frontend.handler.block._STAR_swipe,(function (p1__50502_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50502_SHARP_,new cljs.core.Keyword(null,"x0","x0",410843387),tx),new cljs.core.Keyword(null,"y0","y0",111454807),ty);
}));
} else {
}

var map__50510 = cljs.core.deref(frontend.handler.block._STAR_swipe);
var map__50510__$1 = cljs.core.__destructure_map(map__50510);
var x0__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50510__$1,new cljs.core.Keyword(null,"x0","x0",410843387));
var y0 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50510__$1,new cljs.core.Keyword(null,"y0","y0",111454807));
var dx = (tx - x0__$1);
var dy = (ty - y0);
...
var map__50511 = cljs.core.deref(frontend.handler.block._STAR_swipe);
var map__50511__$1 = cljs.core.__destructure_map(map__50511);
var x0 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50511__$1,new cljs.core.Keyword(null,"x0","x0",410843387));
var tx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50511__$1,new cljs.core.Keyword(null,"tx","tx",466630418));
var dx = (tx - x0);
