...
var blocks_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58083_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(p1__58083_SHARP_,new cljs.core.Keyword("block","level","block/level",1182509971),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("block","children","block/children",-1040716209)], 0));
}),blocks);
...
var _STAR_transaction_data_STAR__orig_val__58088 = frontend.modules.outliner.core._STAR_transaction_data_STAR_;
var _STAR_transaction_data_STAR__temp_val__58089 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.core._STAR_transaction_data_STAR_ = _STAR_transaction_data_STAR__temp_val__58089);

try{frontend.handler.editor.save_current_block_BANG_.cljs$core$IFn$_invoke$arity$0();

if(top_QMARK_){
var first_child_QMARK__58136 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(frontend.modules.outliner.tree._get_parent_id(target_node),frontend.modules.outliner.tree._get_left_id(target_node));
if(first_child_QMARK__58136){
var parent_58137 = frontend.modules.outliner.tree._get_parent(target_node);
frontend.modules.outliner.core.move_blocks_BANG_(blocks,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(parent_58137),false);
} else {
var before_node_58138 = frontend.modules.outliner.tree._get_left(target_node);
frontend.modules.outliner.core.move_blocks_BANG_(blocks,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(before_node_58138),true);
}
} else {
...
}finally {(frontend.modules.outliner.core._STAR_transaction_data_STAR_ = _STAR_transaction_data_STAR__orig_val__58088);
}}
} else {
return null;
