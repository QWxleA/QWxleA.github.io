...
var blocks_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58002_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(p1__58002_SHARP_,new cljs.core.Keyword("block","level","block/level",1182509971),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("block","children","block/children",-1040716209)], 0));
}),blocks);
...
var transact_data__50573__auto__ = frontend.modules.outliner.core._STAR_transaction_data_STAR_;
var opts__50574__auto__ = (cljs.core.truth_(transact_data__50573__auto__)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"move-blocks","move-blocks",-955702999)], null),new cljs.core.Keyword(null,"nested-transaction?","nested-transaction?",-1949299281),true):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"move-blocks","move-blocks",-955702999)], null));
if(cljs.core.truth_(transact_data__50573__auto__)){
...
var _STAR_transaction_data_STAR__orig_val__58007 = frontend.modules.outliner.core._STAR_transaction_data_STAR_;
var _STAR_transaction_data_STAR__temp_val__58008 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.core._STAR_transaction_data_STAR_ = _STAR_transaction_data_STAR__temp_val__58008);

try{frontend.handler.editor.save_current_block_BANG_.cljs$core$IFn$_invoke$arity$0();

if(top_QMARK_){
var first_child_QMARK__58064 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(frontend.modules.outliner.tree._get_parent_id(target_node),frontend.modules.outliner.tree._get_left_id(target_node));
if(first_child_QMARK__58064){
var parent_58068 = frontend.modules.outliner.tree._get_parent(target_node);
frontend.modules.outliner.core.move_blocks_BANG_(blocks,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(parent_58068),false);
} else {
var before_node_58069 = frontend.modules.outliner.tree._get_left(target_node);
frontend.modules.outliner.core.move_blocks_BANG_(blocks,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(before_node_58069),true);
}
} else {
frontend.modules.outliner.core.move_blocks_BANG_(blocks,target_block,(!(nested_QMARK_)));
}

var r__50575__auto__ = cljs.core.persistent_BANG_(frontend.modules.outliner.core._STAR_transaction_data_STAR_);
var tx__50576__auto__ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"tx-data","tx-data",934159761),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([r__50575__auto__], 0));
var tx_meta__50577__auto__ = cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tx-meta","tx-meta",1159283194),r__50575__auto__));
var all_tx__50578__auto__ = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(tx__50576__auto__,new cljs.core.Keyword(null,"additional-tx","additional-tx",-343057604).cljs$core$IFn$_invoke$arity$1(opts__50574__auto__));
var opts_SHARP___50579__auto__ = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(opts__50574__auto__,new cljs.core.Keyword(null,"additional-tx","additional-tx",-343057604)),tx_meta__50577__auto__], 0));
if(cljs.core.seq(all_tx__50578__auto__)){
if(cljs.core.truth_(new cljs.core.Keyword(null,"nested-transaction?","nested-transaction?",-1949299281).cljs$core$IFn$_invoke$arity$1(opts__50574__auto__))){
return null;
} else {
var result__50580__auto__ = frontend.modules.outliner.datascript.transact_BANG_(all_tx__50578__auto__,opts_SHARP___50579__auto__);
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"tx-data","tx-data",934159761),all_tx__50578__auto__,new cljs.core.Keyword(null,"tx-meta","tx-meta",1159283194),tx_meta__50577__auto__,new cljs.core.Keyword(null,"tx-report","tx-report",1910895391),result__50580__auto__], null);
}
} else {
return null;
}
}finally {(frontend.modules.outliner.core._STAR_transaction_data_STAR_ = _STAR_transaction_data_STAR__orig_val__58007);
}}
} else {
return null;
