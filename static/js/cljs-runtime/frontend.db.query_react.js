...
var G__77192 = frontend.state.get_current_page();
if((G__77192 == null)){
return null;
} else {
return clojure.string.lower_case(G__77192);
}
} else {
...
var G__77195 = result__$1;
var G__77195__$1 = (((G__77195 == null))?null:frontend.db.query_react.remove_nested_children_blocks(G__77195));
var G__77195__$2 = (((G__77195__$1 == null))?null:frontend.db.model.sort_by_left_recursive(G__77195__$1));
if((G__77195__$2 == null)){
return null;
} else {
return frontend.db.model.with_pages(G__77195__$2);
}
})():result);
...
}catch (e77196){if((e77196 instanceof Error)){
var e = e77196;
...
}catch (e77194){if((e77194 instanceof Error)){
var e = e77194;
...
var page_ref_QMARK_ = (function (p1__77197_SHARP_){
return ((typeof p1__77197_SHARP_ === 'string') && (logseq.graph_parser.text.page_ref_QMARK_(p1__77197_SHARP_)));
});
...
var vec__77199 = cljs.core.rest(f);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77199,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77199,(1),null);
var vec__77202 = ((page_ref_QMARK_(x))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [y,x], null));
var page_ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77202,(0),null);
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77202,(1),null);
...
frontend.db.query_react.react_query = (function frontend$db$query_react$react_query(repo,p__77207,query_opts){
var map__77208 = p__77207;
var map__77208__$1 = cljs.core.__destructure_map(map__77208);
var query_SINGLEQUOTE_ = map__77208__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
var inputs__$1 = (function (){var G__77210 = resolved_inputs;
if(cljs.core.truth_(rules)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__77210,rules);
} else {
return G__77210;
}
})();
