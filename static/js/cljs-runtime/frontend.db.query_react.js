...
var G__43507 = (function (){var or__5043__auto__ = frontend.state.get_current_page();
...
return clojure.string.lower_case(G__43507);
}
} else {
...
var G__43509 = result__$1;
var G__43509__$1 = (((G__43509 == null))?null:frontend.db.query_react.remove_nested_children_blocks(G__43509));
var G__43509__$2 = (((G__43509__$1 == null))?null:frontend.db.model.sort_by_left_recursive(G__43509__$1));
if((G__43509__$2 == null)){
return null;
} else {
return frontend.db.model.with_pages(G__43509__$2);
}
})():result);
...
}catch (e43508){if((e43508 instanceof Error)){
var e = e43508;
...
var page_ref_QMARK_ = (function (p1__43511_SHARP_){
return ((typeof p1__43511_SHARP_ === 'string') && (logseq.graph_parser.text.page_ref_QMARK_(p1__43511_SHARP_)));
});
...
var vec__43512 = cljs.core.rest(f);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43512,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43512,(1),null);
var vec__43515 = ((page_ref_QMARK_(x))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [y,x], null));
var page_ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43515,(0),null);
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43515,(1),null);
...
frontend.db.query_react.react_query = (function frontend$db$query_react$react_query(repo,p__43518,query_opts){
var map__43519 = p__43518;
var map__43519__$1 = cljs.core.__destructure_map(map__43519);
var query_SINGLEQUOTE_ = map__43519__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43519__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43519__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43519__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
var inputs__$1 = (function (){var G__43520 = resolved_inputs;
if(cljs.core.truth_(rules)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__43520,rules);
} else {
return G__43520;
}
})();
