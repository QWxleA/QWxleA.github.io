...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60226){
var vec__60227 = p__60226;
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60227,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60227,(1),null);
...
var color = (function (){var G__60238 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dark_QMARK_,current_page_QMARK_], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__60238)){
return "#999";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__60238)){
return "#045591";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__60238)){
return "#93a1a1";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__60238)){
return "#ffffff";
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60238)].join('')));
...
var G__60245 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),p__$1,new cljs.core.Keyword(null,"label","label",1718410804),p__$1,new cljs.core.Keyword(null,"size","size",1098693007),size,new cljs.core.Keyword(null,"color","color",1011675173),color__$1], null);
if(cljs.core.contains_QMARK_(parents,p__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60245,new cljs.core.Keyword(null,"parent","parent",-878878779),true);
} else {
return G__60245;
}
...
frontend.handler.graph.normalize_page_name = (function frontend$handler$graph$normalize_page_name(p__60250){
var map__60251 = p__60250;
var map__60251__$1 = cljs.core.__destructure_map(map__60251);
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60251__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60251__$1,new cljs.core.Keyword(null,"links","links",-654507394));
var page_name__GT_original_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60251__$1,new cljs.core.Keyword(null,"page-name->original-name","page-name->original-name",599049389));
var links__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60252){
var map__60253 = p__60252;
var map__60253__$1 = cljs.core.__destructure_map(map__60253);
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60253__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60253__$1,new cljs.core.Keyword(null,"target","target",253001721));
...
frontend.handler.graph.build_global_graph = (function frontend$handler$graph$build_global_graph(theme,p__60260){
var map__60261 = p__60260;
var map__60261__$1 = cljs.core.__destructure_map(map__60261);
var journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60261__$1,new cljs.core.Keyword(null,"journal?","journal?",-897756522));
var orphan_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60261__$1,new cljs.core.Keyword(null,"orphan-pages?","orphan-pages?",-824819206));
var builtin_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60261__$1,new cljs.core.Keyword(null,"builtin-pages?","builtin-pages?",1299611390));
...
var nodes = (function (){var G__60272 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","name","block/name",1619760316),pages_after_journal_filter);
var G__60272__$1 = ((cljs.core.not(builtin_pages_QMARK_))?cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p){
return cljs.core.contains_QMARK_(build_in_pages,clojure.string.lower_case(p));
}),G__60272):G__60272);
if(cljs.core.not(orphan_pages_QMARK_)){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60259_SHARP_){
return cljs.core.contains_QMARK_(linked__$1,clojure.string.lower_case(p1__60259_SHARP_));
}),G__60272__$1);
} else {
return G__60272__$1;
}
})();
var page_links = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__60273){
var vec__60274 = p__60273;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60274,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60274,(1),null);
...
var links__$1 = frontend.handler.graph.build_links(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__60282){
var vec__60283 = p__60282;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60283,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60283,(1),null);
return (to == null);
}),links));
...
var page_entity = (function (){var G__60295 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page__$1], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__60295) : frontend.db.entity.call(null,G__60295));
})();
...
var tags__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__60286_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page__$1,p1__60286_SHARP_);
}),tags);
...
var namespaces = (frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1(repo) : frontend.db.get_all_namespace_relation.call(null,repo));
var links = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(namespaces,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60299){
var vec__60300 = p__60299;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60300,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60300,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [page__$1,p], null);
}),ref_pages),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60304){
var vec__60305 = p__60304;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60305,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60305,(1),null);
...
var namespaces = (frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1(repo) : frontend.db.get_all_namespace_relation.call(null,repo));
var links = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60325){
var vec__60326 = p__60325;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60326,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60326,(1),null);
 ...
 */
frontend.handler.graph.n_hops = (function frontend$handler$graph$n_hops(p__60340,nodes,level){
var map__60341 = p__60340;
var map__60341__$1 = cljs.core.__destructure_map(map__60341);
var graph = map__60341__$1;
var links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60341__$1,new cljs.core.Keyword(null,"links","links",-654507394));
...
var G__60401 = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.concat,nodes__$1,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (nodes__$1,level__$1,links__$1,map__60341,map__60341__$1,graph,links){
return (function (id){
...
});})(nodes__$1,level__$1,links__$1,map__60341,map__60341__$1,graph,links))
,nodes__$1)));
var G__60402 = (level__$1 - (1));
nodes__$1 = G__60401;
level__$1 = G__60402;
continue;
}
