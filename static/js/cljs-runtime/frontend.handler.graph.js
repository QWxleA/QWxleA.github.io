...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70157){
var vec__70158 = p__70157;
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70158,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70158,(1),null);
...
var color = (function (){var G__70161 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dark_QMARK_,current_page_QMARK_], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__70161)){
return "#999";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__70161)){
return "#045591";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__70161)){
return "#93a1a1";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__70161)){
return "#ffffff";
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__70161)].join('')));
...
var G__70163 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),p__$1,new cljs.core.Keyword(null,"label","label",1718410804),p__$1,new cljs.core.Keyword(null,"size","size",1098693007),size,new cljs.core.Keyword(null,"color","color",1011675173),color__$1], null);
if(cljs.core.contains_QMARK_(parents,p__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70163,new cljs.core.Keyword(null,"parent","parent",-878878779),true);
} else {
return G__70163;
}
...
var or__4253__auto__ = logseq.graph_parser.util.uuid_string_QMARK_(id);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
frontend.handler.graph.normalize_page_name = (function frontend$handler$graph$normalize_page_name(p__70168){
var map__70169 = p__70168;
var map__70169__$1 = cljs.core.__destructure_map(map__70169);
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70169__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70169__$1,new cljs.core.Keyword(null,"links","links",-654507394));
var page_name__GT_original_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70169__$1,new cljs.core.Keyword(null,"page-name->original-name","page-name->original-name",599049389));
var links__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70170){
var map__70171 = p__70170;
var map__70171__$1 = cljs.core.__destructure_map(map__70171);
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70171__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70171__$1,new cljs.core.Keyword(null,"target","target",253001721));
...
frontend.handler.graph.build_global_graph = (function frontend$handler$graph$build_global_graph(theme,p__70173){
var map__70174 = p__70173;
var map__70174__$1 = cljs.core.__destructure_map(map__70174);
var journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70174__$1,new cljs.core.Keyword(null,"journal?","journal?",-897756522));
var orphan_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70174__$1,new cljs.core.Keyword(null,"orphan-pages?","orphan-pages?",-824819206));
var builtin_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70174__$1,new cljs.core.Keyword(null,"builtin-pages?","builtin-pages?",1299611390));
...
var nodes = (function (){var G__70175 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","name","block/name",1619760316),pages_after_journal_filter);
var G__70175__$1 = ((cljs.core.not(builtin_pages_QMARK_))?cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p){
return cljs.core.contains_QMARK_(build_in_pages,clojure.string.lower_case(p));
}),G__70175):G__70175);
if(cljs.core.not(orphan_pages_QMARK_)){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__70172_SHARP_){
return cljs.core.contains_QMARK_(linked__$1,clojure.string.lower_case(p1__70172_SHARP_));
}),G__70175__$1);
} else {
return G__70175__$1;
}
})();
var page_links = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__70177){
var vec__70178 = p__70177;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70178,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70178,(1),null);
...
var links__$1 = frontend.handler.graph.build_links(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__70181){
var vec__70182 = p__70181;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70182,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70182,(1),null);
return (to == null);
}),links));
...
var page_entity = (function (){var G__70187 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page__$1], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__70187) : frontend.db.entity.call(null,G__70187));
})();
...
var tags__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__70185_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page__$1,p1__70185_SHARP_);
}),tags);
...
var namespaces = (frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1(repo) : frontend.db.get_all_namespace_relation.call(null,repo));
var links = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(namespaces,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70188){
var vec__70189 = p__70188;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70189,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70189,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [page__$1,p], null);
}),ref_pages),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70192){
var vec__70193 = p__70192;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70193,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70193,(1),null);
...
var namespaces = (frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1(repo) : frontend.db.get_all_namespace_relation.call(null,repo));
var links = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70196){
var vec__70197 = p__70196;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70197,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70197,(1),null);
 ...
 */
frontend.handler.graph.n_hops = (function frontend$handler$graph$n_hops(p__70201,nodes,level){
var map__70202 = p__70201;
var map__70202__$1 = cljs.core.__destructure_map(map__70202);
var graph = map__70202__$1;
var links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70202__$1,new cljs.core.Keyword(null,"links","links",-654507394));
...
var G__70227 = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.concat,nodes__$1,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (nodes__$1,level__$1,links__$1,map__70202,map__70202__$1,graph,links){
return (function (id){
...
});})(nodes__$1,level__$1,links__$1,map__70202,map__70202__$1,graph,links))
,nodes__$1)));
var G__70228 = (level__$1 - (1));
nodes__$1 = G__70227;
level__$1 = G__70228;
continue;
}
