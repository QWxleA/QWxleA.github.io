...
var get_graph_name_fn = (function (p1__61262_SHARP_){
return clojure.string.lower_case(cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(logseq.graph_parser.text.get_graph_name_from_path(p1__61262_SHARP_),"/")));
});
var current_graph_name = get_graph_name_fn(current_repo_url);
var repos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"url","url",276297046),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__61263_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(p1__61263_SHARP_),frontend.config.local_repo);
...
var repo_names = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61264_SHARP_){
return get_graph_name_fn(p1__61264_SHARP_);
}),repos);
...
var graph_name = (function (){var G__61272 = pathname;
var G__61272__$1 = (((G__61272 == null))?null:clojure.string.replace(G__61272,"/",""));
if((G__61272__$1 == null)){
return null;
} else {
return clojure.string.lower_case(G__61272__$1);
}
})();
var vec__61269 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61265_SHARP_){
return search_params.get(p1__61265_SHARP_);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["page","block-id"], null));
var page_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61269,(0),null);
var block_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61269,(1),null);
if(clojure.string.blank_QMARK_(graph_name)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(graph_name,current_graph_name)){
} else {
var graph_idx_61273 = repo_names.indexOf(graph_name);
var graph_url_61274 = ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(graph_idx_61273,(-1)))?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(repos,graph_idx_61273):null);
if(cljs.core.truth_(graph_url_61274)){
frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("graph","switch","graph/switch",178853840),graph_url_61274], null));
...
var db_page_name_61275 = frontend.db.model.get_redirect_page_name.cljs$core$IFn$_invoke$arity$1(page_name);
frontend.handler.editor.insert_first_page_block_if_not_exists_BANG_.cljs$core$IFn$_invoke$arity$1(db_page_name_61275);
} else {
