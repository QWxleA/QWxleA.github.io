...
var vec__97387 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97387,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97387,(1),null);
...
var vec__97390 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97390,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97390,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__97400 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97400,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97400,(1),null);
...
var G__97664 = cljs.core.next(parses__$1);
parses__$1 = G__97664;
continue;
}
...
var G__97408 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__97409 = G__97408;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97409,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97409,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97409,(2),null);
var selection = vec__97409;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__97408__$1 = G__97408;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__97416 = G__97408__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97416,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97416,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97416,(2),null);
var selection__$1 = vec__97416;
...
var G__97679 = cljs.core.long$(end__$1);
var G__97680 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__97681 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__97679;
parses__$1 = G__97680;
G__97408__$1 = G__97681;
continue;
...
var G__97425 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__97426 = G__97425;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97426,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97426,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97426,(2),null);
var selection = vec__97426;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__97425__$1 = G__97425;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__97433 = G__97425__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97433,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97433,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97433,(2),null);
var selection__$1 = vec__97433;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__97691 = cljs.core.long$(end__$1);
var G__97692 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__97693 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__97691;
parses__$1 = G__97692;
G__97425__$1 = G__97693;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__97474 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__97475 = G__97474;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97475,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97475,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97475,(2),null);
var selection = vec__97475;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__97474__$1 = G__97474;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__97526 = G__97474__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97526,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97526,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97526,(2),null);
var selection__$1 = vec__97526;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__97717 = cljs.core.long$(end__$1);
var G__97718 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__97719 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__97717;
parses__$1 = G__97718;
G__97474__$1 = G__97719;
continue;
...
if(cljs.core.truth_((function (){var fexpr__97609 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__97609.cljs$core$IFn$_invoke$arity$1 ? fexpr__97609.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__97609.call(null,output_format));
})())){
} else {
...
var G__97610 = output_format;
var G__97610__$1 = (((G__97610 instanceof cljs.core.Keyword))?G__97610.fqn:null);
switch (G__97610__$1) {
case "enlive":
...
var and__5041__auto____$1 = (function (){var G__97622 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__97621 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__97621.cljs$core$IFn$_invoke$arity$1 ? fexpr__97621.cljs$core$IFn$_invoke$arity$1(G__97622) : fexpr__97621.call(null,G__97622));
})();
