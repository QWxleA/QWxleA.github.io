...
return logseq.graph_parser.block.page_name__GT_map(original_page_name,with_id_QMARK_,(function (){var G__49402 = frontend.state.get_current_repo();
return (frontend.db.get_db.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_db.cljs$core$IFn$_invoke$arity$1(G__49402) : frontend.db.get_db.call(null,G__49402));
...
(frontend.format.block.parse_block.cljs$core$IFn$_invoke$arity$2 = (function (p__49414,p__49415){
var map__49416 = p__49414;
var map__49416__$1 = cljs.core.__destructure_map(map__49416);
var block = map__49416__$1;
var uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49416__$1,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49416__$1,new cljs.core.Keyword("block","content","block/content",-161885195));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49416__$1,new cljs.core.Keyword("block","page","block/page",822314108));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49416__$1,new cljs.core.Keyword("block","format","block/format",-1212045901));
var map__49417 = p__49415;
var map__49417__$1 = cljs.core.__destructure_map(map__49417);
var with_id_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49417__$1,new cljs.core.Keyword(null,"with-id?","with-id?",1405069912),true);
...
var parent_refs = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("block","path-refs","block/path-refs",-2109181352).cljs$core$IFn$_invoke$arity$1((function (){var G__49423 = frontend.state.get_current_repo();
var G__49424 = uuid;
return (frontend.db.get_block_parent.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_block_parent.cljs$core$IFn$_invoke$arity$2(G__49423,G__49424) : frontend.db.get_block_parent.call(null,G__49423,G__49424));
})()));
var map__49422 = new_block;
var map__49422__$1 = cljs.core.__destructure_map(map__49422);
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49422__$1,new cljs.core.Keyword("block","refs","block/refs",-1214495349));
...
var block__$2 = (function (){var G__49425 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([block__$1,new_block,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","path-refs","block/path-refs",-2109181352),path_ref_pages], null)], 0));
if((cljs.core.count(blocks) > (1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49425,new cljs.core.Keyword("block","warning","block/warning",2131709542),new cljs.core.Keyword(null,"multiple-blocks","multiple-blocks",1235340805));
} else {
return G__49425;
}
})();
...
var result = (function (){var G__49451 = ((cljs.core.seq(body__$1))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","body","block/body",2004112880),body__$1], null):cljs.core.PersistentArrayMap.EMPTY);
if(cljs.core.truth_(title)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49451,new cljs.core.Keyword("block","title","block/title",710445684),title);
} else {
return G__49451;
}
})();
...
var G__49487 = clojure.string.replace(s,["$",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),cljs.core.first(args));
var G__49488 = cljs.core.rest(args);
var G__49489 = (n + (1));
s = G__49487;
args = G__49488;
n = G__49489;
...
frontend.format.block.break_line_paragraph_QMARK_ = (function frontend$format$block$break_line_paragraph_QMARK_(p__49466){
var vec__49467 = p__49466;
var typ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49467,(0),null);
var break_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49467,(1),null);
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(typ,"Paragraph")) && (cljs.core.every_QMARK_((function (p1__49464_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__49464_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Break_Line"], null));
}),break_lines)));
});
...
var vec__49472 = ast;
var typ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49472,(0),null);
var paras = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49472,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [typ,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49471_SHARP_){
return cljs.core.last(p1__49471_SHARP_);
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49470_SHARP_){
var vec__49475 = p1__49470_SHARP_;
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49475,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49475,(1),null);
