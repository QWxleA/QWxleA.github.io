...
return daiquiri.core.create_element("div",{'className':"filters"},[daiquiri.core.create_element("div",{'className':"sm:flex sm:items-start"},[(function (){var attrs70625 = frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("filter",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"fontSize","fontSize",919623033),(20)], null)], null));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs70625))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, ["mx-auto","flex-shrink-0","flex","items-center","justify-center","h-12","w-12","rounded-full","bg-gray-200","text-gray-500","sm:mx-0","sm:h-10","sm:w-10"], null)], null),attrs70625], 0))):{'className':"mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-gray-200 text-gray-500 sm:mx-0 sm:h-10 sm:w-10"}),((cljs.core.map_QMARK_(attrs70625))?null:[daiquiri.interpreter.interpret(attrs70625)]));
...
return daiquiri.core.create_element("div",{'className':"mt-5 sm:mt-4 sm:flex sm gap-1 flex-wrap"},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function frontend$components$reference$iter__70628(s__70629){
return (new cljs.core.LazySeq(null,(function (){
var s__70629__$1 = s__70629;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__70629__$1);
if(temp__5720__auto__){
var s__70629__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70629__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__70629__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__70631 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__70630 = (0);
while(true){
if((i__70630 < size__4651__auto__)){
var reference = cljs.core._nth(c__4650__auto__,i__70630);
cljs.core.chunk_append(b__70631,(function (){var lc_reference = clojure.string.lower_case(reference);
var filtered = cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,lc_reference);
var color = (function (){var pred__70632 = cljs.core._EQ_;
var expr__70633 = filtered;
if(cljs.core.truth_((pred__70632.cljs$core$IFn$_invoke$arity$2 ? pred__70632.cljs$core$IFn$_invoke$arity$2(true,expr__70633) : pred__70632.call(null,true,expr__70633)))){
return "text-green-400";
} else {
if(cljs.core.truth_((pred__70632.cljs$core$IFn$_invoke$arity$2 ? pred__70632.cljs$core$IFn$_invoke$arity$2(false,expr__70633) : pred__70632.call(null,false,expr__70633)))){
return "text-red-400";
} else {
return null;
}
...
return daiquiri.core.create_element("button",{'key':reference,'style':{'borderColor':"currentColor"},'onClick':((function (i__70630,lc_reference,filtered,color,reference,c__4650__auto__,size__4651__auto__,b__70631,s__70629__$2,temp__5720__auto__,filters){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(filters_atom,((function (i__70630,lc_reference,filtered,color,reference,c__4650__auto__,size__4651__auto__,b__70631,s__70629__$2,temp__5720__auto__,filters){
return (function (p1__70624_SHARP_){
if((cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,lc_reference) == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__70624_SHARP_,lc_reference,cljs.core.not(e.shiftKey));
} else {
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__70624_SHARP_,lc_reference);
}
});})(i__70630,lc_reference,filtered,color,reference,c__4650__auto__,size__4651__auto__,b__70631,s__70629__$2,temp__5720__auto__,filters))
);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70631),frontend$components$reference$iter__70628(cljs.core.chunk_rest(s__70629__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70631),null);
}
} else {
var reference = cljs.core.first(s__70629__$2);
return cljs.core.cons((function (){var lc_reference = clojure.string.lower_case(reference);
var filtered = cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,lc_reference);
var color = (function (){var pred__70635 = cljs.core._EQ_;
var expr__70636 = filtered;
if(cljs.core.truth_((pred__70635.cljs$core$IFn$_invoke$arity$2 ? pred__70635.cljs$core$IFn$_invoke$arity$2(true,expr__70636) : pred__70635.call(null,true,expr__70636)))){
return "text-green-400";
} else {
if(cljs.core.truth_((pred__70635.cljs$core$IFn$_invoke$arity$2 ? pred__70635.cljs$core$IFn$_invoke$arity$2(false,expr__70636) : pred__70635.call(null,false,expr__70636)))){
return "text-red-400";
} else {
return null;
}
...
return daiquiri.core.create_element("button",{'key':reference,'style':{'borderColor':"currentColor"},'onClick':((function (lc_reference,filtered,color,reference,s__70629__$2,temp__5720__auto__,filters){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(filters_atom,(function (p1__70624_SHARP_){
if((cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,lc_reference) == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__70624_SHARP_,lc_reference,cljs.core.not(e.shiftKey));
} else {
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__70624_SHARP_,lc_reference);
...
return frontend.handler.page.save_filter_BANG_(page_name,cljs.core.deref(filters_atom));
});})(lc_reference,filtered,color,reference,s__70629__$2,temp__5720__auto__,filters))
,'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, ["border","rounded","px-1","mb-1","mr-1",color], null))},[daiquiri.interpreter.interpret(reference)]);
})(),frontend$components$reference$iter__70628(cljs.core.rest(s__70629__$2)));
}
} else {
return null;
}
...
var ref_blocks = (cljs.core.truth_(block_id)?(frontend.db.get_block_referenced_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_block_referenced_blocks.cljs$core$IFn$_invoke$arity$1(block_id) : frontend.db.get_block_referenced_blocks.call(null,block_id)):(frontend.db.get_page_referenced_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page_referenced_blocks.cljs$core$IFn$_invoke$arity$1(page_name__$2) : frontend.db.get_page_referenced_blocks.call(null,page_name__$2)));
var filters = ((cljs.core.seq(filter_state))?medley.core.map_vals((function (p1__70638_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,p1__70638_SHARP_);
...
var n_ref__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,(function (){var iter__4652__auto__ = (function frontend$components$reference$iter__70651(s__70652){
return (new cljs.core.LazySeq(null,(function (){
var s__70652__$1 = s__70652;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__70652__$1);
if(temp__5720__auto__){
var s__70652__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70652__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__70652__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__70654 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__70653 = (0);
while(true){
if((i__70653 < size__4651__auto__)){
var vec__70656 = cljs.core._nth(c__4650__auto__,i__70653);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70656,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70656,(1),null);
cljs.core.chunk_append(b__70654,cljs.core.count(rfs));

var G__70699 = (i__70653 + (1));
i__70653 = G__70699;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70654),frontend$components$reference$iter__70651(cljs.core.chunk_rest(s__70652__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70654),null);
}
} else {
var vec__70660 = cljs.core.first(s__70652__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70660,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70660,(1),null);
return cljs.core.cons(cljs.core.count(rfs),frontend$components$reference$iter__70651(cljs.core.rest(s__70652__$2)));
}
} else {
return null;
}
...
}),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"default-collapsed?","default-collapsed?",-1350393823),default_collapsed_QMARK_,new cljs.core.Keyword(null,"title-trigger?","title-trigger?",-613599873),true], null)):null)]:[daiquiri.interpreter.interpret(attrs70640),((cljs.core.seq(refed_blocks_ids))?frontend.ui.foldable(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-row.flex-1.justify-between.items-center","div.flex.flex-row.flex-1.justify-between.items-center",-2124603115),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2.font-bold.opacity-50","h2.font-bold.opacity-50",1276193375),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(n_ref)," Linked Reference",(((n_ref > (1)))?"s":null)].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.filter.fade-link","a.filter.fade-link",2055145599),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Filter",new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),(function (e){
return frontend.util.stop_propagation(e);
}),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var ref_blocks = (cljs.core.truth_(block_id)?(frontend.db.get_block_referenced_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_block_referenced_blocks.cljs$core$IFn$_invoke$arity$1(block_id) : frontend.db.get_block_referenced_blocks.call(null,block_id)):(frontend.db.get_page_referenced_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page_referenced_blocks.cljs$core$IFn$_invoke$arity$1(page_name__$2) : frontend.db.get_page_referenced_blocks.call(null,page_name__$2)));
var ref_pages = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","original-name","block/original-name",-1620099234),cljs.core.first),ref_blocks);
...
var filtered_ref_blocks = frontend.handler.block.filter_blocks(repo,ref_blocks,filters,true);
var n_ref__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,(function (){var iter__4652__auto__ = (function frontend$components$reference$iter__70676(s__70677){
return (new cljs.core.LazySeq(null,(function (){
var s__70677__$1 = s__70677;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__70677__$1);
if(temp__5720__auto__){
var s__70677__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70677__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__70677__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__70679 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__70678 = (0);
while(true){
if((i__70678 < size__4651__auto__)){
var vec__70680 = cljs.core._nth(c__4650__auto__,i__70678);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70680,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70680,(1),null);
cljs.core.chunk_append(b__70679,cljs.core.count(rfs));

var G__70700 = (i__70678 + (1));
i__70678 = G__70700;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70679),frontend$components$reference$iter__70676(cljs.core.chunk_rest(s__70677__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70679),null);
}
} else {
var vec__70683 = cljs.core.first(s__70677__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70683,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70683,(1),null);
return cljs.core.cons(cljs.core.count(rfs),frontend$components$reference$iter__70676(cljs.core.rest(s__70677__$2)));
}
} else {
return null;
}
...
var attrs70686 = (function (){var ref_hiccup = frontend.components.block.__GT_hiccup(ref_blocks,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(page_name),"-unlinked-"].join(''),new cljs.core.Keyword(null,"ref?","ref?",1932693720),true,new cljs.core.Keyword(null,"group-by-page?","group-by-page?",1520059448),true,new cljs.core.Keyword(null,"editor-box","editor-box",708759870),frontend.components.editor.box], null),cljs.core.PersistentArrayMap.EMPTY);
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs70686))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["references-blocks"], null)], null),attrs70686], 0))):{'className':"references-blocks"}),((cljs.core.map_QMARK_(attrs70686))?null:[daiquiri.interpreter.interpret(attrs70686)]));
...
cljs.core.reset_BANG_(cljs.core.second(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state)),cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,(function (){var iter__4652__auto__ = (function frontend$components$reference$iter__70687(s__70688){
return (new cljs.core.LazySeq(null,(function (){
var s__70688__$1 = s__70688;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__70688__$1);
if(temp__5720__auto__){
var s__70688__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70688__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__70688__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__70690 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__70689 = (0);
while(true){
if((i__70689 < size__4651__auto__)){
var vec__70691 = cljs.core._nth(c__4650__auto__,i__70689);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70691,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70691,(1),null);
cljs.core.chunk_append(b__70690,cljs.core.count(rfs));

var G__70701 = (i__70689 + (1));
i__70689 = G__70701;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70690),frontend$components$reference$iter__70687(cljs.core.chunk_rest(s__70688__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70690),null);
}
} else {
var vec__70694 = cljs.core.first(s__70688__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70694,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70694,(1),null);
return cljs.core.cons(cljs.core.count(rfs),frontend$components$reference$iter__70687(cljs.core.rest(s__70688__$2)));
}
} else {
return null;
}
...
return iter__4652__auto__((function (){var G__70697 = cljs.core.first(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state));
return (frontend.db.get_page_unlinked_references.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page_unlinked_references.cljs$core$IFn$_invoke$arity$1(G__70697) : frontend.db.get_page_unlinked_references.call(null,G__70697));
})());
})()));
