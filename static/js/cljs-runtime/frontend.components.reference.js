...
return daiquiri.core.create_element("div",{'className':"filters"},[daiquiri.core.create_element("div",{'className':"sm:flex sm:items-start"},[(function (){var attrs60804 = frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("filter",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"fontSize","fontSize",919623033),(20)], null)], null));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs60804))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, ["mx-auto","flex-shrink-0","flex","items-center","justify-center","h-12","w-12","rounded-full","bg-gray-200","text-gray-500","sm:mx-0","sm:h-10","sm:w-10"], null)], null),attrs60804], 0))):{'className':"mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-gray-200 text-gray-500 sm:mx-0 sm:h-10 sm:w-10"}),((cljs.core.map_QMARK_(attrs60804))?null:[daiquiri.interpreter.interpret(attrs60804)]));
...
return daiquiri.core.create_element("div",{'className':"mt-5 sm:mt-4 sm:flex sm gap-1 flex-wrap"},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5520__auto__ = (function frontend$components$reference$iter__60807(s__60808){
return (new cljs.core.LazySeq(null,(function (){
var s__60808__$1 = s__60808;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__60808__$1);
if(temp__5720__auto__){
var s__60808__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60808__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__60808__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__60810 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__60809 = (0);
while(true){
if((i__60809 < size__5519__auto__)){
var reference = cljs.core._nth(c__5518__auto__,i__60809);
cljs.core.chunk_append(b__60810,(function (){var lc_reference = clojure.string.lower_case(reference);
var filtered = cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,lc_reference);
var color = (function (){var pred__60811 = cljs.core._EQ_;
var expr__60812 = filtered;
if(cljs.core.truth_((pred__60811.cljs$core$IFn$_invoke$arity$2 ? pred__60811.cljs$core$IFn$_invoke$arity$2(true,expr__60812) : pred__60811.call(null,true,expr__60812)))){
return "text-green-400";
} else {
if(cljs.core.truth_((pred__60811.cljs$core$IFn$_invoke$arity$2 ? pred__60811.cljs$core$IFn$_invoke$arity$2(false,expr__60812) : pred__60811.call(null,false,expr__60812)))){
return "text-red-400";
} else {
return null;
}
...
return daiquiri.core.create_element("button",{'key':reference,'style':{'borderColor':"currentColor"},'onClick':((function (i__60809,lc_reference,filtered,color,reference,c__5518__auto__,size__5519__auto__,b__60810,s__60808__$2,temp__5720__auto__,filters){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(filters_atom,((function (i__60809,lc_reference,filtered,color,reference,c__5518__auto__,size__5519__auto__,b__60810,s__60808__$2,temp__5720__auto__,filters){
return (function (p1__60799_SHARP_){
if((cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,lc_reference) == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__60799_SHARP_,lc_reference,cljs.core.not(e.shiftKey));
} else {
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__60799_SHARP_,lc_reference);
}
});})(i__60809,lc_reference,filtered,color,reference,c__5518__auto__,size__5519__auto__,b__60810,s__60808__$2,temp__5720__auto__,filters))
);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60810),frontend$components$reference$iter__60807(cljs.core.chunk_rest(s__60808__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60810),null);
}
} else {
var reference = cljs.core.first(s__60808__$2);
return cljs.core.cons((function (){var lc_reference = clojure.string.lower_case(reference);
var filtered = cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,lc_reference);
var color = (function (){var pred__60815 = cljs.core._EQ_;
var expr__60816 = filtered;
if(cljs.core.truth_((pred__60815.cljs$core$IFn$_invoke$arity$2 ? pred__60815.cljs$core$IFn$_invoke$arity$2(true,expr__60816) : pred__60815.call(null,true,expr__60816)))){
return "text-green-400";
} else {
if(cljs.core.truth_((pred__60815.cljs$core$IFn$_invoke$arity$2 ? pred__60815.cljs$core$IFn$_invoke$arity$2(false,expr__60816) : pred__60815.call(null,false,expr__60816)))){
return "text-red-400";
} else {
return null;
}
...
return daiquiri.core.create_element("button",{'key':reference,'style':{'borderColor':"currentColor"},'onClick':((function (lc_reference,filtered,color,reference,s__60808__$2,temp__5720__auto__,filters){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(filters_atom,(function (p1__60799_SHARP_){
if((cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,lc_reference) == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__60799_SHARP_,lc_reference,cljs.core.not(e.shiftKey));
} else {
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__60799_SHARP_,lc_reference);
...
return frontend.handler.page.save_filter_BANG_(page_name,cljs.core.deref(filters_atom));
});})(lc_reference,filtered,color,reference,s__60808__$2,temp__5720__auto__,filters))
,'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, ["border","rounded","px-1","mb-1","mr-1",color], null))},[daiquiri.interpreter.interpret(reference)]);
})(),frontend$components$reference$iter__60807(cljs.core.rest(s__60808__$2)));
}
} else {
return null;
}
...
var ref_blocks = (cljs.core.truth_(block_id)?(frontend.db.get_block_referenced_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_block_referenced_blocks.cljs$core$IFn$_invoke$arity$1(block_id) : frontend.db.get_block_referenced_blocks.call(null,block_id)):(frontend.db.get_page_referenced_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page_referenced_blocks.cljs$core$IFn$_invoke$arity$1(page_name__$2) : frontend.db.get_page_referenced_blocks.call(null,page_name__$2)));
var filters = ((cljs.core.seq(filter_state))?cljs.core.update_vals(cljs.core.group_by(cljs.core.second,filter_state),(function (p1__60818_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,p1__60818_SHARP_);
})):null);
var filtered_ref_blocks = frontend.handler.block.filter_blocks(repo,ref_blocks,filters,true);
var n_ref__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,(function (){var iter__5520__auto__ = (function frontend$components$reference$iter__60831(s__60832){
return (new cljs.core.LazySeq(null,(function (){
var s__60832__$1 = s__60832;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__60832__$1);
if(temp__5720__auto__){
var s__60832__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60832__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__60832__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__60834 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__60833 = (0);
while(true){
if((i__60833 < size__5519__auto__)){
var vec__60835 = cljs.core._nth(c__5518__auto__,i__60833);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60835,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60835,(1),null);
cljs.core.chunk_append(b__60834,cljs.core.count(rfs));

var G__60875 = (i__60833 + (1));
i__60833 = G__60875;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60834),frontend$components$reference$iter__60831(cljs.core.chunk_rest(s__60832__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60834),null);
}
} else {
var vec__60838 = cljs.core.first(s__60832__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60838,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60838,(1),null);
return cljs.core.cons(cljs.core.count(rfs),frontend$components$reference$iter__60831(cljs.core.rest(s__60832__$2)));
}
} else {
return null;
}
...
}),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"default-collapsed?","default-collapsed?",-1350393823),default_collapsed_QMARK_,new cljs.core.Keyword(null,"title-trigger?","title-trigger?",-613599873),true], null)):null)]:[daiquiri.interpreter.interpret(attrs60820),((cljs.core.seq(refed_blocks_ids))?frontend.ui.foldable(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-row.flex-1.justify-between.items-center","div.flex.flex-row.flex-1.justify-between.items-center",-2124603115),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2.font-bold.opacity-50","h2.font-bold.opacity-50",1276193375),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(n_ref)," Linked Reference",(((n_ref > (1)))?"s":null)].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.filter.fade-link","a.filter.fade-link",2055145599),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Filter",new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),(function (e){
return frontend.util.stop_propagation(e);
}),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var ref_blocks = (cljs.core.truth_(block_id)?(frontend.db.get_block_referenced_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_block_referenced_blocks.cljs$core$IFn$_invoke$arity$1(block_id) : frontend.db.get_block_referenced_blocks.call(null,block_id)):(frontend.db.get_page_referenced_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page_referenced_blocks.cljs$core$IFn$_invoke$arity$1(page_name__$2) : frontend.db.get_page_referenced_blocks.call(null,page_name__$2)));
var ref_pages = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","original-name","block/original-name",-1620099234),cljs.core.first),ref_blocks);
...
var filtered_ref_blocks = frontend.handler.block.filter_blocks(repo,ref_blocks,filters,true);
var n_ref__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,(function (){var iter__5520__auto__ = (function frontend$components$reference$iter__60851(s__60852){
return (new cljs.core.LazySeq(null,(function (){
var s__60852__$1 = s__60852;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__60852__$1);
if(temp__5720__auto__){
var s__60852__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60852__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__60852__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__60854 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__60853 = (0);
while(true){
if((i__60853 < size__5519__auto__)){
var vec__60855 = cljs.core._nth(c__5518__auto__,i__60853);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60855,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60855,(1),null);
cljs.core.chunk_append(b__60854,cljs.core.count(rfs));

var G__60880 = (i__60853 + (1));
i__60853 = G__60880;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60854),frontend$components$reference$iter__60851(cljs.core.chunk_rest(s__60852__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60854),null);
}
} else {
var vec__60858 = cljs.core.first(s__60852__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60858,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60858,(1),null);
return cljs.core.cons(cljs.core.count(rfs),frontend$components$reference$iter__60851(cljs.core.rest(s__60852__$2)));
}
} else {
return null;
}
...
var attrs60861 = (function (){var ref_hiccup = frontend.components.block.__GT_hiccup(ref_blocks,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(page_name),"-unlinked-"].join(''),new cljs.core.Keyword(null,"ref?","ref?",1932693720),true,new cljs.core.Keyword(null,"group-by-page?","group-by-page?",1520059448),true,new cljs.core.Keyword(null,"editor-box","editor-box",708759870),frontend.components.editor.box], null),cljs.core.PersistentArrayMap.EMPTY);
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs60861))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["references-blocks"], null)], null),attrs60861], 0))):{'className':"references-blocks"}),((cljs.core.map_QMARK_(attrs60861))?null:[daiquiri.interpreter.interpret(attrs60861)]));
...
cljs.core.reset_BANG_(cljs.core.second(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state)),cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,(function (){var iter__5520__auto__ = (function frontend$components$reference$iter__60862(s__60863){
return (new cljs.core.LazySeq(null,(function (){
var s__60863__$1 = s__60863;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__60863__$1);
if(temp__5720__auto__){
var s__60863__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60863__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__60863__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__60865 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__60864 = (0);
while(true){
if((i__60864 < size__5519__auto__)){
var vec__60866 = cljs.core._nth(c__5518__auto__,i__60864);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60866,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60866,(1),null);
cljs.core.chunk_append(b__60865,cljs.core.count(rfs));

var G__60881 = (i__60864 + (1));
i__60864 = G__60881;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60865),frontend$components$reference$iter__60862(cljs.core.chunk_rest(s__60863__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60865),null);
}
} else {
var vec__60869 = cljs.core.first(s__60863__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60869,(0),null);
var rfs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60869,(1),null);
return cljs.core.cons(cljs.core.count(rfs),frontend$components$reference$iter__60862(cljs.core.rest(s__60863__$2)));
}
} else {
return null;
}
...
return iter__5520__auto__((function (){var G__60872 = cljs.core.first(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state));
return (frontend.db.get_page_unlinked_references.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page_unlinked_references.cljs$core$IFn$_invoke$arity$1(G__60872) : frontend.db.get_page_unlinked_references.call(null,G__60872));
})());
})()));
