...
var repos = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__61924_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(p1__61924_SHARP_),frontend.config.local_repo);
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs61933))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","my-4"], null)], null),attrs61933], 0))):{'className':"flex flex-row my-4"}),((cljs.core.map_QMARK_(attrs61933))?null:[daiquiri.interpreter.interpret(attrs61933)]));
})(),cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5520__auto__ = (function frontend$components$repo$iter__61935(s__61936){
return (new cljs.core.LazySeq(null,(function (){
var s__61936__$1 = s__61936;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__61936__$1);
if(temp__5720__auto__){
var s__61936__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61936__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__61936__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__61938 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__61937 = (0);
while(true){
if((i__61937 < size__5519__auto__)){
var map__61941 = cljs.core._nth(c__5518__auto__,i__61937);
var map__61941__$1 = cljs.core.__destructure_map(map__61941);
var repo = map__61941__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61941__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61941__$1,new cljs.core.Keyword(null,"url","url",276297046));
cljs.core.chunk_append(b__61938,(function (){var local_QMARK_ = frontend.config.local_db_QMARK_(url);
...
return daiquiri.core.create_element("a",{'title':local_dir,'onClick':((function (i__61937,local_dir,graph_name,local_QMARK_,map__61941,map__61941__$1,repo,id,url,c__5518__auto__,size__5519__auto__,b__61938,s__61936__$2,temp__5720__auto__,repos,repos__$1){
return (function (){
...
});})(i__61937,local_dir,graph_name,local_QMARK_,map__61941,map__61941__$1,repo,id,url,c__5518__auto__,size__5519__auto__,b__61938,s__61936__$2,temp__5720__auto__,repos,repos__$1))
},[graph_name]);
})():daiquiri.core.create_element("a",{'target':"_blank",'href':url},[daiquiri.interpreter.interpret((frontend.db.get_repo_path.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_repo_path.cljs$core$IFn$_invoke$arity$1(url) : frontend.db.get_repo_path.call(null,url)))])),(function (){var attrs61942 = (cljs.core.truth_(frontend.encrypt.encrypted_db_QMARK_(url))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.control","a.control",1833131627),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),"Show encryption information about this graph",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__61937,local_QMARK_,map__61941,map__61941__$1,repo,id,url,c__5518__auto__,size__5519__auto__,b__61938,s__61936__$2,temp__5720__auto__,repos,repos__$1){
return (function (){
return frontend.state.set_modal_BANG_.cljs$core$IFn$_invoke$arity$1(frontend.components.encryption.encryption_dialog(url));
});})(i__61937,local_QMARK_,map__61941,map__61941__$1,repo,id,url,c__5518__auto__,size__5519__auto__,b__61938,s__61936__$2,temp__5720__auto__,repos,repos__$1))
], null),"\uD83D\uDD10"], null):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs61942))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["controls"], null)], null),attrs61942], 0))):{'className':"controls"}),((cljs.core.map_QMARK_(attrs61942))?[daiquiri.core.create_element("a",{'title':"No worries, unlink this graph will clear its cache only, it does not remove your files on the disk.",'onClick':((function (i__61937,attrs61942,local_QMARK_,map__61941,map__61941__$1,repo,id,url,c__5518__auto__,size__5519__auto__,b__61938,s__61936__$2,temp__5720__auto__,repos,repos__$1){
return (function (){
return frontend.handler.repo.remove_repo_BANG_(repo);
});})(i__61937,attrs61942,local_QMARK_,map__61941,map__61941__$1,repo,id,url,c__5518__auto__,size__5519__auto__,b__61938,s__61936__$2,temp__5720__auto__,repos,repos__$1))
,'className':"text-gray-400 ml-4 font-medium text-sm"},["Unlink"])]:[daiquiri.interpreter.interpret(attrs61942),daiquiri.core.create_element("a",{'title':"No worries, unlink this graph will clear its cache only, it does not remove your files on the disk.",'onClick':((function (i__61937,attrs61942,local_QMARK_,map__61941,map__61941__$1,repo,id,url,c__5518__auto__,size__5519__auto__,b__61938,s__61936__$2,temp__5720__auto__,repos,repos__$1){
return (function (){
return frontend.handler.repo.remove_repo_BANG_(repo);
});})(i__61937,attrs61942,local_QMARK_,map__61941,map__61941__$1,repo,id,url,c__5518__auto__,size__5519__auto__,b__61938,s__61936__$2,temp__5720__auto__,repos,repos__$1))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61938),frontend$components$repo$iter__61935(cljs.core.chunk_rest(s__61936__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61938),null);
}
} else {
var map__61943 = cljs.core.first(s__61936__$2);
var map__61943__$1 = cljs.core.__destructure_map(map__61943);
var repo = map__61943__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61943__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61943__$1,new cljs.core.Keyword(null,"url","url",276297046));
return cljs.core.cons((function (){var local_QMARK_ = frontend.config.local_db_QMARK_(url);
return daiquiri.core.create_element("div",{'key':id,'className':"flex justify-between mb-4"},[((local_QMARK_)?(function (){var local_dir = frontend.config.get_local_dir(url);
var graph_name = logseq.graph_parser.text.get_graph_name_from_path(local_dir);
return daiquiri.core.create_element("a",{'title':local_dir,'onClick':((function (local_dir,graph_name,local_QMARK_,map__61943,map__61943__$1,repo,id,url,s__61936__$2,temp__5720__auto__,repos,repos__$1){
return (function (){
return frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("graph","switch","graph/switch",178853840),url], null));
});})(local_dir,graph_name,local_QMARK_,map__61943,map__61943__$1,repo,id,url,s__61936__$2,temp__5720__auto__,repos,repos__$1))
},[graph_name]);
})():daiquiri.core.create_element("a",{'target':"_blank",'href':url},[daiquiri.interpreter.interpret((frontend.db.get_repo_path.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_repo_path.cljs$core$IFn$_invoke$arity$1(url) : frontend.db.get_repo_path.call(null,url)))])),(function (){var attrs61942 = (cljs.core.truth_(frontend.encrypt.encrypted_db_QMARK_(url))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.control","a.control",1833131627),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),"Show encryption information about this graph",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (local_QMARK_,map__61943,map__61943__$1,repo,id,url,s__61936__$2,temp__5720__auto__,repos,repos__$1){
return (function (){
return frontend.state.set_modal_BANG_.cljs$core$IFn$_invoke$arity$1(frontend.components.encryption.encryption_dialog(url));
});})(local_QMARK_,map__61943,map__61943__$1,repo,id,url,s__61936__$2,temp__5720__auto__,repos,repos__$1))
], null),"\uD83D\uDD10"], null):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs61942))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["controls"], null)], null),attrs61942], 0))):{'className':"controls"}),((cljs.core.map_QMARK_(attrs61942))?[daiquiri.core.create_element("a",{'title':"No worries, unlink this graph will clear its cache only, it does not remove your files on the disk.",'onClick':((function (attrs61942,local_QMARK_,map__61943,map__61943__$1,repo,id,url,s__61936__$2,temp__5720__auto__,repos,repos__$1){
return (function (){
return frontend.handler.repo.remove_repo_BANG_(repo);
});})(attrs61942,local_QMARK_,map__61943,map__61943__$1,repo,id,url,s__61936__$2,temp__5720__auto__,repos,repos__$1))
,'className':"text-gray-400 ml-4 font-medium text-sm"},["Unlink"])]:[daiquiri.interpreter.interpret(attrs61942),daiquiri.core.create_element("a",{'title':"No worries, unlink this graph will clear its cache only, it does not remove your files on the disk.",'onClick':((function (attrs61942,local_QMARK_,map__61943,map__61943__$1,repo,id,url,s__61936__$2,temp__5720__auto__,repos,repos__$1){
return (function (){
return frontend.handler.repo.remove_repo_BANG_(repo);
});})(attrs61942,local_QMARK_,map__61943,map__61943__$1,repo,id,url,s__61936__$2,temp__5720__auto__,repos,repos__$1))
...
})(),frontend$components$repo$iter__61935(cljs.core.rest(s__61936__$2)));
}
} else {
return null;
}
...
var repo_links = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__61952){
var map__61953 = p__61952;
var map__61953__$1 = cljs.core.__destructure_map(map__61953);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61953__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var render_content = (function (p__61981){
var map__61982 = p__61981;
var map__61982__$1 = cljs.core.__destructure_map(map__61982);
var toggle_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61982__$1,new cljs.core.Keyword(null,"toggle-fn","toggle-fn",-1172657425));
...
var links_header = (function (){var G__61984 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"modal-class","modal-class",226435127),frontend.util.hiccup__GT_class("origin-top-right.absolute.left-0.mt-2.rounded-md.shadow-lg")], null);
if((cljs.core.count(repos__$1) > (1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61984,new cljs.core.Keyword(null,"links-header","links-header",-1729119536),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.font-medium.text-sm.opacity-60.px-4.pt-2","div.font-medium.text-sm.opacity-60.px-4.pt-2",917690640),"Switch to:"], null));
} else {
return G__61984;
}
})();
