...
goog.scope(function(){
  logseq.graph_parser.utf8.goog$module$goog$object = goog.module.get('goog.object');
});
...
logseq.graph_parser.utf8.length = (function logseq$graph_parser$utf8$length(arr){
return logseq.graph_parser.utf8.goog$module$goog$object.get(arr,"length");
});
