...
return daiquiri.core.create_element("div",{'id':"main-container",'className':"cp__sidebar-main-layout flex-1 flex"},[daiquiri.core.create_element("div",{'id':"app-container"},[daiquiri.core.create_element("div",{'id':"left-container"},[daiquiri.core.create_element("div",{'id':"main-container",'className':"cp__sidebar-main-layout flex-1 flex"},[daiquiri.core.create_element("div",{'id':"main-content-container",'className':"scrollbar-spacing w-full flex justify-center"},[daiquiri.core.create_element("div",{'className':"cp__sidebar-main-content"},[daiquiri.core.create_element("div",{'className':"ls-center"},[(function (){var attrs52783 = frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("bug",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),frontend.ui.icon_size], null)], null));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs52783))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["icon-box","p-1","rounded","mb-3"], null)], null),attrs52783], 0))):{'className':"icon-box p-1 rounded mb-3"}),((cljs.core.map_QMARK_(attrs52783))?null:[daiquiri.interpreter.interpret(attrs52783)]));
})(),daiquiri.core.create_element("div",{'className':"text-xl font-bold"},["Sorry. Something went wrong!"]),daiquiri.core.create_element("div",{'className':"mt-2 mb-2"},["Logseq is having a problem. To try to get it back to a\n         working state, please try the following safe steps in order:"]),daiquiri.core.create_element("div",null,[daiquiri.core.create_element("div",{'className':"flex flex-row justify-between align-items mb-2 items-center py-4"},[daiquiri.core.create_element("div",{'className':"flex flex-col items-start"},[daiquiri.core.create_element("div",{'className':"text-2xs font-bold uppercase toned-down"},["STEP 1"]),daiquiri.core.create_element("div",null,[daiquiri.core.create_element("span",{'className':"highlighted font-bold"},["Rebuild"]),daiquiri.core.create_element("span",{'className':"toned-down"},[" search index"])])]),(function (){var attrs52795 = frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic("Try",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"small?","small?",95242445),true,new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return frontend.handler.search.rebuild_indices_BANG_.cljs$core$IFn$_invoke$arity$1(true);
})], 0));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs52795))?daiquiri.interpreter.element_attributes(attrs52795):null),((cljs.core.map_QMARK_(attrs52795))?null:[daiquiri.interpreter.interpret(attrs52795)]));
})()]),daiquiri.core.create_element("div",{'className':"flex flex-row justify-between align-items mb-2 items-center separator-top py-4"},[daiquiri.core.create_element("div",{'className':"flex flex-col items-start"},[daiquiri.core.create_element("div",{'className':"text-2xs font-bold uppercase toned-down"},["STEP 2"]),daiquiri.core.create_element("div",null,[daiquiri.core.create_element("span",{'className':"highlighted font-bold"},["Relaunch"]),daiquiri.core.create_element("span",{'className':"toned-down"},[" the app"])]),daiquiri.core.create_element("div",{'className':"text-xs toned-down"},["Quit the app and then reopen it."])]),(function (){var attrs52798 = frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("command",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"rounded-md p-1 mr-2 bg-quaternary"], null));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs52798))?daiquiri.interpreter.element_attributes(attrs52798):null),((cljs.core.map_QMARK_(attrs52798))?[daiquiri.interpreter.interpret(frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("letter-q",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"rounded-md p-1 bg-quaternary"], null)))]:[daiquiri.interpreter.interpret(attrs52798),daiquiri.interpreter.interpret(frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("letter-q",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"rounded-md p-1 bg-quaternary"], null)))]));
})()]),daiquiri.core.create_element("div",{'className':"flex flex-row justify-between align-items mb-4 items-center separator-top py-4"},[daiquiri.core.create_element("div",{'className':"flex flex-col items-start"},[daiquiri.core.create_element("div",{'className':"text-2xs font-bold uppercase toned-down"},["STEP 3"]),daiquiri.core.create_element("div",null,[daiquiri.core.create_element("span",{'className':"highlighted font-bold"},["Clear"]),daiquiri.core.create_element("span",{'className':"toned-down"},[" local storage"])]),daiquiri.core.create_element("div",{'className':"text-xs toned-down"},["This does delete minor preferences like dark/light theme preference."])]),(function (){var attrs52802 = frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic("Try",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"small?","small?",95242445),true,new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
localStorage.clear();
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs52802))?daiquiri.interpreter.element_attributes(attrs52802):null),((cljs.core.map_QMARK_(attrs52802))?null:[daiquiri.interpreter.interpret(attrs52802)]));
