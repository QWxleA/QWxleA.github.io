...
var G__51886 = config;
var G__51887 = block__$1;
var G__51888 = (level + (1));
return (frontend.extensions.slide.block_container.cljs$core$IFn$_invoke$arity$3 ? frontend.extensions.slide.block_container.cljs$core$IFn$_invoke$arity$3(G__51886,G__51887,G__51888) : frontend.extensions.slide.block_container.call(null,G__51886,G__51887,G__51888));
}),children):null);
...
var attrs51889 = dom_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs51889))?daiquiri.interpreter.element_attributes(attrs51889):null),((cljs.core.map_QMARK_(attrs51889))?[(function (){var attrs51890 = block_el;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs51890))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative"], null)], null),attrs51890], 0))):{'className':"relative"}),((cljs.core.map_QMARK_(attrs51890))?[((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]:[daiquiri.interpreter.interpret(attrs51890),((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]));
})(),daiquiri.interpreter.interpret(children__$1)]:[daiquiri.interpreter.interpret(attrs51889),(function (){var attrs51896 = block_el;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs51896))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative"], null)], null),attrs51896], 0))):{'className':"relative"}),((cljs.core.map_QMARK_(attrs51896))?[((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]:[daiquiri.interpreter.interpret(attrs51896),((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]));
})(),daiquiri.interpreter.interpret(children__$1)]));
} else {
var attrs51901 = dom_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs51901))?daiquiri.interpreter.element_attributes(attrs51901):null),((cljs.core.map_QMARK_(attrs51901))?[daiquiri.interpreter.interpret(block_el)]:[daiquiri.interpreter.interpret(attrs51901),daiquiri.interpreter.interpret(block_el)]));
}
...
var page = (function (){var G__51903 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__51903) : frontend.db.entity.call(null,G__51903));
})();
var journal_QMARK_ = new cljs.core.Keyword(null,"journal?","journal?",-897756522).cljs$core$IFn$_invoke$arity$1(page);
var repo = frontend.state.get_current_repo();
var blocks = frontend.modules.outliner.tree.blocks__GT_vec_tree.cljs$core$IFn$_invoke$arity$2((function (){var G__51904 = repo;
var G__51905 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$2(G__51904,G__51905) : frontend.db.get_paginated_blocks.call(null,G__51904,G__51905));
})(),page_name);
