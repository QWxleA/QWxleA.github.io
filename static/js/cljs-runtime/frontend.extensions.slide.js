...
var G__61646 = config;
var G__61647 = block__$1;
var G__61648 = (level + (1));
return (frontend.extensions.slide.block_container.cljs$core$IFn$_invoke$arity$3 ? frontend.extensions.slide.block_container.cljs$core$IFn$_invoke$arity$3(G__61646,G__61647,G__61648) : frontend.extensions.slide.block_container.call(null,G__61646,G__61647,G__61648));
}),children):null);
...
var attrs61649 = dom_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs61649))?daiquiri.interpreter.element_attributes(attrs61649):null),((cljs.core.map_QMARK_(attrs61649))?[(function (){var attrs61650 = block_el;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs61650))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative"], null)], null),attrs61650], 0))):{'className':"relative"}),((cljs.core.map_QMARK_(attrs61650))?[((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]:[daiquiri.interpreter.interpret(attrs61650),((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]));
})(),daiquiri.interpreter.interpret(children__$1)]:[daiquiri.interpreter.interpret(attrs61649),(function (){var attrs61655 = block_el;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs61655))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative"], null)], null),attrs61655], 0))):{'className':"relative"}),((cljs.core.map_QMARK_(attrs61655))?[((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]:[daiquiri.interpreter.interpret(attrs61655),((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]));
})(),daiquiri.interpreter.interpret(children__$1)]));
} else {
var attrs61660 = dom_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs61660))?daiquiri.interpreter.element_attributes(attrs61660):null),((cljs.core.map_QMARK_(attrs61660))?[daiquiri.interpreter.interpret(block_el)]:[daiquiri.interpreter.interpret(attrs61660),daiquiri.interpreter.interpret(block_el)]));
}
...
var page = (function (){var G__61662 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__61662) : frontend.db.entity.call(null,G__61662));
})();
var journal_QMARK_ = new cljs.core.Keyword(null,"journal?","journal?",-897756522).cljs$core$IFn$_invoke$arity$1(page);
var repo = frontend.state.get_current_repo();
var blocks = frontend.modules.outliner.tree.blocks__GT_vec_tree.cljs$core$IFn$_invoke$arity$2((function (){var G__61663 = repo;
var G__61664 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$2(G__61663,G__61664) : frontend.db.get_paginated_blocks.call(null,G__61663,G__61664));
})(),page_name);
