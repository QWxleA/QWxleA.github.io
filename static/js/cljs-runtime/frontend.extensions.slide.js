...
var G__61316 = config;
var G__61317 = block__$1;
var G__61318 = (level + (1));
return (frontend.extensions.slide.block_container.cljs$core$IFn$_invoke$arity$3 ? frontend.extensions.slide.block_container.cljs$core$IFn$_invoke$arity$3(G__61316,G__61317,G__61318) : frontend.extensions.slide.block_container.call(null,G__61316,G__61317,G__61318));
}),children):null);
...
var attrs61323 = dom_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs61323))?daiquiri.interpreter.element_attributes(attrs61323):null),((cljs.core.map_QMARK_(attrs61323))?[(function (){var attrs61324 = block_el;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs61324))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative"], null)], null),attrs61324], 0))):{'className':"relative"}),((cljs.core.map_QMARK_(attrs61324))?[((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]:[daiquiri.interpreter.interpret(attrs61324),((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]));
})(),daiquiri.interpreter.interpret(children__$1)]:[daiquiri.interpreter.interpret(attrs61323),(function (){var attrs61332 = block_el;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs61332))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative"], null)], null),attrs61332], 0))):{'className':"relative"}),((cljs.core.map_QMARK_(attrs61332))?[((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]:[daiquiri.interpreter.interpret(attrs61332),((deep_level_QMARK_)?daiquiri.core.create_element("span",{'className':"opacity-30 text-xl"},["Hidden children"]):null)]));
})(),daiquiri.interpreter.interpret(children__$1)]));
} else {
var attrs61340 = dom_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs61340))?daiquiri.interpreter.element_attributes(attrs61340):null),((cljs.core.map_QMARK_(attrs61340))?[daiquiri.interpreter.interpret(block_el)]:[daiquiri.interpreter.interpret(attrs61340),daiquiri.interpreter.interpret(block_el)]));
}
...
var page = (function (){var G__61342 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__61342) : frontend.db.entity.call(null,G__61342));
})();
var journal_QMARK_ = new cljs.core.Keyword(null,"journal?","journal?",-897756522).cljs$core$IFn$_invoke$arity$1(page);
var repo = frontend.state.get_current_repo();
var blocks = frontend.modules.outliner.tree.blocks__GT_vec_tree.cljs$core$IFn$_invoke$arity$2((function (){var G__61343 = repo;
var G__61344 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$2(G__61343,G__61344) : frontend.db.get_paginated_blocks.call(null,G__61343,G__61344));
})(),page_name);
