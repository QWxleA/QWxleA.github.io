...
var hickory$core$HiccupRepresentable$as_hiccup$dyn_104193 = (function (this$){
...
return hickory$core$HiccupRepresentable$as_hiccup$dyn_104193(this$);
}
});
...
var hickory$core$HickoryRepresentable$as_hickory$dyn_104194 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return hickory$core$HickoryRepresentable$as_hickory$dyn_104194(this$);
}
});
...
var pred__104153 = cljs.core._EQ_;
var expr__104154 = (this$["nodeType"]);
if(cljs.core.truth_((pred__104153.cljs$core$IFn$_invoke$arity$2 ? pred__104153.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__104154) : pred__104153.call(null,hickory.core.Attribute,expr__104154)))){
...
if(cljs.core.truth_((pred__104153.cljs$core$IFn$_invoke$arity$2 ? pred__104153.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__104154) : pred__104153.call(null,hickory.core.Comment,expr__104154)))){
return ["<!--",cljs.core.str.cljs$core$IFn$_invoke$arity$1((this$["data"])),"-->"].join('');
} else {
if(cljs.core.truth_((pred__104153.cljs$core$IFn$_invoke$arity$2 ? pred__104153.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__104154) : pred__104153.call(null,hickory.core.Document,expr__104154)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,hickory.core.as_seq((this$["childNodes"])));
} else {
if(cljs.core.truth_((pred__104153.cljs$core$IFn$_invoke$arity$2 ? pred__104153.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__104154) : pred__104153.call(null,hickory.core.DocumentType,expr__104154)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__104153.cljs$core$IFn$_invoke$arity$2 ? pred__104153.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__104154) : pred__104153.call(null,hickory.core.Element,expr__104154)))){
...
if(cljs.core.truth_((pred__104153.cljs$core$IFn$_invoke$arity$2 ? pred__104153.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__104154) : pred__104153.call(null,hickory.core.Text,expr__104154)))){
return hickory.utils.html_escape(goog.dom.getRawTextContent(this$));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__104154)].join('')));
}
}
}
}
...
var pred__104164 = cljs.core._EQ_;
var expr__104165 = (this$["nodeType"]);
if(cljs.core.truth_((pred__104164.cljs$core$IFn$_invoke$arity$2 ? pred__104164.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__104165) : pred__104164.call(null,hickory.core.Attribute,expr__104165)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__104164.cljs$core$IFn$_invoke$arity$2 ? pred__104164.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__104165) : pred__104164.call(null,hickory.core.Comment,expr__104165)))){
...
if(cljs.core.truth_((pred__104164.cljs$core$IFn$_invoke$arity$2 ? pred__104164.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__104165) : pred__104164.call(null,hickory.core.Document,expr__104165)))){
...
if(cljs.core.truth_((pred__104164.cljs$core$IFn$_invoke$arity$2 ? pred__104164.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__104165) : pred__104164.call(null,hickory.core.DocumentType,expr__104165)))){
...
if(cljs.core.truth_((pred__104164.cljs$core$IFn$_invoke$arity$2 ? pred__104164.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__104165) : pred__104164.call(null,hickory.core.Element,expr__104165)))){
...
if(cljs.core.truth_((pred__104164.cljs$core$IFn$_invoke$arity$2 ? pred__104164.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__104165) : pred__104164.call(null,hickory.core.Text,expr__104165)))){
return goog.dom.getRawTextContent(this$);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__104165)].join('')));
}
}
}
}
...
var temp__5720__auto__ = cljs.core.second((function (){var or__4253__auto__ = cljs.core.re_find(/<!DOCTYPE ([^>]*)>/,s);
...
var temp__5720__auto___104195 = (doc["head"]["firstChild"]);
if(cljs.core.truth_(temp__5720__auto___104195)){
var title_el_104196 = temp__5720__auto___104195;
if(cljs.core.empty_QMARK_((title_el_104196["text"]))){
hickory.core.remove_el(title_el_104196);
} else {
}
} else {
}
