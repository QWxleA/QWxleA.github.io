...
var c__27595__auto___49294 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__27596__auto__ = (function (){var switch__27572__auto__ = (function (state_49279){
var state_val_49280 = (state_49279[(1)]);
if((state_val_49280 === (1))){
var inst_49274 = frontend.extensions.video.youtube.load_youtube_api();
var state_49279__$1 = state_49279;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_49279__$1,(2),inst_49274);
} else {
if((state_val_49280 === (2))){
var inst_49276 = (state_49279[(2)]);
var inst_49277 = frontend.extensions.video.youtube.register_player(state);
var state_49279__$1 = (function (){var statearr_49281 = state_49279;
(statearr_49281[(7)] = inst_49276);
...
var statearr_49282 = [null,null,null,null,null,null,null,null];
(statearr_49282[(0)] = frontend$extensions$video$youtube$state_machine__27573__auto__);

(statearr_49282[(1)] = (1));

return statearr_49282;
});
var frontend$extensions$video$youtube$state_machine__27573__auto____1 = (function (state_49279){
while(true){
var ret_value__27574__auto__ = (function (){try{while(true){
var result__27575__auto__ = switch__27572__auto__(state_49279);
...
}catch (e49283){var ex__27576__auto__ = e49283;
var statearr_49284_49295 = state_49279;
(statearr_49284_49295[(2)] = ex__27576__auto__);


if(cljs.core.seq((state_49279[(4)]))){
var statearr_49285_49296 = state_49279;
(statearr_49285_49296[(1)] = cljs.core.first((state_49279[(4)])));
...
var G__49297 = state_49279;
state_49279 = G__49297;
continue;
} else {
...
frontend$extensions$video$youtube$state_machine__27573__auto__ = function(state_49279){
switch(arguments.length){
case 0:
return frontend$extensions$video$youtube$state_machine__27573__auto____0.call(this);
case 1:
return frontend$extensions$video$youtube$state_machine__27573__auto____1.call(this,state_49279);
}
...
var state__27597__auto__ = (function (){var statearr_49286 = f__27596__auto__();
(statearr_49286[(6)] = c__27595__auto___49294);
...
var temp__5720__auto__ = cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49287_SHARP_){
return frontend.extensions.video.youtube.dom_after_video_node_QMARK_(p1__49287_SHARP_,target);
...
var vec__49288 = cljs.core.re_matches(reg,timestamp__$1);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49288,(0),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49288,(1),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49288,(2),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49288,(3),null);
var vec__49291 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(frontend.util.safe_parse_int,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [hours,minutes,seconds], null));
var hours__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49291,(0),null);
var minutes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49291,(1),null);
var seconds__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49291,(2),null);
