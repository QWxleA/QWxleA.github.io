...
}catch (e63341){if((e63341 instanceof Error)){
var e = e63341;
...
var el_63370__$1 = el.querySelector(".draw-wrap");
while(true){
if((((el_63370__$1 == null)) || ((((void 0 === el_63370__$1)) || ((void 0 === el_63370__$1.classList)))))){
} else {
if(cljs.core.truth_(el_63370__$1.classList.contains("block-content"))){
var width_63371 = el_63370__$1.clientWidth;
cljs.core.reset_BANG_(new cljs.core.Keyword("frontend.extensions.excalidraw","draw-width","frontend.extensions.excalidraw/draw-width",-681100043).cljs$core$IFn$_invoke$arity$1(state),width_63371);
} else {
var G__63372 = el_63370__$1.parentNode;
el_63370__$1 = G__63372;
continue;
...
var map__63344 = option;
var map__63344__$1 = cljs.core.__destructure_map(map__63344);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63344__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63344__$1,new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638));
...
var temp__5720__auto__ = (function (){var G__63354 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_uuid], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__63354) : frontend.db.pull.call(null,G__63354));
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
return (frontend.extensions.excalidraw.excalidraw.cljs$core$IFn$_invoke$arity$1 ? frontend.extensions.excalidraw.excalidraw.cljs$core$IFn$_invoke$arity$1(G__63361) : frontend.extensions.excalidraw.excalidraw.call(null,G__63361));
})())])]);
} else {
return null;
}
...
var attrs63366 = frontend.ui.loading("Loading");
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs63366))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ls-center"], null)], null),attrs63366], 0))):{'className':"ls-center"}),((cljs.core.map_QMARK_(attrs63366))?null:[daiquiri.interpreter.interpret(attrs63366)]));
} else {
...
var vec__63367 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63367,(0),null);
