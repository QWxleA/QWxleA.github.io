...
}catch (e63700){if((e63700 instanceof Error)){
var e = e63700;
...
var el_63725__$1 = el.querySelector(".draw-wrap");
while(true){
if((((el_63725__$1 == null)) || ((((void 0 === el_63725__$1)) || ((void 0 === el_63725__$1.classList)))))){
} else {
if(cljs.core.truth_(el_63725__$1.classList.contains("block-content"))){
var width_63728 = el_63725__$1.clientWidth;
cljs.core.reset_BANG_(new cljs.core.Keyword("frontend.extensions.excalidraw","draw-width","frontend.extensions.excalidraw/draw-width",-681100043).cljs$core$IFn$_invoke$arity$1(state),width_63728);
} else {
var G__63729 = el_63725__$1.parentNode;
el_63725__$1 = G__63729;
continue;
...
var map__63701 = option;
var map__63701__$1 = cljs.core.__destructure_map(map__63701);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63701__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63701__$1,new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638));
...
var temp__5720__auto__ = (function (){var G__63702 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_uuid], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__63702) : frontend.db.pull.call(null,G__63702));
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
}),'style':{'width':cljs.core.deref(_STAR_draw_width),'height':(cljs.core.truth_(wide_mode_QMARK_)?(650):(500))},'className':"draw-wrap"},[daiquiri.interpreter.interpret((function (){var G__63704 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (elements,app_state){
...
return (frontend.extensions.excalidraw.excalidraw.cljs$core$IFn$_invoke$arity$1 ? frontend.extensions.excalidraw.excalidraw.cljs$core$IFn$_invoke$arity$1(G__63704) : frontend.extensions.excalidraw.excalidraw.call(null,G__63704));
})())])]);
} else {
return null;
}
...
var attrs63711 = frontend.ui.loading("Loading");
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs63711))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ls-center"], null)], null),attrs63711], 0))):{'className':"ls-center"}),((cljs.core.map_QMARK_(attrs63711))?null:[daiquiri.interpreter.interpret(attrs63711)]));
} else {
...
var vec__63716 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63716,(0),null);
