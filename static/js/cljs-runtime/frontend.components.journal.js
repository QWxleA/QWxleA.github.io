...
return daiquiri.interpreter.interpret((function (){var temp__5720__auto__ = (function (){var G__61821 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(page) : frontend.util.page_name_sanity_lc.call(null,page))], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__61821) : frontend.db.pull.call(null,G__61821));
})();
...
frontend.components.journal.journal_cp = rum.core.lazy_build(rum.core.build_defc,(function (p__61825){
var vec__61826 = p__61825;
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61826,(0),null);
var format = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61826,(1),null);
...
var page_entity = (function (){var G__61829 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(title) : frontend.util.page_name_sanity_lc.call(null,title))], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__61829) : frontend.db.pull.call(null,G__61829));
})();
...
var attrs61824 = (function (){var G__61830 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(data_page_tags)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61830,new cljs.core.Keyword(null,"data-page-tags","data-page-tags",347588105),data_page_tags);
} else {
return G__61830;
}
})();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs61824))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex-1","journal","page"], null)], null),attrs61824], 0))):{'className':"flex-1 journal page"}),((cljs.core.map_QMARK_(attrs61824))?[frontend.ui.foldable(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.initial-color.title.journal-title","a.initial-color.title.journal-title",1631221905),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),page], null)),new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),(function (e){
...
var temp__5720__auto___61921 = page_entity;
if(cljs.core.truth_(temp__5720__auto___61921)){
var page_61922__$1 = temp__5720__auto___61921;
frontend.state.sidebar_add_block_BANG_(frontend.state.get_current_repo(),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page_61922__$1),new cljs.core.Keyword(null,"page","page",849072397));
} else {
}
...
}),null,cljs.core.PersistentArrayMap.EMPTY)),cljs.core.PersistentArrayMap.EMPTY),frontend.components.page.today_queries(repo,today_QMARK_,false),rum.core.with_key(frontend.components.reference.references(title),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(title),"-refs"].join(''))]:[daiquiri.interpreter.interpret(attrs61824),frontend.ui.foldable(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.initial-color.title.journal-title","a.initial-color.title.journal-title",1631221905),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),page], null)),new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),(function (e){
if(frontend.util.right_click_QMARK_(e)){
return frontend.state.set_state_BANG_(new cljs.core.Keyword("page-title","context","page-title/context",1788836745),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"page","page",849072397),page], null));
} else {
return null;
...
if(cljs.core.truth_(frontend.components.journal.goog$module$goog$object.get(e,"shiftKey"))){
var temp__5720__auto___61923 = page_entity;
if(cljs.core.truth_(temp__5720__auto___61923)){
var page_61924__$1 = temp__5720__auto___61923;
frontend.state.sidebar_add_block_BANG_(frontend.state.get_current_repo(),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page_61924__$1),new cljs.core.Keyword(null,"page","page",849072397));
} else {
}
...
return daiquiri.core.create_element("div",{'id':"journals"},[frontend.ui.infinite_list("main-content-container",(function (){var iter__5520__auto__ = (function frontend$components$journal$iter__61873(s__61874){
return (new cljs.core.LazySeq(null,(function (){
var s__61874__$1 = s__61874;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__61874__$1);
if(temp__5720__auto__){
var s__61874__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61874__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__61874__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__61876 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__61875 = (0);
while(true){
if((i__61875 < size__5519__auto__)){
var map__61883 = cljs.core._nth(c__5518__auto__,i__61875);
var map__61883__$1 = cljs.core.__destructure_map(map__61883);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61883__$1,new cljs.core.Keyword("block","name","block/name",1619760316));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61883__$1,new cljs.core.Keyword("block","format","block/format",-1212045901));
cljs.core.chunk_append(b__61876,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.journal-item.content","div.journal-item.content",1590520916),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null),frontend.components.journal.journal_cp(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [name,format], null))], null));

var G__61934 = (i__61875 + (1));
i__61875 = G__61934;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61876),frontend$components$journal$iter__61873(cljs.core.chunk_rest(s__61874__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61876),null);
}
} else {
var map__61892 = cljs.core.first(s__61874__$2);
var map__61892__$1 = cljs.core.__destructure_map(map__61892);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61892__$1,new cljs.core.Keyword("block","name","block/name",1619760316));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61892__$1,new cljs.core.Keyword("block","format","block/format",-1212045901));
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.journal-item.content","div.journal-item.content",1590520916),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null),frontend.components.journal.journal_cp(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [name,format], null))], null),frontend$components$journal$iter__61873(cljs.core.rest(s__61874__$2)));
}
} else {
return null;
}
...
var latest_journals = (function (){var G__61895 = frontend.state.get_current_repo();
var G__61896 = journals_length;
return (frontend.db.get_latest_journals.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_latest_journals.cljs$core$IFn$_invoke$arity$2(G__61895,G__61896) : frontend.db.get_latest_journals.call(null,G__61895,G__61896));
})();
