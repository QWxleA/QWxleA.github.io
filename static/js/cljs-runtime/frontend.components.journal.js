...
return daiquiri.interpreter.interpret((function (){var temp__5720__auto__ = (function (){var G__47891 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(page) : frontend.util.page_name_sanity_lc.call(null,page))], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__47891) : frontend.db.pull.call(null,G__47891));
})();
...
frontend.components.journal.journal_cp = rum.core.lazy_build(rum.core.build_defc,(function (p__47895){
var vec__47896 = p__47895;
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47896,(0),null);
var format = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47896,(1),null);
...
var page_entity = (function (){var G__47899 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(title) : frontend.util.page_name_sanity_lc.call(null,title))], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__47899) : frontend.db.pull.call(null,G__47899));
})();
...
var temp__5720__auto___47963 = page_entity;
if(cljs.core.truth_(temp__5720__auto___47963)){
var page_47964__$1 = temp__5720__auto___47963;
frontend.state.sidebar_add_block_BANG_(frontend.state.get_current_repo(),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page_47964__$1),new cljs.core.Keyword(null,"page","page",849072397));
} else {
}
...
}),null,cljs.core.PersistentArrayMap.EMPTY)),cljs.core.PersistentArrayMap.EMPTY),frontend.components.page.today_queries(repo,today_QMARK_,false),rum.core.with_key(frontend.components.reference.references(title),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(title),"-refs"].join(''))]:[daiquiri.interpreter.interpret(attrs47894),frontend.ui.foldable(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.initial-color.title.journal-title","a.initial-color.title.journal-title",1631221905),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),page], null)),new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),(function (e){
if(frontend.util.right_click_QMARK_(e)){
return frontend.state.set_state_BANG_(new cljs.core.Keyword("page-title","context","page-title/context",1788836745),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"page","page",849072397),page], null));
} else {
return null;
...
if(cljs.core.truth_(frontend.components.journal.goog$module$goog$object.get(e,"shiftKey"))){
var temp__5720__auto___47965 = page_entity;
if(cljs.core.truth_(temp__5720__auto___47965)){
var page_47966__$1 = temp__5720__auto___47965;
frontend.state.sidebar_add_block_BANG_(frontend.state.get_current_repo(),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page_47966__$1),new cljs.core.Keyword(null,"page","page",849072397));
} else {
}
...
return daiquiri.core.create_element("div",{'id':"journals"},[frontend.ui.infinite_list("main-content-container",(function (){var iter__5520__auto__ = (function frontend$components$journal$iter__47947(s__47948){
return (new cljs.core.LazySeq(null,(function (){
var s__47948__$1 = s__47948;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__47948__$1);
if(temp__5720__auto__){
var s__47948__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47948__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__47948__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__47950 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__47949 = (0);
while(true){
if((i__47949 < size__5519__auto__)){
var map__47951 = cljs.core._nth(c__5518__auto__,i__47949);
var map__47951__$1 = cljs.core.__destructure_map(map__47951);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47951__$1,new cljs.core.Keyword("block","name","block/name",1619760316));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47951__$1,new cljs.core.Keyword("block","format","block/format",-1212045901));
cljs.core.chunk_append(b__47950,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.journal-item.content","div.journal-item.content",1590520916),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null),frontend.components.journal.journal_cp(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [name,format], null))], null));

var G__47967 = (i__47949 + (1));
i__47949 = G__47967;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47950),frontend$components$journal$iter__47947(cljs.core.chunk_rest(s__47948__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47950),null);
}
} else {
var map__47953 = cljs.core.first(s__47948__$2);
var map__47953__$1 = cljs.core.__destructure_map(map__47953);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47953__$1,new cljs.core.Keyword("block","name","block/name",1619760316));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47953__$1,new cljs.core.Keyword("block","format","block/format",-1212045901));
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.journal-item.content","div.journal-item.content",1590520916),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null),frontend.components.journal.journal_cp(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [name,format], null))], null),frontend$components$journal$iter__47947(cljs.core.rest(s__47948__$2)));
}
} else {
return null;
}
...
var latest_journals = (function (){var G__47959 = frontend.state.get_current_repo();
var G__47960 = journals_length;
return (frontend.db.get_latest_journals.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_latest_journals.cljs$core$IFn$_invoke$arity$2(G__47959,G__47960) : frontend.db.get_latest_journals.call(null,G__47959,G__47960));
})();
