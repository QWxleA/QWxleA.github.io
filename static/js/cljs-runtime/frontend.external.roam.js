...
return clojure.string.replace(text,frontend.external.roam.uid_pattern,(function (p__61547){
...
return clojure.string.replace(text,frontend.external.roam.macro_pattern,(function (p__61551){
var vec__61552 = p__61551;
var original = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61552,(0),null);
var text__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61552,(1),null);
var vec__61555 = logseq.graph_parser.util.split_first(":",text__$1);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61555,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61555,(1),null);
...
var seq__61558 = cljs.core.seq(uids);
var chunk__61559 = null;
var count__61560 = (0);
var i__61561 = (0);
while(true){
if((i__61561 < count__61560)){
var uid = chunk__61559.cljs$core$IIndexed$_nth$arity$2(null,i__61561);
...
var G__61590 = seq__61558;
var G__61591 = chunk__61559;
var G__61592 = count__61560;
var G__61593 = (i__61561 + (1));
seq__61558 = G__61590;
chunk__61559 = G__61591;
count__61560 = G__61592;
i__61561 = G__61593;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__61558);
if(temp__5720__auto__){
var seq__61558__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__61558__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__61558__$1);
var G__61594 = cljs.core.chunk_rest(seq__61558__$1);
var G__61595 = c__5565__auto__;
var G__61596 = cljs.core.count(c__5565__auto__);
var G__61597 = (0);
seq__61558 = G__61594;
chunk__61559 = G__61595;
count__61560 = G__61596;
i__61561 = G__61597;
continue;
} else {
var uid = cljs.core.first(seq__61558__$1);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(frontend.external.roam.uid__GT_uuid,cljs.core.assoc,uid,cljs.core.random_uuid());


var G__61598 = cljs.core.next(seq__61558__$1);
var G__61599 = null;
var G__61600 = (0);
var G__61601 = (0);
seq__61558 = G__61598;
chunk__61559 = G__61599;
count__61560 = G__61600;
i__61561 = G__61601;
continue;
}
} else {
...
frontend.external.roam.child__GT_text = (function frontend$external$roam$child__GT_text(p__61562,level){
var map__61563 = p__61562;
var map__61563__$1 = cljs.core.__destructure_map(map__61563);
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61563__$1,new cljs.core.Keyword(null,"uid","uid",-1447769400));
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61563__$1,new cljs.core.Keyword(null,"string","string",-1989541586));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61563__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var children_text = (function (){var G__61564 = children;
var G__61565 = (level + (1));
return (frontend.external.roam.children__GT_text.cljs$core$IFn$_invoke$arity$2 ? frontend.external.roam.children__GT_text.cljs$core$IFn$_invoke$arity$2(G__61564,G__61565) : frontend.external.roam.children__GT_text.call(null,G__61564,G__61565));
})();
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.interpose.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61566_SHARP_){
return frontend.external.roam.child__GT_text(p1__61566_SHARP_,level);
}),children)));
});
...
var map__61567 = page_data;
var map__61567__$1 = cljs.core.__destructure_map(map__61567);
var create_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61567__$1,new cljs.core.Keyword(null,"create-time","create-time",875410581));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61567__$1,new cljs.core.Keyword(null,"title","title",636505583));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61567__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61567__$1,new cljs.core.Keyword(null,"edit-time","edit-time",-1528280702));
var initial_level = (1);
...
var files__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__61568_SHARP_){
return (new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(p1__61568_SHARP_) == null);
}),files);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__61569){
var vec__61570 = p__61569;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61570,(0),null);
var vec__61573 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61570,(1),null);
var seq__61574 = cljs.core.seq(vec__61573);
var first__61575 = cljs.core.first(seq__61574);
var seq__61574__$1 = cljs.core.next(seq__61574);
var fst = first__61575;
var others = seq__61574__$1;
...
(frontend.external.roam.Roam.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k61577,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__61581 = k61577;
switch (G__61581) {
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61577,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__61582){
var vec__61583 = p__61582;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61583,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61583,(1),null);
...
(frontend.external.roam.Roam.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61576){
var self__ = this;
var G__61576__$1 = this;
return (new cljs.core.RecordIter((0),G__61576__$1,0,cljs.core.PersistentVector.EMPTY,(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(frontend.external.roam.Roam.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61578,other61579){
var self__ = this;
var this61578__$1 = this;
return (((!((other61579 == null)))) && ((((this61578__$1.constructor === other61579.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61578__$1.__extmap,other61579.__extmap)))));
}));
...
(frontend.external.roam.Roam.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k61577){
var self__ = this;
var this__5347__auto____$1 = this;
return cljs.core.contains_QMARK_(self__.__extmap,k61577);
}));

(frontend.external.roam.Roam.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__61576){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__61586 = cljs.core.keyword_identical_QMARK_;
var expr__61587 = k__5349__auto__;
return (new frontend.external.roam.Roam(self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__61576),null));
}));
...
(frontend.external.roam.Roam.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__61576){
var self__ = this;
var this__5339__auto____$1 = this;
return (new frontend.external.roam.Roam(G__61576,self__.__extmap,self__.__hash));
}));
 ...
 */
frontend.external.roam.map__GT_Roam = (function frontend$external$roam$map__GT_Roam(G__61580){
var extmap__5382__auto__ = (function (){var G__61589 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$1(G__61580);
if(cljs.core.record_QMARK_(G__61580)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61589);
} else {
return G__61589;
}
})();
