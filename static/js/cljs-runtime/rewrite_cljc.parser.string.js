...
if((c === "\n")){
var G__92766 = escape_QMARK_;
var G__92767 = rewrite_cljc.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__92766;
lines = G__92767;
continue;
} else {
buf.append(c);

var G__92768 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__92769 = lines;
escape_QMARK_ = G__92768;
lines = G__92769;
continue;
