...
var page = (function (){var G__49955 = repo;
var G__49956 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name__$2], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$2 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$2(G__49955,G__49956) : frontend.db.entity.call(null,G__49955,G__49956));
})();
...
})], null)], null):null),(cljs.core.truth_(frontend.handler.plugin.lsp_enabled_QMARK_)?(function (){var iter__5520__auto__ = (function frontend$components$page_menu$page_menu_$_iter__49973(s__49974){
return (new cljs.core.LazySeq(null,(function (){
var s__49974__$1 = s__49974;
while(true){
var temp__5720__auto____$1 = cljs.core.seq(s__49974__$1);
if(temp__5720__auto____$1){
var s__49974__$2 = temp__5720__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49974__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__49974__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__49976 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__49975 = (0);
while(true){
if((i__49975 < size__5519__auto__)){
var vec__49980 = cljs.core._nth(c__5518__auto__,i__49975);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49980,(0),null);
var map__49983 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49980,(1),null);
var map__49983__$1 = cljs.core.__destructure_map(map__49983);
var cmd = map__49983__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49983__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49980,(2),null);
var pid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49980,(3),null);
cljs.core.chunk_append(b__49976,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),label,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__49975,vec__49980,___$1,map__49983,map__49983__$1,cmd,label,action,pid,c__5518__auto__,size__5519__auto__,b__49976,s__49974__$2,temp__5720__auto____$1,page_name__$2,repo,page,page_original_name,block_QMARK_,contents_QMARK_,properties,public_QMARK_,favorites,favorited_QMARK_,developer_mode_QMARK_,file_path,_,page_name__$1,temp__5720__auto__){
return (function (){
...
});})(i__49975,vec__49980,___$1,map__49983,map__49983__$1,cmd,label,action,pid,c__5518__auto__,size__5519__auto__,b__49976,s__49974__$2,temp__5720__auto____$1,page_name__$2,repo,page,page_original_name,block_QMARK_,contents_QMARK_,properties,public_QMARK_,favorites,favorited_QMARK_,developer_mode_QMARK_,file_path,_,page_name__$1,temp__5720__auto__))
], null)], null));

var G__50008 = (i__49975 + (1));
i__49975 = G__50008;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49976),frontend$components$page_menu$page_menu_$_iter__49973(cljs.core.chunk_rest(s__49974__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49976),null);
}
} else {
var vec__49985 = cljs.core.first(s__49974__$2);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(0),null);
var map__49988 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(1),null);
var map__49988__$1 = cljs.core.__destructure_map(map__49988);
var cmd = map__49988__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49988__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(2),null);
var pid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(3),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),label,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__49985,___$1,map__49988,map__49988__$1,cmd,label,action,pid,s__49974__$2,temp__5720__auto____$1,page_name__$2,repo,page,page_original_name,block_QMARK_,contents_QMARK_,properties,public_QMARK_,favorites,favorited_QMARK_,developer_mode_QMARK_,file_path,_,page_name__$1,temp__5720__auto__){
return (function (){
return frontend.commands.exec_plugin_simple_command_BANG_(pid,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cmd,new cljs.core.Keyword(null,"page","page",849072397),page_name__$2),action);
});})(vec__49985,___$1,map__49988,map__49988__$1,cmd,label,action,pid,s__49974__$2,temp__5720__auto____$1,page_name__$2,repo,page,page_original_name,block_QMARK_,contents_QMARK_,properties,public_QMARK_,favorites,favorited_QMARK_,developer_mode_QMARK_,file_path,_,page_name__$1,temp__5720__auto__))
], null)], null),frontend$components$page_menu$page_menu_$_iter__49973(cljs.core.rest(s__49974__$2)));
}
} else {
return null;
}
...
var _STAR_print_newline_STAR__orig_val__49990_50011 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__49991_50012 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__49992_50013 = true;
var _STAR_print_fn_STAR__temp_val__49993_50014 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__49992_50013);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__49993_50014);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1((function (){var G__49994 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__49994) : frontend.db.pull.call(null,G__49994));
})());
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__49991_50012);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__49990_50011);
}
