...
(frontend.handler.search.search.cljs$core$IFn$_invoke$arity$3 = (function (repo,q,p__44872){
var map__44873 = p__44872;
var map__44873__$1 = cljs.core.__destructure_map(map__44873);
var opts = map__44873__$1;
var page_db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44873__$1,new cljs.core.Keyword(null,"page-db-id","page-db-id",-761574235),null);
var limit = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44873__$1,new cljs.core.Keyword(null,"limit","limit",-1355822363),(20));
var more_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44873__$1,new cljs.core.Keyword(null,"more?","more?",519437444));
if(clojure.string.blank_QMARK_(q)){
return null;
} else {
var page_db_id__$1 = ((typeof page_db_id === 'string')?new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1((function (){var G__44876 = repo;
var G__44877 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(page_db_id) : frontend.util.page_name_sanity_lc.call(null,page_db_id))], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$2 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$2(G__44876,G__44877) : frontend.db.entity.call(null,G__44876,G__44877));
})()):page_db_id);
...
var m_44917 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("search","result","search/result",443756363),null,new cljs.core.Keyword("search","q","search/q",-553992135),""], null);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(frontend.state.state,cljs.core.merge,m_44917);
