...
var items = (function (){var or__4253__auto__ = (frontend.db.get_key_value.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_key_value.cljs$core$IFn$_invoke$arity$2(repo,new cljs.core.Keyword("recent","search","recent/search",360685449)) : frontend.db.get_key_value.call(null,repo,new cljs.core.Keyword("recent","search","recent/search",360685449)));
