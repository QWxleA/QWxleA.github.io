 ...
 */
frontend.handler.route.redirect_BANG_ = (function frontend$handler$route$redirect_BANG_(p__46883){
var map__46884 = p__46883;
var map__46884__$1 = cljs.core.__destructure_map(map__46884);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46884__$1,new cljs.core.Keyword(null,"to","to",192099007));
var path_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46884__$1,new cljs.core.Keyword(null,"path-params","path-params",-48130597));
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46884__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
var push = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46884__$1,new cljs.core.Keyword(null,"push","push",799791267),true);
...
var temp__5718__auto__ = (function (){var G__46890 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.uuid(name__$1)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__46890) : frontend.db.entity.call(null,G__46890));
})();
...
var page = (function (){var G__46891 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(name__$1) : frontend.util.page_name_sanity_lc.call(null,name__$1))], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__46891) : frontend.db.pull.call(null,G__46891));
})();
...
var map__46892 = route;
var map__46892__$1 = cljs.core.__destructure_map(map__46892);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46892__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var path_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46892__$1,new cljs.core.Keyword(null,"path-params","path-params",-48130597));
...
var map__46895 = route;
var map__46895__$1 = cljs.core.__destructure_map(map__46895);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46895__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var route_46921 = ((frontend.state.custom_home_page_QMARK_())?new cljs.core.Keyword(null,"all-journals","all-journals",-347015095):new cljs.core.Keyword(null,"home","home",-74557309));
frontend.handler.route.redirect_BANG_(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"to","to",192099007),route_46921], null));
...
var temp__5720__auto__ = new cljs.core.Keyword("file","path","file/path",-191335748).cljs$core$IFn$_invoke$arity$1((function (){var G__46909 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1((function (){var G__46910 = clojure.string.lower_case(page);
return (frontend.db.get_page_file.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page_file.cljs$core$IFn$_invoke$arity$1(G__46910) : frontend.db.get_page_file.call(null,G__46910));
})());
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__46909) : frontend.db.entity.call(null,G__46909));
})());
if(cljs.core.truth_(temp__5720__auto__)){
