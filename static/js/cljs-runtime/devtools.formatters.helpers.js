...
var G__41812 = devtools.prefs.pref(v);
v = G__41812;
continue;
} else {
return v;
...
}catch (e41777){var _e__40391__auto__ = e41777;
return false;
}})();
...
}catch (e41779){var _e__40391__auto__ = e41779;
return false;
}})();
...
}catch (e41781){var _e__40391__auto__ = e41781;
return false;
}}
}
});
...
var vec__41796 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41796,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41796,(1),null);
...
return cljs.core.some((function (p1__41800_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41800_SHARP_);
}),template);
});
