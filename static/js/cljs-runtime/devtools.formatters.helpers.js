...
var G__55988 = devtools.prefs.pref(v);
v = G__55988;
continue;
} else {
return v;
...
}catch (e55945){var _e__54664__auto__ = e55945;
return false;
}})();
...
}catch (e55947){var _e__54664__auto__ = e55947;
return false;
}})();
...
}catch (e55950){var _e__54664__auto__ = e55950;
return false;
}}
}
});
...
var vec__55963 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55963,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55963,(1),null);
...
return cljs.core.some((function (p1__55966_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__55966_SHARP_);
}),template);
});
