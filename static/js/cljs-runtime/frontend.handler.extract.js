goog.provide('frontend.handler.extract');
frontend.handler.extract.get_page_name = (function frontend$handler$extract$get_page_name(file,ast){
...
var first_block = cljs.core.last(cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(frontend.format.block.heading_block_QMARK_,ast__$1)));
...
var and__4251__auto__ = first_block;
if(cljs.core.truth_(and__4251__auto__)){
var and__4251__auto____$1 = typeof title === 'string';
...
if(frontend.config.mldoc_support_QMARK_(clojure.string.lower_case(frontend.util.get_file_ext(file)))){
return frontend.util.url_decode(clojure.string.replace(result,".","/"));
} else {
return result;
}
} else {
...
var or__4253__auto__ = property_name;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(frontend.state.page_name_order(),"heading")){
var or__4253__auto____$1 = first_block_name;
...
var or__4253__auto____$1 = file_name;
if(cljs.core.truth_(or__4253__auto____$1)){
return or__4253__auto____$1;
} else {
...
frontend.handler.extract.extract_pages_and_blocks = (function frontend$handler$extract$extract_pages_and_blocks(repo_url,format,ast,properties,file,content){
try{var page = frontend.handler.extract.get_page_name(file,ast);
var vec__94289 = frontend.format.block.convert_page_if_journal(page);
var _original_page_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94289,(0),null);
var page_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94289,(1),null);
var _journal_day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94289,(2),null);
var blocks = frontend.format.block.with_parent_and_left(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name], null),frontend.format.block.extract_blocks(ast,content,false,format));
...
var page_entity = (function (){var alias = new cljs.core.Keyword(null,"alias","alias",-2039751630).cljs$core$IFn$_invoke$arity$1(properties);
...
var aliases = (function (){var and__4251__auto__ = alias__$1;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.seq(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__94287_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page_name,frontend.util.page_name_sanity_lc(p1__94287_SHARP_))) || (clojure.string.blank_QMARK_(p1__94287_SHARP_)));
}),alias__$1));
} else {
return and__4251__auto__;
}
...
var page_name__$1 = frontend.util.page_name_sanity_lc(alias__$2);
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.page_name_sanity_lc(alias__$3)], null);
}),aliases__$1):null);
...
var G__94292 = logseq.graph_parser.util.remove_nils(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(frontend.format.block.page_name__GT_map.cljs$core$IFn$_invoke$arity$2(page,false),new cljs.core.Keyword("block","file","block/file",183171933),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("file","path","file/path",-191335748),logseq.graph_parser.util.path_normalize(file)], null)));
var G__94292__$1 = ((cljs.core.seq(properties))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__94292,new cljs.core.Keyword("block","properties","block/properties",708347145),properties):G__94292);
var G__94292__$2 = ((cljs.core.seq(aliases__$1))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__94292__$1,new cljs.core.Keyword("block","alias","block/alias",-2112644699),aliases__$1):G__94292__$1);
if(cljs.core.truth_(new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(properties))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__94292__$2,new cljs.core.Keyword("block","tags","block/tags",1814948340),(function (){var tags = new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(properties);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.page_name_sanity_lc(tag),new cljs.core.Keyword("block","original-name","block/original-name",-1620099234),tag], null);
}),tags__$2);
})());
} else {
return G__94292__$2;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(frontend.format.block.page_name__GT_map.cljs$core$IFn$_invoke$arity$2(page__$2,true),new cljs.core.Keyword("block","format","block/format",-1212045901),format);
}),frontend.util.split_namespace_pages(page__$1));
} else {
return null;
}
})();
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("block","original-name","block/original-name",-1620099234),page__$1,new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.page_name_sanity_lc(page__$1)], null);
}),cljs.core.deref(ref_tags)),namespace_pages], 0))));
var pages__$1 = frontend.util.distinct_by(new cljs.core.Keyword("block","name","block/name",1619760316),pages);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(page__$1,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),frontend.db.new_block_id());
}),pages__$2);
...
}catch (e94288){if((e94288 instanceof Error)){
var e = e94288;
return lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("frontend.handler.extract",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"exception","exception",-335277064),e,new cljs.core.Keyword(null,"line","line",212345235),138], null)),e);
} else {
throw e94288;

}
}});
frontend.handler.extract.extract_blocks_pages = (function frontend$handler$extract$extract_blocks_pages(repo_url,file,content){
if(clojure.string.blank_QMARK_(content)){
return cljs.core.PersistentVector.EMPTY;
} else {
var format = frontend.format.get_format(file);
var _ = cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Parsing start: ",file], 0));
...
var properties = (function (){var properties = (function (){var and__4251__auto__ = frontend.util.property.properties_ast_QMARK_(first_block);
if(and__4251__auto__){
return clojure.walk.keywordize_keys(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__94293){
var vec__94294 = p__94293;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94294,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94294,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,((typeof y === 'string')?logseq.graph_parser.text.parse_property.cljs$core$IFn$_invoke$arity$4(format,x,y,frontend.state.get_config.cljs$core$IFn$_invoke$arity$0()):y)], null);
}),cljs.core.last(first_block))));
} else {
return and__4251__auto__;
}
})();
if(cljs.core.truth_((function (){var and__4251__auto__ = properties;
if(cljs.core.truth_(and__4251__auto__)){
...
return clojure.string.replace((function (){var or__4253__auto__ = v;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return "";
...
return frontend.handler.extract.extract_pages_and_blocks(repo_url,format,ast,properties,file,content);
}
});
frontend.handler.extract.with_block_uuid = (function frontend$handler$extract$with_block_uuid(pages){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(page,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),frontend.db.new_block_id());
}
}),frontend.util.distinct_by(new cljs.core.Keyword("block","name","block/name",1619760316),pages));
});
frontend.handler.extract.with_ref_pages = (function frontend$handler$extract$with_ref_pages(pages,blocks){
...
//# sourceMappingURL=frontend.handler.extract.js.map
