...
frontend.db.conn.me_tx = (function frontend$db$conn$me_tx(_db,p__33277){
var map__33278 = p__33277;
var map__33278__$1 = cljs.core.__destructure_map(map__33278);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33278__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33278__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var avatar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33278__$1,new cljs.core.Keyword(null,"avatar","avatar",-1607499307));
...
(frontend.db.conn.start_BANG_.cljs$core$IFn$_invoke$arity$3 = (function (me__$1,repo,p__33283){
var map__33285 = p__33283;
var map__33285__$1 = cljs.core.__destructure_map(map__33285);
var db_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33285__$1,new cljs.core.Keyword(null,"db-type","db-type",404552925));
var listen_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33285__$1,new cljs.core.Keyword(null,"listen-handler","listen-handler",-1690024921));
...
datascript.core.transact_BANG_.cljs$core$IFn$_invoke$arity$2(db_conn,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__33287 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("schema","version","schema/version",1396190655),frontend.db_schema.version], null);
if(cljs.core.truth_(db_type)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33287,new cljs.core.Keyword("db","type","db/type",1174271242),db_type);
} else {
return G__33287;
}
