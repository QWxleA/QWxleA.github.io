...
var content = (function (){var G__55664 = type;
...
})),'className':"block my-2 text-lg rounded border"},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5520__auto__ = (function frontend$components$export$iter__55732(s__55733){
return (new cljs.core.LazySeq(null,(function (){
var s__55733__$1 = s__55733;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__55733__$1);
if(temp__5720__auto__){
var s__55733__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55733__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__55733__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__55735 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__55734 = (0);
while(true){
if((i__55734 < size__5519__auto__)){
var map__55736 = cljs.core._nth(c__5518__auto__,i__55734);
var map__55736__$1 = cljs.core.__destructure_map(map__55736);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55736__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55736__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55736__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
cljs.core.chunk_append(b__55735,(function (){var attrs55730 = (function (){var G__55739 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),label,new cljs.core.Keyword(null,"value","value",305978217),(function (){var or__5043__auto__ = value;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55739,new cljs.core.Keyword(null,"selected","selected",574897764),selected);
} else {
return G__55739;
}
})();
return daiquiri.core.create_element("option",((cljs.core.map_QMARK_(attrs55730))?daiquiri.interpreter.element_attributes(attrs55730):null),((cljs.core.map_QMARK_(attrs55730))?[daiquiri.interpreter.interpret(label)]:[daiquiri.interpreter.interpret(attrs55730),daiquiri.interpreter.interpret(label)]));
})());

var G__55747 = (i__55734 + (1));
i__55734 = G__55747;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55735),frontend$components$export$iter__55732(cljs.core.chunk_rest(s__55733__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55735),null);
}
} else {
var map__55740 = cljs.core.first(s__55733__$2);
var map__55740__$1 = cljs.core.__destructure_map(map__55740);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55740__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55740__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55740__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
return cljs.core.cons((function (){var attrs55730 = (function (){var G__55741 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),label,new cljs.core.Keyword(null,"value","value",305978217),(function (){var or__5043__auto__ = value;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return label;
...
if(cljs.core.truth_(selected)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55741,new cljs.core.Keyword(null,"selected","selected",574897764),selected);
} else {
return G__55741;
}
})();
return daiquiri.core.create_element("option",((cljs.core.map_QMARK_(attrs55730))?daiquiri.interpreter.element_attributes(attrs55730):null),((cljs.core.map_QMARK_(attrs55730))?[daiquiri.interpreter.interpret(label)]:[daiquiri.interpreter.interpret(attrs55730),daiquiri.interpreter.interpret(label)]));
})(),frontend$components$export$iter__55732(cljs.core.rest(s__55733__$2)));
}
} else {
return null;
}
...
})], null))),daiquiri.core.create_element("div",{'style':{'visibility':((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"text","text",-1790561697),type))?"visible":"hidden")}},["remove emphasis"])]:[daiquiri.interpreter.interpret(attrs55725),daiquiri.core.create_element("div",{'style':{'visibility':((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"text","text",-1790561697),type))?"visible":"hidden")}},["[[text]] -> text"]),daiquiri.interpreter.interpret(frontend.ui.checkbox(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"margin-right","margin-right",809689658),(6),new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1em",new cljs.core.Keyword(null,"visibility","visibility",1338380893),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"text","text",-1790561697),type))?"visible":"hidden")], null),new cljs.core.Keyword(null,"checked","checked",-50955819),cljs.core.contains_QMARK_(text_remove_options,new cljs.core.Keyword(null,"emphasis","emphasis",293543451)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (e){
return frontend.state.update_export_block_text_remove_options_BANG_(e,new cljs.core.Keyword(null,"emphasis","emphasis",293543451));
...
})(),(function (){var attrs55693 = frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic((cljs.core.truth_(cljs.core.deref(copied_QMARK_))?"Copied to clipboard!":"Copy to clipboard"),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs55693))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["mt-4"], null)], null),attrs55693], 0))):{'className':"mt-4"}),((cljs.core.map_QMARK_(attrs55693))?null:[daiquiri.interpreter.interpret(attrs55693)]));
})()]);
