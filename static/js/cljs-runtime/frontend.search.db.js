 ...
 */
frontend.search.db.block__GT_index = (function frontend$search$db$block__GT_index(p__43661){
var map__43662 = p__43661;
var map__43662__$1 = cljs.core.__destructure_map(map__43662);
var block = map__43662__$1;
var uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43662__$1,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43662__$1,new cljs.core.Keyword("block","page","block/page",822314108));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43662__$1,new cljs.core.Keyword("block","content","block/content",-161885195));
...
var pages = cljs_bean.core.__GT_js(cljs.core.map.cljs$core$IFn$_invoke$arity$2(frontend.search.db.original_page_name__GT_index,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,(function (){var G__43672 = frontend.state.get_current_repo();
return (frontend.db.get_pages.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_pages.cljs$core$IFn$_invoke$arity$1(G__43672) : frontend.db.get_pages.call(null,G__43672));
})())));
