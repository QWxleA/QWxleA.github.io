...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54354){
var vec__54355 = p__54354;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54355,(0),null);
var map__54358 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54355,(1),null);
var map__54358__$1 = cljs.core.__destructure_map(map__54358);
var binding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54358__$1,new cljs.core.Keyword(null,"binding","binding",539932593));
...
var G__54363 = k;
var G__54363__$1 = (((G__54363 == null))?null:frontend.util.safe_lower_case(G__54363));
var G__54363__$2 = (((G__54363__$1 == null))?null:clojure.string.replace(G__54363__$1,/;+/,"semicolon"));
var G__54363__$3 = (((G__54363__$2 == null))?null:clojure.string.replace(G__54363__$2,/=+/,"equals"));
var G__54363__$4 = (((G__54363__$3 == null))?null:clojure.string.replace(G__54363__$3,/~+/,"dash"));
var G__54363__$5 = (((G__54363__$4 == null))?null:clojure.string.replace(G__54363__$4,"[","open-square-bracket"));
var G__54363__$6 = (((G__54363__$5 == null))?null:clojure.string.replace(G__54363__$5,"]","close-square-bracket"));
if((G__54363__$6 == null)){
return null;
} else {
return clojure.string.replace(G__54363__$6,"'","single-quote");
}
});
...
var dict = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54364){
var vec__54365 = p__54364;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54365,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54365,(1),null);
...
var handler_m = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54389){
var vec__54390 = p__54389;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54390,(0),null);
var map__54393 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54390,(1),null);
var map__54393__$1 = cljs.core.__destructure_map(map__54393);
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54393__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
...
var G__54394 = handler_m;
var G__54394__$1 = (cljs.core.truth_(state)?cljs.core.reduce_kv((function (r,k,handle_fn){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(r,k,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(handle_fn,state));
}),cljs.core.PersistentArrayMap.EMPTY,G__54394):G__54394);
...
}),cljs.core.PersistentArrayMap.EMPTY,G__54394__$1);
} else {
return G__54394__$1;
}
}));
...
var new_result = borkdude.rewrite_edn.update(result,new cljs.core.Keyword(null,"shortcuts","shortcuts",1717107810),(function (p1__54417_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(borkdude.rewrite_edn.sexpr(p1__54417_SHARP_),k);
}));
...
return cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.key,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__54421){
var vec__54422 = p__54421;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54422,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54422,(1),null);
...
var parse_shortcut = (function (p1__54431_SHARP_){
try{return goog.ui.KeyboardShortcutHandler.parseStringShortcut(p1__54431_SHARP_);
}catch (e54455){if((e54455 instanceof Error)){
var e = e54455;
return console.error("[shortcut/parse-error]",[cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54431_SHARP_)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e.message)].join(''));
} else {
throw e54455;
...
var data = (function (){var G__54458 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.vals(cljs.core.deref(frontend.modules.shortcut.config.config)));
return (id.cljs$core$IFn$_invoke$arity$1 ? id.cljs$core$IFn$_invoke$arity$1(G__54458) : id.call(null,G__54458));
})();
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54463){
var vec__54465 = p__54463;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54465,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54465,(1),null);
