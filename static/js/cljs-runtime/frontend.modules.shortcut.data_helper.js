...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__64428){
var vec__64429 = p__64428;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64429,(0),null);
var map__64432 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64429,(1),null);
var map__64432__$1 = cljs.core.__destructure_map(map__64432);
var binding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64432__$1,new cljs.core.Keyword(null,"binding","binding",539932593));
...
var G__64433 = k;
var G__64433__$1 = (((G__64433 == null))?null:frontend.util.safe_lower_case(G__64433));
var G__64433__$2 = (((G__64433__$1 == null))?null:clojure.string.replace(G__64433__$1,/;+/,"semicolon"));
var G__64433__$3 = (((G__64433__$2 == null))?null:clojure.string.replace(G__64433__$2,/=+/,"equals"));
var G__64433__$4 = (((G__64433__$3 == null))?null:clojure.string.replace(G__64433__$3,/~+/,"dash"));
var G__64433__$5 = (((G__64433__$4 == null))?null:clojure.string.replace(G__64433__$4,"[","open-square-bracket"));
var G__64433__$6 = (((G__64433__$5 == null))?null:clojure.string.replace(G__64433__$5,"]","close-square-bracket"));
if((G__64433__$6 == null)){
return null;
} else {
return clojure.string.replace(G__64433__$6,"'","single-quote");
}
});
...
var dict = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__64434){
var vec__64435 = p__64434;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64435,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64435,(1),null);
...
var handler_m = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__64447){
var vec__64450 = p__64447;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64450,(0),null);
var map__64455 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64450,(1),null);
var map__64455__$1 = cljs.core.__destructure_map(map__64455);
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64455__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
...
var G__64461 = handler_m;
var G__64461__$1 = (cljs.core.truth_(state)?cljs.core.reduce_kv((function (r,k,handle_fn){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(r,k,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(handle_fn,state));
}),cljs.core.PersistentArrayMap.EMPTY,G__64461):G__64461);
...
}),cljs.core.PersistentArrayMap.EMPTY,G__64461__$1);
} else {
return G__64461__$1;
}
}));
...
var new_result = borkdude.rewrite_edn.update(result,new cljs.core.Keyword(null,"shortcuts","shortcuts",1717107810),(function (p1__64489_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(borkdude.rewrite_edn.sexpr(p1__64489_SHARP_),k);
}));
...
return cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.key,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__64494){
var vec__64495 = p__64494;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64495,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64495,(1),null);
...
var parse_shortcut = (function (p1__64498_SHARP_){
try{return goog.ui.KeyboardShortcutHandler.parseStringShortcut(p1__64498_SHARP_);
}catch (e64504){if((e64504 instanceof Error)){
var e = e64504;
return console.error("[shortcut/parse-error]",[cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__64498_SHARP_)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e.message)].join(''));
} else {
throw e64504;
...
var data = (function (){var G__64507 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.vals(cljs.core.deref(frontend.modules.shortcut.config.config)));
return (id.cljs$core$IFn$_invoke$arity$1 ? id.cljs$core$IFn$_invoke$arity$1(G__64507) : id.call(null,G__64507));
})();
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__64537){
var vec__64538 = p__64537;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64538,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64538,(1),null);
