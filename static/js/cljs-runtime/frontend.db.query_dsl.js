...
var tf = (function (){var G__43140 = kind;
switch (G__43140) {
case "y":
...
var duration = cljs.core.parse_long(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(input__$1,(0),(((input__$1).length) - (1))));
var kind = cljs.core.last(input__$1);
var tf = (function (){var G__43141 = kind;
switch (G__43141) {
case "y":
return cljs_time.core.years;
...
frontend.db.query_dsl.build_and_or_not = (function frontend$db$query_dsl$build_and_or_not(e,p__43142,level,fe){
var map__43143 = p__43142;
var map__43143__$1 = cljs.core.__destructure_map(map__43143);
var env = map__43143__$1;
var current_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43143__$1,new cljs.core.Keyword(null,"current-filter","current-filter",1519815247));
var vars = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43143__$1,new cljs.core.Keyword(null,"vars","vars",-2046957217));
var raw_clauses = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (form){
var G__43144 = form;
var G__43145 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(env,new cljs.core.Keyword(null,"current-filter","current-filter",1519815247),fe);
var G__43146 = (level + (1));
return (frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3 ? frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3(G__43144,G__43145,G__43146) : frontend.db.query_dsl.build_query.call(null,G__43144,G__43145,G__43146));
}),cljs.core.rest(e));
...
var vec__43147 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,end], null));
var start__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43147,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43147,(1),null);
...
var vec__43150 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,end], null));
var start__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43150,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43150,(1),null);
...
var vec__43153 = cljs.core.rest(e);
...
var vec__43157 = cljs.core.rest(e);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43157,(0),null);
var order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43157,(1),null);
...
var get_value = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k__$1,"created-at"))?new cljs.core.Keyword("block","created-at","block/created-at",1440015):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k__$1,"updated-at"))?new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551):(function (p1__43156_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__43156_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","properties","block/properties",708347145),k__$1], null));
})
));
...
var page_name = (function (){var G__43160 = logseq.graph_parser.text.page_ref_un_brackets_BANG_(e);
return (frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(G__43160) : frontend.util.page_name_sanity_lc.call(null,G__43160));
})();
...
(frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3 = (function (e,p__43163,level){
var map__43164 = p__43163;
var map__43164__$1 = cljs.core.__destructure_map(map__43164);
var env = map__43164__$1;
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43164__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43164__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620),cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null));
var sample = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43164__$1,new cljs.core.Keyword(null,"sample","sample",79023601));
...
var G__43166 = s;
var G__43166__$1 = (((G__43166 == null))?null:clojure.string.replace(G__43166,logseq.graph_parser.text.page_ref_re,"\"[[$1]]\""));
if((G__43166__$1 == null)){
return null;
} else {
return clojure.string.replace(G__43166__$1,logseq.graph_parser.text.between_re,(function (p__43167){
var vec__43168 = p__43167;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(1),null);
...
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.some((function (p1__43165_SHARP_){
return clojure.string.ends_with_QMARK_(x__$1,p1__43165_SHARP_);
...
var vec__43171 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(cljs.core.set(syms),forms),syms);
var b_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43171,(0),null);
var p_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43171,(1),null);
var not_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43171,(2),null);
...
var form = (function (){var G__43175 = s__$1;
var G__43175__$1 = (((G__43175 == null))?null:frontend.db.query_dsl.pre_transform(G__43175));
if((G__43175__$1 == null)){
return null;
} else {
return cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(G__43175__$1);
}
})();
...
var map__43174 = (cljs.core.truth_(form)?frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$2(form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sort-by","sort-by",-322599303),sort_by,new cljs.core.Keyword(null,"blocks?","blocks?",58578620),blocks_QMARK_,new cljs.core.Keyword(null,"sample","sample",79023601),sample], null)):null);
var map__43174__$1 = cljs.core.__destructure_map(map__43174);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43174__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43174__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
var map__43176 = frontend.db.query_dsl.parse(query_string_SINGLEQUOTE_);
var map__43176__$1 = cljs.core.__destructure_map(map__43176);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43176__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43176__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43176__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43176__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620));
var sample = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43176__$1,new cljs.core.Keyword(null,"sample","sample",79023601));
var temp__5720__auto__ = (function (){var G__43177 = query;
if((G__43177 == null)){
return null;
} else {
return frontend.db.query_dsl.query_wrapper(G__43177,blocks_QMARK_);
}
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
var map__43178 = frontend.db.query_dsl.parse(query_string);
var map__43178__$1 = cljs.core.__destructure_map(map__43178);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43178__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43178__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43178__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43178__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var temp__5720__auto__ = (function (){var G__43179 = query;
if((G__43179 == null)){
return null;
} else {
return frontend.db.query_dsl.query_wrapper(G__43179,blocks_QMARK_);
}
})();
if(cljs.core.truth_(temp__5720__auto__)){
var query_SINGLEQUOTE_ = temp__5720__auto__;
