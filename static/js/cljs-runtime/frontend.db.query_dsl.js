...
var tf = (function (){var G__43505 = kind;
switch (G__43505) {
case "y":
...
var duration = cljs.core.parse_long(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(input__$1,(0),(((input__$1).length) - (1))));
var kind = cljs.core.last(input__$1);
var tf = (function (){var G__43506 = kind;
switch (G__43506) {
case "y":
return cljs_time.core.years;
...
frontend.db.query_dsl.build_and_or_not = (function frontend$db$query_dsl$build_and_or_not(e,p__43507,level,fe){
var map__43508 = p__43507;
var map__43508__$1 = cljs.core.__destructure_map(map__43508);
var env = map__43508__$1;
var current_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43508__$1,new cljs.core.Keyword(null,"current-filter","current-filter",1519815247));
var vars = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43508__$1,new cljs.core.Keyword(null,"vars","vars",-2046957217));
var raw_clauses = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (form){
var G__43509 = form;
var G__43510 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(env,new cljs.core.Keyword(null,"current-filter","current-filter",1519815247),fe);
var G__43511 = (level + (1));
return (frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3 ? frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3(G__43509,G__43510,G__43511) : frontend.db.query_dsl.build_query.call(null,G__43509,G__43510,G__43511));
}),cljs.core.rest(e));
...
var vec__43512 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,end], null));
var start__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43512,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43512,(1),null);
...
var vec__43515 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,end], null));
var start__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43515,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43515,(1),null);
...
var vec__43518 = cljs.core.rest(e);
...
var vec__43522 = cljs.core.rest(e);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43522,(0),null);
var order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43522,(1),null);
...
var get_value = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k__$1,"created-at"))?new cljs.core.Keyword("block","created-at","block/created-at",1440015):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k__$1,"updated-at"))?new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551):(function (p1__43521_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__43521_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","properties","block/properties",708347145),k__$1], null));
})
));
...
var page_name = (function (){var G__43525 = logseq.graph_parser.text.page_ref_un_brackets_BANG_(e);
return (frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(G__43525) : frontend.util.page_name_sanity_lc.call(null,G__43525));
})();
...
(frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3 = (function (e,p__43528,level){
var map__43529 = p__43528;
var map__43529__$1 = cljs.core.__destructure_map(map__43529);
var env = map__43529__$1;
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43529__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43529__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620),cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null));
var sample = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43529__$1,new cljs.core.Keyword(null,"sample","sample",79023601));
...
var G__43531 = s;
var G__43531__$1 = (((G__43531 == null))?null:clojure.string.replace(G__43531,logseq.graph_parser.text.page_ref_re,"\"[[$1]]\""));
if((G__43531__$1 == null)){
return null;
} else {
return clojure.string.replace(G__43531__$1,logseq.graph_parser.text.between_re,(function (p__43532){
var vec__43533 = p__43532;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43533,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43533,(1),null);
...
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.some((function (p1__43530_SHARP_){
return clojure.string.ends_with_QMARK_(x__$1,p1__43530_SHARP_);
...
var vec__43536 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(cljs.core.set(syms),forms),syms);
var b_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43536,(0),null);
var p_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43536,(1),null);
var not_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43536,(2),null);
...
var form = (function (){var G__43540 = s__$1;
var G__43540__$1 = (((G__43540 == null))?null:frontend.db.query_dsl.pre_transform(G__43540));
if((G__43540__$1 == null)){
return null;
} else {
return cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(G__43540__$1);
}
})();
...
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43539__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43539__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
var map__43541 = frontend.db.query_dsl.parse(query_string_SINGLEQUOTE_);
var map__43541__$1 = cljs.core.__destructure_map(map__43541);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43541__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43541__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43541__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43541__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620));
var sample = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43541__$1,new cljs.core.Keyword(null,"sample","sample",79023601));
var temp__5720__auto__ = (function (){var G__43542 = query;
if((G__43542 == null)){
return null;
} else {
return frontend.db.query_dsl.query_wrapper(G__43542,blocks_QMARK_);
}
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
var map__43543 = frontend.db.query_dsl.parse(query_string);
var map__43543__$1 = cljs.core.__destructure_map(map__43543);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43543__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43543__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43543__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43543__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var temp__5720__auto__ = (function (){var G__43544 = query;
if((G__43544 == null)){
return null;
} else {
return frontend.db.query_dsl.query_wrapper(G__43544,blocks_QMARK_);
}
})();
if(cljs.core.truth_(temp__5720__auto__)){
var query_SINGLEQUOTE_ = temp__5720__auto__;
