...
var tf = (function (){var G__56784 = kind;
switch (G__56784) {
case "y":
...
var duration = frontend.util.parse_int(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(input__$1,(0),(((input__$1).length) - (1))));
var kind = cljs.core.last(input__$1);
var tf = (function (){var G__56785 = kind;
switch (G__56785) {
case "y":
return cljs_time.core.years;
...
frontend.db.query_dsl.build_and_or_not = (function frontend$db$query_dsl$build_and_or_not(e,p__56786,level,fe){
var map__56787 = p__56786;
var map__56787__$1 = cljs.core.__destructure_map(map__56787);
var env = map__56787__$1;
var current_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56787__$1,new cljs.core.Keyword(null,"current-filter","current-filter",1519815247));
var vars = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56787__$1,new cljs.core.Keyword(null,"vars","vars",-2046957217));
var raw_clauses = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (form){
var G__56788 = form;
var G__56789 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(env,new cljs.core.Keyword(null,"current-filter","current-filter",1519815247),fe);
var G__56790 = (level + (1));
return (frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3 ? frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3(G__56788,G__56789,G__56790) : frontend.db.query_dsl.build_query.call(null,G__56788,G__56789,G__56790));
}),cljs.core.rest(e));
...
var vec__56791 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,end], null));
var start__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56791,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56791,(1),null);
...
var vec__56794 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,end], null));
var start__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56794,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56794,(1),null);
...
var vec__56797 = cljs.core.rest(e);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56797,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56797,(1),null);
...
var vec__56801 = cljs.core.rest(e);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56801,(0),null);
var order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56801,(1),null);
...
var get_value = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k__$1,"created-at"))?new cljs.core.Keyword("block","created-at","block/created-at",1440015):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k__$1,"updated-at"))?new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551):(function (p1__56800_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__56800_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","properties","block/properties",708347145),k__$1], null));
})
));
...
var page_name = logseq.graph_parser.text.page_ref_un_brackets_BANG_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.rest(e))));
var page = frontend.util.page_name_sanity_lc(page_name);
...
var page_name = frontend.util.page_name_sanity_lc(logseq.graph_parser.text.page_ref_un_brackets_BANG_(e));
...
(frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$3 = (function (e,p__56806,level){
var map__56807 = p__56806;
var map__56807__$1 = cljs.core.__destructure_map(map__56807);
var env = map__56807__$1;
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56807__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56807__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620),cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null));
var sample = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56807__$1,new cljs.core.Keyword(null,"sample","sample",79023601));
...
var G__56809 = s;
var G__56809__$1 = (((G__56809 == null))?null:clojure.string.replace(G__56809,logseq.graph_parser.text.page_ref_re,"\"[[$1]]\""));
if((G__56809__$1 == null)){
return null;
} else {
return clojure.string.replace(G__56809__$1,logseq.graph_parser.text.between_re,(function (p__56810){
var vec__56811 = p__56810;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56811,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56811,(1),null);
...
var and__4251__auto__ = logseq.graph_parser.util.safe_re_find(/\d/,cljs.core.first(x__$1));
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.some((function (p1__56808_SHARP_){
return clojure.string.ends_with_QMARK_(x__$1,p1__56808_SHARP_);
...
var vec__56814 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(cljs.core.set(syms),forms),syms);
var b_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56814,(0),null);
var p_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56814,(1),null);
var not_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56814,(2),null);
...
var form = (function (){var G__56818 = s__$1;
var G__56818__$1 = (((G__56818 == null))?null:frontend.db.query_dsl.pre_transform(G__56818));
if((G__56818__$1 == null)){
return null;
} else {
return cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(G__56818__$1);
}
})();
...
var map__56817 = (cljs.core.truth_(form)?frontend.db.query_dsl.build_query.cljs$core$IFn$_invoke$arity$2(form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sort-by","sort-by",-322599303),sort_by,new cljs.core.Keyword(null,"blocks?","blocks?",58578620),blocks_QMARK_,new cljs.core.Keyword(null,"sample","sample",79023601),sample], null)):null);
var map__56817__$1 = cljs.core.__destructure_map(map__56817);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56817__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56817__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
var map__56819 = frontend.db.query_dsl.parse(query_string_SINGLEQUOTE_);
var map__56819__$1 = cljs.core.__destructure_map(map__56819);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56819__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56819__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56819__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56819__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620));
var sample = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56819__$1,new cljs.core.Keyword(null,"sample","sample",79023601));
var temp__5720__auto__ = (function (){var G__56820 = query;
if((G__56820 == null)){
return null;
} else {
return frontend.db.query_dsl.query_wrapper(G__56820,blocks_QMARK_);
}
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
var map__56821 = frontend.db.query_dsl.parse(query_string);
var map__56821__$1 = cljs.core.__destructure_map(map__56821);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56821__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56821__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var blocks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56821__$1,new cljs.core.Keyword(null,"blocks?","blocks?",58578620));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56821__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var temp__5720__auto__ = (function (){var G__56822 = query;
if((G__56822 == null)){
return null;
} else {
return frontend.db.query_dsl.query_wrapper(G__56822,blocks_QMARK_);
}
})();
if(cljs.core.truth_(temp__5720__auto__)){
var query_SINGLEQUOTE_ = temp__5720__auto__;
