...
(rewrite_cljc.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k77543,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__77566 = k77543;
var G__77566__$1 = (((G__77566 instanceof cljs.core.Keyword))?G__77566.fqn:null);
switch (G__77566__$1) {
case "k":
return self__.k;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k77543,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__77568){
var vec__77571 = p__77568;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77571,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77571,(1),null);
...
(rewrite_cljc.node.keyword.KeywordNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__77542){
var self__ = this;
var G__77542__$1 = this;
return (new cljs.core.RecordIter((0),G__77542__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k","k",-2146297393),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_cljc.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this77545,other77546){
var self__ = this;
var this77545__$1 = this;
return (((!((other77546 == null)))) && ((((this77545__$1.constructor === other77546.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77545__$1.k,other77546.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77545__$1.namespaced_QMARK_,other77546.namespaced_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77545__$1.__extmap,other77546.__extmap)))))))));
}));
...
(rewrite_cljc.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k77543){
var self__ = this;
var this__5347__auto____$1 = this;
var G__77597 = k77543;
var G__77597__$1 = (((G__77597 instanceof cljs.core.Keyword))?G__77597.fqn:null);
switch (G__77597__$1) {
case "k":
case "namespaced?":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k77543);

}
}));

(rewrite_cljc.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__77542){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__77601 = cljs.core.keyword_identical_QMARK_;
var expr__77602 = k__5349__auto__;
if(cljs.core.truth_((pred__77601.cljs$core$IFn$_invoke$arity$2 ? pred__77601.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__77602) : pred__77601.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__77602)))){
return (new rewrite_cljc.node.keyword.KeywordNode(G__77542,self__.namespaced_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77601.cljs$core$IFn$_invoke$arity$2 ? pred__77601.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__77602) : pred__77601.call(null,new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__77602)))){
return (new rewrite_cljc.node.keyword.KeywordNode(self__.k,G__77542,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_cljc.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__77542),null));
}
}
}));
...
(rewrite_cljc.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__77542){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_cljc.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,G__77542,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_cljc.node.keyword.map__GT_KeywordNode = (function rewrite_cljc$node$keyword$map__GT_KeywordNode(G__77548){
var extmap__5382__auto__ = (function (){var G__77606 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__77548,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], 0));
if(cljs.core.record_QMARK_(G__77548)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__77606);
} else {
return G__77606;
}
})();
return (new rewrite_cljc.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__77548),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877).cljs$core$IFn$_invoke$arity$1(G__77548),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
...
var len__5766__auto___77618 = arguments.length;
var i__5767__auto___77619 = (0);
while(true){
if((i__5767__auto___77619 < len__5766__auto___77618)){
args__5772__auto__.push((arguments[i__5767__auto___77619]));

var G__77620 = (i__5767__auto___77619 + (1));
i__5767__auto___77619 = G__77620;
continue;
} else {
}
break;
...
(rewrite_cljc.node.keyword.keyword_node.cljs$core$IFn$_invoke$arity$variadic = (function (k,p__77611){
var vec__77612 = p__77611;
var namespaced_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77612,(0),null);
...
/** @this {Function} */
(rewrite_cljc.node.keyword.keyword_node.cljs$lang$applyTo = (function (seq77608){
var G__77609 = cljs.core.first(seq77608);
var seq77608__$1 = cljs.core.next(seq77608);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__77609,seq77608__$1);
}));
