...
frontend.ui.ls_textarea = rum.core.lazy_build(rum.core.build_defc,(function (p__55068){
var map__55070 = p__55068;
var map__55070__$1 = cljs.core.__destructure_map(map__55070);
var props = map__55070__$1;
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55070__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var el_55913 = rum.core.dom_node(state);
el_55913.addEventListener("mouseup",(function (p1__55066_SHARP_){
var start = frontend.util.get_selection_start(el_55913);
var end = frontend.util.get_selection_end(el_55913);
...
return new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"caret","caret",-1275001854),frontend.util.cursor.get_caret_pos.cljs$core$IFn$_invoke$arity$1(el_55913),new cljs.core.Keyword(null,"start","start",-355208981),start,new cljs.core.Keyword(null,"end","end",-268185958),end,new cljs.core.Keyword(null,"text","text",-1790561697),el_55913.value.substring(start,end),new cljs.core.Keyword(null,"point","point",1813198264),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"x","x",2099068185),p1__55066_SHARP_.x,new cljs.core.Keyword(null,"y","y",-1757859776),p1__55066_SHARP_.y], null)], null);
} else {
return and__5041__auto__;
}
})();
...
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["dropdown-wrapper",[cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$__$1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__55078 = state;
switch (G__55078) {
case "entering":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55078)].join('')));
...
var G__55918__delegate = function (state,content_fn,modal_content_fn,p__55080){
var vec__55081 = p__55080;
var map__55084 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55081,(0),null);
var map__55084__$1 = cljs.core.__destructure_map(map__55084);
var modal_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55084__$1,new cljs.core.Keyword(null,"modal-class","modal-class",226435127));
var z_index = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__55084__$1,new cljs.core.Keyword(null,"z-index","z-index",1892827090),(999));
var map__55086 = state;
var map__55086__$1 = cljs.core.__destructure_map(map__55086);
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55086__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
return daiquiri.core.create_element("div",{'style':{'zIndex':z_index},'className':"relative ui__dropdown-trigger"},[daiquiri.interpreter.interpret((content_fn.cljs$core$IFn$_invoke$arity$1 ? content_fn.cljs$core$IFn$_invoke$arity$1(state) : content_fn.call(null,state))),daiquiri.interpreter.interpret((function (){var G__55091 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),cljs.core.deref(open_QMARK_),new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__55092 = (function (dropdown_state){
...
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__55091,G__55092) : frontend.ui.css_transition.call(null,G__55091,G__55092));
})())]);
};
var G__55918 = function (state,content_fn,modal_content_fn,var_args){
var p__55080 = null;
if (arguments.length > 3) {
var G__55922__i = 0, G__55922__a = new Array(arguments.length -  3);
while (G__55922__i < G__55922__a.length) {G__55922__a[G__55922__i] = arguments[G__55922__i + 3]; ++G__55922__i;}
  p__55080 = new cljs.core.IndexedSeq(G__55922__a,0,null);
} 
return G__55918__delegate.call(this,state,content_fn,modal_content_fn,p__55080);};
G__55918.cljs$lang$maxFixedArity = 3;
G__55918.cljs$lang$applyTo = (function (arglist__55923){
var state = cljs.core.first(arglist__55923);
arglist__55923 = cljs.core.next(arglist__55923);
var content_fn = cljs.core.first(arglist__55923);
arglist__55923 = cljs.core.next(arglist__55923);
var modal_content_fn = cljs.core.first(arglist__55923);
var p__55080 = cljs.core.rest(arglist__55923);
return G__55918__delegate(state,content_fn,modal_content_fn,p__55080);
});
...
var attrs55104 = options;
return daiquiri.core.create_element("a",((cljs.core.map_QMARK_(attrs55104))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, ["block","px-4","py-2","text-sm","transition","ease-in-out","duration-150","cursor","menu-link"], null)], null),attrs55104], 0))):{'className':"block px-4 py-2 text-sm transition ease-in-out duration-150 cursor menu-link"}),((cljs.core.map_QMARK_(attrs55104))?[daiquiri.interpreter.interpret(child)]:[daiquiri.interpreter.interpret(attrs55104),daiquiri.interpreter.interpret(child)]));
}),null,"frontend.ui/menu-link");
frontend.ui.dropdown_with_links = rum.core.lazy_build(rum.core.build_defc,(function (content_fn,links,p__55121){
var map__55123 = p__55121;
var map__55123__$1 = cljs.core.__destructure_map(map__55123);
var opts = map__55123__$1;
var links_header = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55123__$1,new cljs.core.Keyword(null,"links-header","links-header",-1729119536));
var links_footer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55123__$1,new cljs.core.Keyword(null,"links-footer","links-footer",1890937614));
return frontend.ui.dropdown(content_fn,(function (p__55210){
var map__55211 = p__55210;
var map__55211__$1 = cljs.core.__destructure_map(map__55211);
var close_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55211__$1,new cljs.core.Keyword(null,"close-fn","close-fn",-1779772512));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.py-1.rounded-md.shadow-xs","div.py-1.rounded-md.shadow-xs",1383490521),(cljs.core.truth_(links_header)?links_header:null),(function (){var iter__5520__auto__ = (function frontend$ui$iter__55213(s__55214){
return (new cljs.core.LazySeq(null,(function (){
var s__55214__$1 = s__55214;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__55214__$1);
if(temp__5720__auto__){
var s__55214__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55214__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__55214__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__55216 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__55215 = (0);
while(true){
if((i__55215 < size__5519__auto__)){
var map__55220 = cljs.core._nth(c__5518__auto__,i__55215);
var map__55220__$1 = cljs.core.__destructure_map(map__55220);
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55220__$1,new cljs.core.Keyword(null,"options","options",99638489));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55220__$1,new cljs.core.Keyword(null,"title","title",636505583));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55220__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55220__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var hover_detail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55220__$1,new cljs.core.Keyword(null,"hover-detail","hover-detail",-1668874248));
cljs.core.chunk_append(b__55216,(function (){var new_options = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([options,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),hover_detail,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__55215,map__55220,map__55220__$1,options,title,icon,hr,hover_detail,c__5518__auto__,size__5519__auto__,b__55216,s__55214__$2,temp__5720__auto__,map__55211,map__55211__$1,close_fn,map__55123,map__55123__$1,opts,links_header,links_footer){
return (function (e){
var temp__5720__auto___55929__$1 = new cljs.core.Keyword(null,"on-click","on-click",1632826543).cljs$core$IFn$_invoke$arity$1(options);
if(cljs.core.truth_(temp__5720__auto___55929__$1)){
var on_click_fn_55931 = temp__5720__auto___55929__$1;
(on_click_fn_55931.cljs$core$IFn$_invoke$arity$1 ? on_click_fn_55931.cljs$core$IFn$_invoke$arity$1(e) : on_click_fn_55931.call(null,e));
} else {
}

return (close_fn.cljs$core$IFn$_invoke$arity$0 ? close_fn.cljs$core$IFn$_invoke$arity$0() : close_fn.call(null));
});})(i__55215,map__55220,map__55220__$1,options,title,icon,hr,hover_detail,c__5518__auto__,size__5519__auto__,b__55216,s__55214__$2,temp__5720__auto__,map__55211,map__55211__$1,close_fn,map__55123,map__55123__$1,opts,links_header,links_footer))
], null)], 0));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55216),frontend$ui$iter__55213(cljs.core.chunk_rest(s__55214__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55216),null);
}
} else {
var map__55223 = cljs.core.first(s__55214__$2);
var map__55223__$1 = cljs.core.__destructure_map(map__55223);
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55223__$1,new cljs.core.Keyword(null,"options","options",99638489));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55223__$1,new cljs.core.Keyword(null,"title","title",636505583));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55223__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55223__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var hover_detail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55223__$1,new cljs.core.Keyword(null,"hover-detail","hover-detail",-1668874248));
return cljs.core.cons((function (){var new_options = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([options,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),hover_detail,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__55223,map__55223__$1,options,title,icon,hr,hover_detail,s__55214__$2,temp__5720__auto__,map__55211,map__55211__$1,close_fn,map__55123,map__55123__$1,opts,links_header,links_footer){
return (function (e){
var temp__5720__auto___55935__$1 = new cljs.core.Keyword(null,"on-click","on-click",1632826543).cljs$core$IFn$_invoke$arity$1(options);
if(cljs.core.truth_(temp__5720__auto___55935__$1)){
var on_click_fn_55936 = temp__5720__auto___55935__$1;
(on_click_fn_55936.cljs$core$IFn$_invoke$arity$1 ? on_click_fn_55936.cljs$core$IFn$_invoke$arity$1(e) : on_click_fn_55936.call(null,e));
} else {
}

return (close_fn.cljs$core$IFn$_invoke$arity$0 ? close_fn.cljs$core$IFn$_invoke$arity$0() : close_fn.call(null));
});})(map__55223,map__55223__$1,options,title,icon,hr,hover_detail,s__55214__$2,temp__5720__auto__,map__55211,map__55211__$1,close_fn,map__55123,map__55123__$1,opts,links_header,links_footer))
], null)], 0));
var child = (cljs.core.truth_(hr)?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.items-center","div.flex.items-center",-1537844053),(cljs.core.truth_(icon)?icon:null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"8px"], null)], null),title], null)], null));
if(cljs.core.truth_(hr)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"hr.my-1","hr.my-1",-305187328),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),"dropdown-hr"], null)], null);
...
})(),frontend$ui$iter__55213(cljs.core.rest(s__55214__$2)));
}
} else {
return null;
}
...
var len__5766__auto___55937 = arguments.length;
var i__5767__auto___55938 = (0);
while(true){
if((i__5767__auto___55938 < len__5766__auto___55937)){
args__5772__auto__.push((arguments[i__5767__auto___55938]));

var G__55939 = (i__5767__auto___55938 + (1));
i__5767__auto___55938 = G__55939;
continue;
} else {
}
break;
...
(frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic = (function (text,p__55228){
var map__55229 = p__55228;
var map__55229__$1 = cljs.core.__destructure_map(map__55229);
var option = map__55229__$1;
var background = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55229__$1,new cljs.core.Keyword(null,"background","background",-863952629));
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55229__$1,new cljs.core.Keyword(null,"href","href",-793805698));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55229__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var intent = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55229__$1,new cljs.core.Keyword(null,"intent","intent",-390846953));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55229__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var small_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__55229__$1,new cljs.core.Keyword(null,"small?","small?",95242445),false);
var large_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__55229__$1,new cljs.core.Keyword(null,"large?","large?",1460879088),false);
...
/** @this {Function} */
(frontend.ui.button.cljs$lang$applyTo = (function (seq55226){
var G__55227 = cljs.core.first(seq55226);
var seq55226__$1 = cljs.core.next(seq55226);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55227,seq55226__$1);
}));
...
var vec__55233 = (function (){var G__55236 = status;
...
var color_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55233,(0),null);
var svg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55233,(1),null);
return daiquiri.core.create_element("div",{'style':daiquiri.interpreter.element_attributes(((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,"exiting")) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,"exited"))))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"z-index","z-index",1892827090),(-1)], null):null)),'className':"ui__notifications-content"},[daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, ["max-w-sm","w-full","shadow-lg","rounded-lg","pointer-events-auto","notification-area",(function (){var G__55237 = state;
switch (G__55237) {
case "entering":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55237)].join('')));

}
})()], null))},[daiquiri.core.create_element("div",{'style':{'maxHeight':"calc(100vh - 200px)",'overflowY':"scroll",'overflowX':"hidden"},'className':"rounded-lg shadow-xs"},[daiquiri.core.create_element("div",{'className':"p-4"},[daiquiri.core.create_element("div",{'className':"flex items-start"},[(function (){var attrs55239 = svg;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs55239))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex-shrink-0"], null)], null),attrs55239], 0))):{'className':"flex-shrink-0"}),((cljs.core.map_QMARK_(attrs55239))?null:[daiquiri.interpreter.interpret(attrs55239)]));
...
return daiquiri.interpreter.interpret((function (){var G__55253 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class-name","class-name",945142584),"notifications ui__notifications"], null);
var G__55254 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
var k = cljs.core.first(el);
var v = cljs.core.second(el);
var G__55256 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"timeout","timeout",-318625318),(100),new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(k)], null);
var G__55257 = (function (state){
...
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__55256,G__55257) : frontend.ui.css_transition.call(null,G__55256,G__55257));
}),contents));
return (frontend.ui.transition_group.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.transition_group.cljs$core$IFn$_invoke$arity$2(G__55253,G__55254) : frontend.ui.transition_group.call(null,G__55253,G__55254));
})());
...
if(cljs.core.truth_(frontend.util.electron_QMARK_())){
window.apis.on("full-screen",(function (p1__55259_SHARP_){
return cljs.core.js_invoke.cljs$core$IFn$_invoke$arity$variadic(cl,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__55259_SHARP_,"enter"))?"add":"remove"),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["is-fullscreen"], 0));
}));

return promesa.core.then.cljs$core$IFn$_invoke$arity$2(electron.ipc.ipc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"getAppBaseInfo","getAppBaseInfo",-1406218507)], 0)),(function (p1__55261_SHARP_){
var map__55264 = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__55261_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
var map__55264__$1 = cljs.core.__destructure_map(map__55264);
var isFullScreen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55264__$1,new cljs.core.Keyword(null,"isFullScreen","isFullScreen",-1879720011));
...
var handler_55947 = (cljs.core.truth_(down_QMARK_)?cljs.core.conj:cljs.core.disj);
var keystroke_55948 = e.key;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(active_keystroke,handler_55947,keystroke_55948);
...
frontend.ui.on_scroll = (function frontend$ui$on_scroll(node,p__55335){
var map__55337 = p__55335;
var map__55337__$1 = cljs.core.__destructure_map(map__55337);
var on_load = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55337__$1,new cljs.core.Keyword(null,"on-load","on-load",1415151594));
var on_top_reached = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55337__$1,new cljs.core.Keyword(null,"on-top-reached","on-top-reached",1295153037));
var threshold = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__55337__$1,new cljs.core.Keyword(null,"threshold","threshold",204221583),(500));
var bottom_reached = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55337__$1,new cljs.core.Keyword(null,"bottom-reached","bottom-reached",-2132308834));
var scroll_top = frontend.ui.goog$module$goog$object.get(node,"scrollTop");
 ...
 */
frontend.ui.infinite_list = rum.core.lazy_build(rum.core.build_defcs,(function (state,_list_element_id,body,p__55342){
var map__55343 = p__55342;
var map__55343__$1 = cljs.core.__destructure_map(map__55343);
var on_load = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55343__$1,new cljs.core.Keyword(null,"on-load","on-load",1415151594));
var has_more = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55343__$1,new cljs.core.Keyword(null,"has-more","has-more",-320006781));
var more = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55343__$1,new cljs.core.Keyword(null,"more","more",-2058821800));
var more_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__55343__$1,new cljs.core.Keyword(null,"more-class","more-class",-869337192),"text-sm");
var attrs55341 = body;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs55341))?daiquiri.interpreter.element_attributes(attrs55341):null),((cljs.core.map_QMARK_(attrs55341))?[(cljs.core.truth_(has_more)?daiquiri.core.create_element("div",{'className':"w-full p-4"},[daiquiri.core.create_element("a",{'onClick':on_load,'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["fade-link","text-link","font-bold",more_class], null))},[daiquiri.interpreter.interpret((function (){var or__5043__auto__ = more;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
})())])]):null)]:[daiquiri.interpreter.interpret(attrs55341),(cljs.core.truth_(has_more)?daiquiri.core.create_element("div",{'className':"w-full p-4"},[daiquiri.core.create_element("a",{'onClick':on_load,'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["fade-link","text-link","font-bold",more_class], null))},[daiquiri.interpreter.interpret((function (){var or__5043__auto__ = more;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("page","earlier","page/earlier",-61115488)], 0));
...
frontend.ui.auto_complete = rum.core.lazy_build(rum.core.build_defcs,(function (state,matched,p__55347){
var map__55348 = p__55347;
var map__55348__$1 = cljs.core.__destructure_map(map__55348);
var on_chosen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55348__$1,new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900));
var on_shift_chosen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55348__$1,new cljs.core.Keyword(null,"on-shift-chosen","on-shift-chosen",-310778328));
var get_group_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55348__$1,new cljs.core.Keyword(null,"get-group-name","get-group-name",-160379696));
var empty_placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55348__$1,new cljs.core.Keyword(null,"empty-placeholder","empty-placeholder",-68202085));
var item_render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55348__$1,new cljs.core.Keyword(null,"item-render","item-render",253627868));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55348__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
});})(i__55353,chosen_QMARK_,vec__55357,idx,item,c__5518__auto__,size__5519__auto__,b__55354,s__55352__$2,temp__5720__auto__,current_idx,map__55348,map__55348__$1,on_chosen,on_shift_chosen,get_group_name,empty_placeholder,item_render,class$))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55354),frontend$ui$iter__55351(cljs.core.chunk_rest(s__55352__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55354),null);
}
} else {
var vec__55364 = cljs.core.first(s__55352__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55364,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55364,(1),null);
return cljs.core.cons(daiquiri.core.create_element(daiquiri.core.fragment,{'key':idx},[(function (){var item_cp = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null),(function (){var chosen_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(current_idx),idx);
return frontend.ui.menu_link(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),["ac-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),((chosen_QMARK_)?"chosen":null),new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),((function (chosen_QMARK_,vec__55364,idx,item,s__55352__$2,temp__5720__auto__,current_idx,map__55348,map__55348__$1,on_chosen,on_shift_chosen,get_group_name,empty_placeholder,item_render,class$){
return (function (e){
frontend.util.stop(e);
...
});})(chosen_QMARK_,vec__55364,idx,item,s__55352__$2,temp__5720__auto__,current_idx,map__55348,map__55348__$1,on_chosen,on_shift_chosen,get_group_name,empty_placeholder,item_render,class$))
], null),(cljs.core.truth_(item_render)?(item_render.cljs$core$IFn$_invoke$arity$2 ? item_render.cljs$core$IFn$_invoke$arity$2(item,chosen_QMARK_) : item_render.call(null,item,chosen_QMARK_)):item));
})()], null);
if(cljs.core.truth_(get_group_name)){
return daiquiri.interpreter.interpret((function (){var temp__5718__auto__ = (get_group_name.cljs$core$IFn$_invoke$arity$1 ? get_group_name.cljs$core$IFn$_invoke$arity$1(item) : get_group_name.call(null,item));
...
})()]),frontend$ui$iter__55351(cljs.core.rest(s__55352__$2)));
}
} else {
return null;
}
...
return daiquiri.core.create_element("div",{'onClick':close_fn,'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui__modal-overlay",(function (){var G__55410 = state;
switch (G__55410) {
case "entering":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55410)].join('')));
...
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui__modal-panel","transform","transition-all","sm:min-w-lg","sm",(function (){var G__55423 = transition_state;
switch (G__55423) {
case "entering":
...
return daiquiri.core.create_element("div",{'style':{'zIndex':(cljs.core.truth_(show_QMARK_)?(999):(-1))},'label':label,'className':"ui__modal"},[daiquiri.interpreter.interpret((function (){var G__55508 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__55509 = (function (state){
return frontend.ui.modal_overlay(state,close_fn);
});
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__55508,G__55509) : frontend.ui.css_transition.call(null,G__55508,G__55509));
})()),daiquiri.interpreter.interpret((function (){var G__55515 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__55516 = (function (state){
return frontend.ui.modal_panel(show_QMARK_,modal_panel_content__$1,state,close_fn,fullscreen_QMARK_,close_btn_QMARK_);
});
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__55515,G__55516) : frontend.ui.css_transition.call(null,G__55515,G__55516));
})())]);
...
var G__55521 = rum.core.dom_node(state).querySelector("button.ui__modal-close");
if((G__55521 == null)){
return null;
} else {
return G__55521.click();
}
...
var G__55524 = rum.core.dom_node(state__$1).querySelector("button.ui__modal-enter");
if((G__55524 == null)){
return null;
} else {
return G__55524.click();
}
})], null));
}))], null),"frontend.ui/modal");
frontend.ui.make_confirm_modal = (function frontend$ui$make_confirm_modal(p__55530){
var map__55531 = p__55530;
var map__55531__$1 = cljs.core.__destructure_map(map__55531);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55531__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55531__$1,new cljs.core.Keyword(null,"title","title",636505583));
var sub_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55531__$1,new cljs.core.Keyword(null,"sub-title","sub-title",-1781490288));
var sub_checkbox_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55531__$1,new cljs.core.Keyword(null,"sub-checkbox?","sub-checkbox?",-671905753));
var on_cancel = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__55531__$1,new cljs.core.Keyword(null,"on-cancel","on-cancel",-2071892932),(function (){
return cljs.core.List.EMPTY;
}));
var on_confirm = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55531__$1,new cljs.core.Keyword(null,"on-confirm","on-confirm",1527003038));
...
return (on_confirm.cljs$core$IFn$_invoke$arity$2 ? on_confirm.cljs$core$IFn$_invoke$arity$2(G__55540,G__55541) : on_confirm.call(null,G__55540,G__55541));
} else {
return and__5041__auto__;
}
...
var iter__5520__auto__ = (function frontend$ui$iter__55587(s__55588){
return (new cljs.core.LazySeq(null,(function (){
var s__55588__$1 = s__55588;
while(true){
var temp__5720__auto____$1 = cljs.core.seq(s__55588__$1);
if(temp__5720__auto____$1){
var s__55588__$2 = temp__5720__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__55588__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__55588__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__55590 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__55589 = (0);
while(true){
if((i__55589 < size__5519__auto__)){
var vec__55618 = cljs.core._nth(c__5518__auto__,i__55589);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55618,(0),null);
var modal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55618,(1),null);
cljs.core.chunk_append(b__55590,(function (){var id = new cljs.core.Keyword("modal","id","modal/id",-1274892409).cljs$core$IFn$_invoke$arity$1(modal);
...
var close_fn = ((function (i__55589,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,vec__55618,idx,modal,c__5518__auto__,size__5519__auto__,b__55590,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (){
return frontend.state.close_sub_modal_BANG_.cljs$core$IFn$_invoke$arity$1(id);
});})(i__55589,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,vec__55618,idx,modal,c__5518__auto__,size__5519__auto__,b__55590,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
var modal_panel_content__$1 = (function (){var or__5043__auto__ = modal_panel_content;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return ((function (i__55589,or__5043__auto__,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,vec__55618,idx,modal,c__5518__auto__,size__5519__auto__,b__55590,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (_close){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null);
});
;})(i__55589,or__5043__auto__,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,vec__55618,idx,modal,c__5518__auto__,size__5519__auto__,b__55590,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
}
})();
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.ui__modal.is-sub-modal","div.ui__modal.is-sub-modal",1533892698),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"z-index","z-index",1892827090),(cljs.core.truth_(show_QMARK_)?((999) + idx):(-1))], null),new cljs.core.Keyword(null,"label","label",1718410804),label], null),(function (){var G__55649 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__55650 = ((function (i__55589,G__55649,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__55618,idx,modal,c__5518__auto__,size__5519__auto__,b__55590,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (state){
return frontend.ui.modal_overlay(state,close_fn);
});})(i__55589,G__55649,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__55618,idx,modal,c__5518__auto__,size__5519__auto__,b__55590,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__55649,G__55650) : frontend.ui.css_transition.call(null,G__55649,G__55650));
})(),(function (){var G__55651 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__55652 = ((function (i__55589,G__55651,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__55618,idx,modal,c__5518__auto__,size__5519__auto__,b__55590,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (state){
return frontend.ui.modal_panel(show_QMARK_,modal_panel_content__$1,state,close_fn,false,close_btn_QMARK_);
});})(i__55589,G__55651,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__55618,idx,modal,c__5518__auto__,size__5519__auto__,b__55590,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__55651,G__55652) : frontend.ui.css_transition.call(null,G__55651,G__55652));
})()], null);
})());

var G__56012 = (i__55589 + (1));
i__55589 = G__56012;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55590),frontend$ui$iter__55587(cljs.core.chunk_rest(s__55588__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55590),null);
}
} else {
var vec__55654 = cljs.core.first(s__55588__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55654,(0),null);
var modal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55654,(1),null);
...
var show_QMARK_ = new cljs.core.Keyword("modal","show?","modal/show?",1441869594).cljs$core$IFn$_invoke$arity$1(modal);
var label = new cljs.core.Keyword("modal","label","modal/label",-1776753955).cljs$core$IFn$_invoke$arity$1(modal);
var close_fn = ((function (id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,vec__55654,idx,modal,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (){
return frontend.state.close_sub_modal_BANG_.cljs$core$IFn$_invoke$arity$1(id);
});})(id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,vec__55654,idx,modal,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
var modal_panel_content__$1 = (function (){var or__5043__auto__ = modal_panel_content;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return ((function (or__5043__auto__,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,vec__55654,idx,modal,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (_close){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null);
});
;})(or__5043__auto__,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,vec__55654,idx,modal,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
}
})();
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.ui__modal.is-sub-modal","div.ui__modal.is-sub-modal",1533892698),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"z-index","z-index",1892827090),(cljs.core.truth_(show_QMARK_)?((999) + idx):(-1))], null),new cljs.core.Keyword(null,"label","label",1718410804),label], null),(function (){var G__55660 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__55661 = ((function (G__55660,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__55654,idx,modal,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (state){
return frontend.ui.modal_overlay(state,close_fn);
});})(G__55660,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__55654,idx,modal,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__55660,G__55661) : frontend.ui.css_transition.call(null,G__55660,G__55661));
})(),(function (){var G__55663 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__55664 = ((function (G__55663,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__55654,idx,modal,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (state){
return frontend.ui.modal_panel(show_QMARK_,modal_panel_content__$1,state,close_fn,false,close_btn_QMARK_);
});})(G__55663,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__55654,idx,modal,s__55588__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__55663,G__55664) : frontend.ui.css_transition.call(null,G__55663,G__55664));
})()], null);
})(),frontend$ui$iter__55587(cljs.core.rest(s__55588__$2)));
}
} else {
return null;
}
...
frontend.ui.foldable = rum.core.lazy_build(rum.core.build_defcs,(function (state,header,content,p__55685){
var map__55686 = p__55685;
var map__55686__$1 = cljs.core.__destructure_map(map__55686);
var title_trigger_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55686__$1,new cljs.core.Keyword(null,"title-trigger?","title-trigger?",-613599873));
...
return daiquiri.core.create_element("div",{'className':"flex flex-col"},[daiquiri.core.create_element("div",{'className':"content"},[(function (){var attrs55690 = (function (){var G__55700 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-over","on-mouse-over",-858472552),(function (){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__55700,new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),on_mouse_down,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"class","class",-2030961996),"cursor"], 0));
} else {
return G__55700;
}
})();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs55690))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex-1","flex-row","foldable-title"], null)], null),attrs55690], 0))):{'className':"flex-1 flex-row foldable-title"}),((cljs.core.map_QMARK_(attrs55690))?[(function (){var attrs55694 = (cljs.core.truth_(frontend.mobile.util.native_platform_QMARK_())?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.block-control.opacity-50.hover:opacity-100.mr-2","a.block-control.opacity-50.hover:opacity-100.mr-2",-1668360838),(function (){var G__55702 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"width","width",-384071477),(14),new cljs.core.Keyword(null,"height","height",1025178622),(16),new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),(-30)], null)], null);
if(cljs.core.not(title_trigger_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55702,new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),on_mouse_down);
} else {
return G__55702;
}
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs55694))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","items-center"], null)], null),attrs55694], 0))):{'className':"flex flex-row items-center"}),((cljs.core.map_QMARK_(attrs55694))?[((cljs.core.fn_QMARK_(header))?daiquiri.interpreter.interpret((function (){var G__55704 = cljs.core.deref(collapsed_QMARK_);
return (header.cljs$core$IFn$_invoke$arity$1 ? header.cljs$core$IFn$_invoke$arity$1(G__55704) : header.call(null,G__55704));
})()):daiquiri.interpreter.interpret(header))]:[daiquiri.interpreter.interpret(attrs55694),((cljs.core.fn_QMARK_(header))?daiquiri.interpreter.interpret((function (){var G__55706 = cljs.core.deref(collapsed_QMARK_);
return (header.cljs$core$IFn$_invoke$arity$1 ? header.cljs$core$IFn$_invoke$arity$1(G__55706) : header.call(null,G__55706));
})()):daiquiri.interpreter.interpret(header))]));
})()]:[daiquiri.interpreter.interpret(attrs55690),(function (){var attrs55698 = (cljs.core.truth_(frontend.mobile.util.native_platform_QMARK_())?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.block-control.opacity-50.hover:opacity-100.mr-2","a.block-control.opacity-50.hover:opacity-100.mr-2",-1668360838),(function (){var G__55708 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"width","width",-384071477),(14),new cljs.core.Keyword(null,"height","height",1025178622),(16),new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),(-30)], null)], null);
if(cljs.core.not(title_trigger_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55708,new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),on_mouse_down);
} else {
return G__55708;
}
})(),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_((function (){var or__5043__auto__ = cljs.core.deref(control_QMARK_);
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs55698))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","items-center"], null)], null),attrs55698], 0))):{'className':"flex flex-row items-center"}),((cljs.core.map_QMARK_(attrs55698))?[((cljs.core.fn_QMARK_(header))?daiquiri.interpreter.interpret((function (){var G__55710 = cljs.core.deref(collapsed_QMARK_);
return (header.cljs$core$IFn$_invoke$arity$1 ? header.cljs$core$IFn$_invoke$arity$1(G__55710) : header.call(null,G__55710));
})()):daiquiri.interpreter.interpret(header))]:[daiquiri.interpreter.interpret(attrs55698),((cljs.core.fn_QMARK_(header))?daiquiri.interpreter.interpret((function (){var G__55712 = cljs.core.deref(collapsed_QMARK_);
return (header.cljs$core$IFn$_invoke$arity$1 ? header.cljs$core$IFn$_invoke$arity$1(G__55712) : header.call(null,G__55712));
})()):daiquiri.interpreter.interpret(header))]));
})()]));
...
var args_56034 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
if(new cljs.core.Keyword(null,"default-collapsed?","default-collapsed?",-1350393823).cljs$core$IFn$_invoke$arity$1(cljs.core.last(args_56034)) === true){
...
var temp__5720__auto__ = (function (){var G__55714 = clojure.string.lower_case(type__$1);
switch (G__55714) {
case "note":
...
frontend.ui.catch_error = rum.core.lazy_build(rum.core.build_defcs,(function (p__55715,error_view,view){
var map__55716 = p__55715;
var map__55716__$1 = cljs.core.__destructure_map(map__55716);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55716__$1,new cljs.core.Keyword("frontend.ui","error","frontend.ui/error",-2009366008));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55716__$1,new cljs.core.Keyword("rum","react-component","rum/react-component",-1879897248));
if((!((error == null)))){
...
frontend.ui.catch_error_and_notify = rum.core.lazy_build(rum.core.build_defcs,(function (p__55717,error_view,view){
var map__55718 = p__55717;
var map__55718__$1 = cljs.core.__destructure_map(map__55718);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55718__$1,new cljs.core.Keyword("frontend.ui","error","frontend.ui/error",-2009366008));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55718__$1,new cljs.core.Keyword("rum","react-component","rum/react-component",-1879897248));
if((!((error == null)))){
return daiquiri.interpreter.interpret(error_view);
} else {
return daiquiri.interpreter.interpret(view);
 ...
 */
frontend.ui.block_error = rum.core.lazy_build(rum.core.build_defc,(function (title,p__55726){
var map__55727 = p__55726;
var map__55727__$1 = cljs.core.__destructure_map(map__55727);
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55727__$1,new cljs.core.Keyword(null,"content","content",15833224));
var section_attrs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55727__$1,new cljs.core.Keyword(null,"section-attrs","section-attrs",1373816150));
var attrs55723 = section_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs55723))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["border","mt-1","p-1","cursor-pointer","block-content-fallback-ui"], null)], null),attrs55723], 0))):{'className':"border mt-1 p-1 cursor-pointer block-content-fallback-ui"}),((cljs.core.map_QMARK_(attrs55723))?[daiquiri.core.create_element("div",{'className':"flex justify-between items-center px-1"},[(function (){var attrs55728 = title;
return daiquiri.core.create_element("h5",((cljs.core.map_QMARK_(attrs55728))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-red-600","pb-1"], null)], null),attrs55728], 0))):{'className':"text-red-600 pb-1"}),((cljs.core.map_QMARK_(attrs55728))?null:[daiquiri.interpreter.interpret(attrs55728)]));
})(),daiquiri.core.create_element("a",{'href':"https://github.com/logseq/logseq/issues/new?labels=from:in-app&template=bug_report.yaml",'target':"_blank",'className':"text-xs opacity-50 hover:opacity-80"},["report issue"])]),(cljs.core.truth_(content)?(function (){var attrs55724 = content;
return daiquiri.core.create_element("pre",((cljs.core.map_QMARK_(attrs55724))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["m-0","text-sm"], null)], null),attrs55724], 0))):{'className':"m-0 text-sm"}),((cljs.core.map_QMARK_(attrs55724))?null:[daiquiri.interpreter.interpret(attrs55724)]));
})():null)]:[daiquiri.interpreter.interpret(attrs55723),daiquiri.core.create_element("div",{'className':"flex justify-between items-center px-1"},[(function (){var attrs55731 = title;
return daiquiri.core.create_element("h5",((cljs.core.map_QMARK_(attrs55731))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-red-600","pb-1"], null)], null),attrs55731], 0))):{'className':"text-red-600 pb-1"}),((cljs.core.map_QMARK_(attrs55731))?null:[daiquiri.interpreter.interpret(attrs55731)]));
})(),daiquiri.core.create_element("a",{'href':"https://github.com/logseq/logseq/issues/new?labels=from:in-app&template=bug_report.yaml",'target':"_blank",'className':"text-xs opacity-50 hover:opacity-80"},["report issue"])]),(cljs.core.truth_(content)?(function (){var attrs55725 = content;
return daiquiri.core.create_element("pre",((cljs.core.map_QMARK_(attrs55725))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["m-0","text-sm"], null)], null),attrs55725], 0))):{'className':"m-0 text-sm"}),((cljs.core.map_QMARK_(attrs55725))?null:[daiquiri.interpreter.interpret(attrs55725)]));
})():null)]));
...
})()], null))},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5520__auto__ = (function frontend$ui$iter__55760(s__55761){
return (new cljs.core.LazySeq(null,(function (){
var s__55761__$1 = s__55761;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__55761__$1);
if(temp__5720__auto__){
var s__55761__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55761__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__55761__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__55763 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__55762 = (0);
while(true){
if((i__55762 < size__5519__auto__)){
var map__55793 = cljs.core._nth(c__5518__auto__,i__55762);
var map__55793__$1 = cljs.core.__destructure_map(map__55793);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55793__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55793__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55793__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
cljs.core.chunk_append(b__55763,(function (){var attrs55741 = (function (){var G__55827 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),label,new cljs.core.Keyword(null,"default-value","default-value",232220170),(function (){var or__5043__auto__ = value;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return label;
...
return daiquiri.core.create_element("option",((cljs.core.map_QMARK_(attrs55741))?daiquiri.interpreter.element_attributes(attrs55741):null),((cljs.core.map_QMARK_(attrs55741))?[daiquiri.interpreter.interpret(label)]:[daiquiri.interpreter.interpret(attrs55741),daiquiri.interpreter.interpret(label)]));
})());

var G__56048 = (i__55762 + (1));
i__55762 = G__56048;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55763),frontend$ui$iter__55760(cljs.core.chunk_rest(s__55761__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55763),null);
}
} else {
var map__55833 = cljs.core.first(s__55761__$2);
var map__55833__$1 = cljs.core.__destructure_map(map__55833);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55833__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55833__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55833__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
return cljs.core.cons((function (){var attrs55741 = (function (){var G__55835 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),label,new cljs.core.Keyword(null,"default-value","default-value",232220170),(function (){var or__5043__auto__ = value;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return label;
...
if(cljs.core.truth_(selected)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55835,new cljs.core.Keyword(null,"selected","selected",574897764),selected);
} else {
return G__55835;
}
})();
return daiquiri.core.create_element("option",((cljs.core.map_QMARK_(attrs55741))?daiquiri.interpreter.element_attributes(attrs55741):null),((cljs.core.map_QMARK_(attrs55741))?[daiquiri.interpreter.interpret(label)]:[daiquiri.interpreter.interpret(attrs55741),daiquiri.interpreter.interpret(label)]));
})(),frontend$ui$iter__55760(cljs.core.rest(s__55761__$2)));
}
} else {
return null;
}
...
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui__radio-list",class$], null))},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5520__auto__ = (function frontend$ui$iter__55842(s__55843){
return (new cljs.core.LazySeq(null,(function (){
var s__55843__$1 = s__55843;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__55843__$1);
if(temp__5720__auto__){
var s__55843__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55843__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__55843__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__55845 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__55844 = (0);
while(true){
if((i__55844 < size__5519__auto__)){
var map__55848 = cljs.core._nth(c__5518__auto__,i__55844);
var map__55848__$1 = cljs.core.__destructure_map(map__55848);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55848__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55848__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55848__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
cljs.core.chunk_append(b__55845,daiquiri.core.create_element("label",{'key':["radio-list-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(label)].join('')},[daiquiri.core.create_element("input",{'value':value,'type':"radio",'onChange':rum.core.mark_sync_update(((function (i__55844,map__55848,map__55848__$1,label,value,selected,c__5518__auto__,size__5519__auto__,b__55845,s__55843__$2,temp__5720__auto__){
return (function (p1__55837_SHARP_){
var G__55851 = frontend.util.evalue(p1__55837_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__55851) : on_change.call(null,G__55851));
});})(i__55844,map__55848,map__55848__$1,label,value,selected,c__5518__auto__,size__5519__auto__,b__55845,s__55843__$2,temp__5720__auto__))
),'checked':selected,'className':"form-radio"},[]),daiquiri.interpreter.interpret(label)]));

var G__56058 = (i__55844 + (1));
i__55844 = G__56058;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55845),frontend$ui$iter__55842(cljs.core.chunk_rest(s__55843__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55845),null);
}
} else {
var map__55855 = cljs.core.first(s__55843__$2);
var map__55855__$1 = cljs.core.__destructure_map(map__55855);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55855__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55855__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55855__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
return cljs.core.cons(daiquiri.core.create_element("label",{'key':["radio-list-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(label)].join('')},[daiquiri.core.create_element("input",{'value':value,'type':"radio",'onChange':rum.core.mark_sync_update(((function (map__55855,map__55855__$1,label,value,selected,s__55843__$2,temp__5720__auto__){
return (function (p1__55837_SHARP_){
var G__55857 = frontend.util.evalue(p1__55837_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__55857) : on_change.call(null,G__55857));
});})(map__55855,map__55855__$1,label,value,selected,s__55843__$2,temp__5720__auto__))
),'checked':selected,'className':"form-radio"},[]),daiquiri.interpreter.interpret(label)]),frontend$ui$iter__55842(cljs.core.rest(s__55843__$2)));
}
} else {
return null;
}
...
var G__55859 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(cljs.core.truth_(checked_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(checked_vals,value):cljs.core.disj.cljs$core$IFn$_invoke$arity$2(checked_vals,value)));
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__55859) : on_change.call(null,G__55859));
});
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui__checkbox-list",class$], null))},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5520__auto__ = (function frontend$ui$iter__55860(s__55861){
return (new cljs.core.LazySeq(null,(function (){
var s__55861__$1 = s__55861;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__55861__$1);
if(temp__5720__auto__){
var s__55861__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55861__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__55861__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__55863 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__55862 = (0);
while(true){
if((i__55862 < size__5519__auto__)){
var map__55864 = cljs.core._nth(c__5518__auto__,i__55862);
var map__55864__$1 = cljs.core.__destructure_map(map__55864);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55864__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55864__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55864__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
cljs.core.chunk_append(b__55863,daiquiri.core.create_element("label",{'key':["check-list-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(label)].join('')},[daiquiri.core.create_element("input",{'value':value,'type':"checkbox",'onChange':rum.core.mark_sync_update(on_item_change),'checked':selected,'className':"form-checkbox"},[]),daiquiri.interpreter.interpret(label)]));

var G__56063 = (i__55862 + (1));
i__55862 = G__56063;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55863),frontend$ui$iter__55860(cljs.core.chunk_rest(s__55861__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55863),null);
}
} else {
var map__55865 = cljs.core.first(s__55861__$2);
var map__55865__$1 = cljs.core.__destructure_map(map__55865);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55865__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55865__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55865__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
return cljs.core.cons(daiquiri.core.create_element("label",{'key':["check-list-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(label)].join('')},[daiquiri.core.create_element("input",{'value':value,'type':"checkbox",'onChange':rum.core.mark_sync_update(on_item_change),'checked':selected,'className':"form-checkbox"},[]),daiquiri.interpreter.interpret(label)]),frontend$ui$iter__55860(cljs.core.rest(s__55861__$2)));
}
} else {
return null;
}
...
frontend.ui.tippy = rum.core.lazy_build(rum.core.build_defcs,(function (state,p__55866,child){
var map__55867 = p__55866;
var map__55867__$1 = cljs.core.__destructure_map(map__55867);
var opts = map__55867__$1;
var fixed_position_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55867__$1,new cljs.core.Keyword(null,"fixed-position?","fixed-position?",-918460562));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55867__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
var in_editor_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55867__$1,new cljs.core.Keyword(null,"in-editor?","in-editor?",323048069));
...
}catch (e55873){if((e55873 instanceof Error)){
var e = e55873;
...
var G__55872 = React.createElement(React.Fragment,{'key':"tippy-children"},daiquiri.interpreter.interpret(child));
return (frontend.ui.Tippy.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.Tippy.cljs$core$IFn$_invoke$arity$2(G__55871,G__55872) : frontend.ui.Tippy.call(null,G__55871,G__55872));
})());
...
frontend.ui.slider = (function frontend$ui$slider(default_value,p__55875){
var map__55876 = p__55875;
var map__55876__$1 = cljs.core.__destructure_map(map__55876);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55876__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55876__$1,new cljs.core.Keyword(null,"max","max",61366548));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55876__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.cursor-pointer","input.cursor-pointer",-632859928),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"range",new cljs.core.Keyword(null,"value","value",305978217),(default_value | (0)),new cljs.core.Keyword(null,"min","min",444991522),min,new cljs.core.Keyword(null,"max","max",61366548),max,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),"100%"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__55874_SHARP_){
var value = frontend.util.evalue(p1__55874_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(value) : on_change.call(null,value));
})], null)], null);
});
...
return daiquiri.core.create_element("div",null,[daiquiri.core.create_element("div",{'className':"flex justify-between mb-1"},[(function (){var attrs55880 = label_left;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs55880))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-base"], null)], null),attrs55880], 0))):{'className':"text-base"}),((cljs.core.map_QMARK_(attrs55880))?null:[daiquiri.interpreter.interpret(attrs55880)]));
})(),(function (){var attrs55881 = label_right;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs55881))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-sm","font-medium"], null)], null),attrs55881], 0))):{'className':"text-sm font-medium"}),((cljs.core.map_QMARK_(attrs55881))?null:[daiquiri.interpreter.interpret(attrs55881)]));
...
return daiquiri.core.create_element("div",{'ref':(function (p1__55882_SHARP_){
return cljs.core.reset_BANG_(new cljs.core.Keyword("frontend.ui","ref","frontend.ui/ref",-122429065).cljs$core$IFn$_invoke$arity$1(state),p1__55882_SHARP_);
}),'style':{'minHeight':(24)},'className':"lazy-visibility"},[(cljs.core.truth_(visible_QMARK_)?((cljs.core.fn_QMARK_(content_fn))?daiquiri.core.create_element("div",{'ref':(function (p1__55883_SHARP_){
var temp__5720__auto__ = (function (){var and__5041__auto__ = p1__55883_SHARP_;
if(cljs.core.truth_(and__5041__auto__)){
return p1__55883_SHARP_.classList;
} else {
return and__5041__auto__;
}
})();
...
frontend.ui.lazy_visible = rum.core.lazy_build(rum.core.build_defcs,(function (state,content_fn,sensor_opts,p__55886){
var map__55887 = p__55886;
var map__55887__$1 = cljs.core.__destructure_map(map__55887);
var once_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55887__$1,new cljs.core.Keyword(null,"once?","once?",-872881597));
...
return daiquiri.interpreter.interpret((function (){var G__55896 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (v){
...
var G__55897 = frontend.ui.lazy_visible_inner(cljs.core.deref(_STAR_visible_QMARK_),content_fn);
return (frontend.ui.visibility_sensor.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.visibility_sensor.cljs$core$IFn$_invoke$arity$2(G__55896,G__55897) : frontend.ui.visibility_sensor.call(null,G__55896,G__55897));
})());
}
