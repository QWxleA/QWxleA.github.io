...
frontend.ui.ls_textarea = rum.core.lazy_build(rum.core.build_defc,(function (p__65623){
var map__65624 = p__65623;
var map__65624__$1 = cljs.core.__destructure_map(map__65624);
var props = map__65624__$1;
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65624__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var el_66676 = rum.core.dom_node(state);
el_66676.addEventListener("mouseup",(function (p1__65622_SHARP_){
var start = frontend.util.get_selection_start(el_66676);
var end = frontend.util.get_selection_end(el_66676);
...
return new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"caret","caret",-1275001854),frontend.util.cursor.get_caret_pos.cljs$core$IFn$_invoke$arity$1(el_66676),new cljs.core.Keyword(null,"start","start",-355208981),start,new cljs.core.Keyword(null,"end","end",-268185958),end,new cljs.core.Keyword(null,"text","text",-1790561697),el_66676.value.substring(start,end),new cljs.core.Keyword(null,"point","point",1813198264),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"x","x",2099068185),p1__65622_SHARP_.x,new cljs.core.Keyword(null,"y","y",-1757859776),p1__65622_SHARP_.y], null)], null);
} else {
return and__4251__auto__;
}
})();
...
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["dropdown-wrapper",[cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$__$1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__65643 = state;
switch (G__65643) {
case "entering":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65643)].join('')));
...
var G__66713__delegate = function (state,content_fn,modal_content_fn,p__65644){
var vec__65645 = p__65644;
var map__65648 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65645,(0),null);
var map__65648__$1 = cljs.core.__destructure_map(map__65648);
var modal_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65648__$1,new cljs.core.Keyword(null,"modal-class","modal-class",226435127));
var z_index = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65648__$1,new cljs.core.Keyword(null,"z-index","z-index",1892827090),(999));
var map__65649 = state;
var map__65649__$1 = cljs.core.__destructure_map(map__65649);
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65649__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
return daiquiri.core.create_element("div",{'style':{'zIndex':z_index},'className':"relative ui__dropdown-trigger"},[daiquiri.interpreter.interpret((content_fn.cljs$core$IFn$_invoke$arity$1 ? content_fn.cljs$core$IFn$_invoke$arity$1(state) : content_fn.call(null,state))),daiquiri.interpreter.interpret((function (){var G__65652 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),cljs.core.deref(open_QMARK_),new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__65653 = (function (dropdown_state){
...
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__65652,G__65653) : frontend.ui.css_transition.call(null,G__65652,G__65653));
})())]);
};
var G__66713 = function (state,content_fn,modal_content_fn,var_args){
var p__65644 = null;
if (arguments.length > 3) {
var G__66732__i = 0, G__66732__a = new Array(arguments.length -  3);
while (G__66732__i < G__66732__a.length) {G__66732__a[G__66732__i] = arguments[G__66732__i + 3]; ++G__66732__i;}
  p__65644 = new cljs.core.IndexedSeq(G__66732__a,0,null);
} 
return G__66713__delegate.call(this,state,content_fn,modal_content_fn,p__65644);};
G__66713.cljs$lang$maxFixedArity = 3;
G__66713.cljs$lang$applyTo = (function (arglist__66733){
var state = cljs.core.first(arglist__66733);
arglist__66733 = cljs.core.next(arglist__66733);
var content_fn = cljs.core.first(arglist__66733);
arglist__66733 = cljs.core.next(arglist__66733);
var modal_content_fn = cljs.core.first(arglist__66733);
var p__65644 = cljs.core.rest(arglist__66733);
return G__66713__delegate(state,content_fn,modal_content_fn,p__65644);
});
...
var attrs65654 = options;
return daiquiri.core.create_element("a",((cljs.core.map_QMARK_(attrs65654))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, ["block","px-4","py-2","text-sm","transition","ease-in-out","duration-150","cursor","menu-link"], null)], null),attrs65654], 0))):{'className':"block px-4 py-2 text-sm transition ease-in-out duration-150 cursor menu-link"}),((cljs.core.map_QMARK_(attrs65654))?[daiquiri.interpreter.interpret(child)]:[daiquiri.interpreter.interpret(attrs65654),daiquiri.interpreter.interpret(child)]));
}),null,"frontend.ui/menu-link");
frontend.ui.dropdown_with_links = rum.core.lazy_build(rum.core.build_defc,(function (content_fn,links,p__65655){
var map__65656 = p__65655;
var map__65656__$1 = cljs.core.__destructure_map(map__65656);
var opts = map__65656__$1;
var links_header = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65656__$1,new cljs.core.Keyword(null,"links-header","links-header",-1729119536));
var links_footer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65656__$1,new cljs.core.Keyword(null,"links-footer","links-footer",1890937614));
return frontend.ui.dropdown(content_fn,(function (p__65665){
var map__65666 = p__65665;
var map__65666__$1 = cljs.core.__destructure_map(map__65666);
var close_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65666__$1,new cljs.core.Keyword(null,"close-fn","close-fn",-1779772512));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.py-1.rounded-md.shadow-xs","div.py-1.rounded-md.shadow-xs",1383490521),(cljs.core.truth_(links_header)?links_header:null),(function (){var iter__4652__auto__ = (function frontend$ui$iter__65667(s__65668){
return (new cljs.core.LazySeq(null,(function (){
var s__65668__$1 = s__65668;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__65668__$1);
if(temp__5720__auto__){
var s__65668__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65668__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__65668__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__65670 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__65669 = (0);
while(true){
if((i__65669 < size__4651__auto__)){
var map__65671 = cljs.core._nth(c__4650__auto__,i__65669);
var map__65671__$1 = cljs.core.__destructure_map(map__65671);
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65671__$1,new cljs.core.Keyword(null,"options","options",99638489));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65671__$1,new cljs.core.Keyword(null,"title","title",636505583));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65671__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65671__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var hover_detail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65671__$1,new cljs.core.Keyword(null,"hover-detail","hover-detail",-1668874248));
cljs.core.chunk_append(b__65670,(function (){var new_options = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([options,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),hover_detail,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__65669,map__65671,map__65671__$1,options,title,icon,hr,hover_detail,c__4650__auto__,size__4651__auto__,b__65670,s__65668__$2,temp__5720__auto__,map__65666,map__65666__$1,close_fn,map__65656,map__65656__$1,opts,links_header,links_footer){
return (function (e){
var temp__5720__auto___66743__$1 = new cljs.core.Keyword(null,"on-click","on-click",1632826543).cljs$core$IFn$_invoke$arity$1(options);
if(cljs.core.truth_(temp__5720__auto___66743__$1)){
var on_click_fn_66744 = temp__5720__auto___66743__$1;
(on_click_fn_66744.cljs$core$IFn$_invoke$arity$1 ? on_click_fn_66744.cljs$core$IFn$_invoke$arity$1(e) : on_click_fn_66744.call(null,e));
} else {
}

return (close_fn.cljs$core$IFn$_invoke$arity$0 ? close_fn.cljs$core$IFn$_invoke$arity$0() : close_fn.call(null));
});})(i__65669,map__65671,map__65671__$1,options,title,icon,hr,hover_detail,c__4650__auto__,size__4651__auto__,b__65670,s__65668__$2,temp__5720__auto__,map__65666,map__65666__$1,close_fn,map__65656,map__65656__$1,opts,links_header,links_footer))
], null)], 0));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65670),frontend$ui$iter__65667(cljs.core.chunk_rest(s__65668__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65670),null);
}
} else {
var map__65672 = cljs.core.first(s__65668__$2);
var map__65672__$1 = cljs.core.__destructure_map(map__65672);
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65672__$1,new cljs.core.Keyword(null,"options","options",99638489));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65672__$1,new cljs.core.Keyword(null,"title","title",636505583));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65672__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65672__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var hover_detail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65672__$1,new cljs.core.Keyword(null,"hover-detail","hover-detail",-1668874248));
return cljs.core.cons((function (){var new_options = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([options,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),hover_detail,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__65672,map__65672__$1,options,title,icon,hr,hover_detail,s__65668__$2,temp__5720__auto__,map__65666,map__65666__$1,close_fn,map__65656,map__65656__$1,opts,links_header,links_footer){
return (function (e){
var temp__5720__auto___66801__$1 = new cljs.core.Keyword(null,"on-click","on-click",1632826543).cljs$core$IFn$_invoke$arity$1(options);
if(cljs.core.truth_(temp__5720__auto___66801__$1)){
var on_click_fn_66803 = temp__5720__auto___66801__$1;
(on_click_fn_66803.cljs$core$IFn$_invoke$arity$1 ? on_click_fn_66803.cljs$core$IFn$_invoke$arity$1(e) : on_click_fn_66803.call(null,e));
} else {
}

return (close_fn.cljs$core$IFn$_invoke$arity$0 ? close_fn.cljs$core$IFn$_invoke$arity$0() : close_fn.call(null));
});})(map__65672,map__65672__$1,options,title,icon,hr,hover_detail,s__65668__$2,temp__5720__auto__,map__65666,map__65666__$1,close_fn,map__65656,map__65656__$1,opts,links_header,links_footer))
], null)], 0));
var child = (cljs.core.truth_(hr)?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.items-center","div.flex.items-center",-1537844053),(cljs.core.truth_(icon)?icon:null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"8px"], null)], null),title], null)], null));
if(cljs.core.truth_(hr)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"hr.my-1","hr.my-1",-305187328),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),"dropdown-hr"], null)], null);
...
})(),frontend$ui$iter__65667(cljs.core.rest(s__65668__$2)));
}
} else {
return null;
}
...
var len__4864__auto___66811 = arguments.length;
var i__4865__auto___66812 = (0);
while(true){
if((i__4865__auto___66812 < len__4864__auto___66811)){
args__4870__auto__.push((arguments[i__4865__auto___66812]));

var G__66815 = (i__4865__auto___66812 + (1));
i__4865__auto___66812 = G__66815;
continue;
} else {
}
break;
...
(frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic = (function (text,p__65675){
var map__65676 = p__65675;
var map__65676__$1 = cljs.core.__destructure_map(map__65676);
var option = map__65676__$1;
var background = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65676__$1,new cljs.core.Keyword(null,"background","background",-863952629));
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65676__$1,new cljs.core.Keyword(null,"href","href",-793805698));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65676__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var intent = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65676__$1,new cljs.core.Keyword(null,"intent","intent",-390846953));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65676__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var small_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65676__$1,new cljs.core.Keyword(null,"small?","small?",95242445),false);
var large_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65676__$1,new cljs.core.Keyword(null,"large?","large?",1460879088),false);
...
/** @this {Function} */
(frontend.ui.button.cljs$lang$applyTo = (function (seq65673){
var G__65674 = cljs.core.first(seq65673);
var seq65673__$1 = cljs.core.next(seq65673);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65674,seq65673__$1);
}));
...
var vec__65677 = (function (){var G__65680 = status;
var G__65680__$1 = (((G__65680 instanceof cljs.core.Keyword))?G__65680.fqn:null);
switch (G__65680__$1) {
case "success":
...
var color_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65677,(0),null);
var svg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65677,(1),null);
return daiquiri.core.create_element("div",{'style':daiquiri.interpreter.element_attributes(((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,"exiting")) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,"exited"))))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"z-index","z-index",1892827090),(-1)], null):null)),'className':"ui__notifications-content"},[daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, ["max-w-sm","w-full","shadow-lg","rounded-lg","pointer-events-auto","notification-area",(function (){var G__65681 = state;
switch (G__65681) {
case "entering":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65681)].join('')));

}
})()], null))},[daiquiri.core.create_element("div",{'style':{'maxHeight':"calc(100vh - 200px)",'overflowY':"scroll",'overflowX':"hidden"},'className':"rounded-lg shadow-xs"},[daiquiri.core.create_element("div",{'className':"p-4"},[daiquiri.core.create_element("div",{'className':"flex items-start"},[(function (){var attrs65682 = svg;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs65682))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex-shrink-0"], null)], null),attrs65682], 0))):{'className':"flex-shrink-0"}),((cljs.core.map_QMARK_(attrs65682))?null:[daiquiri.interpreter.interpret(attrs65682)]));
...
return daiquiri.interpreter.interpret((function (){var G__65741 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class-name","class-name",945142584),"notifications ui__notifications"], null);
var G__65742 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
var k = cljs.core.first(el);
var v = cljs.core.second(el);
var G__65743 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"timeout","timeout",-318625318),(100),new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(k)], null);
var G__65744 = (function (state){
...
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__65743,G__65744) : frontend.ui.css_transition.call(null,G__65743,G__65744));
}),contents));
return (frontend.ui.transition_group.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.transition_group.cljs$core$IFn$_invoke$arity$2(G__65741,G__65742) : frontend.ui.transition_group.call(null,G__65741,G__65742));
})());
...
if(cljs.core.truth_(frontend.util.electron_QMARK_())){
window.apis.on("full-screen",(function (p1__65750_SHARP_){
return cljs.core.js_invoke.cljs$core$IFn$_invoke$arity$variadic(cl,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__65750_SHARP_,"enter"))?"add":"remove"),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["is-fullscreen"], 0));
}));

return promesa.core.then.cljs$core$IFn$_invoke$arity$2(electron.ipc.ipc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"getAppBaseInfo","getAppBaseInfo",-1406218507)], 0)),(function (p1__65751_SHARP_){
var map__65754 = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__65751_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
var map__65754__$1 = cljs.core.__destructure_map(map__65754);
var isFullScreen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65754__$1,new cljs.core.Keyword(null,"isFullScreen","isFullScreen",-1879720011));
...
var temp__5720__auto___66897 = (function (){var and__4251__auto__ = (function (){var or__4253__auto__ = (function (){var and__4251__auto__ = frontend.util.mobile_QMARK_();
if(cljs.core.truth_(and__4251__auto__)){
...
if(cljs.core.truth_(temp__5720__auto___66897)){
var vp_66899 = temp__5720__auto___66897;
var raf_pending_QMARK__66900 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(false);
var set_raf_pending_BANG__66901 = (function (p1__65757_SHARP_){
return cljs.core.reset_BANG_(raf_pending_QMARK__66900,p1__65757_SHARP_);
});
var on_viewport_changed_66902 = (function (){
var update_vw_state = goog.functions.debounce((function (){
frontend.state.set_visual_viewport_state(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"height","height",1025178622),vp_66899.height,new cljs.core.Keyword(null,"page-top","page-top",68258296),vp_66899.pageTop,new cljs.core.Keyword(null,"offset-top","offset-top",91937233),vp_66899.offsetTop], null));
...
if(cljs.core.truth_(cljs.core.deref(raf_pending_QMARK__66900))){
return null;
} else {
var f = (function (){
set_raf_pending_BANG__66901(false);
...
set_raf_pending_BANG__66901(true);
...
vp_66899.addEventListener("resize",on_viewport_changed_66902);

vp_66899.addEventListener("scroll",on_viewport_changed_66902);
...
var handler_66908 = (cljs.core.truth_(down_QMARK_)?cljs.core.conj:cljs.core.disj);
var keystroke_66909 = e.key;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(active_keystroke,handler_66908,keystroke_66909);
...
frontend.ui.on_scroll = (function frontend$ui$on_scroll(node,p__65783){
var map__65786 = p__65783;
var map__65786__$1 = cljs.core.__destructure_map(map__65786);
var on_load = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65786__$1,new cljs.core.Keyword(null,"on-load","on-load",1415151594));
var on_top_reached = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65786__$1,new cljs.core.Keyword(null,"on-top-reached","on-top-reached",1295153037));
var threshold = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65786__$1,new cljs.core.Keyword(null,"threshold","threshold",204221583),(500));
var bottom_reached = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65786__$1,new cljs.core.Keyword(null,"bottom-reached","bottom-reached",-2132308834));
var scroll_top = frontend.ui.goog$module$goog$object.get(node,"scrollTop");
 ...
 */
frontend.ui.infinite_list = rum.core.lazy_build(rum.core.build_defcs,(function (state,_list_element_id,body,p__65834){
var map__65836 = p__65834;
var map__65836__$1 = cljs.core.__destructure_map(map__65836);
var on_load = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65836__$1,new cljs.core.Keyword(null,"on-load","on-load",1415151594));
var has_more = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65836__$1,new cljs.core.Keyword(null,"has-more","has-more",-320006781));
var more = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65836__$1,new cljs.core.Keyword(null,"more","more",-2058821800));
var more_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65836__$1,new cljs.core.Keyword(null,"more-class","more-class",-869337192),"text-sm");
var attrs65816 = body;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs65816))?daiquiri.interpreter.element_attributes(attrs65816):null),((cljs.core.map_QMARK_(attrs65816))?[(cljs.core.truth_(has_more)?daiquiri.core.create_element("div",{'className':"w-full p-4"},[daiquiri.core.create_element("a",{'onClick':on_load,'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["fade-link","text-link","font-bold",more_class], null))},[daiquiri.interpreter.interpret((function (){var or__4253__auto__ = more;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
})())])]):null)]:[daiquiri.interpreter.interpret(attrs65816),(cljs.core.truth_(has_more)?daiquiri.core.create_element("div",{'className':"w-full p-4"},[daiquiri.core.create_element("a",{'onClick':on_load,'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["fade-link","text-link","font-bold",more_class], null))},[daiquiri.interpreter.interpret((function (){var or__4253__auto__ = more;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("page","earlier","page/earlier",-61115488)], 0));
...
frontend.ui.auto_complete = rum.core.lazy_build(rum.core.build_defcs,(function (state,matched,p__65867){
var map__65868 = p__65867;
var map__65868__$1 = cljs.core.__destructure_map(map__65868);
var on_chosen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65868__$1,new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900));
var on_shift_chosen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65868__$1,new cljs.core.Keyword(null,"on-shift-chosen","on-shift-chosen",-310778328));
var get_group_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65868__$1,new cljs.core.Keyword(null,"get-group-name","get-group-name",-160379696));
var empty_placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65868__$1,new cljs.core.Keyword(null,"empty-placeholder","empty-placeholder",-68202085));
var item_render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65868__$1,new cljs.core.Keyword(null,"item-render","item-render",253627868));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65868__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
});})(i__65874,chosen_QMARK_,vec__65877,idx,item,c__4650__auto__,size__4651__auto__,b__65875,s__65873__$2,temp__5720__auto__,current_idx,map__65868,map__65868__$1,on_chosen,on_shift_chosen,get_group_name,empty_placeholder,item_render,class$))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65875),frontend$ui$iter__65872(cljs.core.chunk_rest(s__65873__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65875),null);
}
} else {
var vec__65884 = cljs.core.first(s__65873__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65884,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65884,(1),null);
return cljs.core.cons(daiquiri.core.create_element(daiquiri.core.fragment,{'key':idx},[(function (){var item_cp = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null),(function (){var chosen_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(current_idx),idx);
return frontend.ui.menu_link(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),["ac-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),((chosen_QMARK_)?"chosen":null),new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),((function (chosen_QMARK_,vec__65884,idx,item,s__65873__$2,temp__5720__auto__,current_idx,map__65868,map__65868__$1,on_chosen,on_shift_chosen,get_group_name,empty_placeholder,item_render,class$){
return (function (e){
frontend.util.stop(e);
...
});})(chosen_QMARK_,vec__65884,idx,item,s__65873__$2,temp__5720__auto__,current_idx,map__65868,map__65868__$1,on_chosen,on_shift_chosen,get_group_name,empty_placeholder,item_render,class$))
], null),(cljs.core.truth_(item_render)?(item_render.cljs$core$IFn$_invoke$arity$2 ? item_render.cljs$core$IFn$_invoke$arity$2(item,chosen_QMARK_) : item_render.call(null,item,chosen_QMARK_)):item));
})()], null);
if(cljs.core.truth_(get_group_name)){
return daiquiri.interpreter.interpret((function (){var temp__5718__auto__ = (get_group_name.cljs$core$IFn$_invoke$arity$1 ? get_group_name.cljs$core$IFn$_invoke$arity$1(item) : get_group_name.call(null,item));
...
})()]),frontend$ui$iter__65872(cljs.core.rest(s__65873__$2)));
}
} else {
return null;
}
...
return daiquiri.core.create_element("div",{'onClick':close_fn,'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui__modal-overlay",(function (){var G__65910 = state;
switch (G__65910) {
case "entering":
...
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui__modal-panel","transform","transition-all","sm:min-w-lg","sm",(function (){var G__65926 = transition_state;
switch (G__65926) {
case "entering":
...
return daiquiri.core.create_element("div",{'style':{'zIndex':(cljs.core.truth_(show_QMARK_)?(999):(-1))},'label':label,'className':"ui__modal"},[daiquiri.interpreter.interpret((function (){var G__65962 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__65963 = (function (state){
return frontend.ui.modal_overlay(state,close_fn);
});
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__65962,G__65963) : frontend.ui.css_transition.call(null,G__65962,G__65963));
})()),daiquiri.interpreter.interpret((function (){var G__65967 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__65968 = (function (state){
return frontend.ui.modal_panel(show_QMARK_,modal_panel_content__$1,state,close_fn,fullscreen_QMARK_,close_btn_QMARK_);
});
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__65967,G__65968) : frontend.ui.css_transition.call(null,G__65967,G__65968));
})())]);
...
var G__65969 = rum.core.dom_node(state).querySelector("button.ui__modal-close");
if((G__65969 == null)){
return null;
} else {
return G__65969.click();
}
...
var G__65970 = rum.core.dom_node(state__$1).querySelector("button.ui__modal-enter");
if((G__65970 == null)){
return null;
} else {
return G__65970.click();
}
})], null));
}))], null),"frontend.ui/modal");
frontend.ui.make_confirm_modal = (function frontend$ui$make_confirm_modal(p__65972){
var map__65973 = p__65972;
var map__65973__$1 = cljs.core.__destructure_map(map__65973);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65973__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65973__$1,new cljs.core.Keyword(null,"title","title",636505583));
var sub_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65973__$1,new cljs.core.Keyword(null,"sub-title","sub-title",-1781490288));
var sub_checkbox_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65973__$1,new cljs.core.Keyword(null,"sub-checkbox?","sub-checkbox?",-671905753));
var on_cancel = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65973__$1,new cljs.core.Keyword(null,"on-cancel","on-cancel",-2071892932),(function (){
return cljs.core.List.EMPTY;
}));
var on_confirm = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65973__$1,new cljs.core.Keyword(null,"on-confirm","on-confirm",1527003038));
...
return (on_confirm.cljs$core$IFn$_invoke$arity$2 ? on_confirm.cljs$core$IFn$_invoke$arity$2(G__65974,G__65975) : on_confirm.call(null,G__65974,G__65975));
} else {
return and__4251__auto__;
}
...
var iter__4652__auto__ = (function frontend$ui$iter__65994(s__65995){
return (new cljs.core.LazySeq(null,(function (){
var s__65995__$1 = s__65995;
while(true){
var temp__5720__auto____$1 = cljs.core.seq(s__65995__$1);
if(temp__5720__auto____$1){
var s__65995__$2 = temp__5720__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__65995__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__65995__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__65997 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__65996 = (0);
while(true){
if((i__65996 < size__4651__auto__)){
var vec__65998 = cljs.core._nth(c__4650__auto__,i__65996);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65998,(0),null);
var modal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65998,(1),null);
cljs.core.chunk_append(b__65997,(function (){var id = new cljs.core.Keyword("modal","id","modal/id",-1274892409).cljs$core$IFn$_invoke$arity$1(modal);
...
var close_fn = ((function (i__65996,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,vec__65998,idx,modal,c__4650__auto__,size__4651__auto__,b__65997,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (){
return frontend.state.close_sub_modal_BANG_.cljs$core$IFn$_invoke$arity$1(id);
});})(i__65996,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,vec__65998,idx,modal,c__4650__auto__,size__4651__auto__,b__65997,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
var modal_panel_content__$1 = (function (){var or__4253__auto__ = modal_panel_content;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return ((function (i__65996,or__4253__auto__,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,vec__65998,idx,modal,c__4650__auto__,size__4651__auto__,b__65997,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (_close){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null);
});
;})(i__65996,or__4253__auto__,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,vec__65998,idx,modal,c__4650__auto__,size__4651__auto__,b__65997,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
}
})();
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.ui__modal.is-sub-modal","div.ui__modal.is-sub-modal",1533892698),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"z-index","z-index",1892827090),(cljs.core.truth_(show_QMARK_)?((999) + idx):(-1))], null),new cljs.core.Keyword(null,"label","label",1718410804),label], null),(function (){var G__66001 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__66002 = ((function (i__65996,G__66001,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__65998,idx,modal,c__4650__auto__,size__4651__auto__,b__65997,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (state){
return frontend.ui.modal_overlay(state,close_fn);
});})(i__65996,G__66001,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__65998,idx,modal,c__4650__auto__,size__4651__auto__,b__65997,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__66001,G__66002) : frontend.ui.css_transition.call(null,G__66001,G__66002));
})(),(function (){var G__66003 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__66004 = ((function (i__65996,G__66003,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__65998,idx,modal,c__4650__auto__,size__4651__auto__,b__65997,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (state){
return frontend.ui.modal_panel(show_QMARK_,modal_panel_content__$1,state,close_fn,false,close_btn_QMARK_);
});})(i__65996,G__66003,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__65998,idx,modal,c__4650__auto__,size__4651__auto__,b__65997,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__66003,G__66004) : frontend.ui.css_transition.call(null,G__66003,G__66004));
})()], null);
})());

var G__67001 = (i__65996 + (1));
i__65996 = G__67001;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65997),frontend$ui$iter__65994(cljs.core.chunk_rest(s__65995__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65997),null);
}
} else {
var vec__66005 = cljs.core.first(s__65995__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66005,(0),null);
var modal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66005,(1),null);
...
var show_QMARK_ = new cljs.core.Keyword("modal","show?","modal/show?",1441869594).cljs$core$IFn$_invoke$arity$1(modal);
var label = new cljs.core.Keyword("modal","label","modal/label",-1776753955).cljs$core$IFn$_invoke$arity$1(modal);
var close_fn = ((function (id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,vec__66005,idx,modal,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (){
return frontend.state.close_sub_modal_BANG_.cljs$core$IFn$_invoke$arity$1(id);
});})(id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,vec__66005,idx,modal,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
var modal_panel_content__$1 = (function (){var or__4253__auto__ = modal_panel_content;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return ((function (or__4253__auto__,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,vec__66005,idx,modal,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (_close){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null);
});
;})(or__4253__auto__,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,vec__66005,idx,modal,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
}
})();
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.ui__modal.is-sub-modal","div.ui__modal.is-sub-modal",1533892698),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"z-index","z-index",1892827090),(cljs.core.truth_(show_QMARK_)?((999) + idx):(-1))], null),new cljs.core.Keyword(null,"label","label",1718410804),label], null),(function (){var G__66008 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__66009 = ((function (G__66008,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__66005,idx,modal,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (state){
return frontend.ui.modal_overlay(state,close_fn);
});})(G__66008,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__66005,idx,modal,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__66008,G__66009) : frontend.ui.css_transition.call(null,G__66008,G__66009));
})(),(function (){var G__66010 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),show_QMARK_,new cljs.core.Keyword(null,"timeout","timeout",-318625318),(0)], null);
var G__66011 = ((function (G__66010,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__66005,idx,modal,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__){
return (function (state){
return frontend.ui.modal_panel(show_QMARK_,modal_panel_content__$1,state,close_fn,false,close_btn_QMARK_);
});})(G__66010,id,modal_panel_content,close_btn_QMARK_,show_QMARK_,label,close_fn,modal_panel_content__$1,vec__66005,idx,modal,s__65995__$2,temp__5720__auto____$1,modals,temp__5720__auto__))
;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__66010,G__66011) : frontend.ui.css_transition.call(null,G__66010,G__66011));
})()], null);
})(),frontend$ui$iter__65994(cljs.core.rest(s__65995__$2)));
}
} else {
return null;
}
...
frontend.ui.foldable = rum.core.lazy_build(rum.core.build_defcs,(function (state,header,content,p__66016){
var map__66017 = p__66016;
var map__66017__$1 = cljs.core.__destructure_map(map__66017);
var title_trigger_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66017__$1,new cljs.core.Keyword(null,"title-trigger?","title-trigger?",-613599873));
...
return daiquiri.core.create_element("div",{'className':"flex flex-col"},[daiquiri.core.create_element("div",{'className':"content"},[(function (){var attrs66021 = (function (){var G__66052 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-over","on-mouse-over",-858472552),(function (){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__66052,new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),on_mouse_down,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"class","class",-2030961996),"cursor"], 0));
} else {
return G__66052;
}
})();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs66021))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex-1","flex-row","foldable-title"], null)], null),attrs66021], 0))):{'className':"flex-1 flex-row foldable-title"}),((cljs.core.map_QMARK_(attrs66021))?[(function (){var attrs66042 = (cljs.core.truth_(frontend.mobile.util.is_native_platform_QMARK_())?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.block-control.opacity-50.hover:opacity-100.mr-2","a.block-control.opacity-50.hover:opacity-100.mr-2",-1668360838),(function (){var G__66054 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"width","width",-384071477),(14),new cljs.core.Keyword(null,"height","height",1025178622),(16),new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),(-30)], null)], null);
if(cljs.core.not(title_trigger_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66054,new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),on_mouse_down);
} else {
return G__66054;
}
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs66042))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","items-center"], null)], null),attrs66042], 0))):{'className':"flex flex-row items-center"}),((cljs.core.map_QMARK_(attrs66042))?[((cljs.core.fn_QMARK_(header))?daiquiri.interpreter.interpret((function (){var G__66065 = cljs.core.deref(collapsed_QMARK_);
return (header.cljs$core$IFn$_invoke$arity$1 ? header.cljs$core$IFn$_invoke$arity$1(G__66065) : header.call(null,G__66065));
})()):daiquiri.interpreter.interpret(header))]:[daiquiri.interpreter.interpret(attrs66042),((cljs.core.fn_QMARK_(header))?daiquiri.interpreter.interpret((function (){var G__66069 = cljs.core.deref(collapsed_QMARK_);
return (header.cljs$core$IFn$_invoke$arity$1 ? header.cljs$core$IFn$_invoke$arity$1(G__66069) : header.call(null,G__66069));
})()):daiquiri.interpreter.interpret(header))]));
})()]:[daiquiri.interpreter.interpret(attrs66021),(function (){var attrs66051 = (cljs.core.truth_(frontend.mobile.util.is_native_platform_QMARK_())?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.block-control.opacity-50.hover:opacity-100.mr-2","a.block-control.opacity-50.hover:opacity-100.mr-2",-1668360838),(function (){var G__66070 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"width","width",-384071477),(14),new cljs.core.Keyword(null,"height","height",1025178622),(16),new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),(-30)], null)], null);
if(cljs.core.not(title_trigger_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66070,new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),on_mouse_down);
} else {
return G__66070;
}
})(),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_((function (){var or__4253__auto__ = cljs.core.deref(control_QMARK_);
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs66051))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","items-center"], null)], null),attrs66051], 0))):{'className':"flex flex-row items-center"}),((cljs.core.map_QMARK_(attrs66051))?[((cljs.core.fn_QMARK_(header))?daiquiri.interpreter.interpret((function (){var G__66072 = cljs.core.deref(collapsed_QMARK_);
return (header.cljs$core$IFn$_invoke$arity$1 ? header.cljs$core$IFn$_invoke$arity$1(G__66072) : header.call(null,G__66072));
})()):daiquiri.interpreter.interpret(header))]:[daiquiri.interpreter.interpret(attrs66051),((cljs.core.fn_QMARK_(header))?daiquiri.interpreter.interpret((function (){var G__66074 = cljs.core.deref(collapsed_QMARK_);
return (header.cljs$core$IFn$_invoke$arity$1 ? header.cljs$core$IFn$_invoke$arity$1(G__66074) : header.call(null,G__66074));
})()):daiquiri.interpreter.interpret(header))]));
})()]));
...
var args_67100 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
if(new cljs.core.Keyword(null,"default-collapsed?","default-collapsed?",-1350393823).cljs$core$IFn$_invoke$arity$1(cljs.core.last(args_67100)) === true){
...
var temp__5720__auto__ = (function (){var G__66082 = clojure.string.lower_case(type__$1);
switch (G__66082) {
case "note":
...
frontend.ui.catch_error = rum.core.lazy_build(rum.core.build_defcs,(function (p__66083,error_view,view){
var map__66084 = p__66083;
var map__66084__$1 = cljs.core.__destructure_map(map__66084);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66084__$1,new cljs.core.Keyword("frontend.ui","error","frontend.ui/error",-2009366008));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66084__$1,new cljs.core.Keyword("rum","react-component","rum/react-component",-1879897248));
if((!((error == null)))){
...
frontend.ui.catch_error_and_notify = rum.core.lazy_build(rum.core.build_defcs,(function (p__66092,error_view,view){
var map__66094 = p__66092;
var map__66094__$1 = cljs.core.__destructure_map(map__66094);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66094__$1,new cljs.core.Keyword("frontend.ui","error","frontend.ui/error",-2009366008));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66094__$1,new cljs.core.Keyword("rum","react-component","rum/react-component",-1879897248));
if((!((error == null)))){
return daiquiri.interpreter.interpret(error_view);
} else {
return daiquiri.interpreter.interpret(view);
 ...
 */
frontend.ui.block_error = rum.core.lazy_build(rum.core.build_defc,(function (title,p__66122){
var map__66123 = p__66122;
var map__66123__$1 = cljs.core.__destructure_map(map__66123);
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66123__$1,new cljs.core.Keyword(null,"content","content",15833224));
var section_attrs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66123__$1,new cljs.core.Keyword(null,"section-attrs","section-attrs",1373816150));
var attrs66119 = section_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs66119))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["border","mt-1","p-1","cursor-pointer","block-content-fallback-ui"], null)], null),attrs66119], 0))):{'className':"border mt-1 p-1 cursor-pointer block-content-fallback-ui"}),((cljs.core.map_QMARK_(attrs66119))?[daiquiri.core.create_element("div",{'className':"flex justify-between items-center px-1"},[(function (){var attrs66126 = title;
return daiquiri.core.create_element("h5",((cljs.core.map_QMARK_(attrs66126))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-red-600","pb-1"], null)], null),attrs66126], 0))):{'className':"text-red-600 pb-1"}),((cljs.core.map_QMARK_(attrs66126))?null:[daiquiri.interpreter.interpret(attrs66126)]));
})(),daiquiri.core.create_element("a",{'href':"https://github.com/logseq/logseq/issues/new?labels=from:in-app&template=bug_report.yaml",'target':"_blank",'className':"text-xs opacity-50 hover:opacity-80"},["report issue"])]),(cljs.core.truth_(content)?(function (){var attrs66120 = content;
return daiquiri.core.create_element("pre",((cljs.core.map_QMARK_(attrs66120))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["m-0","text-sm"], null)], null),attrs66120], 0))):{'className':"m-0 text-sm"}),((cljs.core.map_QMARK_(attrs66120))?null:[daiquiri.interpreter.interpret(attrs66120)]));
})():null)]:[daiquiri.interpreter.interpret(attrs66119),daiquiri.core.create_element("div",{'className':"flex justify-between items-center px-1"},[(function (){var attrs66137 = title;
return daiquiri.core.create_element("h5",((cljs.core.map_QMARK_(attrs66137))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-red-600","pb-1"], null)], null),attrs66137], 0))):{'className':"text-red-600 pb-1"}),((cljs.core.map_QMARK_(attrs66137))?null:[daiquiri.interpreter.interpret(attrs66137)]));
})(),daiquiri.core.create_element("a",{'href':"https://github.com/logseq/logseq/issues/new?labels=from:in-app&template=bug_report.yaml",'target':"_blank",'className':"text-xs opacity-50 hover:opacity-80"},["report issue"])]),(cljs.core.truth_(content)?(function (){var attrs66121 = content;
return daiquiri.core.create_element("pre",((cljs.core.map_QMARK_(attrs66121))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["m-0","text-sm"], null)], null),attrs66121], 0))):{'className':"m-0 text-sm"}),((cljs.core.map_QMARK_(attrs66121))?null:[daiquiri.interpreter.interpret(attrs66121)]));
})():null)]));
...
})()], null))},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function frontend$ui$iter__66154(s__66155){
return (new cljs.core.LazySeq(null,(function (){
var s__66155__$1 = s__66155;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__66155__$1);
if(temp__5720__auto__){
var s__66155__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__66155__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__66155__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__66157 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__66156 = (0);
while(true){
if((i__66156 < size__4651__auto__)){
var map__66162 = cljs.core._nth(c__4650__auto__,i__66156);
var map__66162__$1 = cljs.core.__destructure_map(map__66162);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66162__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66162__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66162__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
cljs.core.chunk_append(b__66157,(function (){var attrs66153 = (function (){var G__66167 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),label,new cljs.core.Keyword(null,"default-value","default-value",232220170),(function (){var or__4253__auto__ = value;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return label;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66167,new cljs.core.Keyword(null,"selected","selected",574897764),selected);
} else {
return G__66167;
}
})();
return daiquiri.core.create_element("option",((cljs.core.map_QMARK_(attrs66153))?daiquiri.interpreter.element_attributes(attrs66153):null),((cljs.core.map_QMARK_(attrs66153))?[daiquiri.interpreter.interpret(label)]:[daiquiri.interpreter.interpret(attrs66153),daiquiri.interpreter.interpret(label)]));
})());

var G__67270 = (i__66156 + (1));
i__66156 = G__67270;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__66157),frontend$ui$iter__66154(cljs.core.chunk_rest(s__66155__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__66157),null);
}
} else {
var map__66169 = cljs.core.first(s__66155__$2);
var map__66169__$1 = cljs.core.__destructure_map(map__66169);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66169__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66169__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66169__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
return cljs.core.cons((function (){var attrs66153 = (function (){var G__66170 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),label,new cljs.core.Keyword(null,"default-value","default-value",232220170),(function (){var or__4253__auto__ = value;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return label;
...
if(cljs.core.truth_(selected)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66170,new cljs.core.Keyword(null,"selected","selected",574897764),selected);
} else {
return G__66170;
}
})();
return daiquiri.core.create_element("option",((cljs.core.map_QMARK_(attrs66153))?daiquiri.interpreter.element_attributes(attrs66153):null),((cljs.core.map_QMARK_(attrs66153))?[daiquiri.interpreter.interpret(label)]:[daiquiri.interpreter.interpret(attrs66153),daiquiri.interpreter.interpret(label)]));
})(),frontend$ui$iter__66154(cljs.core.rest(s__66155__$2)));
}
} else {
return null;
}
...
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui__radio-list",class$], null))},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function frontend$ui$iter__66172(s__66173){
return (new cljs.core.LazySeq(null,(function (){
var s__66173__$1 = s__66173;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__66173__$1);
if(temp__5720__auto__){
var s__66173__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__66173__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__66173__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__66175 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__66174 = (0);
while(true){
if((i__66174 < size__4651__auto__)){
var map__66177 = cljs.core._nth(c__4650__auto__,i__66174);
var map__66177__$1 = cljs.core.__destructure_map(map__66177);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66177__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66177__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66177__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
cljs.core.chunk_append(b__66175,daiquiri.core.create_element("label",{'key':["radio-list-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(label)].join('')},[daiquiri.core.create_element("input",{'value':value,'type':"radio",'onChange':rum.core.mark_sync_update(((function (i__66174,map__66177,map__66177__$1,label,value,selected,c__4650__auto__,size__4651__auto__,b__66175,s__66173__$2,temp__5720__auto__){
return (function (p1__66171_SHARP_){
var G__66178 = frontend.util.evalue(p1__66171_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__66178) : on_change.call(null,G__66178));
});})(i__66174,map__66177,map__66177__$1,label,value,selected,c__4650__auto__,size__4651__auto__,b__66175,s__66173__$2,temp__5720__auto__))
),'checked':selected,'className':"form-radio"},[]),daiquiri.interpreter.interpret(label)]));

var G__67302 = (i__66174 + (1));
i__66174 = G__67302;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__66175),frontend$ui$iter__66172(cljs.core.chunk_rest(s__66173__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__66175),null);
}
} else {
var map__66183 = cljs.core.first(s__66173__$2);
var map__66183__$1 = cljs.core.__destructure_map(map__66183);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66183__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66183__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66183__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
return cljs.core.cons(daiquiri.core.create_element("label",{'key':["radio-list-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(label)].join('')},[daiquiri.core.create_element("input",{'value':value,'type':"radio",'onChange':rum.core.mark_sync_update(((function (map__66183,map__66183__$1,label,value,selected,s__66173__$2,temp__5720__auto__){
return (function (p1__66171_SHARP_){
var G__66184 = frontend.util.evalue(p1__66171_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__66184) : on_change.call(null,G__66184));
});})(map__66183,map__66183__$1,label,value,selected,s__66173__$2,temp__5720__auto__))
),'checked':selected,'className':"form-radio"},[]),daiquiri.interpreter.interpret(label)]),frontend$ui$iter__66172(cljs.core.rest(s__66173__$2)));
}
} else {
return null;
}
...
var G__66214 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(cljs.core.truth_(checked_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(checked_vals,value):cljs.core.disj.cljs$core$IFn$_invoke$arity$2(checked_vals,value)));
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__66214) : on_change.call(null,G__66214));
});
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui__checkbox-list",class$], null))},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function frontend$ui$iter__66243(s__66244){
return (new cljs.core.LazySeq(null,(function (){
var s__66244__$1 = s__66244;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__66244__$1);
if(temp__5720__auto__){
var s__66244__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__66244__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__66244__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__66246 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__66245 = (0);
while(true){
if((i__66245 < size__4651__auto__)){
var map__66260 = cljs.core._nth(c__4650__auto__,i__66245);
var map__66260__$1 = cljs.core.__destructure_map(map__66260);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66260__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66260__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66260__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
cljs.core.chunk_append(b__66246,daiquiri.core.create_element("label",{'key':["check-list-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(label)].join('')},[daiquiri.core.create_element("input",{'value':value,'type':"checkbox",'onChange':rum.core.mark_sync_update(on_item_change),'checked':selected,'className':"form-checkbox"},[]),daiquiri.interpreter.interpret(label)]));

var G__67310 = (i__66245 + (1));
i__66245 = G__67310;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__66246),frontend$ui$iter__66243(cljs.core.chunk_rest(s__66244__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__66246),null);
}
} else {
var map__66275 = cljs.core.first(s__66244__$2);
var map__66275__$1 = cljs.core.__destructure_map(map__66275);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66275__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66275__$1,new cljs.core.Keyword(null,"value","value",305978217));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66275__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
return cljs.core.cons(daiquiri.core.create_element("label",{'key':["check-list-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(label)].join('')},[daiquiri.core.create_element("input",{'value':value,'type':"checkbox",'onChange':rum.core.mark_sync_update(on_item_change),'checked':selected,'className':"form-checkbox"},[]),daiquiri.interpreter.interpret(label)]),frontend$ui$iter__66243(cljs.core.rest(s__66244__$2)));
}
} else {
return null;
}
...
frontend.ui.tippy = rum.core.lazy_build(rum.core.build_defcs,(function (state,p__66328,child){
var map__66335 = p__66328;
var map__66335__$1 = cljs.core.__destructure_map(map__66335);
var opts = map__66335__$1;
var fixed_position_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66335__$1,new cljs.core.Keyword(null,"fixed-position?","fixed-position?",-918460562));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66335__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
}catch (e66404){if((e66404 instanceof Error)){
var e = e66404;
lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("frontend.ui",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"exception","exception",-335277064),e,new cljs.core.Keyword(null,"line","line",212345235),846], null)),e);
...
var G__66395 = React.createElement(React.Fragment,{'key':"tippy-children"},daiquiri.interpreter.interpret(child));
return (frontend.ui.Tippy.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.Tippy.cljs$core$IFn$_invoke$arity$2(G__66394,G__66395) : frontend.ui.Tippy.call(null,G__66394,G__66395));
})());
...
frontend.ui.slider = (function frontend$ui$slider(default_value,p__66416){
var map__66417 = p__66416;
var map__66417__$1 = cljs.core.__destructure_map(map__66417);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66417__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66417__$1,new cljs.core.Keyword(null,"max","max",61366548));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66417__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.cursor-pointer","input.cursor-pointer",-632859928),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"range",new cljs.core.Keyword(null,"value","value",305978217),(default_value | (0)),new cljs.core.Keyword(null,"min","min",444991522),min,new cljs.core.Keyword(null,"max","max",61366548),max,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),"100%"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__66413_SHARP_){
var value = frontend.util.evalue(p1__66413_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(value) : on_change.call(null,value));
})], null)], null);
});
...
return daiquiri.core.create_element("div",null,[daiquiri.core.create_element("div",{'className':"flex justify-between mb-1"},[(function (){var attrs66518 = label_left;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs66518))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-base"], null)], null),attrs66518], 0))):{'className':"text-base"}),((cljs.core.map_QMARK_(attrs66518))?null:[daiquiri.interpreter.interpret(attrs66518)]));
})(),(function (){var attrs66522 = label_right;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs66522))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["text-sm","font-medium"], null)], null),attrs66522], 0))):{'className':"text-sm font-medium"}),((cljs.core.map_QMARK_(attrs66522))?null:[daiquiri.interpreter.interpret(attrs66522)]));
...
return daiquiri.core.create_element("div",{'ref':(function (p1__66528_SHARP_){
return cljs.core.reset_BANG_(new cljs.core.Keyword("frontend.ui","ref","frontend.ui/ref",-122429065).cljs$core$IFn$_invoke$arity$1(state),p1__66528_SHARP_);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword("frontend.ui","ref","frontend.ui/ref",-122429065),cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("frontend.ui","height","frontend.ui/height",-529489906),cljs.core.atom.cljs$core$IFn$_invoke$arity$1((24))], 0));
...
var observer_67333 = (new ResizeObserver((function (entries){
...
observer_67333.observe(cljs.core.deref(new cljs.core.Keyword("frontend.ui","ref","frontend.ui/ref",-122429065).cljs$core$IFn$_invoke$arity$1(state)));
} else {
}

return state;
})], null)], null),"frontend.ui/lazy-visible-inner");
frontend.ui.lazy_visible = rum.core.lazy_build(rum.core.build_defcs,(function (state,content_fn,sensor_opts,p__66564){
var map__66566 = p__66564;
var map__66566__$1 = cljs.core.__destructure_map(map__66566);
var reset_height_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66566__$1,new cljs.core.Keyword(null,"reset-height?","reset-height?",1975120568));
var once_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66566__$1,new cljs.core.Keyword(null,"once?","once?",-872881597));
...
return daiquiri.interpreter.interpret((function (){var G__66610 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (v){
cljs.core.reset_BANG_(_STAR_visible_QMARK_,v);

if(cljs.core.truth_((function (){var and__4251__auto__ = once_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
return v;
} else {
return and__4251__auto__;
...
var G__66611 = frontend.ui.lazy_visible_inner(cljs.core.deref(_STAR_visible_QMARK_),content_fn,reset_height_QMARK_);
return (frontend.ui.visibility_sensor.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.visibility_sensor.cljs$core$IFn$_invoke$arity$2(G__66610,G__66611) : frontend.ui.visibility_sensor.call(null,G__66610,G__66611));
})());
}
