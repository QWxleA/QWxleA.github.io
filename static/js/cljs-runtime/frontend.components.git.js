...
return daiquiri.core.create_element("div",{'style':{'width':(700)},'className':"w-full sm:max-w-lg"},[daiquiri.core.create_element("div",{'className':"font-bold mb-4"},[[cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(frontend.util.format.cljs$core$IFn$_invoke$arity$variadic(" (%s)",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([hash], 0)))].join('')]),(function (){var attrs51189 = content;
return daiquiri.core.create_element("pre",((cljs.core.map_QMARK_(attrs51189))?daiquiri.interpreter.element_attributes(attrs51189):null),((cljs.core.map_QMARK_(attrs51189))?null:[daiquiri.interpreter.interpret(attrs51189)]));
