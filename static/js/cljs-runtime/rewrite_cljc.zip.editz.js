...
return rewrite_cljc.node.coerce((function (){var G__78812 = rewrite_cljc.node.sexpr(node);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__78812) : f.call(null,G__78812));
})());
});
/**
...
var len__5766__auto___78830 = arguments.length;
var i__5767__auto___78831 = (0);
while(true){
if((i__5767__auto___78831 < len__5766__auto___78830)){
args__5772__auto__.push((arguments[i__5767__auto___78831]));

var G__78835 = (i__5767__auto___78831 + (1));
i__5767__auto___78831 = G__78835;
continue;
} else {
}
break;
...
return rewrite_cljc.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_cljc.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__78813_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__78813_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_cljc.zip.editz.edit.cljs$lang$applyTo = (function (seq78814){
var G__78815 = cljs.core.first(seq78814);
var seq78814__$1 = cljs.core.next(seq78814);
var G__78816 = cljs.core.first(seq78814__$1);
var seq78814__$2 = cljs.core.next(seq78814__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__78815,G__78816,seq78814__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__78823 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__78823) : str_fn.call(null,G__78823));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__78824 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__78824) : str_fn.call(null,G__78824));
})()):null)));
...
var G__78827 = rewrite_cljc.zip.base.tag(zloc);
var G__78827__$1 = (((G__78827 instanceof cljs.core.Keyword))?G__78827.fqn:null);
switch (G__78827__$1) {
case "token":
return rewrite_cljc.zip.editz.edit_token(zloc,(function (p1__78825_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__78825_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__78826_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__78826_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78827__$1)].join('')));
...
var G__78829 = rewrite_cljc.zip.base.tag(zloc);
var G__78829__$1 = (((G__78829 instanceof cljs.core.Keyword))?G__78829.fqn:null);
switch (G__78829__$1) {
case "token":
return rewrite_cljc.zip.editz.edit_token(zloc,(function (p1__78828_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__78828_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78829__$1)].join('')));
