...
(rewrite_cljc.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k77534,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__77547 = k77534;
var G__77547__$1 = (((G__77547 instanceof cljs.core.Keyword))?G__77547.fqn:null);
switch (G__77547__$1) {
case "value":
return self__.value;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k77534,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__77550){
var vec__77551 = p__77550;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77551,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77551,(1),null);
...
(rewrite_cljc.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__77533){
var self__ = this;
var G__77533__$1 = this;
return (new cljs.core.RecordIter((0),G__77533__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_cljc.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this77535,other77536){
var self__ = this;
var this77535__$1 = this;
return (((!((other77536 == null)))) && ((((this77535__$1.constructor === other77536.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77535__$1.value,other77536.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77535__$1.base,other77536.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77535__$1.__extmap,other77536.__extmap)))))))));
}));
...
var abs_value = (function (){var G__77588 = self__.value;
if((self__.value < (0))){
return (- G__77588);
} else {
return G__77588;
...
var prefix = (function (){var G__77590 = cljs.core.long$(self__.base);
switch (G__77590) {
case (8):
return "0";
...
(rewrite_cljc.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k77534){
var self__ = this;
var this__5347__auto____$1 = this;
var G__77596 = k77534;
var G__77596__$1 = (((G__77596 instanceof cljs.core.Keyword))?G__77596.fqn:null);
switch (G__77596__$1) {
case "value":
case "base":
return true;
...
(rewrite_cljc.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__77533){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__77598 = cljs.core.keyword_identical_QMARK_;
var expr__77599 = k__5349__auto__;
if(cljs.core.truth_((pred__77598.cljs$core$IFn$_invoke$arity$2 ? pred__77598.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__77599) : pred__77598.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__77599)))){
return (new rewrite_cljc.node.integer.IntNode(G__77533,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77598.cljs$core$IFn$_invoke$arity$2 ? pred__77598.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__77599) : pred__77598.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__77599)))){
return (new rewrite_cljc.node.integer.IntNode(self__.value,G__77533,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_cljc.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__77533),null));
}
}
}));
...
(rewrite_cljc.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__77533){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_cljc.node.integer.IntNode(self__.value,self__.base,G__77533,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_cljc.node.integer.map__GT_IntNode = (function rewrite_cljc$node$integer$map__GT_IntNode(G__77537){
var extmap__5382__auto__ = (function (){var G__77605 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__77537,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__77537)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__77605);
} else {
return G__77605;
}
})();
return (new rewrite_cljc.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__77537),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__77537),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
