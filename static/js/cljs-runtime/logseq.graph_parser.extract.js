...
logseq.graph_parser.extract.extract_pages_and_blocks = (function logseq$graph_parser$extract$extract_pages_and_blocks(format,ast,properties,file,content,p__63451){
var map__63452 = p__63451;
var map__63452__$1 = cljs.core.__destructure_map(map__63452);
var options = map__63452__$1;
var date_formatter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63452__$1,new cljs.core.Keyword(null,"date-formatter","date-formatter",-223324709));
var page_name_order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63452__$1,new cljs.core.Keyword(null,"page-name-order","page-name-order",-1625414065));
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63452__$1,new cljs.core.Keyword(null,"db","db",993250759));
try{var page = logseq.graph_parser.extract.get_page_name(file,ast,page_name_order);
var vec__63454 = logseq.graph_parser.block.convert_page_if_journal(page,date_formatter);
var _original_page_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63454,(0),null);
var page_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63454,(1),null);
var _journal_day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63454,(2),null);
...
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.seq(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__63450_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page_name,logseq.graph_parser.util.page_name_sanity_lc(p1__63450_SHARP_))) || (clojure.string.blank_QMARK_(p1__63450_SHARP_)));
}),alias__$1));
} else {
return and__4251__auto__;
}
...
var G__63457 = logseq.graph_parser.util.remove_nils(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(logseq.graph_parser.block.page_name__GT_map(page,false,db,true,date_formatter),new cljs.core.Keyword("block","file","block/file",183171933),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("file","path","file/path",-191335748),logseq.graph_parser.util.path_normalize(file)], null)));
var G__63457__$1 = ((cljs.core.seq(properties))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63457,new cljs.core.Keyword("block","properties","block/properties",708347145),properties):G__63457);
var G__63457__$2 = ((cljs.core.seq(aliases__$1))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63457__$1,new cljs.core.Keyword("block","alias","block/alias",-2112644699),aliases__$1):G__63457__$1);
if(cljs.core.truth_(new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(properties))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63457__$2,new cljs.core.Keyword("block","tags","block/tags",1814948340),(function (){var tags = new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(properties);
...
}catch (e63453){var e = e63453;
return lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("logseq.graph-parser.extract",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"exception","exception",-335277064),e,new cljs.core.Keyword(null,"line","line",212345235),137], null)),e);
}});
logseq.graph_parser.extract.extract_blocks_pages = (function logseq$graph_parser$extract$extract_blocks_pages(file,content,p__63458){
var map__63459 = p__63458;
var map__63459__$1 = cljs.core.__destructure_map(map__63459);
var options = map__63459__$1;
var user_config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63459__$1,new cljs.core.Keyword(null,"user-config","user-config",-1138679827));
...
var properties = (function (){var properties = (function (){var and__4251__auto__ = logseq.graph_parser.property.properties_ast_QMARK_(first_block);
if(and__4251__auto__){
return clojure.walk.keywordize_keys(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__63460){
var vec__63461 = p__63460;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63461,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63461,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,((typeof y === 'string')?logseq.graph_parser.text.parse_property.cljs$core$IFn$_invoke$arity$4(format,x,y,user_config):y)], null);
...
logseq.graph_parser.extract.extract_all_block_refs = (function logseq$graph_parser$extract$extract_all_block_refs(content){
