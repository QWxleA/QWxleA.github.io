...
var G__55784 = (i__4865__auto___55783 + (1));
i__4865__auto___55783 = G__55784;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq55582){
var G__55583 = cljs.core.first(seq55582);
var seq55582__$1 = cljs.core.next(seq55582);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55583,seq55582__$1);
}));
...
return cljs.core.some((function (p1__55597_SHARP_){
return (p1__55597_SHARP_ === object);
}),history);
});
...
var args__4870__auto__ = [];
var len__4864__auto___55786 = arguments.length;
var i__4865__auto___55787 = (0);
while(true){
if((i__4865__auto___55787 < len__4864__auto___55786)){
args__4870__auto__.push((arguments[i__4865__auto___55787]));

var G__55788 = (i__4865__auto___55787 + (1));
i__4865__auto___55787 = G__55788;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__55704){
var vec__55705 = p__55704;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55705,(0),null);
var _STAR_ = (function (p__55710){
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq55675){
var G__55676 = cljs.core.first(seq55675);
var seq55675__$1 = cljs.core.next(seq55675);
var G__55677 = cljs.core.first(seq55675__$1);
var seq55675__$2 = cljs.core.next(seq55675__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55676,G__55677,seq55675__$2);
}));
