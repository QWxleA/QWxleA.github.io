...
try{var G__65320_65678 = (function (p1__65295_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__65295_SHARP_);
});
var G__65321_65679 = (function (p1__65296_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__65296_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__65320_65678,G__65321_65679) : f.call(null,G__65320_65678,G__65321_65679));
}catch (e65317){var e_65680 = e65317;
promesa.protocols._reject_BANG_(d,e_65680);
}
return d;
}));
...
try{var G__65363 = (function (p1__65298_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__65298_SHARP_);
});
var G__65364 = (function (p1__65300_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__65300_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__65363,G__65364) : f.call(null,G__65363,G__65364));
...
var i__4865__auto___65720 = (0);
while(true){
if((i__4865__auto___65720 < len__4864__auto___65719)){
args_arr__4885__auto__.push((arguments[i__4865__auto___65720]));

var G__65725 = (i__4865__auto___65720 + (1));
i__4865__auto___65720 = G__65725;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65538_SHARP_,p2__65539_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__65538_SHARP_,p2__65539_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq65541){
var G__65542 = cljs.core.first(seq65541);
var seq65541__$1 = cljs.core.next(seq65541);
var G__65543 = cljs.core.first(seq65541__$1);
var seq65541__$2 = cljs.core.next(seq65541__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65542,G__65543,seq65541__$2);
}));
...
default:
var args_arr__4885__auto__ = [];
var len__4864__auto___65727 = arguments.length;
var i__4865__auto___65728 = (0);
while(true){
if((i__4865__auto___65728 < len__4864__auto___65727)){
args_arr__4885__auto__.push((arguments[i__4865__auto___65728]));

var G__65733 = (i__4865__auto___65728 + (1));
i__4865__auto___65728 = G__65733;
continue;
} else {
}
break;
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq65552){
var G__65554 = cljs.core.first(seq65552);
var seq65552__$1 = cljs.core.next(seq65552);
var G__65555 = cljs.core.first(seq65552__$1);
var seq65552__$2 = cljs.core.next(seq65552__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65554,G__65555,seq65552__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__65573_SHARP_){
return (p1__65573_SHARP_ instanceof pred_or_type);
}));
...
var seq__65600 = cljs.core.seq(promises);
var chunk__65601 = null;
var count__65602 = (0);
var i__65603 = (0);
while(true){
if((i__65603 < count__65602)){
var p = chunk__65601.cljs$core$IIndexed$_nth$arity$2(null,i__65603);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(p),((function (seq__65600,chunk__65601,count__65602,i__65603,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__65600,chunk__65601,count__65602,i__65603,p,state){
...
});})(seq__65600,chunk__65601,count__65602,i__65603,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__65600,chunk__65601,count__65602,i__65603,p,state))
),((function (seq__65600,chunk__65601,count__65602,i__65603,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__65600,chunk__65601,count__65602,i__65603,p,state){
return (function (state__$1){
...
var map__65632 = cljs.core.deref(state);
var map__65632__$1 = cljs.core.__destructure_map(map__65632);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65632__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65632__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65632__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__65635 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__65635) : reject.call(null,G__65635));
} else {
...
var G__65761 = seq__65600;
var G__65762 = chunk__65601;
var G__65763 = count__65602;
var G__65764 = (i__65603 + (1));
seq__65600 = G__65761;
chunk__65601 = G__65762;
count__65602 = G__65763;
i__65603 = G__65764;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__65600);
if(temp__5720__auto__){
var seq__65600__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__65600__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__65600__$1);
var G__65765 = cljs.core.chunk_rest(seq__65600__$1);
var G__65766 = c__4679__auto__;
var G__65767 = cljs.core.count(c__4679__auto__);
var G__65768 = (0);
seq__65600 = G__65765;
chunk__65601 = G__65766;
count__65602 = G__65767;
i__65603 = G__65768;
continue;
} else {
var p = cljs.core.first(seq__65600__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(p),((function (seq__65600,chunk__65601,count__65602,i__65603,p,seq__65600__$1,temp__5720__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__65600,chunk__65601,count__65602,i__65603,p,seq__65600__$1,temp__5720__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__65600,chunk__65601,count__65602,i__65603,p,seq__65600__$1,temp__5720__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__65600,chunk__65601,count__65602,i__65603,p,seq__65600__$1,temp__5720__auto__,state))
),((function (seq__65600,chunk__65601,count__65602,i__65603,p,seq__65600__$1,temp__5720__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__65600,chunk__65601,count__65602,i__65603,p,seq__65600__$1,temp__5720__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__65636 = cljs.core.deref(state);
var map__65636__$1 = cljs.core.__destructure_map(map__65636);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65636__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65636__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65636__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__65637 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__65637) : reject.call(null,G__65637));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__65772 = cljs.core.next(seq__65600__$1);
var G__65773 = null;
var G__65774 = (0);
var G__65775 = (0);
seq__65600 = G__65772;
chunk__65601 = G__65773;
count__65602 = G__65774;
i__65603 = G__65775;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65638_SHARP_,p2__65639_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__65638_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__65639_SHARP_) : f.call(null,p2__65639_SHARP_));
}));
...
return (function() { 
var G__65780__delegate = function (args){
return promesa.core.create.cljs$core$IFn$_invoke$arity$1((function (resolve,reject){
...
var G__65780 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__65782__i = 0, G__65782__a = new Array(arguments.length -  0);
while (G__65782__i < G__65782__a.length) {G__65782__a[G__65782__i] = arguments[G__65782__i + 0]; ++G__65782__i;}
  args = new cljs.core.IndexedSeq(G__65782__a,0,null);
} 
return G__65780__delegate.call(this,args);};
G__65780.cljs$lang$maxFixedArity = 0;
G__65780.cljs$lang$applyTo = (function (arglist__65783){
var args = cljs.core.seq(arglist__65783);
return G__65780__delegate(args);
});
G__65780.cljs$core$IFn$_invoke$arity$variadic = G__65780__delegate;
return G__65780;
})()
;
});
