...
var or__5043__auto__ = cljs.core.some((function (p1__83557_SHARP_){
return clojure.string.starts_with_QMARK_(path,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(dir),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__83557_SHARP_)].join(''));
...
var or__5043__auto____$1 = cljs.core.some((function (p1__83558_SHARP_){
return clojure.string.includes_QMARK_(path,["/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__83558_SHARP_),"/"].join(''));
}),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [".",".recycle","assets","node_modules","logseq/bak","version-files"], null));
if(cljs.core.truth_(or__5043__auto____$1)){
return or__5043__auto____$1;
} else {
var or__5043__auto____$2 = cljs.core.some((function (p1__83559_SHARP_){
return clojure.string.ends_with_QMARK_(path,p1__83559_SHARP_);
...
return (((!(clojure.string.blank_QMARK_(module$node_modules$path$path.extname(path__$1))))) && (cljs.core.not(cljs.core.some((function (p1__83560_SHARP_){
return clojure.string.ends_with_QMARK_(path__$1,p1__83560_SHARP_);
