...
return rewrite_cljc.reader.read_repeatedly(reader,(function (p1__92823_SHARP_){
var _STAR_delimiter_STAR__orig_val__92824 = rewrite_cljc.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__92825 = delimiter;
(rewrite_cljc.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__92825);

try{return rewrite_cljc.parser.core.parse_next(p1__92823_SHARP_);
}finally {(rewrite_cljc.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__92824);
}}));
});
rewrite_cljc.parser.core.parse_printables = (function rewrite_cljc$parser$core$parse_printables(var_args){
var args__4870__auto__ = [];
var len__4864__auto___92849 = arguments.length;
var i__4865__auto___92850 = (0);
while(true){
if((i__4865__auto___92850 < len__4864__auto___92849)){
args__4870__auto__.push((arguments[i__4865__auto___92850]));

var G__92852 = (i__4865__auto___92850 + (1));
i__4865__auto___92850 = G__92852;
continue;
} else {
}
break;
...
return rewrite_cljc.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__4871__auto__);
});

(rewrite_cljc.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__92830){
var vec__92831 = p__92830;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92831,(0),null);
...
/** @this {Function} */
(rewrite_cljc.parser.core.parse_printables.cljs$lang$applyTo = (function (seq92826){
var G__92827 = cljs.core.first(seq92826);
var seq92826__$1 = cljs.core.next(seq92826);
var G__92828 = cljs.core.first(seq92826__$1);
var seq92826__$2 = cljs.core.next(seq92826__$1);
var G__92829 = cljs.core.first(seq92826__$2);
var seq92826__$3 = cljs.core.next(seq92826__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__92827,G__92828,G__92829,seq92826__$3);
}));
...
var G__92837 = rewrite_cljc.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__92837)){
return rewrite_cljc.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\"",G__92837)){
...
return cljs.core.cons((function (){var G__92838 = rewrite_cljc.reader.peek(reader);
switch (G__92838) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__92837)){
