...
var hierarchy__5643__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__78614 = cljs.core.get_global_hierarchy;
return (fexpr__78614.cljs$core$IFn$_invoke$arity$0 ? fexpr__78614.cljs$core$IFn$_invoke$arity$0() : fexpr__78614.call(null));
})());
...
return rewrite_cljc.reader.read_repeatedly(reader,(function (p1__78615_SHARP_){
var _STAR_delimiter_STAR__orig_val__78617 = rewrite_cljc.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__78618 = delimiter;
(rewrite_cljc.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__78618);

try{return rewrite_cljc.parser.core.parse_next(p1__78615_SHARP_);
}finally {(rewrite_cljc.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__78617);
}}));
});
rewrite_cljc.parser.core.parse_printables = (function rewrite_cljc$parser$core$parse_printables(var_args){
var args__5772__auto__ = [];
var len__5766__auto___78660 = arguments.length;
var i__5767__auto___78661 = (0);
while(true){
if((i__5767__auto___78661 < len__5766__auto___78660)){
args__5772__auto__.push((arguments[i__5767__auto___78661]));

var G__78662 = (i__5767__auto___78661 + (1));
i__5767__auto___78661 = G__78662;
continue;
} else {
}
break;
...
(rewrite_cljc.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__78624){
var vec__78625 = p__78624;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78625,(0),null);
...
/** @this {Function} */
(rewrite_cljc.parser.core.parse_printables.cljs$lang$applyTo = (function (seq78619){
var G__78620 = cljs.core.first(seq78619);
var seq78619__$1 = cljs.core.next(seq78619);
var G__78621 = cljs.core.first(seq78619__$1);
var seq78619__$2 = cljs.core.next(seq78619__$1);
var G__78622 = cljs.core.first(seq78619__$2);
var seq78619__$3 = cljs.core.next(seq78619__$2);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__78620,G__78621,G__78622,seq78619__$3);
}));
...
var G__78637 = rewrite_cljc.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__78637)){
return rewrite_cljc.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\"",G__78637)){
...
return cljs.core.cons((function (){var G__78643 = rewrite_cljc.reader.peek(reader);
switch (G__78643) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__78637)){
