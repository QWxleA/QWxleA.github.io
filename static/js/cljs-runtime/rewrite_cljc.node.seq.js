...
(rewrite_cljc.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k78133,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__78164 = k78133;
var G__78164__$1 = (((G__78164 instanceof cljs.core.Keyword))?G__78164.fqn:null);
switch (G__78164__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k78133,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__78166){
var vec__78168 = p__78166;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78168,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78168,(1),null);
...
(rewrite_cljc.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__78132){
var self__ = this;
var G__78132__$1 = this;
return (new cljs.core.RecordIter((0),G__78132__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_cljc.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this78136,other78138){
var self__ = this;
var this78136__$1 = this;
return (((!((other78138 == null)))) && ((((this78136__$1.constructor === other78138.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this78136__$1.tag,other78138.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this78136__$1.format_string,other78138.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this78136__$1.wrap_length,other78138.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this78136__$1.seq_fn,other78138.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this78136__$1.children,other78138.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this78136__$1.__extmap,other78138.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__78203 = rewrite_cljc.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__78203) : self__.seq_fn.call(null,G__78203));
}));
...
(rewrite_cljc.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k78133){
var self__ = this;
var this__5347__auto____$1 = this;
var G__78206 = k78133;
var G__78206__$1 = (((G__78206 instanceof cljs.core.Keyword))?G__78206.fqn:null);
switch (G__78206__$1) {
case "tag":
case "format-string":
case "wrap-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k78133);

}
}));

(rewrite_cljc.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__78132){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__78207 = cljs.core.keyword_identical_QMARK_;
var expr__78208 = k__5349__auto__;
if(cljs.core.truth_((pred__78207.cljs$core$IFn$_invoke$arity$2 ? pred__78207.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__78208) : pred__78207.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__78208)))){
return (new rewrite_cljc.node.seq.SeqNode(G__78132,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__78207.cljs$core$IFn$_invoke$arity$2 ? pred__78207.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__78208) : pred__78207.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__78208)))){
return (new rewrite_cljc.node.seq.SeqNode(self__.tag,G__78132,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__78207.cljs$core$IFn$_invoke$arity$2 ? pred__78207.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__78208) : pred__78207.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__78208)))){
return (new rewrite_cljc.node.seq.SeqNode(self__.tag,self__.format_string,G__78132,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__78207.cljs$core$IFn$_invoke$arity$2 ? pred__78207.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__78208) : pred__78207.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__78208)))){
return (new rewrite_cljc.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__78132,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__78207.cljs$core$IFn$_invoke$arity$2 ? pred__78207.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__78208) : pred__78207.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__78208)))){
return (new rewrite_cljc.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__78132,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_cljc.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__78132),null));
}
}
}
}
...
(rewrite_cljc.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__78132){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_cljc.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__78132,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_cljc.node.seq.map__GT_SeqNode = (function rewrite_cljc$node$seq$map__GT_SeqNode(G__78151){
var extmap__5382__auto__ = (function (){var G__78214 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__78151,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__78151)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__78214);
} else {
return G__78214;
}
})();
return (new rewrite_cljc.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__78151),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__78151),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__78151),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__78151),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__78151),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
...
return rewrite_cljc.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),(function (p1__78215_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__78215_SHARP_);
}),children);
});
/**
...
return rewrite_cljc.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),(function (p1__78217_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__78217_SHARP_);
}),children);
});
