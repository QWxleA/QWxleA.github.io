...
return frontend.util.distinct_by(new cljs.core.Keyword(null,"url","url",276297046),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__32697_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(repo),new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(p1__32697_SHARP_));
}),repos));
}));
...
var temp__5720__auto___32804 = goog.dom.getElement(input_id);
if(cljs.core.truth_(temp__5720__auto___32804)){
var input_32805 = temp__5720__auto___32804;
frontend.util.set_change_value(input_32805,value);
} else {
}
} else {
}
...
return cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__32715_SHARP_){
var temp__5720__auto__ = dommy.core.attr(p1__32715_SHARP_,"blockid");
if(cljs.core.truth_(temp__5720__auto__)){
var id = temp__5720__auto__;
...
return cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [repo,db_id,block_type], null),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__32724_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.second(p1__32724_SHARP_),db_id);
}),blocks)));
}));
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__32726_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.second(p1__32726_SHARP_),idx);
}),blocks);
} else {
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32727_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__32727_SHARP_,old_sidebar_key)){
...
return cljs.core.some((function (p1__32728_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.second(p1__32728_SHARP_),idx);
...
(frontend.state.set_sub_modal_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (panel_content,p__32757){
var map__32758 = p__32757;
var map__32758__$1 = cljs.core.__destructure_map(map__32758);
var opts = map__32758__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32758__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32758__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var close_btn_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32758__$1,new cljs.core.Keyword(null,"close-btn?","close-btn?",336318726));
var show_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32758__$1,new cljs.core.Keyword(null,"show?","show?",1543842127));
var center_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32758__$1,new cljs.core.Keyword(null,"center?","center?",-323116631));
...
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.first(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__32753_SHARP_,p2__32752_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("modal","id","modal/id",-1274892409).cljs$core$IFn$_invoke$arity$1(p2__32752_SHARP_),id)){
...
var input = medley.core.filter_vals((function (p1__32754_SHARP_){
return (!((p1__32754_SHARP_ == null)));
...
var id_32859 = all_QMARK__a_id;
var mid_32860 = new cljs.core.Keyword("modal","id","modal/id",-1274892409).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(frontend.state.state));
var modals_32861 = new cljs.core.Keyword("modal","subsets","modal/subsets",627467906).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(frontend.state.state));
if(cljs.core.truth_((function (){var and__5041__auto__ = id_32859;
if(cljs.core.truth_(and__5041__auto__)){
return (((!(clojure.string.blank_QMARK_(mid_32860)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id_32859,mid_32860)));
} else {
return and__5041__auto__;
}
})())){
...
var temp__5720__auto___32866 = (cljs.core.truth_(id_32859)?cljs.core.first(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__32761_SHARP_,p2__32760_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("modal","id","modal/id",-1274892409).cljs$core$IFn$_invoke$arity$1(p2__32760_SHARP_),id_32859)){
return p1__32761_SHARP_;
} else {
return null;
}
}),modals_32861)):(cljs.core.count(modals_32861) - (1)));
if(cljs.core.truth_(temp__5720__auto___32866)){
var idx_32868 = temp__5720__auto___32866;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(frontend.state.state,cljs.core.assoc,new cljs.core.Keyword("modal","subsets","modal/subsets",627467906),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,medley.core.remove_nth.cljs$core$IFn$_invoke$arity$2(idx_32868,modals_32861)));
} else {
}
}
}
...
(frontend.state.set_modal_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (modal_panel_content,p__32769){
...
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32770__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var fullscreen_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32770__$1,new cljs.core.Keyword(null,"fullscreen?","fullscreen?",-1171717820));
var close_btn_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32770__$1,new cljs.core.Keyword(null,"close-btn?","close-btn?",336318726));
var center_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32770__$1,new cljs.core.Keyword(null,"center?","center?",-323116631));
...
return cljs.core.filterv((function (p1__32772_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.first(p1__32772_SHARP_)),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type));
...
return cljs.core.filterv((function (p1__32773_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.first(p1__32773_SHARP_)),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type));
...
var pid__$1 = temp__5720__auto__;
if((hook_or_all == null)){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(frontend.state.state,cljs.core.update,new cljs.core.Keyword("plugin","installed-hooks","plugin/installed-hooks",-227057271),(function (p1__32774_SHARP_){
return cljs.core.update_vals(p1__32774_SHARP_,(function (ids){
return cljs.core.disj.cljs$core$IFn$_invoke$arity$2(ids,pid__$1);
}));
}));
} else {
var temp__5720__auto___32895__$1 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(frontend.state.state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("plugin","installed-hooks","plugin/installed-hooks",-227057271),hook_or_all], null));
if(cljs.core.truth_(temp__5720__auto___32895__$1)){
var coll_32896 = temp__5720__auto___32895__$1;
frontend.state.set_state_BANG_(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("plugin","installed-hooks","plugin/installed-hooks",-227057271),hook_or_all], null),cljs.core.disj.cljs$core$IFn$_invoke$arity$2(coll_32896,pid__$1));
} else {
}
}
...
frontend.state.update_state_BANG_(new cljs.core.Keyword("copy","export-block-text-remove-options","copy/export-block-text-remove-options",-1213505869),(function (p1__32775_SHARP_){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(p1__32775_SHARP_,k) : f.call(null,p1__32775_SHARP_,k));
}));
...
var G__32776 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(frontend.state.get_config.cljs$core$IFn$_invoke$arity$0(),new cljs.core.Keyword("export","bullet-indentation","export/bullet-indentation",-647274253),new cljs.core.Keyword(null,"tab","tab",-559583621));
...
return cljs.core.filterv((function (p1__32779_SHARP_){
var and__5041__auto__ = (cljs.core.truth_(include_unpacked_QMARK_)?true:new cljs.core.Keyword(null,"iir","iir",-231680811).cljs$core$IFn$_invoke$arity$1(p1__32779_SHARP_));
if(cljs.core.truth_(and__5041__auto__)){
var and__5041__auto____$1 = (((!(cljs.core.boolean_QMARK_(enabled_QMARK_))))?true:cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.not(enabled_QMARK_),cljs.core.boolean$(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__32779_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",1556144875),new cljs.core.Keyword(null,"disabled","disabled",-1529784218)], null)))));
if(and__5041__auto____$1){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.boolean$(theme_QMARK_),new cljs.core.Keyword(null,"theme","theme",-1247880880).cljs$core$IFn$_invoke$arity$1(p1__32779_SHARP_));
} else {
return and__5041__auto____$1;
}
} else {
...
var temp__5718__auto___32925 = new cljs.core.Keyword(null,"error-code","error-code",180497232).cljs$core$IFn$_invoke$arity$1(payload);
if(cljs.core.truth_(temp__5718__auto___32925)){
var error_32926 = temp__5718__auto___32925;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(frontend.state.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("plugin","updates-coming","plugin/updates-coming",104160263),id], null),cljs.core.assoc,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"error-code","error-code",180497232),error_32926], 0));
} else {
...
return cljs.core.filterv((function (p1__32782_SHARP_){
return frontend.state.coming_update_new_version_QMARK_(p1__32782_SHARP_);
}),updates);
} else {
return null;
}
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__32783_SHARP_){
return (((!(((cljs.core.seq(unchecked)) && (cljs.core.contains_QMARK_(unchecked,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__32783_SHARP_))))))) && (cljs.core.not(new cljs.core.Keyword(null,"error-code","error-code",180497232).cljs$core$IFn$_invoke$arity$1(p1__32783_SHARP_))));
}),updates));
} else {
return null;
}
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__32784_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__32784_SHARP_),current_repo);
