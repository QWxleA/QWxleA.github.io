...
var G__74093 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__74094 = n;
var G__74095 = cljs.core.nnext(bs);
var G__74096 = true;
ret = G__74093;
n = G__74094;
bs = G__74095;
seen_rest_QMARK_ = G__74096;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__73998_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4253__auto__ = mkns;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return cljs.core.namespace(p1__73998_SHARP_);
}
})(),cljs.core.name(p1__73998_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__73999_SHARP_){
...
return cljs.core.namespace(p1__73999_SHARP_);
}
})(),cljs.core.name(p1__73999_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__74000_SHARP_,p2__74001_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__74000_SHARP_,p2__74001_SHARP_,(function (){var fexpr__74078 = cljs.core.val(entry);
return (fexpr__74078.cljs$core$IFn$_invoke$arity$1 ? fexpr__74078.cljs$core$IFn$_invoke$arity$1(p2__74001_SHARP_) : fexpr__74078.call(null,p2__74001_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__74079 = cljs.core.key(entry);
return (fexpr__74079.cljs$core$IFn$_invoke$arity$1 ? fexpr__74079.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__74079.call(null,bes));
})());
...
var G__74106 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__74107 = cljs.core.next(bes);
ret = G__74106;
bes = G__74107;
continue;
} else {
...
var temp__5718__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__74008_SHARP_){
return (cljs.core.first(p1__74008_SHARP_) instanceof cljs.core.Keyword);
}),bents));
