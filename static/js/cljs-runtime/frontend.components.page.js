...
var root = (cljs.core.truth_(block_id)?(function (){var G__70707 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__70707) : frontend.db.pull.call(null,G__70707));
...
var G__70708 = repo;
var G__70709 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(root);
var G__70710 = opts;
return (frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$3 ? frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$3(G__70708,G__70709,G__70710) : frontend.db.get_paginated_blocks.call(null,G__70708,G__70709,G__70710));
} else {
return null;
}
});
frontend.components.page.open_first_block_BANG_ = (function frontend$components$page$open_first_block_BANG_(state){
var vec__70715_71101 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var __71102 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70715_71101,(0),null);
var blocks_71103 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70715_71101,(1),null);
var __71104__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70715_71101,(2),null);
var sidebar_QMARK__71105 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70715_71101,(3),null);
var preview_QMARK__71106 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70715_71101,(4),null);
if(cljs.core.truth_((function (){var and__4251__auto__ = (function (){var or__4253__auto__ = preview_QMARK__71106;
...
return cljs.core.not(sidebar_QMARK__71105);
} else {
return and__4251__auto__;
}
})())){
var block_71110 = cljs.core.first(blocks_71103);
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(blocks_71103),(1))) && (((clojure.string.blank_QMARK_(new cljs.core.Keyword("block","content","block/content",-161885195).cljs$core$IFn$_invoke$arity$1(block_71110))) && (cljs.core.not(preview_QMARK__71106)))))){
frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3(block_71110,new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block_71110));
} else {
}
} else {
}
...
}),'className':"flex-1 flex-col rounded-sm add-button-link-wrap"},[daiquiri.core.create_element("div",{'className':"flex flex-row"},[daiquiri.core.create_element("div",{'style':{'height':(20),'width':(20),'marginLeft':(2)},'className':"block"},[(function (){var attrs70725 = frontend.ui.icon.cljs$core$IFn$_invoke$arity$1("circle-plus");
return daiquiri.core.create_element("a",((cljs.core.map_QMARK_(attrs70725))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["add-button-link","block"], null)], null),attrs70725], 0))):{'className':"add-button-link block"}),((cljs.core.map_QMARK_(attrs70725))?null:[daiquiri.interpreter.interpret(attrs70725)]));
})()])])]);
}),null,"frontend.components.page/add-button");
frontend.components.page.page_blocks_cp = rum.core.lazy_build(rum.core.build_defc,(function (repo,page_e,p__70728){
var map__70729 = p__70728;
var map__70729__$1 = cljs.core.__destructure_map(map__70729);
var config = map__70729__$1;
var sidebar_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70729__$1,new cljs.core.Keyword(null,"sidebar?","sidebar?",-534999672));
...
var block_entity = (function (){var G__70730 = (cljs.core.truth_(block_id)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name], null));
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__70730) : frontend.db.entity.call(null,G__70730));
})();
...
var page_e_71118 = cljs.core.second(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state));
var page_name_71119 = new cljs.core.Keyword("block","name","block/name",1619760316).cljs$core$IFn$_invoke$arity$1(page_e_71118);
if(cljs.core.truth_((function (){var and__4251__auto__ = (frontend.db.journal_page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? frontend.db.journal_page_QMARK_.cljs$core$IFn$_invoke$arity$1(page_name_71119) : frontend.db.journal_page_QMARK_.call(null,page_name_71119));
if(cljs.core.truth_(and__4251__auto__)){
return (frontend.date.journal_title__GT_int(page_name_71119) >= frontend.date.journal_title__GT_int(frontend.date.today()));
} else {
return and__4251__auto__;
}
})())){
frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("journal","insert-template","journal/insert-template",-1273735332),page_name_71119], null));
} else {
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70736),frontend$components$page$iter__70733(cljs.core.chunk_rest(s__70734__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70736),null);
}
} else {
var query = cljs.core.first(s__70734__$2);
return cljs.core.cons(rum.core.with_key(frontend.ui.catch_error(frontend.ui.component_error("Failed default query:",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"content","content",15833224),cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([query], 0))], null)),frontend.components.block.custom_query(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mt-10"], null),new cljs.core.Keyword(null,"editor-box","editor-box",708759870),frontend.components.editor.box,new cljs.core.Keyword(null,"page","page",849072397),frontend.components.page.page], null),query)),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(repo),"-custom-query-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"query","query",-1288509510).cljs$core$IFn$_invoke$arity$1(query))].join('')),frontend$components$page$iter__70733(cljs.core.rest(s__70734__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70740),frontend$components$page$tagged_pages_$_iter__70737(cljs.core.chunk_rest(s__70738__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70740),null);
}
} else {
var vec__70744 = cljs.core.first(s__70738__$2);
var original_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70744,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70744,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["tagged-page-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),name], null))], null),original_name], null)], null),frontend$components$page$tagged_pages_$_iter__70737(cljs.core.rest(s__70738__$2)));
}
} else {
return null;
}
...
var merge_QMARK_ = (function (){var and__4251__auto__ = cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(frontend.util.page_name_sanity_lc(page_name),frontend.util.page_name_sanity_lc(cljs.core.deref(_STAR_title_value)));
...
var G__70747 = cljs.core.deref(_STAR_title_value);
return (frontend.db.page_exists_QMARK_.cljs$core$IFn$_invoke$arity$1 ? frontend.db.page_exists_QMARK_.cljs$core$IFn$_invoke$arity$1(G__70747) : frontend.db.page_exists_QMARK_.call(null,G__70747));
} else {
...
var temp__5720__auto__ = (function (){var G__70750 = repo;
var G__70751 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__70752 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$3 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$3(G__70750,G__70751,G__70752) : frontend.db.pull.call(null,G__70750,G__70751,G__70752));
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
}),'className':"page-title"},[daiquiri.core.create_element("h1",{'data-ref':page_name,'className':"title ls-page-title"},[((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(icon,""))?(function (){var attrs70753 = icon;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs70753))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["page-icon"], null)], null),attrs70753], 0))):{'className':"page-icon"}),((cljs.core.map_QMARK_(attrs70753))?null:[daiquiri.interpreter.interpret(attrs70753)]));
...
frontend.components.page.page = rum.core.lazy_build(rum.core.build_defcs,(function (state,p__70754){
var map__70755 = p__70754;
var map__70755__$1 = cljs.core.__destructure_map(map__70755);
var option = map__70755__$1;
var repo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70755__$1,new cljs.core.Keyword(null,"repo","repo",-1999060679));
var page_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70755__$1,new cljs.core.Keyword(null,"page-name","page-name",974981762));
...
var page_name__$1 = frontend.util.page_name_sanity_lc(path_page_name);
var block_QMARK_ = logseq.graph_parser.util.uuid_string_QMARK_(page_name__$1);
var block_id = (function (){var and__4251__auto__ = block_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
...
var format = (function (){var page = (cljs.core.truth_(block_id)?new cljs.core.Keyword("block","name","block/name",1619760316).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","page","block/page",822314108).cljs$core$IFn$_invoke$arity$1((function (){var G__70770 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__70770) : frontend.db.entity.call(null,G__70770));
})())):page_name__$1);
...
var page = (cljs.core.truth_(block_QMARK_)?(function (){var G__70771 = repo__$1;
var G__70772 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","page","block/page",822314108).cljs$core$IFn$_invoke$arity$1((function (){var G__70773 = repo__$1;
var G__70774 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$2 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$2(G__70773,G__70774) : frontend.db.entity.call(null,G__70773,G__70774));
})()));
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$2 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$2(G__70771,G__70772) : frontend.db.entity.call(null,G__70771,G__70772));
})():(function (){
if(cljs.core.truth_((function (){var G__70775 = repo__$1;
var G__70776 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name__$1], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$2 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$2(G__70775,G__70776) : frontend.db.entity.call(null,G__70775,G__70776));
})())){
} else {
var m_71125 = frontend.format.block.page_name__GT_map.cljs$core$IFn$_invoke$arity$2(path_page_name,true);
var G__70777_71126 = repo__$1;
var G__70778_71127 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [m_71125], null);
(frontend.db.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? frontend.db.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__70777_71126,G__70778_71127) : frontend.db.transact_BANG_.call(null,G__70777_71126,G__70778_71127));
}

var G__70779 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name__$1], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__70779) : frontend.db.pull.call(null,G__70779));
})()
);
var map__70769 = new cljs.core.Keyword("block","properties","block/properties",708347145).cljs$core$IFn$_invoke$arity$1(page);
var map__70769__$1 = cljs.core.__destructure_map(map__70769);
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70769__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page_name__$2,frontend.util.page_name_sanity_lc(frontend.date.journal_name.cljs$core$IFn$_invoke$arity$0()));
} else {
return and__4251__auto__;
}
})();
...
})():null),(function (){var page__$1 = (cljs.core.truth_(block_QMARK_)?(function (){var G__70780 = repo__$1;
var G__70781 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$2 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$2(G__70780,G__70781) : frontend.db.entity.call(null,G__70780,G__70781));
})():page);
...
frontend.components.page.graph_filter_section = rum.core.lazy_build(rum.core.build_defcs,(function (state,title,content,p__70782){
var map__70783 = p__70782;
var map__70783__$1 = cljs.core.__destructure_map(map__70783);
var search_filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70783__$1,new cljs.core.Keyword(null,"search-filters","search-filters",-2121899355));
...
}),'className':"w-full px-4 py-2 text-left focus:outline-none"},[(function (){var attrs70784 = title;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs70784))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","items-center","justify-between"], null)], null),attrs70784], 0))):{'className':"flex items-center justify-between"}),((cljs.core.map_QMARK_(attrs70784))?[(cljs.core.truth_(cljs.core.deref(open_QMARK_))?frontend.components.svg.caret_down():frontend.components.svg.caret_right())]:[daiquiri.interpreter.interpret(attrs70784),(cljs.core.truth_(cljs.core.deref(open_QMARK_))?frontend.components.svg.caret_down():frontend.components.svg.caret_right())]));
...
var map__70786 = settings;
var map__70786__$1 = cljs.core.__destructure_map(map__70786);
var journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70786__$1,new cljs.core.Keyword(null,"journal?","journal?",-897756522));
var orphan_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__70786__$1,new cljs.core.Keyword(null,"orphan-pages?","orphan-pages?",-824819206),true);
var builtin_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70786__$1,new cljs.core.Keyword(null,"builtin-pages?","builtin-pages?",1299611390));
...
})(),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"min","min",444991522),(1),new cljs.core.Keyword(null,"max","max",61366548),(10),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__70785_SHARP_){
return cljs.core.reset_BANG_(frontend.components.page._STAR_n_hops,(p1__70785_SHARP_ | (0)));
...
return frontend.components.page.filter_expand_area(open_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.p-6","div.p-6",1412057822),((cljs.core.seq(search_graph_filters))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4652__auto__ = (function frontend$components$page$iter__70797(s__70798){
return (new cljs.core.LazySeq(null,(function (){
var s__70798__$1 = s__70798;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__70798__$1);
if(temp__5720__auto__){
var s__70798__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70798__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__70798__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__70800 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__70799 = (0);
while(true){
if((i__70799 < size__4651__auto__)){
var q = cljs.core._nth(c__4650__auto__,i__70799);
cljs.core.chunk_append(b__70800,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-row.justify-between.items-center.mb-2","div.flex.flex-row.justify-between.items-center.mb-2",14359473),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.font-medium","span.font-medium",1169799421),q], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.search-filter-close.opacity-70.opacity-100","a.search-filter-close.opacity-70.opacity-100",820760152),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__70799,q,c__4650__auto__,size__4651__auto__,b__70800,s__70798__$2,temp__5720__auto__,map__70786,map__70786__$1,journal_QMARK_,orphan_pages_QMARK_,builtin_pages_QMARK_,journal_QMARK__SINGLEQUOTE_,orphan_pages_QMARK__SINGLEQUOTE_,builtin_pages_QMARK__SINGLEQUOTE_,journal_QMARK___$1,orphan_pages_QMARK___$1,builtin_pages_QMARK___$1,set_setting_BANG_,search_graph_filters,focus_nodes){
return (function (){
return frontend.state.remove_search_filter_BANG_(q);
});})(i__70799,q,c__4650__auto__,size__4651__auto__,b__70800,s__70798__$2,temp__5720__auto__,map__70786,map__70786__$1,journal_QMARK_,orphan_pages_QMARK_,builtin_pages_QMARK_,journal_QMARK__SINGLEQUOTE_,orphan_pages_QMARK__SINGLEQUOTE_,builtin_pages_QMARK__SINGLEQUOTE_,journal_QMARK___$1,orphan_pages_QMARK___$1,builtin_pages_QMARK___$1,set_setting_BANG_,search_graph_filters,focus_nodes))
], null),frontend.components.svg.close], null)], null));

var G__71132 = (i__70799 + (1));
i__70799 = G__71132;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70800),frontend$components$page$iter__70797(cljs.core.chunk_rest(s__70798__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70800),null);
}
} else {
var q = cljs.core.first(s__70798__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-row.justify-between.items-center.mb-2","div.flex.flex-row.justify-between.items-center.mb-2",14359473),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.font-medium","span.font-medium",1169799421),q], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.search-filter-close.opacity-70.opacity-100","a.search-filter-close.opacity-70.opacity-100",820760152),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (q,s__70798__$2,temp__5720__auto__,map__70786,map__70786__$1,journal_QMARK_,orphan_pages_QMARK_,builtin_pages_QMARK_,journal_QMARK__SINGLEQUOTE_,orphan_pages_QMARK__SINGLEQUOTE_,builtin_pages_QMARK__SINGLEQUOTE_,journal_QMARK___$1,orphan_pages_QMARK___$1,builtin_pages_QMARK___$1,set_setting_BANG_,search_graph_filters,focus_nodes){
return (function (){
return frontend.state.remove_search_filter_BANG_(q);
});})(q,s__70798__$2,temp__5720__auto__,map__70786,map__70786__$1,journal_QMARK_,orphan_pages_QMARK_,builtin_pages_QMARK_,journal_QMARK__SINGLEQUOTE_,orphan_pages_QMARK__SINGLEQUOTE_,builtin_pages_QMARK__SINGLEQUOTE_,journal_QMARK___$1,orphan_pages_QMARK___$1,builtin_pages_QMARK___$1,set_setting_BANG_,search_graph_filters,focus_nodes))
], null),frontend.components.svg.close], null)], null),frontend$components$page$iter__70797(cljs.core.rest(s__70798__$2)));
}
} else {
return null;
}
...
var vec__70801 = rum.core.react(frontend.components.page.layout);
var width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70801,(0),null);
var height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70801,(1),null);
...
return ((cljs.core.not((function (){var G__70804 = new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(link);
return (nodes.cljs$core$IFn$_invoke$arity$1 ? nodes.cljs$core$IFn$_invoke$arity$1(G__70804) : nodes.call(null,G__70804));
})())) && (cljs.core.not((function (){var G__70805 = new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(link);
return (nodes.cljs$core$IFn$_invoke$arity$1 ? nodes.cljs$core$IFn$_invoke$arity$1(G__70805) : nodes.call(null,G__70805));
})())));
}),links);
}));
...
var filter_patterns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__70806_SHARP_){
return cljs.core.re_pattern(["(?i)",frontend.util.regex_escape(p1__70806_SHARP_)].join(''));
}),filters);
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (node){
return cljs.core.some((function (p1__70807_SHARP_){
return cljs.core.re_find(p1__70807_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(node));
}),filter_patterns);
}),nodes);
} else {
return nodes;
...
var search_graph_filters = frontend.state.sub(new cljs.core.Keyword("search","graph-filters","search/graph-filters",1646966152));
var graph__$1 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(graph,new cljs.core.Keyword(null,"nodes","nodes",-2099585805),(function (p1__70808_SHARP_){
return frontend.components.page.filter_graph_nodes(p1__70808_SHARP_,search_graph_filters);
}));
...
var dark_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(theme,"dark");
var graph = (cljs.core.truth_(logseq.graph_parser.util.uuid_string_QMARK_(page))?frontend.handler.graph.build_block_graph(cljs.core.uuid(page),theme):frontend.handler.graph.build_page_graph(page,theme));
...
return daiquiri.core.create_element("label",{'htmlFor':key},[(function (){var attrs70821 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"checked","checked",-50955819),cljs.core.boolean$(checked),new cljs.core.Keyword(null,"ref","ref",1289896967),_STAR_input,new cljs.core.Keyword(null,"id","id",-1388402092),key], null),opts], 0));
return daiquiri.core.create_element("input",((cljs.core.map_QMARK_(attrs70821))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["form-checkbox"], null)], null),attrs70821], 0))):{'className':"form-checkbox"}),((cljs.core.map_QMARK_(attrs70821))?null:[daiquiri.interpreter.interpret(attrs70821)]));
})()]);
...
})},[daiquiri.core.create_element("span",{'className':"flex items-center"},[(function (){var attrs70824 = title;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs70824))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["mr-1"], null)], null),attrs70824], 0))):{'className':"mr-1"}),((cljs.core.map_QMARK_(attrs70824))?null:[daiquiri.interpreter.interpret(attrs70824)]));
})(),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(by_item),key))?(function (){var attrs70825 = (cljs.core.truth_(cljs.core.deref(desc_QMARK_))?frontend.components.svg.caret_down():frontend.components.svg.caret_up());
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs70825))?daiquiri.interpreter.element_attributes(attrs70825):null),((cljs.core.map_QMARK_(attrs70825))?null:[daiquiri.interpreter.interpret(attrs70825)]));
})():null)])])]);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70833),frontend$components$page$batch_delete_dialog_$_iter__70830(cljs.core.chunk_rest(s__70831__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70833),null);
}
} else {
var vec__70838 = cljs.core.first(s__70831__$2);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70838,(0),null);
var map__70841 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70838,(1),null);
var map__70841__$1 = cljs.core.__destructure_map(map__70841);
var page = map__70841__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70841__$1,new cljs.core.Keyword("block","name","block/name",1619760316));
var created_at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70841__$1,new cljs.core.Keyword("block","created-at","block/created-at",1440015));
var updated_at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70841__$1,new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551));
var backlinks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70841__$1,new cljs.core.Keyword("block","backlinks","block/backlinks",1819963441));
...
var seq__70843_71145 = cljs.core.seq(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","name","block/name",1619760316),pages));
var chunk__70844_71146 = null;
var count__70845_71147 = (0);
var i__70846_71148 = (0);
while(true){
if((i__70846_71148 < count__70845_71147)){
var page_name_71149 = chunk__70844_71146.cljs$core$IIndexed$_nth$arity$2(null,i__70846_71148);
frontend.handler.page.delete_BANG_(page_name_71149,((function (seq__70843_71145,chunk__70844_71146,count__70845_71147,i__70846_71148,page_name_71149){
return (function (){
return cljs.core.List.EMPTY;
});})(seq__70843_71145,chunk__70844_71146,count__70845_71147,i__70846_71148,page_name_71149))
);


var G__71150 = seq__70843_71145;
var G__71151 = chunk__70844_71146;
var G__71152 = count__70845_71147;
var G__71153 = (i__70846_71148 + (1));
seq__70843_71145 = G__71150;
chunk__70844_71146 = G__71151;
count__70845_71147 = G__71152;
i__70846_71148 = G__71153;
continue;
} else {
var temp__5720__auto___71154 = cljs.core.seq(seq__70843_71145);
if(temp__5720__auto___71154){
var seq__70843_71155__$1 = temp__5720__auto___71154;
if(cljs.core.chunked_seq_QMARK_(seq__70843_71155__$1)){
var c__4679__auto___71156 = cljs.core.chunk_first(seq__70843_71155__$1);
var G__71157 = cljs.core.chunk_rest(seq__70843_71155__$1);
var G__71158 = c__4679__auto___71156;
var G__71159 = cljs.core.count(c__4679__auto___71156);
var G__71160 = (0);
seq__70843_71145 = G__71157;
chunk__70844_71146 = G__71158;
count__70845_71147 = G__71159;
i__70846_71148 = G__71160;
continue;
} else {
var page_name_71161 = cljs.core.first(seq__70843_71155__$1);
frontend.handler.page.delete_BANG_(page_name_71161,((function (seq__70843_71145,chunk__70844_71146,count__70845_71147,i__70846_71148,page_name_71161,seq__70843_71155__$1,temp__5720__auto___71154){
return (function (){
return cljs.core.List.EMPTY;
});})(seq__70843_71145,chunk__70844_71146,count__70845_71147,i__70846_71148,page_name_71161,seq__70843_71155__$1,temp__5720__auto___71154))
);


var G__71162 = cljs.core.next(seq__70843_71155__$1);
var G__71163 = null;
var G__71164 = (0);
var G__71165 = (0);
seq__70843_71145 = G__71162;
chunk__70844_71146 = G__71163;
count__70845_71147 = G__71164;
i__70846_71148 = G__71165;
continue;
}
} else {
}
...
var _STAR_indeterminate = (function (){var G__70854 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [_STAR_checks], null);
var G__70855 = new cljs.core.Keyword("frontend.components.page","indeterminate","frontend.components.page/indeterminate",1341570075);
var G__70856 = (function (checks){
...
return (rum.core.derived_atom.cljs$core$IFn$_invoke$arity$3 ? rum.core.derived_atom.cljs$core$IFn$_invoke$arity$3(G__70854,G__70855,G__70856) : rum.core.derived_atom.call(null,G__70854,G__70855,G__70856));
})();
...
return daiquiri.core.create_element("div",{'className':"flex-1 cp__all_pages"},[(function (){var attrs70861 = frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"all-pages","all-pages",1017563062)], 0));
return daiquiri.core.create_element("h1",((cljs.core.map_QMARK_(attrs70861))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["title"], null)], null),attrs70861], 0))):{'className':"title"}),((cljs.core.map_QMARK_(attrs70861))?null:[daiquiri.interpreter.interpret(attrs70861)]));
})(),(cljs.core.truth_(current_repo)?(function (){
if((cljs.core.deref(_STAR_pages) == null)){
var pages_71166 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (idx,page){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(page,new cljs.core.Keyword("block","backlinks","block/backlinks",1819963441),cljs.core.count(new cljs.core.Keyword("block","_refs","block/_refs",830218531).cljs$core$IFn$_invoke$arity$1((function (){var G__70870 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__70870) : frontend.db.entity.call(null,G__70870));
...
return frontend.components.page.sort_pages_by(sort_by_item,desc_QMARK_,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__70847_SHARP_){
return ((cljs.core.boolean$(journal_QMARK_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,cljs.core.boolean$(new cljs.core.Keyword("block","journal?","block/journal?",-970683127).cljs$core$IFn$_invoke$arity$1(p1__70847_SHARP_)))));
}),pages_71166));
})));

daiquiri.interpreter.interpret(cljs.core.reset_BANG_(_STAR_pages,pages_71166));
} else {
}

if(cljs.core.truth_(cljs.core.deref(_STAR_filter_fn))){
var pages_71167 = (function (){var G__70880 = cljs.core.deref(_STAR_sort_by_item);
var G__70881 = cljs.core.deref(_STAR_desc_QMARK_);
var G__70882 = cljs.core.deref(_STAR_journal_QMARK_);
var fexpr__70879 = cljs.core.deref(_STAR_filter_fn);
return (fexpr__70879.cljs$core$IFn$_invoke$arity$3 ? fexpr__70879.cljs$core$IFn$_invoke$arity$3(G__70880,G__70881,G__70882) : fexpr__70879.call(null,G__70880,G__70881,G__70882));
})();
var pages_71168__$1 = (((!(clojure.string.blank_QMARK_(cljs.core.deref(_STAR_search_key)))))?frontend.search.fuzzy_search.cljs$core$IFn$_invoke$arity$variadic(pages_71167,frontend.util.page_name_sanity_lc(cljs.core.deref(_STAR_search_key)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"limit","limit",-1355822363),(20),new cljs.core.Keyword(null,"extract-fn","extract-fn",-339752723),new cljs.core.Keyword("block","name","block/name",1619760316)], 0)):pages_71167);
var __71169 = cljs.core.reset_BANG_(_STAR_results_all,pages_71168__$1);
var pages_71170__$2 = cljs.core.take.cljs$core$IFn$_invoke$arity$2(per_page_num,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((per_page_num * (cljs.core.deref(_STAR_current_page) - (1))),pages_71168__$1));
cljs.core.reset_BANG_(_STAR_checks,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4652__auto__ = (function frontend$components$page$iter__70883(s__70884){
return (new cljs.core.LazySeq(null,(function (){
var s__70884__$1 = s__70884;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__70884__$1);
if(temp__5720__auto__){
var s__70884__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70884__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__70884__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__70886 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__70885 = (0);
while(true){
if((i__70885 < size__4651__auto__)){
var map__70887 = cljs.core._nth(c__4650__auto__,i__70885);
var map__70887__$1 = cljs.core.__destructure_map(map__70887);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70887__$1,new cljs.core.Keyword("block","idx","block/idx",1480967726));
cljs.core.chunk_append(b__70886,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,cljs.core.boolean$(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(_STAR_checks),idx))], null));

var G__71171 = (i__70885 + (1));
i__70885 = G__71171;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70886),frontend$components$page$iter__70883(cljs.core.chunk_rest(s__70884__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70886),null);
}
} else {
var map__70889 = cljs.core.first(s__70884__$2);
var map__70889__$1 = cljs.core.__destructure_map(map__70889);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70889__$1,new cljs.core.Keyword("block","idx","block/idx",1480967726));
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,cljs.core.boolean$(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(_STAR_checks),idx))], null),frontend$components$page$iter__70883(cljs.core.rest(s__70884__$2)));
}
} else {
return null;
}
...
return iter__4652__auto__(pages_71170__$2);
})()));

daiquiri.interpreter.interpret(cljs.core.reset_BANG_(_STAR_results,pages_71170__$2));
} else {
}
...
var selected = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__70894){
var vec__70898 = p__70894;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70898,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70898,(1),null);
return v;
}),cljs.core.deref(_STAR_checks));
var selected__$1 = (function (){var and__4251__auto__ = cljs.core.seq(selected);
if(and__4251__auto__){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,(function (){var iter__4652__auto__ = (function frontend$components$page$iter__70901(s__70902){
return (new cljs.core.LazySeq(null,(function (){
var s__70902__$1 = s__70902;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__70902__$1);
if(temp__5720__auto__){
var s__70902__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70902__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__70902__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__70904 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__70903 = (0);
while(true){
if((i__70903 < size__4651__auto__)){
var vec__70905 = cljs.core._nth(c__4650__auto__,i__70903);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70905,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70905,(1),null);
cljs.core.chunk_append(b__70904,k);

var G__71172 = (i__70903 + (1));
i__70903 = G__71172;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70904),frontend$components$page$iter__70901(cljs.core.chunk_rest(s__70902__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70904),null);
}
} else {
var vec__70908 = cljs.core.first(s__70902__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70908,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70908,(1),null);
return cljs.core.cons(k,frontend$components$page$iter__70901(cljs.core.rest(s__70902__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__70848_SHARP_){
return cljs.core.contains_QMARK_(selected__$1,new cljs.core.Keyword("block","idx","block/idx",1480967726).cljs$core$IFn$_invoke$arity$1(p1__70848_SHARP_));
...
var seq__70984 = cljs.core.seq(cljs.core.deref(_STAR_results));
var chunk__70985 = null;
var count__70986 = (0);
var i__70987 = (0);
while(true){
if((i__70987 < count__70986)){
var map__70994 = chunk__70985.cljs$core$IIndexed$_nth$arity$2(null,i__70987);
var map__70994__$1 = cljs.core.__destructure_map(map__70994);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70994__$1,new cljs.core.Keyword("block","idx","block/idx",1480967726));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(_STAR_checks,cljs.core.assoc,idx,((indeterminate_QMARK_) || ((!(all_QMARK_)))));


var G__71173 = seq__70984;
var G__71174 = chunk__70985;
var G__71175 = count__70986;
var G__71176 = (i__70987 + (1));
seq__70984 = G__71173;
chunk__70985 = G__71174;
count__70986 = G__71175;
i__70987 = G__71176;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__70984);
if(temp__5720__auto__){
var seq__70984__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__70984__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__70984__$1);
var G__71177 = cljs.core.chunk_rest(seq__70984__$1);
var G__71178 = c__4679__auto__;
var G__71179 = cljs.core.count(c__4679__auto__);
var G__71180 = (0);
seq__70984 = G__71177;
chunk__70985 = G__71178;
count__70986 = G__71179;
i__70987 = G__71180;
continue;
} else {
var map__70995 = cljs.core.first(seq__70984__$1);
var map__70995__$1 = cljs.core.__destructure_map(map__70995);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70995__$1,new cljs.core.Keyword("block","idx","block/idx",1480967726));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(_STAR_checks,cljs.core.assoc,idx,((indeterminate_QMARK_) || ((!(all_QMARK_)))));


var G__71181 = cljs.core.next(seq__70984__$1);
var G__71182 = null;
var G__71183 = (0);
var G__71184 = (0);
seq__70984 = G__71181;
chunk__70985 = G__71182;
count__70986 = G__71183;
i__70987 = G__71184;
continue;
}
} else {
...
}),new cljs.core.Keyword(null,"indeterminate","indeterminate",-513040976),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((-1),cljs.core.deref(_STAR_indeterminate))], null))]),frontend.components.page.sortable_title(frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("block","name","block/name",1619760316)], 0)),new cljs.core.Keyword("block","name","block/name",1619760316),_STAR_sort_by_item,_STAR_desc_QMARK_),(cljs.core.truth_(mobile_QMARK_)?null:daiquiri.interpreter.interpret(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.components.page.sortable_title(frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("page","backlinks","page/backlinks",1645776383)], 0)),new cljs.core.Keyword("block","backlinks","block/backlinks",1819963441),_STAR_sort_by_item,_STAR_desc_QMARK_),frontend.components.page.sortable_title(frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("page","created-at","page/created-at",-84781299)], 0)),new cljs.core.Keyword("block","created-at","block/created-at",1440015),_STAR_sort_by_item,_STAR_desc_QMARK_),frontend.components.page.sortable_title(frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("page","updated-at","page/updated-at",-1598282641)], 0)),new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551),_STAR_sort_by_item,_STAR_desc_QMARK_)], null)))])]),daiquiri.core.create_element("tbody",null,[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function frontend$components$page$iter__71002(s__71003){
return (new cljs.core.LazySeq(null,(function (){
var s__71003__$1 = s__71003;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__71003__$1);
if(temp__5720__auto__){
var s__71003__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__71003__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__71003__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__71005 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__71004 = (0);
while(true){
if((i__71004 < size__4651__auto__)){
var map__71010 = cljs.core._nth(c__4650__auto__,i__71004);
var map__71010__$1 = cljs.core.__destructure_map(map__71010);
var page = map__71010__$1;
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71010__$1,new cljs.core.Keyword("block","idx","block/idx",1480967726));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71010__$1,new cljs.core.Keyword("block","name","block/name",1619760316));
var created_at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71010__$1,new cljs.core.Keyword("block","created-at","block/created-at",1440015));
var updated_at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71010__$1,new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551));
var backlinks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71010__$1,new cljs.core.Keyword("block","backlinks","block/backlinks",1819963441));
cljs.core.chunk_append(b__71005,((clojure.string.blank_QMARK_(name))?null:daiquiri.core.create_element("tr",{'key':name},[daiquiri.core.create_element("td",{'className':"selector"},[frontend.components.page.checkbox_opt(["label-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx)].join(''),cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(_STAR_checks),idx),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__71004,map__71010,map__71010__$1,page,idx,name,created_at,updated_at,backlinks,c__4650__auto__,size__4651__auto__,b__71005,s__71003__$2,temp__5720__auto__,current_repo,per_page_num,_STAR_sort_by_item,_STAR_desc_QMARK_,_STAR_journal_QMARK_,_STAR_results,_STAR_results_all,_STAR_checks,_STAR_pages,_STAR_current_page,_STAR_filter_fn,_STAR_search_key,_STAR_search_input,_STAR_indeterminate,mobile_QMARK_,total_pages,to_page,search_key,refresh_pages){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(_STAR_checks,cljs.core.update,idx,cljs.core.not);
});})(i__71004,map__71010,map__71010__$1,page,idx,name,created_at,updated_at,backlinks,c__4650__auto__,size__4651__auto__,b__71005,s__71003__$2,temp__5720__auto__,current_repo,per_page_num,_STAR_sort_by_item,_STAR_desc_QMARK_,_STAR_journal_QMARK_,_STAR_results,_STAR_results_all,_STAR_checks,_STAR_pages,_STAR_current_page,_STAR_filter_fn,_STAR_search_key,_STAR_search_input,_STAR_indeterminate,mobile_QMARK_,total_pages,to_page,search_key,refresh_pages))
], null))]),daiquiri.core.create_element("td",{'className':"name"},[daiquiri.core.create_element("a",{'onClick':((function (i__71004,map__71010,map__71010__$1,page,idx,name,created_at,updated_at,backlinks,c__4650__auto__,size__4651__auto__,b__71005,s__71003__$2,temp__5720__auto__,current_repo,per_page_num,_STAR_sort_by_item,_STAR_desc_QMARK_,_STAR_journal_QMARK_,_STAR_results,_STAR_results_all,_STAR_checks,_STAR_pages,_STAR_current_page,_STAR_filter_fn,_STAR_search_key,_STAR_search_input,_STAR_indeterminate,mobile_QMARK_,total_pages,to_page,search_key,refresh_pages){
return (function (e){
var repo = frontend.state.get_current_repo();
if(cljs.core.truth_(frontend.components.page.goog$module$goog$object.get(e,"shiftKey"))){
return frontend.state.sidebar_add_block_BANG_(repo,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page),new cljs.core.Keyword(null,"page","page",849072397));
...
,'href':reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword("block","name","block/name",1619760316).cljs$core$IFn$_invoke$arity$1(page)], null))},[frontend.components.block.page_cp(cljs.core.PersistentArrayMap.EMPTY,page)])]),(cljs.core.truth_(mobile_QMARK_)?null:daiquiri.core.create_element("td",{'className':"backlinks"},[(function (){var attrs71029 = backlinks;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs71029))?daiquiri.interpreter.element_attributes(attrs71029):null),((cljs.core.map_QMARK_(attrs71029))?null:[daiquiri.interpreter.interpret(attrs71029)]));
})()])),(cljs.core.truth_(mobile_QMARK_)?null:daiquiri.core.create_element("td",{'className':"created-at"},[(function (){var attrs71034 = (cljs.core.truth_(created_at)?frontend.date.int__GT_local_time_2(created_at):"Unknown");
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs71034))?daiquiri.interpreter.element_attributes(attrs71034):null),((cljs.core.map_QMARK_(attrs71034))?null:[daiquiri.interpreter.interpret(attrs71034)]));
})()])),(cljs.core.truth_(mobile_QMARK_)?null:daiquiri.core.create_element("td",{'className':"updated-at"},[(function (){var attrs71035 = (cljs.core.truth_(updated_at)?frontend.date.int__GT_local_time_2(updated_at):"Unknown");
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs71035))?daiquiri.interpreter.element_attributes(attrs71035):null),((cljs.core.map_QMARK_(attrs71035))?null:[daiquiri.interpreter.interpret(attrs71035)]));
})()]))])));

var G__71185 = (i__71004 + (1));
i__71004 = G__71185;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__71005),frontend$components$page$iter__71002(cljs.core.chunk_rest(s__71003__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__71005),null);
}
} else {
var map__71044 = cljs.core.first(s__71003__$2);
var map__71044__$1 = cljs.core.__destructure_map(map__71044);
var page = map__71044__$1;
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71044__$1,new cljs.core.Keyword("block","idx","block/idx",1480967726));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71044__$1,new cljs.core.Keyword("block","name","block/name",1619760316));
var created_at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71044__$1,new cljs.core.Keyword("block","created-at","block/created-at",1440015));
var updated_at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71044__$1,new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551));
var backlinks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71044__$1,new cljs.core.Keyword("block","backlinks","block/backlinks",1819963441));
return cljs.core.cons(((clojure.string.blank_QMARK_(name))?null:daiquiri.core.create_element("tr",{'key':name},[daiquiri.core.create_element("td",{'className':"selector"},[frontend.components.page.checkbox_opt(["label-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx)].join(''),cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(_STAR_checks),idx),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__71044,map__71044__$1,page,idx,name,created_at,updated_at,backlinks,s__71003__$2,temp__5720__auto__,current_repo,per_page_num,_STAR_sort_by_item,_STAR_desc_QMARK_,_STAR_journal_QMARK_,_STAR_results,_STAR_results_all,_STAR_checks,_STAR_pages,_STAR_current_page,_STAR_filter_fn,_STAR_search_key,_STAR_search_input,_STAR_indeterminate,mobile_QMARK_,total_pages,to_page,search_key,refresh_pages){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(_STAR_checks,cljs.core.update,idx,cljs.core.not);
});})(map__71044,map__71044__$1,page,idx,name,created_at,updated_at,backlinks,s__71003__$2,temp__5720__auto__,current_repo,per_page_num,_STAR_sort_by_item,_STAR_desc_QMARK_,_STAR_journal_QMARK_,_STAR_results,_STAR_results_all,_STAR_checks,_STAR_pages,_STAR_current_page,_STAR_filter_fn,_STAR_search_key,_STAR_search_input,_STAR_indeterminate,mobile_QMARK_,total_pages,to_page,search_key,refresh_pages))
], null))]),daiquiri.core.create_element("td",{'className':"name"},[daiquiri.core.create_element("a",{'onClick':((function (map__71044,map__71044__$1,page,idx,name,created_at,updated_at,backlinks,s__71003__$2,temp__5720__auto__,current_repo,per_page_num,_STAR_sort_by_item,_STAR_desc_QMARK_,_STAR_journal_QMARK_,_STAR_results,_STAR_results_all,_STAR_checks,_STAR_pages,_STAR_current_page,_STAR_filter_fn,_STAR_search_key,_STAR_search_input,_STAR_indeterminate,mobile_QMARK_,total_pages,to_page,search_key,refresh_pages){
return (function (e){
var repo = frontend.state.get_current_repo();
if(cljs.core.truth_(frontend.components.page.goog$module$goog$object.get(e,"shiftKey"))){
return frontend.state.sidebar_add_block_BANG_(repo,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page),new cljs.core.Keyword(null,"page","page",849072397));
...
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs71035))?daiquiri.interpreter.element_attributes(attrs71035):null),((cljs.core.map_QMARK_(attrs71035))?null:[daiquiri.interpreter.interpret(attrs71035)]));
})()]))])),frontend$components$page$iter__71002(cljs.core.rest(s__71003__$2)));
}
} else {
return null;
}
