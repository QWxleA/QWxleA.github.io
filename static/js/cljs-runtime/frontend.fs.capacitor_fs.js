...
return promesa.protocols._promise((function (){var internal_loop_fn_name28387 = (function frontend$fs$capacitor_fs$readdir_$_internal_loop_fn_name28387(result43615,dirs43616){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.all(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [result43615,dirs43616], null)),(function (p__43651){
var vec__43652 = p__43651;
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43652,(0),null);
var dirs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43652,(1),null);
...
return promesa.core.chain.cljs$core$IFn$_invoke$arity$2(module$node_modules$$capacitor$filesystem$dist$plugin_cjs.Filesystem.stat(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"path","path",-188191168),file], null))),(function (p1__43610_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__43610_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
}));
}),files__$3)),(function (files_with_stats){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"uri","uri",-774711847),cljs.core.filterv((function (p__43658){
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(promesa.core.all(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__43660){
var map__43661 = p__43660;
var map__43661__$1 = cljs.core.__destructure_map(map__43661);
var file_result = map__43661__$1;
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43661__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
return promesa.core.chain.cljs$core$IFn$_invoke$arity$variadic(frontend.fs.capacitor_fs.read_file_utf8(uri),(function (p1__43613_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__43613_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"data","data",-232669377),(function (p1__43614_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(file_result,new cljs.core.Keyword(null,"content","content",15833224),p1__43614_SHARP_);
})], 0));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__43662){
var map__43663 = p__43662;
var map__43663__$1 = cljs.core.__destructure_map(map__43663);
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43663__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
return cljs.core.some((function (p1__43612_SHARP_){
return clojure.string.ends_with_QMARK_(uri,p1__43612_SHARP_);
}),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [".md",".markdown",".org",".edn",".css"], null));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__43667){
var map__43668 = p__43667;
var map__43668__$1 = cljs.core.__destructure_map(map__43668);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43668__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
frontend.fs.capacitor_fs.write_file_impl_BANG_ = (function frontend$fs$capacitor_fs$write_file_impl_BANG_(_this,repo,_dir,path,content,p__43673,stat){
var map__43674 = p__43673;
var map__43674__$1 = cljs.core.__destructure_map(map__43674);
var ok_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43674__$1,new cljs.core.Keyword(null,"ok-handler","ok-handler",-804644089));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43674__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var old_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43674__$1,new cljs.core.Keyword(null,"old-content","old-content",1851086779));
var skip_compare_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43674__$1,new cljs.core.Keyword(null,"skip-compare?","skip-compare?",82692960));
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___28360__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.chain.cljs$core$IFn$_invoke$arity$variadic(frontend.fs.capacitor_fs.read_file_utf8(path),(function (p1__43672_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__43672_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
...
var or__5043__auto____$1 = (function (){var G__43675 = repo;
var G__43676 = decodeURI(path);
return (frontend.db.get_file.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_file.cljs$core$IFn$_invoke$arity$2(G__43675,G__43676) : frontend.db.get_file.call(null,G__43675,G__43676));
})();
if(cljs.core.truth_(or__5043__auto____$1)){
return or__5043__auto____$1;
} else {
...
return promesa.protocols._promise((function (){var G__43678 = repo;
var G__43679 = decodeURI(path);
var G__43680 = content__$1;
return (frontend.db.set_file_content_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.db.set_file_content_BANG_.cljs$core$IFn$_invoke$arity$3(G__43678,G__43679,G__43680) : frontend.db.set_file_content_BANG_.call(null,G__43678,G__43679,G__43680));
})());
}));
}));
...
var vec__43682 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43681_SHARP_){
var G__43685 = p1__43681_SHARP_;
if((G__43685 == null)){
return null;
} else {
return decodeURI(G__43685);
}
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dir,path], null));
var dir__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43682,(0),null);
var path__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43682,(1),null);
var dir__$2 = clojure.string.replace(dir__$1,/\/+$/,"");
var path__$2 = (function (){var G__43686 = path__$1;
if((G__43686 == null)){
return null;
} else {
return clojure.string.replace(G__43686,/^\/+/,"");
}
})();
...
(frontend.fs.capacitor_fs.Capacitorfs.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k43693,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__43698 = k43693;
switch (G__43698) {
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43693,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__43699){
var vec__43700 = p__43699;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43700,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43700,(1),null);
...
(frontend.fs.capacitor_fs.Capacitorfs.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__43692){
var self__ = this;
var G__43692__$1 = this;
return (new cljs.core.RecordIter((0),G__43692__$1,0,cljs.core.PersistentVector.EMPTY,(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(frontend.fs.capacitor_fs.Capacitorfs.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43694,other43695){
var self__ = this;
var this43694__$1 = this;
return (((!((other43695 == null)))) && ((((this43694__$1.constructor === other43695.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43694__$1.__extmap,other43695.__extmap)))));
}));
...
(frontend.fs.capacitor_fs.Capacitorfs.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k43693){
var self__ = this;
var this__5347__auto____$1 = this;
return cljs.core.contains_QMARK_(self__.__extmap,k43693);
}));

(frontend.fs.capacitor_fs.Capacitorfs.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__43692){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__43704 = cljs.core.keyword_identical_QMARK_;
var expr__43705 = k__5349__auto__;
return (new frontend.fs.capacitor_fs.Capacitorfs(self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__43692),null));
}));
...
(frontend.fs.capacitor_fs.Capacitorfs.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__43692){
var self__ = this;
var this__5339__auto____$1 = this;
return (new frontend.fs.capacitor_fs.Capacitorfs(G__43692,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var _this__$1 = this;
var vec__43707 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43690_SHARP_){
return frontend.fs.capacitor_fs.get_file_path("",p1__43690_SHARP_);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [old_path,new_path], null));
var old_path__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43707,(0),null);
var new_path__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43707,(1),null);
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___28360__auto__){
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(promesa.core.chain.cljs$core$IFn$_invoke$arity$2(frontend.mobile.util.folder_picker.pickFolder(),(function (p1__43691_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__43691_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
})),(function (p__43710){
var map__43711 = p__43710;
var map__43711__$1 = cljs.core.__destructure_map(map__43711);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43711__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var localDocumentsPath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43711__$1,new cljs.core.Keyword(null,"localDocumentsPath","localDocumentsPath",1185925114));
...
(frontend.fs.capacitor_fs.Capacitorfs.prototype.frontend$fs$protocol$Fs$delete_file_BANG_$arity$5 = (function (_this,repo,dir,path,p__43712){
var self__ = this;
var map__43713 = p__43712;
var map__43713__$1 = cljs.core.__destructure_map(map__43713);
var ok_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43713__$1,new cljs.core.Keyword(null,"ok-handler","ok-handler",-804644089));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43713__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var _this__$1 = this;
var path__$1 = frontend.fs.capacitor_fs.get_file_path(dir,path);
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___28360__auto__){
 ...
 */
frontend.fs.capacitor_fs.map__GT_Capacitorfs = (function frontend$fs$capacitor_fs$map__GT_Capacitorfs(G__43697){
var extmap__5382__auto__ = (function (){var G__43714 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$1(G__43697);
if(cljs.core.record_QMARK_(G__43697)){
