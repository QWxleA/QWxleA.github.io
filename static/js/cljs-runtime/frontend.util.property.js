...
return cljs.core.boolean$((function (){var and__4251__auto__ = typeof line === 'string';
if(and__4251__auto__){
var and__4251__auto____$1 = frontend.util.safe_re_find(/^\s*:[^: ]+: /,line);
...
var vec__63844 = cljs.core.split_with((function (p1__63841_SHARP_){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(p1__63841_SHARP_)),logseq.graph_parser.property.properties_start)));
}),content_lines);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63844,(0),null);
var properties_AMPERSAND_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63844,(1),null);
var properties = cljs.core.rest(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__63842_SHARP_){
return (((!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.trim(p1__63842_SHARP_)),logseq.graph_parser.property.properties_end)))) || (clojure.string.blank_QMARK_(p1__63842_SHARP_)));
}),properties_AMPERSAND_body));
if(cljs.core.seq(properties)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63843_SHARP_){
return clojure.string.upper_case(cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__63843_SHARP_,":"))));
}),properties);
} else {
return null;
}
...
var content_lines = clojure.string.split_lines(content);
var properties = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63847_SHARP_){
return cljs.core.re_matches(/^.+::\s*.+/,p1__63847_SHARP_);
}),content_lines);
if(cljs.core.seq(properties)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63848_SHARP_){
return clojure.string.upper_case(cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__63848_SHARP_,"::"))));
}),properties);
} else {
return null;
}
...
var vec__63852 = cljs.core.split_with((function (p1__63850_SHARP_){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(p1__63850_SHARP_)),logseq.graph_parser.property.properties_start)));
}),lines);
var title_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63852,(0),null);
var properties_AMPERSAND_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63852,(1),null);
var body = cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__63851_SHARP_){
return (((!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.trim(p1__63851_SHARP_)),logseq.graph_parser.property.properties_end)))) || (clojure.string.blank_QMARK_(p1__63851_SHARP_)));
}),properties_AMPERSAND_body);
...
var properties_content = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__63856){
var vec__63857 = p__63856;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63857,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63857,(1),null);
...
var org_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,new cljs.core.Keyword(null,"org","org",1495985));
var properties__$1 = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__63861){
var vec__63862 = p__63861;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63862,(0),null);
var _v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63862,(1),null);
var fexpr__63865 = frontend.util.property.built_in_properties();
return (fexpr__63865.cljs$core$IFn$_invoke$arity$1 ? fexpr__63865.cljs$core$IFn$_invoke$arity$1(k) : fexpr__63865.call(null,k));
}),properties);
...
var map__63869 = cljs.core.group_by((function (s){
...
var properties_lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63869__$1,true);
var body__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63869__$1,false);
...
var properties_in_content = cljs.core.set(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63860_SHARP_){
return frontend.util.property.get_property_key(p1__63860_SHARP_,format);
}),properties_lines)));
...
var built_in_properties_area = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__63873){
...
var has_properties_QMARK_ = ((((title_QMARK_) && (((frontend.format.mldoc.properties_QMARK_(cljs.core.second(ast))) || (frontend.format.mldoc.properties_QMARK_(cljs.core.second(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__63891){
var vec__63892 = p__63891;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63892,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63892,(1),null);
...
var lines = clojure.string.split_lines(content);
var vec__63888 = ((title_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(lines),clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.rest(lines))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",lines)], null));
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63888,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63888,(1),null);
var scheduled = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63877_SHARP_){
return clojure.string.starts_with_QMARK_(p1__63877_SHARP_,"SCHEDULED");
}),lines);
var deadline = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63878_SHARP_){
return clojure.string.starts_with_QMARK_(p1__63878_SHARP_,"DEADLINE");
}),lines);
var body_without_timestamps = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63879_SHARP_){
return (!(((clojure.string.starts_with_QMARK_(p1__63879_SHARP_,"SCHEDULED")) || (clojure.string.starts_with_QMARK_(p1__63879_SHARP_,"DEADLINE")))));
...
var vec__63898 = logseq.graph_parser.util.split_first(":",cljs.core.subs.cljs$core$IFn$_invoke$arity$2(text,(1)));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63898,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63898,(1),null);
...
if(cljs.core.truth_((function (){var G__63901 = cljs.core.first(lines__$1);
return (property_f.cljs$core$IFn$_invoke$arity$1 ? property_f.cljs$core$IFn$_invoke$arity$1(G__63901) : property_f.call(null,G__63901));
})())){
var lines__$2 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (text){
var vec__63902 = logseq.graph_parser.util.split_first(sym,text);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63902,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63902,(1),null);
if(cljs.core.truth_((function (){var and__4251__auto__ = k;
if(cljs.core.truth_(and__4251__auto__)){
return v;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (content__$1,p__63907){
var vec__63908 = p__63907;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63908,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63908,(1),null);
...
var v__$1 = ((cljs.core.coll_QMARK_(v))?(function (){var G__63911 = cljs.core.seq(v);
var G__63911__$1 = (((G__63911 == null))?null:cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(G__63911));
var G__63911__$2 = (((G__63911__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (item){
...
if((G__63911__$2 == null)){
return null;
} else {
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",G__63911__$2);
}
})():v);
...
var lines = (function (){var G__63914 = (function (line){
...
var G__63915 = clojure.string.split_lines(content);
return (remove_f.cljs$core$IFn$_invoke$arity$2 ? remove_f.cljs$core$IFn$_invoke$arity$2(G__63914,G__63915) : remove_f.call(null,G__63914,G__63915));
})();
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",lines);
}
} else {
...
var prefix_f = (function (){var G__63918 = page_format;
var G__63918__$1 = (((G__63918 instanceof cljs.core.Keyword))?G__63918.fqn:null);
switch (G__63918__$1) {
case "org":
return (function (k){
...
var result = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63917_SHARP_){
var and__4251__auto__ = p1__63917_SHARP_;
if(cljs.core.truth_(and__4251__auto__)){
return frontend.util.starts_with_QMARK_(line,(prefix_f.cljs$core$IFn$_invoke$arity$1 ? prefix_f.cljs$core$IFn$_invoke$arity$1(p1__63917_SHARP_) : prefix_f.call(null,p1__63917_SHARP_)));
} else {
return and__4251__auto__;
}
}),property_keys);
...
var lines__$3 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(lines__$2,(function (){var not_exists = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__63920){
var vec__63921 = p__63920;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63921,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63921,(1),null);
return cljs.core.contains_QMARK_(cljs.core.deref(exists_QMARK_),k);
}),properties__$1);
if(cljs.core.seq(not_exists)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__63925){
