...
var vec__43930 = cljs.core.split_with((function (p1__43927_SHARP_){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(p1__43927_SHARP_)),logseq.graph_parser.property.properties_start)));
}),content_lines);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43930,(0),null);
var properties_AMPERSAND_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43930,(1),null);
var properties = cljs.core.rest(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__43928_SHARP_){
return (((!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.trim(p1__43928_SHARP_)),logseq.graph_parser.property.properties_end)))) || (clojure.string.blank_QMARK_(p1__43928_SHARP_)));
}),properties_AMPERSAND_body));
if(cljs.core.seq(properties)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43929_SHARP_){
return clojure.string.upper_case(cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__43929_SHARP_,":"))));
}),properties);
} else {
return null;
}
...
var content_lines = clojure.string.split_lines(content);
var properties = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43935_SHARP_){
return cljs.core.re_matches(/^.+::\s*.+/,p1__43935_SHARP_);
}),content_lines);
if(cljs.core.seq(properties)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43936_SHARP_){
return clojure.string.upper_case(cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__43936_SHARP_,"::"))));
}),properties);
} else {
return null;
}
...
var vec__43976 = cljs.core.split_with((function (p1__43954_SHARP_){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(p1__43954_SHARP_)),logseq.graph_parser.property.properties_start)));
}),lines);
var title_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43976,(0),null);
var properties_AMPERSAND_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43976,(1),null);
var body = cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__43959_SHARP_){
return (((!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.trim(p1__43959_SHARP_)),logseq.graph_parser.property.properties_end)))) || (clojure.string.blank_QMARK_(p1__43959_SHARP_)));
}),properties_AMPERSAND_body);
...
var org_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,new cljs.core.Keyword(null,"org","org",1495985));
var properties__$1 = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__43997){
var vec__43998 = p__43997;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43998,(0),null);
var _v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43998,(1),null);
var fexpr__44001 = frontend.util.property.built_in_properties();
return (fexpr__44001.cljs$core$IFn$_invoke$arity$1 ? fexpr__44001.cljs$core$IFn$_invoke$arity$1(k) : fexpr__44001.call(null,k));
}),properties);
...
var map__44005 = cljs.core.group_by((function (s){
...
var properties_lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44005__$1,true);
var body__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44005__$1,false);
...
var properties_in_content = cljs.core.set(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43996_SHARP_){
return frontend.util.property.get_property_key(p1__43996_SHARP_,format);
}),properties_lines)));
...
var built_in_properties_area = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__44006){
...
var has_properties_QMARK_ = ((((title_QMARK_) && (((frontend.format.mldoc.properties_QMARK_(cljs.core.second(ast))) || (frontend.format.mldoc.properties_QMARK_(cljs.core.second(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__44022){
var vec__44024 = p__44022;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44024,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44024,(1),null);
...
var lines = clojure.string.split_lines(content);
var vec__44017 = ((title_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(lines),clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.rest(lines))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",lines)], null));
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44017,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44017,(1),null);
var scheduled = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44010_SHARP_){
return clojure.string.starts_with_QMARK_(p1__44010_SHARP_,"SCHEDULED");
}),lines);
var deadline = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44011_SHARP_){
return clojure.string.starts_with_QMARK_(p1__44011_SHARP_,"DEADLINE");
}),lines);
var body_without_timestamps = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44012_SHARP_){
return (!(((clojure.string.starts_with_QMARK_(p1__44012_SHARP_,"SCHEDULED")) || (clojure.string.starts_with_QMARK_(p1__44012_SHARP_,"DEADLINE")))));
...
var vec__44036 = logseq.graph_parser.util.split_first(":",cljs.core.subs.cljs$core$IFn$_invoke$arity$2(text,(1)));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44036,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44036,(1),null);
...
if(cljs.core.truth_((function (){var G__44046 = cljs.core.first(lines__$1);
return (property_f.cljs$core$IFn$_invoke$arity$1 ? property_f.cljs$core$IFn$_invoke$arity$1(G__44046) : property_f.call(null,G__44046));
})())){
var lines__$2 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (text){
var vec__44048 = logseq.graph_parser.util.split_first(sym,text);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44048,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44048,(1),null);
if(cljs.core.truth_((function (){var and__5041__auto__ = k;
if(cljs.core.truth_(and__5041__auto__)){
return v;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (content__$1,p__44054){
var vec__44055 = p__44054;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44055,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44055,(1),null);
...
var v__$1 = ((cljs.core.coll_QMARK_(v))?(function (){var G__44058 = cljs.core.seq(v);
var G__44058__$1 = (((G__44058 == null))?null:cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(G__44058));
var G__44058__$2 = (((G__44058__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (item){
...
if((G__44058__$2 == null)){
return null;
} else {
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",G__44058__$2);
}
})():v);
...
var lines = (function (){var G__44072 = (function (line){
...
var G__44073 = clojure.string.split_lines(content);
return (remove_f.cljs$core$IFn$_invoke$arity$2 ? remove_f.cljs$core$IFn$_invoke$arity$2(G__44072,G__44073) : remove_f.call(null,G__44072,G__44073));
})();
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",lines);
}
} else {
...
var prefix_f = (function (){var G__44083 = page_format;
...
var result = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44080_SHARP_){
var and__5041__auto__ = p1__44080_SHARP_;
if(cljs.core.truth_(and__5041__auto__)){
return frontend.util.starts_with_QMARK_(line,(prefix_f.cljs$core$IFn$_invoke$arity$1 ? prefix_f.cljs$core$IFn$_invoke$arity$1(p1__44080_SHARP_) : prefix_f.call(null,p1__44080_SHARP_)));
} else {
return and__5041__auto__;
}
}),property_keys);
...
var lines__$3 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(lines__$2,(function (){var not_exists = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__44088){
var vec__44089 = p__44088;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44089,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44089,(1),null);
return cljs.core.contains_QMARK_(cljs.core.deref(exists_QMARK_),k);
}),properties__$1);
if(cljs.core.seq(not_exists)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__44092){
var vec__44093 = p__44092;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44093,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44093,(1),null);
