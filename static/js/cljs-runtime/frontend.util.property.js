...
if((typeof frontend !== 'undefined') && (typeof frontend.util !== 'undefined') && (typeof frontend.util.property !== 'undefined') && (typeof frontend.util.property.properties_start !== 'undefined')){
} else {
frontend.util.property.properties_start = ":PROPERTIES:";
}
if((typeof frontend !== 'undefined') && (typeof frontend.util !== 'undefined') && (typeof frontend.util.property !== 'undefined') && (typeof frontend.util.property.properties_end !== 'undefined')){
} else {
frontend.util.property.properties_end = ":END:";
}
if((typeof frontend !== 'undefined') && (typeof frontend.util !== 'undefined') && (typeof frontend.util.property !== 'undefined') && (typeof frontend.util.property.properties_end_pattern !== 'undefined')){
} else {
frontend.util.property.properties_end_pattern = cljs.core.re_pattern(frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("%s[\t\r ]*\n|(%s\\s*$)",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([frontend.util.property.properties_end,frontend.util.property.properties_end], 0)));
}
...
var and__4251__auto__ = cljs.core.seq(properties);
...
frontend.util.property.contains_properties_QMARK_ = (function frontend$util$property$contains_properties_QMARK_(content){
if(cljs.core.truth_(content)){
var and__4251__auto__ = clojure.string.includes_QMARK_(content,frontend.util.property.properties_start);
if(and__4251__auto__){
return logseq.graph_parser.util.safe_re_find(frontend.util.property.properties_end_pattern,content);
} else {
return and__4251__auto__;
}
} else {
...
if(cljs.core.truth_(frontend.util.property.contains_properties_QMARK_(content))){
...
return cljs.core.boolean$((function (){var and__4251__auto__ = typeof line === 'string';
if(and__4251__auto__){
return logseq.graph_parser.util.safe_re_find(/^\s?[^ ]+:: /,line);
} else {
return and__4251__auto__;
}
})());
...
var and__4251__auto__ = typeof line === 'string';
if(and__4251__auto__){
var temp__5720__auto__ = cljs.core.last(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,new cljs.core.Keyword(null,"org","org",1495985)))?logseq.graph_parser.util.safe_re_find(/^\s*:([^: ]+): /,line):logseq.graph_parser.util.safe_re_find(/^\s*([^ ]+):: /,line)));
...
return cljs.core.boolean$((function (){var and__4251__auto__ = typeof line === 'string';
if(and__4251__auto__){
var and__4251__auto____$1 = logseq.graph_parser.util.safe_re_find(/^\s*:[^: ]+: /,line);
...
var vec__93516 = cljs.core.split_with((function (p1__93513_SHARP_){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(p1__93513_SHARP_)),frontend.util.property.properties_start)));
}),content_lines);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93516,(0),null);
var properties_AMPERSAND_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93516,(1),null);
var properties = cljs.core.rest(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__93514_SHARP_){
return (((!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.trim(p1__93514_SHARP_)),frontend.util.property.properties_end)))) || (clojure.string.blank_QMARK_(p1__93514_SHARP_)));
}),properties_AMPERSAND_body));
if(cljs.core.seq(properties)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__93515_SHARP_){
return clojure.string.upper_case(cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__93515_SHARP_,":"))));
}),properties);
} else {
return null;
}
...
var content_lines = clojure.string.split_lines(content);
var properties = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__93519_SHARP_){
return cljs.core.re_matches(/^.+::\s*.+/,p1__93519_SHARP_);
}),content_lines);
if(cljs.core.seq(properties)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__93520_SHARP_){
return clojure.string.upper_case(cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__93520_SHARP_,"::"))));
}),properties);
} else {
return null;
}
...
frontend.util.cursor.move_cursor_to_thing.cljs$core$IFn$_invoke$arity$3(input,frontend.util.property.properties_start,(0));

var from = frontend.util.cursor.pos(input);
return frontend.util.cursor.move_cursor_to_thing.cljs$core$IFn$_invoke$arity$3(input,frontend.util.property.properties_end,from);
});
...
var vec__93531 = cljs.core.split_with((function (p1__93521_SHARP_){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(p1__93521_SHARP_)),frontend.util.property.properties_start)));
}),lines);
var title_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93531,(0),null);
var properties_AMPERSAND_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93531,(1),null);
var body = cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__93522_SHARP_){
return (((!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.trim(p1__93522_SHARP_)),frontend.util.property.properties_end)))) || (clojure.string.blank_QMARK_(p1__93522_SHARP_)));
}),properties_AMPERSAND_body);
var body__$1 = ((((cljs.core.seq(body)) && (clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(cljs.core.first(body))),frontend.util.property.properties_end))))?(function (){var line = clojure.string.replace(cljs.core.first(body),/:END:\s?/i,"");
...
var properties_content = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__93542){
var vec__93543 = p__93542;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93543,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93543,(1),null);
...
var org_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,new cljs.core.Keyword(null,"org","org",1495985));
var properties__$1 = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__93547){
var vec__93548 = p__93547;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93548,(0),null);
var _v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93548,(1),null);
var fexpr__93551 = frontend.util.property.built_in_properties();
return (fexpr__93551.cljs$core$IFn$_invoke$arity$1 ? fexpr__93551.cljs$core$IFn$_invoke$arity$1(k) : fexpr__93551.call(null,k));
}),properties);
...
var vec__93552 = ((frontend.format.mldoc.block_with_title_QMARK_(cljs.core.first(cljs.core.ffirst(ast))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(lines),cljs.core.rest(lines)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,lines], null));
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93552,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93552,(1),null);
var properties_in_content_QMARK_ = (function (){var and__4251__auto__ = title;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(clojure.string.upper_case(title),frontend.util.property.properties_start);
} else {
return and__4251__auto__;
}
})();
var no_title_QMARK_ = (function (){var or__4253__auto__ = frontend.util.property.simplified_property_QMARK_(title);
if(or__4253__auto__){
...
var properties_AMPERSAND_body = cljs.core.concat.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_((function (){var and__4251__auto__ = no_title_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
return (!(org_QMARK_));
} else {
return and__4251__auto__;
}
})())?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [title], null):null),(cljs.core.truth_((function (){var and__4251__auto__ = org_QMARK_;
if(and__4251__auto__){
return properties_in_content_QMARK_;
} else {
return and__4251__auto__;
...
var map__93555 = cljs.core.group_by((function (s){
return ((frontend.util.property.simplified_property_QMARK_(s)) || (((org_QMARK_) && (frontend.util.property.org_property_QMARK_(s)))));
}),properties_AMPERSAND_body);
var map__93555__$1 = cljs.core.__destructure_map(map__93555);
var properties_lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93555__$1,true);
var body__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93555__$1,false);
var body__$2 = ((org_QMARK_)?cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (s){
return cljs.core.contains_QMARK_(cljs.core.PersistentHashSet.createAsIfByAssoc([frontend.util.property.properties_start,frontend.util.property.properties_end]),clojure.string.trim(s));
}),body__$1):body__$1);
var properties_in_content = cljs.core.set(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__93546_SHARP_){
return frontend.util.property.get_property_key(p1__93546_SHARP_,format);
}),properties_lines)));
...
var built_in_properties_area = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__93556){
var vec__93557 = p__93556;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93557,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93557,(1),null);
if(org_QMARK_){
...
var body__$3 = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((cljs.core.truth_(no_title_QMARK_)?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [title], null)),((org_QMARK_)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.util.property.properties_start], null):null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([built_in_properties_area,properties_lines,((org_QMARK_)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.util.property.properties_end], null):null),body__$2], 0));
...
var has_properties_QMARK_ = ((((title_QMARK_) && (((frontend.format.mldoc.properties_QMARK_(cljs.core.second(ast))) || (frontend.format.mldoc.properties_QMARK_(cljs.core.second(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__93568){
var vec__93569 = p__93568;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93569,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93569,(1),null);
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("Hiccup",cljs.core.first(x));
}),ast)))))))) || (frontend.format.mldoc.properties_QMARK_(cljs.core.first(ast))));
var lines = clojure.string.split_lines(content);
var vec__93565 = ((title_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(lines),clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.rest(lines))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",lines)], null));
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93565,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93565,(1),null);
var scheduled = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__93560_SHARP_){
return clojure.string.starts_with_QMARK_(p1__93560_SHARP_,"SCHEDULED");
}),lines);
var deadline = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__93561_SHARP_){
return clojure.string.starts_with_QMARK_(p1__93561_SHARP_,"DEADLINE");
}),lines);
var body_without_timestamps = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__93562_SHARP_){
return (!(((clojure.string.starts_with_QMARK_(p1__93562_SHARP_,"SCHEDULED")) || (clojure.string.starts_with_QMARK_(p1__93562_SHARP_,"DEADLINE")))));
...
var start_idx = lines.indexOf(frontend.util.property.properties_start);
var end_idx = lines.indexOf(frontend.util.property.properties_end);
...
var vec__93572 = logseq.graph_parser.util.split_first(":",cljs.core.subs.cljs$core$IFn$_invoke$arity$2(text,(1)));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93572,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93572,(1),null);
...
var lines__$1 = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(before,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.util.property.properties_start], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([middle__$1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.util.property.properties_end], null),after], 0));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",lines__$1);
...
if(cljs.core.truth_((function (){var G__93576 = cljs.core.first(lines__$1);
return (property_f.cljs$core$IFn$_invoke$arity$1 ? property_f.cljs$core$IFn$_invoke$arity$1(G__93576) : property_f.call(null,G__93576));
})())){
var lines__$2 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (text){
var vec__93577 = logseq.graph_parser.util.split_first(sym,text);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93577,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93577,(1),null);
if(cljs.core.truth_((function (){var and__4251__auto__ = k;
if(cljs.core.truth_(and__4251__auto__)){
return v;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (content__$1,p__93587){
var vec__93588 = p__93587;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93588,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93588,(1),null);
...
var v__$1 = ((cljs.core.coll_QMARK_(v))?(function (){var G__93592 = cljs.core.seq(v);
var G__93592__$1 = (((G__93592 == null))?null:cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(G__93592));
var G__93592__$2 = (((G__93592__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (item){
...
if((G__93592__$2 == null)){
return null;
} else {
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",G__93592__$2);
}
})():v);
...
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format__$1,new cljs.core.Keyword(null,"org","org",1495985))) && (cljs.core.not(frontend.util.property.contains_properties_QMARK_(content))))){
return content;
} else {
var lines = (function (){var G__93614 = (function (line){
...
var G__93615 = clojure.string.split_lines(content);
return (remove_f.cljs$core$IFn$_invoke$arity$2 ? remove_f.cljs$core$IFn$_invoke$arity$2(G__93614,G__93615) : remove_f.call(null,G__93614,G__93615));
})();
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",lines);
}
} else {
 ...
 */
frontend.util.property.__GT_new_properties = (function frontend$util$property$__GT_new_properties(content){
if(cljs.core.truth_(frontend.util.property.contains_properties_QMARK_(content))){
var lines = clojure.string.split_lines(content);
var start_idx = lines.indexOf(frontend.util.property.properties_start);
var end_idx = lines.indexOf(frontend.util.property.properties_end);
...
var vec__93634 = logseq.graph_parser.util.split_first(":",cljs.core.subs.cljs$core$IFn$_invoke$arity$2(text,(1)));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93634,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93634,(1),null);
if(cljs.core.truth_((function (){var and__4251__auto__ = k;
if(cljs.core.truth_(and__4251__auto__)){
return v;
} else {
...
var properties__$1 = medley.core.map_keys(cljs.core.name,properties);
...
var prefix_f = (function (){var G__93638 = page_format;
var G__93638__$1 = (((G__93638 instanceof cljs.core.Keyword))?G__93638.fqn:null);
switch (G__93638__$1) {
case "org":
return (function (k){
...
var result = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__93637_SHARP_){
var and__4251__auto__ = p1__93637_SHARP_;
if(cljs.core.truth_(and__4251__auto__)){
return frontend.util.starts_with_QMARK_(line,(prefix_f.cljs$core$IFn$_invoke$arity$1 ? prefix_f.cljs$core$IFn$_invoke$arity$1(p1__93637_SHARP_) : prefix_f.call(null,p1__93637_SHARP_)));
} else {
return and__4251__auto__;
}
}),property_keys);
...
var lines__$3 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(lines__$2,(function (){var not_exists = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__93641){
var vec__93642 = p__93641;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93642,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93642,(1),null);
return cljs.core.contains_QMARK_(cljs.core.deref(exists_QMARK_),k);
}),properties__$1);
if(cljs.core.seq(not_exists)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__93645){
var vec__93646 = p__93645;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93646,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93646,(1),null);
...
frontend.util.property.properties_ast_QMARK_ = (function frontend$util$property$properties_ast_QMARK_(block){
