...
if(typeof s === 'string'){
var fexpr__33196 = frontend.date.goog$module$goog$object.get(module$node_modules$chrono_node$dist$index,"parseDate");
return (fexpr__33196.cljs$core$IFn$_invoke$arity$1 ? fexpr__33196.cljs$core$IFn$_invoke$arity$1(s) : fexpr__33196.call(null,s));
} else {
return null;
}
});
...
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33215__$1,new cljs.core.Keyword(null,"year","year",335913393));
var month = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33215__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var day = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33215__$1,new cljs.core.Keyword(null,"day","day",-274800446));
...
var map__33227 = frontend.date.year_month_day_padded.cljs$core$IFn$_invoke$arity$1(frontend.date.get_date.cljs$core$IFn$_invoke$arity$1(date));
var map__33227__$1 = cljs.core.__destructure_map(map__33227);
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33227__$1,new cljs.core.Keyword(null,"year","year",335913393));
var month = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33227__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var day = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33227__$1,new cljs.core.Keyword(null,"day","day",-274800446));
...
return frontend.date.journal_title__GT_.cljs$core$IFn$_invoke$arity$2(journal_title,(function (p1__33248_SHARP_){
return cljs_time.coerce.to_long(p1__33248_SHARP_);
}));
});
...
return frontend.date.journal_title__GT_.cljs$core$IFn$_invoke$arity$2(journal_title,(function (p1__33249_SHARP_){
return cljs_time.format.unparse(formatter,p1__33249_SHARP_);
}));
});
...
return frontend.date.journal_title__GT_.cljs$core$IFn$_invoke$arity$2(journal_title,(function (p1__33252_SHARP_){
return logseq.graph_parser.date_time_util.format(p1__33252_SHARP_,frontend.state.get_date_formatter());
}));
});
