...
var arg_count_75766 = (cljs.core.count(expr) - (1));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),arg_count_75766)){
} else {
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2(["Wrong number of args (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(arg_count_75766),") passed to: clojure.core/for"].join(''),expr);
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__75574){
var vec__75576 = p__75574;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75576,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75576,(1),null);
...
var err = (function() { 
var G__75770__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__75770 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__75771__i = 0, G__75771__a = new Array(arguments.length -  0);
while (G__75771__i < G__75771__a.length) {G__75771__a[G__75771__i] = arguments[G__75771__i + 0]; ++G__75771__i;}
  msg = new cljs.core.IndexedSeq(G__75771__a,0,null);
} 
return G__75770__delegate.call(this,msg);};
G__75770.cljs$lang$maxFixedArity = 0;
G__75770.cljs$lang$applyTo = (function (arglist__75772){
var msg = cljs.core.seq(arglist__75772);
return G__75770__delegate(msg);
});
G__75770.cljs$core$IFn$_invoke$arity$variadic = G__75770__delegate;
return G__75770;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__75584){
var vec__75586 = p__75584;
var seq__75587 = cljs.core.seq(vec__75586);
var first__75588 = cljs.core.first(seq__75587);
var seq__75587__$1 = cljs.core.next(seq__75587);
var vec__75589 = first__75588;
var seq__75590 = cljs.core.seq(vec__75589);
var first__75591 = cljs.core.first(seq__75590);
var seq__75590__$1 = cljs.core.next(seq__75590);
var bind = first__75591;
var first__75591__$1 = cljs.core.first(seq__75590__$1);
var seq__75590__$2 = cljs.core.next(seq__75590__$1);
var expr__$1 = first__75591__$1;
var mod_pairs = seq__75590__$2;
var vec__75592 = seq__75587__$1;
var vec__75595 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75592,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75595,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75595,(1),null);
var next_groups = vec__75592;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__75606){
var vec__75609 = p__75606;
var seq__75610 = cljs.core.seq(vec__75609);
var first__75611 = cljs.core.first(seq__75610);
var seq__75610__$1 = cljs.core.next(seq__75610);
var vec__75612 = first__75611;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75612,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75612,(1),null);
var pair = vec__75612;
var etc = seq__75610__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__75547__auto__","iterys__75547__auto__",378084266,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__75548__auto__","fs__75548__auto__",149015163,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__75547__auto__","iterys__75547__auto__",378084266,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__75548__auto__","fs__75548__auto__",149015163,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__75548__auto__","fs__75548__auto__",149015163,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__75668){
var vec__75669 = p__75668;
var seq__75670 = cljs.core.seq(vec__75669);
var first__75671 = cljs.core.first(seq__75670);
var seq__75670__$1 = cljs.core.next(seq__75670);
var vec__75672 = first__75671;
