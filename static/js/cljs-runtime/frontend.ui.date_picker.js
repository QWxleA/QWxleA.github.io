...
var G__65357 = pred;
var G__65358 = cljs_time.core.minus.cljs$core$IFn$_invoke$arity$2(date,period);
var G__65359 = period;
pred = G__65357;
date = G__65358;
period = G__65359;
...
var or__4253__auto__ = frontend.ui.date_picker._EQ_date(date1,date2);
if(or__4253__auto__){
...
return (function (p1__65150_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs_time.core.day_of_week(p1__65150_SHARP_),(d + (1)));
});
});
 ...
 */
frontend.ui.date_picker.table_thead = rum.core.lazy_build(rum.core.build_defc,(function (display_month,p__65206){
var map__65208 = p__65206;
var map__65208__$1 = cljs.core.__destructure_map(map__65208);
var show_weeks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65208__$1,new cljs.core.Keyword(null,"show-weeks?","show-weeks?",-1563135221));
var minimum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65208__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059));
var maximum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65208__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714));
var start_of_week = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65208__$1,new cljs.core.Keyword(null,"start-of-week","start-of-week",-1590603824));
...
return daiquiri.core.create_element("thead",((cljs.core.map_QMARK_(attrs65203))?daiquiri.interpreter.element_attributes(attrs65203):null),((cljs.core.map_QMARK_(attrs65203))?[daiquiri.interpreter.interpret(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(template_row,(function (){var iter__4652__auto__ = (function frontend$ui$date_picker$iter__65225(s__65226){
return (new cljs.core.LazySeq(null,(function (){
var s__65226__$1 = s__65226;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__65226__$1);
if(temp__5720__auto__){
var s__65226__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65226__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__65226__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__65228 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__65227 = (0);
while(true){
if((i__65227 < size__4651__auto__)){
var day = cljs.core._nth(c__4650__auto__,i__65227);
cljs.core.chunk_append(b__65228,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"day-enabled"], null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(day))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(day)], null)));

var G__65371 = (i__65227 + (1));
i__65227 = G__65371;
continue;
} else {
return true;
...
return iter__4652__auto__(frontend.ui.date_picker.rotate(start_of_week,frontend.ui.date_picker.days_vector));
})()))]:[daiquiri.interpreter.interpret(attrs65203),daiquiri.interpreter.interpret(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(template_row,(function (){var iter__4652__auto__ = (function frontend$ui$date_picker$iter__65266(s__65267){
return (new cljs.core.LazySeq(null,(function (){
var s__65267__$1 = s__65267;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__65267__$1);
if(temp__5720__auto__){
var s__65267__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65267__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__65267__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__65269 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__65268 = (0);
while(true){
if((i__65268 < size__4651__auto__)){
var day = cljs.core._nth(c__4650__auto__,i__65268);
cljs.core.chunk_append(b__65269,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"day-enabled"], null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(day))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(day)], null)));

var G__65372 = (i__65268 + (1));
i__65268 = G__65372;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65269),frontend$ui$date_picker$iter__65266(cljs.core.chunk_rest(s__65267__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65269),null);
}
} else {
var day = cljs.core.first(s__65267__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"day-enabled"], null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(day))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(day)], null)),frontend$ui$date_picker$iter__65266(cljs.core.rest(s__65267__$2)));
}
} else {
return null;
}
...
frontend.ui.date_picker.table_td = (function frontend$ui$date_picker$table_td(date,focus_month,selected,today,p__65320,disabled_QMARK_,on_change){
var map__65322 = p__65320;
var map__65322__$1 = cljs.core.__destructure_map(map__65322);
var attributes = map__65322__$1;
var minimum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65322__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059));
var maximum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65322__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714));
var minimum__$1 = frontend.util.deref_or_value(minimum);
var maximum__$1 = frontend.util.deref_or_value(maximum);
...
var disabled_day_QMARK_ = (cljs.core.truth_(enabled_day)?cljs.core.not((function (){var fexpr__65325 = new cljs.core.Keyword(null,"selectable-fn","selectable-fn",-1997365738).cljs$core$IFn$_invoke$arity$1(attributes);
return (fexpr__65325.cljs$core$IFn$_invoke$arity$1 ? fexpr__65325.cljs$core$IFn$_invoke$arity$1(date) : fexpr__65325.call(null,date));
})()):true);
...
})())?[classes," active start-date end-date"].join(''):(cljs.core.truth_((function (){var and__4251__auto__ = today;
if(cljs.core.truth_(and__4251__auto__)){
...
var row_dates = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65334_SHARP_){
return frontend.ui.date_picker.inc_date(date,p1__65334_SHARP_);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(table_row,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65335_SHARP_){
return frontend.ui.date_picker.table_td(p1__65335_SHARP_,focus_month,selected,today,attributes,disabled_QMARK_,on_change);
}),row_dates));
});
/**
...
var row_start_dates = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65336_SHARP_){
return frontend.ui.date_picker.inc_date(current_start,((7) * p1__65336_SHARP_));
}),cljs.core.range.cljs$core$IFn$_invoke$arity$1((6)));
return daiquiri.interpreter.interpret(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65338_SHARP_){
return frontend.ui.date_picker.table_tr(p1__65338_SHARP_,focus_month,selected,attributes,disabled_QMARK_,on_change);
}),row_start_dates)));
...
frontend.ui.date_picker.date_picker = rum.core.lazy_build(rum.core.build_defc,(function (_model,p__65344){
var map__65345 = p__65344;
var map__65345__$1 = cljs.core.__destructure_map(map__65345);
var args = map__65345__$1;
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65345__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65345__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var start_of_week = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65345__$1,new cljs.core.Keyword(null,"start-of-week","start-of-week",-1590603824),frontend.state.get_start_of_week());
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65345__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65345__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65345__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var internal_model = frontend.util.react(frontend.ui.date_picker._STAR_internal_model);
var display_month = cljs_time.core.first_day_of_the_month.cljs$core$IFn$_invoke$arity$1((function (){var or__4253__auto__ = internal_model;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
