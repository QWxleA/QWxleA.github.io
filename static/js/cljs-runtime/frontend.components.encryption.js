...
}),'className':"cursor-pointer block w-full rounded-sm p-2"},[daiquiri.core.create_element("div",{'className':"font-medium"},["Public Key:"]),(function (){var attrs60437 = public_key;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs60437))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["font-mono","select-all","break-all"], null)], null),attrs60437], 0))):{'className':"font-mono select-all break-all"}),((cljs.core.map_QMARK_(attrs60437))?null:[daiquiri.interpreter.interpret(attrs60437)]));
})(),(cljs.core.truth_(cljs.core.deref(reveal_secret_phrase_QMARK_))?daiquiri.core.create_element("div",null,[daiquiri.core.create_element("div",{'className':"mt-1 font-medium"},["Private Key:"]),(function (){var attrs60442 = private_key;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs60442))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["font-mono","select-all","break-all"], null)], null),attrs60442], 0))):{'className':"font-mono select-all break-all"}),((cljs.core.map_QMARK_(attrs60442))?null:[daiquiri.interpreter.interpret(attrs60442)]));
