...
frontend.modules.outliner.datascript.after_transact_pipelines = (function frontend$modules$outliner$datascript$after_transact_pipelines(repo,p__49888){
var map__49889 = p__49888;
var map__49889__$1 = cljs.core.__destructure_map(map__49889);
var tx_report = map__49889__$1;
var _db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49889__$1,new cljs.core.Keyword(null,"_db-before","_db-before",1857235147));
var _db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49889__$1,new cljs.core.Keyword(null,"_db-after","_db-after",-1808574796));
var _tx_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49889__$1,new cljs.core.Keyword(null,"_tx-data","_tx-data",-169400406));
var _tempids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49889__$1,new cljs.core.Keyword(null,"_tempids","_tempids",2126372359));
var tx_meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49889__$1,new cljs.core.Keyword(null,"tx-meta","tx-meta",1159283194));
...
var G__49890 = logseq.graph_parser.util.remove_nils(txs);
if((G__49890 == null)){
return null;
} else {
...
var eids_49895 = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.first,new cljs.core.Keyword(null,"tx-data","tx-data",934159761).cljs$core$IFn$_invoke$arity$1(rs)));
var left_AMPERSAND_parent_list_49896 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.next,cljs.core.vec((function (){var G__49892 = new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Symbol(null,"?l","?l",550795544,null),new cljs.core.Symbol(null,"?p","?p",-10896580,null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","left","block/left",-443712566),new cljs.core.Symbol(null,"?l","?l",550795544,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","parent","block/parent",-918309064),new cljs.core.Symbol(null,"?p","?p",-10896580,null)], null)], null);
var G__49893 = cljs.core.deref(conn);
var G__49894 = eids_49895;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$3 ? datascript.core.q.cljs$core$IFn$_invoke$arity$3(G__49892,G__49893,G__49894) : datascript.core.q.call(null,G__49892,G__49893,G__49894));
})()));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(left_AMPERSAND_parent_list_49896),cljs.core.count(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(left_AMPERSAND_parent_list_49896)))){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(eids_49895),"\n","(= (count left&parent-list) (count (distinct left&parent-list)))"].join('')));
}


return rs;
}catch (e49891){if((e49891 instanceof Error)){
var e = e49891;
