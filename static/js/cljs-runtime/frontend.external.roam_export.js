...
var db = (function (){var G__49649 = frontend.state.get_current_repo();
return (frontend.db.get_db.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_db.cljs$core$IFn$_invoke$arity$1(G__49649) : frontend.db.get_db.call(null,G__49649));
})();
...
}),cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.first),(function (){var G__49650 = db;
var G__49651 = new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),cljs.core.list(new cljs.core.Symbol(null,"pull","pull",779986722,null),new cljs.core.Symbol(null,"?r","?r",-516400708,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552)], null)),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?b","?b",1575118075,null),new cljs.core.Keyword("block","refs","block/refs",-1214495349),new cljs.core.Symbol(null,"?r","?r",-516400708,null)], null)], null);
return (datascript.core.q.cljs$core$IFn$_invoke$arity$2 ? datascript.core.q.cljs$core$IFn$_invoke$arity$2(G__49650,G__49651) : datascript.core.q.call(null,G__49650,G__49651));
})()))));
});
...
frontend.external.roam_export.update_uid = (function frontend$external$roam_export$update_uid(p__49653,uuid__GT_uid_map){
var map__49654 = p__49653;
var map__49654__$1 = cljs.core.__destructure_map(map__49654);
var b = map__49654__$1;
var uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49654__$1,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49654__$1,new cljs.core.Keyword("block","content","block/content",-161885195));
var G__49655 = b;
var G__49655__$1 = ((cljs.core.contains_QMARK_(uuid__GT_uid_map,uuid))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49655,new cljs.core.Keyword("block","uid","block/uid",-1623585167),cljs.core.get.cljs$core$IFn$_invoke$arity$2(uuid__GT_uid_map,uuid)):G__49655);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__49655__$1,new cljs.core.Keyword("block","content","block/content",-161885195),(function (p1__49652_SHARP_){
return frontend.external.roam_export.update_content(p1__49652_SHARP_,uuid__GT_uid_map);
}));
} else {
return G__49655__$1;
}
});
frontend.external.roam_export.update_todo = (function frontend$external$roam_export$update_todo(p__49656){
var map__49657 = p__49656;
var map__49657__$1 = cljs.core.__destructure_map(map__49657);
var block = map__49657__$1;
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49657__$1,new cljs.core.Keyword("block","content","block/content",-161885195));
