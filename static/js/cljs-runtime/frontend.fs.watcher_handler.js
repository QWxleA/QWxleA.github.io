...
var seq__53927 = cljs.core.seq(logseq.graph_parser.extract.extract_all_block_refs(content));
var chunk__53928 = null;
var count__53929 = (0);
var i__53930 = (0);
while(true){
if((i__53930 < count__53929)){
var block_id = chunk__53928.cljs$core$IIndexed$_nth$arity$2(null,i__53930);
var temp__5720__auto___53978 = (function (){try{return frontend.db.model.get_block_by_uuid(block_id);
}catch (e53963){if((e53963 instanceof Error)){
var _e = e53963;
return null;
} else {
throw e53963;
...
if(cljs.core.truth_(temp__5720__auto___53978)){
var block_53979 = temp__5720__auto___53978;
var id_property_53980 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","properties","block/properties",708347145).cljs$core$IFn$_invoke$arity$1(block_53979));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(id_property_53980),cljs.core.str.cljs$core$IFn$_invoke$arity$1(block_id))){
} else {
...
var G__53981 = seq__53927;
var G__53982 = chunk__53928;
var G__53983 = count__53929;
var G__53984 = (i__53930 + (1));
seq__53927 = G__53981;
chunk__53928 = G__53982;
count__53929 = G__53983;
i__53930 = G__53984;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__53927);
if(temp__5720__auto__){
var seq__53927__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__53927__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__53927__$1);
var G__53985 = cljs.core.chunk_rest(seq__53927__$1);
var G__53986 = c__5565__auto__;
var G__53987 = cljs.core.count(c__5565__auto__);
var G__53988 = (0);
seq__53927 = G__53985;
chunk__53928 = G__53986;
count__53929 = G__53987;
i__53930 = G__53988;
continue;
} else {
var block_id = cljs.core.first(seq__53927__$1);
var temp__5720__auto___53989__$1 = (function (){try{return frontend.db.model.get_block_by_uuid(block_id);
}catch (e53964){if((e53964 instanceof Error)){
var _e = e53964;
return null;
} else {
throw e53964;
...
if(cljs.core.truth_(temp__5720__auto___53989__$1)){
var block_53990 = temp__5720__auto___53989__$1;
var id_property_53991 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","properties","block/properties",708347145).cljs$core$IFn$_invoke$arity$1(block_53990));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(id_property_53991),cljs.core.str.cljs$core$IFn$_invoke$arity$1(block_id))){
} else {
frontend.handler.editor.set_block_property_BANG_(block_id,"id",block_id);
}
} else {
...
var G__53992 = cljs.core.next(seq__53927__$1);
var G__53993 = null;
var G__53994 = (0);
var G__53995 = (0);
seq__53927 = G__53992;
chunk__53928 = G__53993;
count__53929 = G__53994;
i__53930 = G__53995;
continue;
}
} else {
...
frontend.fs.watcher_handler.handle_changed_BANG_ = (function frontend$fs$watcher_handler$handle_changed_BANG_(type,p__53965){
var map__53966 = p__53965;
var map__53966__$1 = cljs.core.__destructure_map(map__53966);
var payload = map__53966__$1;
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53966__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53966__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53966__$1,new cljs.core.Keyword(null,"content","content",15833224));
var stat = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53966__$1,new cljs.core.Keyword(null,"stat","stat",-1370599836));
...
var map__53967 = stat;
var map__53967__$1 = cljs.core.__destructure_map(map__53967);
var mtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53967__$1,new cljs.core.Keyword(null,"mtime","mtime",963165087));
...
var backup_QMARK__54001 = (!(clojure.string.blank_QMARK_(db_content)));
frontend.fs.watcher_handler.handle_add_and_change_BANG_(repo,path__$1,content,db_content,mtime,backup_QMARK__54001);
} else {
...
var temp__5720__auto___54007 = (frontend.db.get_file_page.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_file_page.cljs$core$IFn$_invoke$arity$1(path__$1) : frontend.db.get_file_page.call(null,path__$1));
if(cljs.core.truth_(temp__5720__auto___54007)){
var page_name_54013 = temp__5720__auto___54007;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Delete page: ",page_name_54013,", file path: ",path__$1,"."], 0));

frontend.handler.page.delete_BANG_.cljs$core$IFn$_invoke$arity$variadic(page_name_54013,(function (){
