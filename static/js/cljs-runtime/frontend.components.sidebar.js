...
frontend.components.sidebar.nav_content_item = rum.core.lazy_build(rum.core.build_defc,(function (name,p__48236,child){
var map__48237 = p__48236;
var map__48237__$1 = cljs.core.__destructure_map(map__48237);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48237__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
}),'className':"header items-center mb-1"},[(function (){var attrs48239 = name;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs48239))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["font-medium","fade-link"], null)], null),attrs48239], 0))):{'className':"font-medium fade-link"}),((cljs.core.map_QMARK_(attrs48239))?null:[daiquiri.interpreter.interpret(attrs48239)]));
})(),daiquiri.core.create_element("span",null,[(function (){var attrs48240 = frontend.components.svg.arrow_down_v2;
return daiquiri.core.create_element("a",((cljs.core.map_QMARK_(attrs48240))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["more"], null)], null),attrs48240], 0))):{'className':"more"}),((cljs.core.map_QMARK_(attrs48240))?null:[daiquiri.interpreter.interpret(attrs48240)]));
})()])]),(function (){var attrs48238 = child;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs48238))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["bd"], null)], null),attrs48238], 0))):{'className':"bd"}),((cljs.core.map_QMARK_(attrs48238))?null:[daiquiri.interpreter.interpret(attrs48238)]));
})()])]);
...
var temp__5720__auto__ = (function (){var G__48241 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),name__$1], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__48241) : frontend.db.entity.call(null,G__48241));
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
})},[(function (){var attrs48242 = icon;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs48242))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["page-icon"], null)], null),attrs48242], 0))):{'className':"page-icon"}),((cljs.core.map_QMARK_(attrs48242))?null:[daiquiri.interpreter.interpret(attrs48242)]));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.favorites.text-sm","ul.favorites.text-sm",800189534),(function (){var iter__5520__auto__ = (function frontend$components$sidebar$iter__48249(s__48250){
return (new cljs.core.LazySeq(null,(function (){
var s__48250__$1 = s__48250;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__48250__$1);
if(temp__5720__auto__){
var s__48250__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48250__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__48250__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__48252 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__48251 = (0);
while(true){
if((i__48251 < size__5519__auto__)){
var name = cljs.core._nth(c__5518__auto__,i__48251);
cljs.core.chunk_append(b__48252,((clojure.string.blank_QMARK_(name))?null:(function (){var temp__5720__auto____$1 = (function (){var G__48253 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.safe_page_name_sanity_lc(name)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__48253) : frontend.db.entity.call(null,G__48253));
})();
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48252),frontend$components$sidebar$iter__48249(cljs.core.chunk_rest(s__48250__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48252),null);
}
} else {
var name = cljs.core.first(s__48250__$2);
return cljs.core.cons(((clojure.string.blank_QMARK_(name))?null:(function (){var temp__5720__auto____$1 = (function (){var G__48254 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.safe_page_name_sanity_lc(name)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__48254) : frontend.db.entity.call(null,G__48254));
})();
if(cljs.core.truth_(temp__5720__auto____$1)){
var entity = temp__5720__auto____$1;
var icon = frontend.components.sidebar.get_page_icon(entity);
...
})()),frontend$components$sidebar$iter__48249(cljs.core.rest(s__48250__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.text-sm","ul.text-sm",423832983),(function (){var iter__5520__auto__ = (function frontend$components$sidebar$iter__48261(s__48262){
return (new cljs.core.LazySeq(null,(function (){
var s__48262__$1 = s__48262;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__48262__$1);
if(temp__5720__auto__){
var s__48262__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48262__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__48262__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__48264 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__48263 = (0);
while(true){
if((i__48263 < size__5519__auto__)){
var name = cljs.core._nth(c__5518__auto__,i__48263);
cljs.core.chunk_append(b__48264,(function (){var temp__5720__auto____$1 = (function (){var G__48265 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.safe_page_name_sanity_lc(name)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__48265) : frontend.db.entity.call(null,G__48265));
})();
if(cljs.core.truth_(temp__5720__auto____$1)){
var entity = temp__5720__auto____$1;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48264),frontend$components$sidebar$iter__48261(cljs.core.chunk_rest(s__48262__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48264),null);
}
} else {
var name = cljs.core.first(s__48262__$2);
return cljs.core.cons((function (){var temp__5720__auto____$1 = (function (){var G__48266 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.safe_page_name_sanity_lc(name)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__48266) : frontend.db.entity.call(null,G__48266));
})();
if(cljs.core.truth_(temp__5720__auto____$1)){
var entity = temp__5720__auto____$1;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li.recent-item.select-none","li.recent-item.select-none",1025549059),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),name,new cljs.core.Keyword(null,"title","title",636505583),name,new cljs.core.Keyword(null,"data-ref","data-ref",-1090558888),name], null),frontend.components.sidebar.page_name(name,frontend.components.sidebar.get_page_icon(entity))], null);
...
})(),frontend$components$sidebar$iter__48261(cljs.core.rest(s__48262__$2)));
}
} else {
return null;
}
...
}),'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item","group","flex","items-center","px-2","py-2","text-sm","font-medium","rounded-md",frontend.util.classnames(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"active","active",1895962068),srs_open_QMARK_], null)], null))], null))},[daiquiri.interpreter.interpret(frontend.ui.icon.cljs$core$IFn$_invoke$arity$1("infinity")),(function (){var attrs48267 = frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("right-side-bar","flashcards","right-side-bar/flashcards",-1920196000)], 0));
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs48267))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex-1"], null)], null),attrs48267], 0))):{'className':"flex-1"}),((cljs.core.map_QMARK_(attrs48267))?null:[daiquiri.interpreter.interpret(attrs48267)]));
...
})())?(function (){var attrs48268 = num;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs48268))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-3","inline-block","py-0","5","px-3","text-xs","font-medium","rounded-full","fade-in"], null)], null),attrs48268], 0))):{'className':"ml-3 inline-block py-0 5 px-3 text-xs font-medium rounded-full fade-in"}),((cljs.core.map_QMARK_(attrs48268))?null:[daiquiri.interpreter.interpret(attrs48268)]));
})():null)]);
...
var page__$1 = ((((typeof page === 'string') && ((!(clojure.string.blank_QMARK_(page))))))?(function (){var G__48269 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),frontend.util.safe_page_name_sanity_lc(page)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__48269) : frontend.db.entity.call(null,G__48269));
})():null);
...
frontend.components.sidebar.sidebar_item = (function frontend$components$sidebar$sidebar_item(p__48270){
var map__48271 = p__48270;
var map__48271__$1 = cljs.core.__destructure_map(map__48271);
var on_click_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48271__$1,new cljs.core.Keyword(null,"on-click-handler","on-click-handler",746440723));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48271__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48271__$1,new cljs.core.Keyword(null,"title","title",636505583));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48271__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var active = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48271__$1,new cljs.core.Keyword(null,"active","active",1895962068));
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48271__$1,new cljs.core.Keyword(null,"href","href",-793805698));
...
return daiquiri.core.create_element("div",{'onClick':(function (p1__48272_SHARP_){
var temp__5720__auto__ = (function (){var and__5041__auto__ = frontend.util.sm_breakpoint_QMARK_();
if(and__5041__auto__){
return p1__48272_SHARP_.target;
} else {
return and__5041__auto__;
}
})();
...
var and__5041__auto___48314 = frontend.util.sm_breakpoint_QMARK_();
if(and__5041__auto___48314){
...
}),'className':"item group flex items-center px-2 py-2 text-sm font-medium rounded-md new-page-link"},[daiquiri.interpreter.interpret(frontend.ui.icon.cljs$core$IFn$_invoke$arity$2("circle-plus mr-3",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(20)], null)], null))),(function (){var attrs48274 = frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("right-side-bar","new-page","right-side-bar/new-page",818114070)], 0));
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs48274))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex-1"], null)], null),attrs48274], 0))):{'className':"flex-1"}),((cljs.core.map_QMARK_(attrs48274))?null:[daiquiri.interpreter.interpret(attrs48274)]));
})()]))]))])]);
}),null,"frontend.components.sidebar/sidebar-nav");
frontend.components.sidebar.left_sidebar = rum.core.lazy_build(rum.core.build_defc,(function (p__48275){
var map__48276 = p__48275;
var map__48276__$1 = cljs.core.__destructure_map(map__48276);
var left_sidebar_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48276__$1,new cljs.core.Keyword(null,"left-sidebar-open?","left-sidebar-open?",899591356));
var route_match = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48276__$1,new cljs.core.Keyword(null,"route-match","route-match",-1450985937));
...
var temp__5720__auto__ = (function (){var G__48277 = frontend.state.get_input();
if((G__48277 == null)){
return null;
} else {
return frontend.util.cursor.pos(G__48277);
}
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
frontend.components.sidebar.main = rum.core.lazy_build(rum.core.build_defc,(function (p__48278){
var map__48279 = p__48278;
var map__48279__$1 = cljs.core.__destructure_map(map__48279);
var route_match = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48279__$1,new cljs.core.Keyword(null,"route-match","route-match",-1450985937));
var global_graph_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48279__$1,new cljs.core.Keyword(null,"global-graph-pages?","global-graph-pages?",1067510840));
var route_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48279__$1,new cljs.core.Keyword(null,"route-name","route-name",-932603717));
var indexeddb_support_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48279__$1,new cljs.core.Keyword(null,"indexeddb-support?","indexeddb-support?",-1571226476));
var db_restoring_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48279__$1,new cljs.core.Keyword(null,"db-restoring?","db-restoring?",-1548628664));
var main_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48279__$1,new cljs.core.Keyword(null,"main-content","main-content",1386726798));
var show_action_bar_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48279__$1,new cljs.core.Keyword(null,"show-action-bar?","show-action-bar?",1936923598));
var show_recording_bar_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48279__$1,new cljs.core.Keyword(null,"show-recording-bar?","show-recording-bar?",-1835604479));
...
return daiquiri.core.create_element("div",{'id':"main-container",'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["cp__sidebar-main-layout","flex-1","flex",frontend.util.classnames(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"is-left-sidebar-open","is-left-sidebar-open",-1193752939),left_sidebar_open_QMARK_], null)], null))], null))},[frontend.components.sidebar.left_sidebar(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"left-sidebar-open?","left-sidebar-open?",899591356),left_sidebar_open_QMARK_,new cljs.core.Keyword(null,"route-match","route-match",-1450985937),route_match], null)),(function (){var attrs48280 = (cljs.core.truth_(show_action_bar_QMARK_)?frontend.mobile.action_bar.action_bar():null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs48280))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),"main-content-container",new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["scrollbar-spacing","w-full","flex","justify-center","flex-row"], null)], null),attrs48280], 0))):{'id':"main-content-container",'className':"scrollbar-spacing w-full flex justify-center flex-row"}),((cljs.core.map_QMARK_(attrs48280))?[daiquiri.core.create_element("div",{'data-is-global-graph-pages':global_graph_pages_QMARK_,'data-is-full-width':(function (){var or__5043__auto__ = global_graph_pages_QMARK_;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
})(),'className':"cp__sidebar-main-content"},[(cljs.core.truth_(show_recording_bar_QMARK_)?frontend.components.sidebar.recording_bar():null),frontend.mobile.mobile_bar.mobile_bar(),frontend.mobile.footer.footer(),((((cljs.core.not(frontend.mobile.util.native_platform_QMARK_())) && (cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"home","home",-74557309),null,new cljs.core.Keyword(null,"page","page",849072397),null], null), null),route_name))))?frontend.components.widgets.demo_graph_alert():null),((cljs.core.not(indexeddb_support_QMARK_))?null:(cljs.core.truth_(db_restoring_QMARK_)?daiquiri.core.create_element("div",{'className':"mt-20"},[(function (){var attrs48281 = frontend.ui.loading(frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"loading","loading",-737050189)], 0)));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs48281))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ls-center"], null)], null),attrs48281], 0))):{'className':"ls-center"}),((cljs.core.map_QMARK_(attrs48281))?null:[daiquiri.interpreter.interpret(attrs48281)]));
...
)),(cljs.core.truth_(onboarding_and_home_QMARK_)?daiquiri.core.create_element("div",{'style':{'paddingBottom':(200)}},[frontend.components.onboarding.intro()]):null)])]:[daiquiri.interpreter.interpret(attrs48280),daiquiri.core.create_element("div",{'data-is-global-graph-pages':global_graph_pages_QMARK_,'data-is-full-width':(function (){var or__5043__auto__ = global_graph_pages_QMARK_;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"my-publishing","my-publishing",227980452),null,new cljs.core.Keyword(null,"all-files","all-files",1120339891),null,new cljs.core.Keyword(null,"all-pages","all-pages",1017563062),null], null), null),route_name);
}
})(),'className':"cp__sidebar-main-content"},[(cljs.core.truth_(show_recording_bar_QMARK_)?frontend.components.sidebar.recording_bar():null),frontend.mobile.mobile_bar.mobile_bar(),frontend.mobile.footer.footer(),((((cljs.core.not(frontend.mobile.util.native_platform_QMARK_())) && (cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"home","home",-74557309),null,new cljs.core.Keyword(null,"page","page",849072397),null], null), null),route_name))))?frontend.components.widgets.demo_graph_alert():null),((cljs.core.not(indexeddb_support_QMARK_))?null:(cljs.core.truth_(db_restoring_QMARK_)?daiquiri.core.create_element("div",{'className':"mt-20"},[(function (){var attrs48282 = frontend.ui.loading(frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"loading","loading",-737050189)], 0)));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs48282))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ls-center"], null)], null),attrs48282], 0))):{'className':"ls-center"}),((cljs.core.map_QMARK_(attrs48282))?null:[daiquiri.interpreter.interpret(attrs48282)]));
})()]):daiquiri.core.create_element("div",{'style':{'marginBottom':(cljs.core.truth_(global_graph_pages_QMARK_)?(0):(cljs.core.truth_(onboarding_and_home_QMARK_)?(-48):(120)
)),'paddingBottom':(cljs.core.truth_(frontend.mobile.util.native_iphone_QMARK_())?"7rem":null)},'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(global_graph_pages_QMARK_)?"":frontend.util.hiccup__GT_class("max-w-7xl.mx-auto.pb-24"))], null))},[daiquiri.interpreter.interpret(main_content)])
...
var temp__5720__auto___48315 = goog.dom.getElement("main-content-container");
if(cljs.core.truth_(temp__5720__auto___48315)){
var element_48316 = temp__5720__auto___48315;
cljs_drag_n_drop.core.subscribe_BANG_(element_48316,new cljs.core.Keyword(null,"upload-files","upload-files",-771877630),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"drop","drop",364481611),(function (_e,files){
...
frontend.handler.common.listen_to_scroll_BANG_(element_48316);
} else {
}
...
var total = new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(state);
var width = Math.round(((finished / total).toFixed((2)) * (100)));
var left_label = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-row.font-bold","div.flex.flex-row.font-bold",2116828028),"Downloading",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.hidden.md:flex.flex-row","div.hidden.md:flex.flex-row",-212067351),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.mr-1","span.mr-1",127520086),": "], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),(function (){var iter__5520__auto__ = (function frontend$components$sidebar$iter__48284(s__48285){
return (new cljs.core.LazySeq(null,(function (){
var s__48285__$1 = s__48285;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__48285__$1);
if(temp__5720__auto__){
var s__48285__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48285__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__48285__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__48287 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__48286 = (0);
while(true){
if((i__48286 < size__5519__auto__)){
var file = cljs.core._nth(c__5518__auto__,i__48286);
cljs.core.chunk_append(b__48287,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),file], null));

var G__48317 = (i__48286 + (1));
i__48286 = G__48317;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48287),frontend$components$sidebar$iter__48284(cljs.core.chunk_rest(s__48285__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48287),null);
}
} else {
var file = cljs.core.first(s__48285__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),file], null),frontend$components$sidebar$iter__48284(cljs.core.rest(s__48285__$2)));
}
} else {
return null;
}
...
var latest_journals = (function (){var G__48289 = frontend.state.get_current_repo();
var G__48290 = journals_length;
return (frontend.db.get_latest_journals.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_latest_journals.cljs$core$IFn$_invoke$arity$2(G__48289,G__48290) : frontend.db.get_latest_journals.call(null,G__48289,G__48290));
})();
...
var attrs48288 = (cljs.core.truth_((function (){var and__5041__auto__ = default_home;
if(cljs.core.truth_(and__5041__auto__)){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs48288))?daiquiri.interpreter.element_attributes(attrs48288):null),((cljs.core.map_QMARK_(attrs48288))?null:[daiquiri.interpreter.interpret(attrs48288)]));
...
var current_repo_48318 = frontend.state.sub(new cljs.core.Keyword("git","current-repo","git/current-repo",107438825));
var default_home_48319 = frontend.components.sidebar.get_default_home_if_valid();
var sidebar_48320 = new cljs.core.Keyword(null,"sidebar","sidebar",35784458).cljs$core$IFn$_invoke$arity$1(default_home_48319);
var sidebar_48321__$1 = ((typeof sidebar_48320 === 'string')?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sidebar_48320], null):sidebar_48320);
var temp__5720__auto___48322 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,cljs.core.seq(sidebar_48321__$1));
if(cljs.core.truth_(temp__5720__auto___48322)){
var pages_48323 = temp__5720__auto___48322;
var seq__48291_48324 = cljs.core.seq(pages_48323);
var chunk__48292_48325 = null;
var count__48293_48326 = (0);
var i__48294_48327 = (0);
while(true){
if((i__48294_48327 < count__48293_48326)){
var page_48328 = chunk__48292_48325.cljs$core$IIndexed$_nth$arity$2(null,i__48294_48327);
var page_48329__$1 = frontend.util.safe_page_name_sanity_lc(page_48328);
var vec__48301_48330 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page_48329__$1,"contents"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["contents",new cljs.core.Keyword(null,"contents","contents",-1567174023)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [page_48329__$1,new cljs.core.Keyword(null,"page","page",849072397)], null));
var db_id_48331 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48301_48330,(0),null);
var block_type_48332 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48301_48330,(1),null);
frontend.state.sidebar_add_block_BANG_(current_repo_48318,db_id_48331,block_type_48332);


var G__48333 = seq__48291_48324;
var G__48334 = chunk__48292_48325;
var G__48335 = count__48293_48326;
var G__48336 = (i__48294_48327 + (1));
seq__48291_48324 = G__48333;
chunk__48292_48325 = G__48334;
count__48293_48326 = G__48335;
i__48294_48327 = G__48336;
continue;
} else {
var temp__5720__auto___48337__$1 = cljs.core.seq(seq__48291_48324);
if(temp__5720__auto___48337__$1){
var seq__48291_48338__$1 = temp__5720__auto___48337__$1;
if(cljs.core.chunked_seq_QMARK_(seq__48291_48338__$1)){
var c__5565__auto___48339 = cljs.core.chunk_first(seq__48291_48338__$1);
var G__48340 = cljs.core.chunk_rest(seq__48291_48338__$1);
var G__48341 = c__5565__auto___48339;
var G__48342 = cljs.core.count(c__5565__auto___48339);
var G__48343 = (0);
seq__48291_48324 = G__48340;
chunk__48292_48325 = G__48341;
count__48293_48326 = G__48342;
i__48294_48327 = G__48343;
continue;
} else {
var page_48344 = cljs.core.first(seq__48291_48338__$1);
var page_48345__$1 = frontend.util.safe_page_name_sanity_lc(page_48344);
var vec__48304_48346 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page_48345__$1,"contents"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["contents",new cljs.core.Keyword(null,"contents","contents",-1567174023)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [page_48345__$1,new cljs.core.Keyword(null,"page","page",849072397)], null));
var db_id_48347 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48304_48346,(0),null);
var block_type_48348 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48304_48346,(1),null);
frontend.state.sidebar_add_block_BANG_(current_repo_48318,db_id_48347,block_type_48348);


var G__48349 = cljs.core.next(seq__48291_48338__$1);
var G__48350 = null;
var G__48351 = (0);
var G__48352 = (0);
seq__48291_48324 = G__48349;
chunk__48292_48325 = G__48350;
count__48293_48326 = G__48351;
i__48294_48327 = G__48352;
continue;
}
} else {
}
...
var G__48309 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class-names","class-names",1257115065),"fade",new cljs.core.Keyword(null,"timeout","timeout",-318625318),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"enter","enter",1792452624),(500),new cljs.core.Keyword(null,"exit","exit",351849638),(300)], null)], null);
var G__48310 = links;
return (frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2 ? frontend.ui.css_transition.cljs$core$IFn$_invoke$arity$2(G__48309,G__48310) : frontend.ui.css_transition.call(null,G__48309,G__48310));
} else {
return null;
}
})());
...
var map__48311 = state;
var map__48311__$1 = cljs.core.__destructure_map(map__48311);
var open_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48311__$1,new cljs.core.Keyword(null,"open-fn","open-fn",1265855718));
var current_repo = frontend.state.sub(new cljs.core.Keyword("git","current-repo","git/current-repo",107438825));
